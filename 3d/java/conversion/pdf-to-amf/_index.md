...
url: /java/conversion/pdf-to-amf/ 
description: Sample Java conversion code for PDF format to AMF file. Use this example code to convert PDF to AMF within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PDF to AMF via Java" h2="PDF to AMF conversion using Java library  without any 3D modeling software." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="AMF" pfName="Aspose.3D" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert PDF to AMF Using Java" %}}

 In order to render PDF to AMF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert PDF to AMF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D API makes it easy for the developers to convert PDF file to AMF in just a few lines of code.
...
{{< blocks/products/pf/agp/demobox sectionTitle="PDF to AMF Conversion Live Demos" sectionDescription="[Convert PDF to AMF](https://products.aspose.app/3d/conversion/pdf-to-amf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
