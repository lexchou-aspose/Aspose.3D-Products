...
{{% blocks/products/pf/agp/text %}}
 ...
 Java programmers can easily convert JT file to DRC in just a few lines of code.
...
{{< blocks/products/pf/agp/demobox-app sectionTitle="JT to DRC Conversion Live Demos" sectionDescription="[Convert JT to DRC](https://products.aspose.app/3d/conversion/jt-to-drc) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
