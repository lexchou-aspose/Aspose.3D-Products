---
title: แยกเนื้อหาจาก GLTF รูปแบบไฟล์ผ่าน .NET 
weight: 830
url: /th/net/extractor/gltf/ 
description: C# ซอร์สโค้ดเพื่อโหลด แสดงผล และเพิ่มเนื้อหาที่แยกจากเอกสาร GLTF ใน .NET Framework, .NET Core, Mono
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แยกเนื้อหาจาก GLTF ผ่าน C#" h2="สร้างแอป .NET ของคุณเองเพื่อแยกเนื้อหาจากไฟล์ GLTF โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแยกเนื้อหาจาก GLTF ไฟล์โดยใช้ C#" %}}

 ในการแยกเนื้อหาจากไฟล์ GLTF เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแยกเนื้อหาจาก GLTF ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D ทำให้นักพัฒนาสามารถดึงเนื้อหาจากไฟล์ GLTF ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

- โหลดไฟล์ GLTF ผ่านตัวสร้างของ Scene class- สร้างวัตถุรูปแบบไฟล์ zip เป็นรูปแบบไฟล์เอาต์พุต- สร้างคลาสเก็บถาวรและจัดการแยกคลาสสินทรัพย์- เรียกวิธีการแยกและบันทึกไฟล์
...
{{% blocks/products/pf/agp/code-block title="รหัส C# เพื่อแยกเนื้อหาจาก GLTF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D เป็น CAD และ Gameware API ในการโหลด แก้ไข และแปลงไฟล์ 3D API เป็นแบบสแตนด์อโลนและไม่จำเป็นต้องมี 3D ซอฟต์แวร์สร้างแบบจำลองหรือเรนเดอร์ใดๆ สามารถใช้ API สำหรับ Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX และรูปแบบอื่นๆ 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="แอปฟรีเพื่อแยกเนื้อหาจาก GLTF" sectionDescription="ตรวจสอบการสาธิตสดของเราที่ [ตัวแยก GLTF](https://products.aspose.app/3d/extractor/gltf) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" เพียงอัปโหลดไฟล์ GLTF แล้วกดปุ่ม \"แยก\"" >}}
