---
title: แยกเนื้อหาจาก U3D รูปแบบไฟล์ผ่าน .NET 
weight: 830
url: /th/net/extractor/u3d/ 
description: C# ซอร์สโค้ดเพื่อโหลด แสดงผล และเพิ่มเนื้อหาที่แยกจากเอกสาร U3D ใน .NET Framework, .NET Core, Mono
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แยกเนื้อหาจาก U3D ผ่าน C#" h2="สร้างแอป .NET ของคุณเองเพื่อแยกเนื้อหาจากไฟล์ U3D โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="U3D" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแยกเนื้อหาจาก U3D ไฟล์โดยใช้ C#" %}}

 ในการแยกเนื้อหาจากไฟล์ U3D เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแยกเนื้อหาจาก U3D ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D ทำให้นักพัฒนาสามารถดึงเนื้อหาจากไฟล์ U3D ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

- โหลดไฟล์ U3D ผ่านตัวสร้างของ Scene class- สร้างวัตถุรูปแบบไฟล์ zip เป็นรูปแบบไฟล์เอาต์พุต- สร้างคลาสเก็บถาวรและจัดการแยกคลาสสินทรัพย์- เรียกวิธีการแยกและบันทึกไฟล์
...
{{% blocks/products/pf/agp/code-block title="รหัส C# เพื่อแยกเนื้อหาจาก U3D" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D เป็น CAD และ Gameware API ในการโหลด แก้ไข และแปลงไฟล์ 3D API เป็นแบบสแตนด์อโลนและไม่จำเป็นต้องมี 3D ซอฟต์แวร์สร้างแบบจำลองหรือเรนเดอร์ใดๆ สามารถใช้ API สำหรับ Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX และรูปแบบอื่นๆ 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="แอปฟรีเพื่อแยกเนื้อหาจาก U3D" sectionDescription="ตรวจสอบการสาธิตสดของเราที่ [ตัวแยก U3D](https://products.aspose.app/3d/extractor/u3d) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" เพียงอัปโหลดไฟล์ U3D แล้วกดปุ่ม \"แยก\"" >}}
