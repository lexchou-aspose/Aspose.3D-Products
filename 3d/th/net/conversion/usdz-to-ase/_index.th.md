---
title: แปลง USDZ เป็น ASE ผ่าน C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง USDZ เป็น ASE ผ่าน C#" h2="ส่งออก USDZ และไฟล์ 3D อื่นๆ โดยใช้ .NET Framework, .NET Core และ Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ส่งออก USDZ ฉากเป็น ASE ด้วย C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# โค้ดสำหรับการแปลง USDZ ถึง ASE" gistPath="" %}}
```cs
