...
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง USD เป็น X ผ่าน C#" h2="ส่งออก USD และไฟล์ 3D อื่นๆ โดยใช้ .NET Framework, .NET Core และ Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ส่งออก USD ฉากเป็น X ด้วย C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# รหัสสำหรับการแปลง USD เป็น X" gistPath="" %}}
```cs
