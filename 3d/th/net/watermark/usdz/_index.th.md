---
title: เพิ่มลายน้ำตาบอดใน USDZ รูปแบบไฟล์ผ่าน .NET 
weight: 830
url: /th/net/watermark/usdz/ 
description: C# ซอร์สโค้ดเพื่อโหลด แสดงผล และเพิ่มลายน้ำที่มองไม่เห็นให้กับเอกสาร USDZ บน .NET Framework, .NET Core, Mono
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="เพิ่มลายน้ำตาบอดใน USDZ ผ่าน C#" h2="สร้างไฟล์ .NET แอปของคุณเองเพื่อใส่ลายน้ำ USDZ โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="USDZ" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="USDZ" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีใส่ลายน้ำให้กับ USDZ ไฟล์โดยใช้ C#" %}}

 เพื่อใส่ลายน้ำไฟล์ USDZ เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการเพิ่ม Blind Watermark ให้กับ USDZ ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D ช่วยให้นักพัฒนาเพิ่มลายน้ำตาบอดลงในไฟล์ USDZ ได้ง่ายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

- โหลดไฟล์ USDZ ผ่านตัวสร้างของ Scene class- รับคลาสตาข่ายของ Aspose.3D- เพิ่มลายน้ำและรหัสผ่านโดยใช้วิธี EncodeWatermark ของ Aspose.3D- เรียกเมธอด Scene.Save ด้วย object
...
{{% blocks/products/pf/agp/code-block title="รหัส C# เพื่อเพิ่มลายน้ำตาบอดใน USDZ" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="แอปฟรีสำหรับเพิ่มลายน้ำตาบอดใน USDZ" sectionDescription="ตรวจสอบการสาธิตสดของเราที่ [ลายน้ำ USDZ](https://products.aspose.app/3d/watermark/usdz) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" เพียงอัปโหลดไฟล์ USDZ แล้วกดปุ่ม \"ลายน้ำ\"" >}}
