---
title: เพิ่มการตรวจสอบลายน้ำตาบอดใน FBX รูปแบบไฟล์ผ่าน .NET 
weight: 830
url: /th/net/verify-watermark/fbx/ 
description: C# ซอร์สโค้ดเพื่อโหลด แสดงผล และเพิ่มการตรวจสอบลายน้ำที่มองไม่เห็นให้กับเอกสาร FBX บน .NET Framework, .NET Core, Mono
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="เพิ่ม Blind Watermark Verification ให้กับ FBX ผ่าน C#" h2="สร้างแอป .NET ของคุณเองเพื่อเพิ่มการตรวจสอบลายน้ำที่มองไม่เห็นให้กับไฟล์ FBX โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FBX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีตรวจสอบลายน้ำให้กับ FBX ไฟล์โดยใช้ C#" %}}

 เพื่อยืนยันลายน้ำ FBX ไฟล์ เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการเพิ่ม Blind Watermark Verification ให้กับ FBX ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D ช่วยให้นักพัฒนาเพิ่มการตรวจสอบลายน้ำที่มองไม่เห็นในไฟล์ FBX ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

- โหลดไฟล์ FBX ผ่านตัวสร้างของ Scene class- รับคลาสตาข่ายของ Aspose.3D- เพิ่มรหัสผ่านโดยใช้วิธี DecodeWatermark ของ Aspose.3D- เรียกเมธอด Scene.Save ด้วย object
...
{{% blocks/products/pf/agp/code-block title="รหัส C# เพื่อเพิ่มการตรวจสอบลายน้ำตาบอดใน FBX" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="แอปฟรีเพื่อเพิ่มการตรวจสอบลายน้ำตาบอดใน FBX" sectionDescription="ตรวจสอบการสาธิตสดของเราที่ [การตรวจสอบลายน้ำ FBX](https://products.aspose.app/3d/verify-watermark/fbx) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
