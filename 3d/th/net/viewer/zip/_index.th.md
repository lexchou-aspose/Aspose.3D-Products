---
title: ดู ZIP รูปแบบไฟล์ผ่าน .NET 
weight: 620
url: /th/net/viewer/zip/ 
description: C# ซอร์สโค้ดสำหรับโหลด แสดงผล และแสดง ZIP เอกสารบน .NET Framework, .NET Core, Mono
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ZIP โปรแกรมดูไฟล์ for .NET" h2="แสดงผลไฟล์ ZIP โดยไม่มีซอฟต์แวร์สร้างแบบจำลองและแสดงผล 3D" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ZIP" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ZIP" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีดูไฟล์ ZIP โดยใช้ C#" %}}

 ในการดูไฟล์ ZIP เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการดู ZIP ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D ทำให้นักพัฒนาสามารถดูไฟล์ ZIP ได้ง่ายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ ZIP ผ่านตัวสร้างของ Scene class1. สร้างอินสแตนซ์ของ Html5SaveOptions1. ตั้งค่าคุณสมบัติสำหรับการจัดรูปแบบขั้นสูง1. เรียกเมธอด Scene.Save ด้วยอ็อบเจกต์ของ Html5SaveOptions1. ตรวจสอบไฟล์ผลลัพธ์ HTML ในเบราว์เซอร์เริ่มต้น
...
{{% blocks/products/pf/agp/code-block title="C# รหัสเพื่อดู ZIP" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// โหลดฉาก ZIP ผ่านอินสแตนซ์ของ Scene
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D เป็น CAD และ Gameware API ในการโหลด แก้ไข และแปลงไฟล์ 3D API เป็นแบบสแตนด์อโลนและไม่จำเป็นต้องมี 3D ซอฟต์แวร์สร้างแบบจำลองหรือเรนเดอร์ใดๆ สามารถใช้ API สำหรับ Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX และรูปแบบอื่นๆ 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="แอปฟรีเพื่อดู ZIP" sectionDescription="ตรวจสอบการสาธิตสดของเราที่ [ดู ZIP](https://products.aspose.app/3d/viewer/zip) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" เพียงอัปโหลดไฟล์ ZIP แล้วกดปุ่ม \"ดู\"" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" ดาวน์โหลดไฟล์ ZIP จากลิงก์ ถ้าจำเป็น" >}}

        {{< blocks/products/pf/agp/i18n/about-file-text fileFormat="ZIP" readMoreLink="https://docs.fileformat.com/compression/zip/" >}}
ZIP นามสกุลไฟล์หมายถึงไฟล์เก็บถาวรที่สามารถเก็บไฟล์หรือไดเรกทอรีได้ตั้งแต่หนึ่งไฟล์ขึ้นไป ไฟล์เก็บถาวรสามารถใช้การบีบอัดกับไฟล์ที่รวมไว้เพื่อลดขนาดไฟล์ ZIP รูปแบบไฟล์ ZIP ได้รับการเผยแพร่สู่สาธารณะในเดือนกุมภาพันธ์ 1989 โดย Phil Katz เพื่อให้สามารถเก็บถาวรไฟล์และโฟลเดอร์ได้สำเร็จ รูปแบบนี้ทำให้เป็นส่วนหนึ่งของยูทิลิตี้ PKZIP ซึ่งสร้างโดย PKWARE, Inc. หลังจากที่มีข้อกำหนดเฉพาะที่พร้อมใช้งาน หลายบริษัทได้ทำให้รูปแบบไฟล์ ZIP เป็นส่วนหนึ่งของยูทิลิตี้ซอฟต์แวร์ของตน รวมถึง Microsoft (ตั้งแต่ Windows 7), Apple (Mac OS X) และอื่น ๆ อีกมากมาย.
