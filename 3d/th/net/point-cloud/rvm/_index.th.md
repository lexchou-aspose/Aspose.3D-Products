---
title: สร้าง Point Cloud เป็น RVM รูปแบบไฟล์ผ่าน .NET 
weight: 830
url: /th/net/point-cloud/rvm/ 
description: C# ซอร์สโค้ดสำหรับโหลด แสดงผล และเพิ่ม create point cloud ให้กับเอกสาร RVM บน .NET Framework, .NET Core, Mono
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="สร้าง Point Cloud ไปที่ RVM ผ่าน C#" h2="สร้างแอป .NET ของคุณเองเพื่อสร้าง point cloud ไปยังไฟล์ RVM โดยใช้ API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="RVM" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="RVM" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีสร้าง Point Cloud ไปยัง RVM ไฟล์โดยใช้ C#" %}}

 ในการสร้าง point cloud ไปยังไฟล์ RVM เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้าง Point Cloud ไปยัง RVM ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D ช่วยให้นักพัฒนาสามารถสร้าง point cloud ไปยังไฟล์ RVM ได้ง่ายโดยใช้โค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

- โหลดไฟล์ RVM ผ่านตัวสร้างของ Scene class- รับวัตถุ pointcloud ของ Aspose.3D- สร้างอ็อบเจ็กต์การแปลงผ่านเมธอด EvaluateGlobalTransform- สร้าง point cloud โดยใช้ Merge method- เรียกเมธอด Scene.Save ด้วย object
...
{{% blocks/products/pf/agp/code-block title="รหัส C# เพื่อสร้าง Point Cloud ไปยัง RVM" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="แอปฟรีสำหรับสร้าง Point Cloud ไปยัง RVM" sectionDescription="ตรวจสอบการสาธิตสดของเราที่ [พอยต์คลาวด์ 3DS](https://products.aspose.app/3d/point-cloud/rvm) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" เพียงอัปโหลดไฟล์ RVM แล้วกดปุ่ม \"สร้าง\"" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" ดาวน์โหลดไฟล์ RVM จากลิงก์ ถ้าจำเป็น" >}}
