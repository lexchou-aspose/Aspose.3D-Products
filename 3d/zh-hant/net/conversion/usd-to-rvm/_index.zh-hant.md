...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 USD 轉換為 RVM" h2="使用 .NET Framework、.NET Core 和 Mono 導出 USD 和其他 3D 文件" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# USD 到 RVM 轉換的代碼" gistPath="" %}}
```cs
// 在 Scene 對像中加載 USD 
