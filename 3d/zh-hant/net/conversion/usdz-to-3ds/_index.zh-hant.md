...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 USDZ 轉換為 3DS" h2="使用 .NET Framework、.NET Core 和 Mono 導出 USDZ 和其他 3D 文件" >}}
...
3. 將帶有 .3ds 擴展名的輸出文件名作為第一個參數傳遞
4. 指定 `Discreet3DS` 字段值 [文件格式](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) 班級
...
{{% blocks/products/pf/agp/code-autogen title="C# USDZ 到 3DS 轉換的代碼" gistPath="" %}}
```cs
// 在 Scene 對像中加載 USDZ 
