...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 USDZ 轉換為 AMF" h2="使用 .NET Framework、.NET Core 和 Mono 導出 USDZ 和其他 3D 文件" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# USDZ 到 AMF 轉換的代碼" gistPath="" %}}
```cs
// 在 Scene 對像中加載 USDZ 
