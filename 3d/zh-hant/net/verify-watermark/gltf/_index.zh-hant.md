---
title: 通過 .NET 向 GLTF 文件格式添加盲水印驗證 
weight: 830
url: /zh-hant/net/verify-watermark/gltf/ 
description: C# 源代碼，用於在 .NET Framework、.NET Core、Mono 上加載、呈現和添加盲水印驗證到 GLTF 文檔。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將盲水印驗證添加到 GLTF" h2="構建您自己的 .NET 應用以使用服務器端 API 向 GLTF 文件添加盲水印驗證。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 為 GLTF 文件添加水印驗證" %}}

 為了給驗證 GLTF 文件添加水印，我們將使用
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D 使開發人員只需幾行代碼即可輕鬆地將盲水印驗證添加到 GLTF 文件中。

{{% /blocks/products/pf/agp/text %}}

- 通過 Scene 類的構造函數加載 GLTF 文件- 獲取 Aspose.3D 的網格類- 使用 Aspose.3D 的 DecodeWatermark 方法添加密碼- 使用對象調用 Scene.Save 方法
...
{{% blocks/products/pf/agp/code-block title="用於向 GLTF 添加盲水印驗證的 C# 代碼" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="向 GLTF 添加盲水印驗證的免費應用程序" sectionDescription="查看我們的現場演示 [水印驗證 GLTF](https://products.aspose.app/3d/verify-watermark/gltf) 具有以下好處。" >}}
