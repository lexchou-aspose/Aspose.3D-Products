---
title: Agregar marca de agua ciega a GLTF formatos de archivo a través de .NET 
weight: 830
url: /es/net/watermark/gltf/ 
description: C# código fuente para cargar, procesar y agregar una marca de agua oculta a GLTF documentos en .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Agregar marca de agua ciega a GLTF a través de C#" h2="Cree sus propias aplicaciones .NET para agregar marcas de agua a GLTF archivos mediante las API del lado del servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo poner una marca de agua en un archivo GLTF usando C#" %}}

 Para poner una marca de agua en el archivo GLTF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para agregar una marca de agua ciega a GLTF a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D facilita a los desarrolladores agregar una marca de agua oculta al archivo GLTF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

- Cargue el archivo GLTF a través del constructor de la clase Escena- Obtener la clase de malla de Aspose.3D- Añadir marca de agua y contraseña mediante el método EncodeWatermark de Aspose.3D- Llame al método Scene.Save con objeto
...
{{% blocks/products/pf/agp/code-block title="Código C# para agregar marca de agua ciega a GLTF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para agregar una marca de agua ciega a GLTF" sectionDescription="Consulte nuestras demostraciones en vivo para [Marca de agua GLTF](https://products.aspose.app/3d/watermark/gltf) con los siguientes beneficios." >}}
