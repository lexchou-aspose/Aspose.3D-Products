...
description: C# código fuente para cargar, procesar y agregar una marca de agua oculta a 3DS documentos en .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Agregar marca de agua ciega a 3DS a través de C#" h2="Cree sus propias aplicaciones .NET para agregar marcas de agua a 3DS archivos mediante las API del lado del servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo poner una marca de agua en un archivo 3DS usando C#" %}}

 Para poner una marca de agua en el archivo 3DS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para agregar una marca de agua ciega a 3DS a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D facilita a los desarrolladores agregar una marca de agua oculta al archivo 3DS con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

- Cargue el archivo 3DS a través del constructor de la clase Escena- Obtener la clase de malla de Aspose.3D- Añadir marca de agua y contraseña mediante el método EncodeWatermark de Aspose.3D- Llame al método Scene.Save con objeto
...
{{% blocks/products/pf/agp/code-block title="Código C# para agregar marca de agua ciega a 3DS" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D es un CAD y Gameware API para cargar, modificar y convertir archivos 3D. API es independiente y no requiere ningún 3D software de modelado o renderizado. Uno puede usar fácilmente API para Discreet3DS, WavefrontOBJ, STL (ASCII, binario), Universal3D, FBX (ASCII, binario), Collada, glTF, PLY, GLB, DirectX y más formatos. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para agregar una marca de agua ciega a 3DS" sectionDescription="Consulte nuestras demostraciones en vivo para [Marca de agua 3DS](https://products.aspose.app/3d/watermark/3ds) con los siguientes beneficios." >}}
