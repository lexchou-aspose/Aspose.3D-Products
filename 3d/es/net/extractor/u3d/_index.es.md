---
title: Extraiga activos de U3D formatos de archivo a través de .NET 
weight: 830
url: /es/net/extractor/u3d/ 
description: Código fuente de C# para cargar, renderizar y agregar activos extraídos de U3D documentos en .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraer activos de U3D a través de C#" h2="Cree sus propias aplicaciones .NET para extraer recursos de archivos U3D mediante las API del lado del servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="U3D" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo extraer activos del archivo U3D usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para extraer activos de U3D a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Código C# para extraer recursos de U3D" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D es un CAD y Gameware API para cargar, modificar y convertir archivos 3D. API es independiente y no requiere ningún 3D software de modelado o renderizado. Uno puede usar fácilmente API para Discreet3DS, WavefrontOBJ, STL (ASCII, binario), Universal3D, FBX (ASCII, binario), Collada, glTF, PLY, GLB, DirectX y más formatos. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para extraer activos de U3D" sectionDescription="Consulte nuestras demostraciones en vivo para [Extractor U3D](https://products.aspose.app/3d/extractor/u3d) con los siguientes beneficios." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar ni configurar nada" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir o compilar código" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue el archivo U3D y presione el botón \"Extraer\"" >}}
