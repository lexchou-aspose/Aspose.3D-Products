---
title: Convertir USD a RVM a través de C# 
description: Convierta USD y otros 3D archivos usando .NET API
url: /es/net/conversion/usd-to-rvm/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir USD a RVM a través de C#" h2="Exporte USD y otros 3D archivos usando .NET Framework, .NET Core y Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportar USD escena como RVM con C#" %}}
...
3. Pase el nombre del archivo de salida con la extensión .rvm como primer parámetro
4. Especifique el valor del campo `RvmBinary` de [Formato de archivo](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) clase
...
{{% blocks/products/pf/agp/code-autogen title="C# Código para USD a RVM Conversión" gistPath="" %}}
```cs
// carga el USD en un objeto de Escena 
var scene = new Aspose.ThreeD.Scene("template.usd");
// guardar USD como RVM 
