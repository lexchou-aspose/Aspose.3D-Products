---
title: Convertir USD a JT a través de C# 
description: Convierta USD y otros 3D archivos usando .NET API
url: /es/net/conversion/usd-to-jt/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir USD a JT a través de C#" h2="Exporte USD y otros 3D archivos usando .NET Framework, .NET Core y Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportar USD escena como JT con C#" %}}
...
3. Pase el nombre del archivo de salida con la extensión .jt como primer parámetro
4. Especifique el valor del campo `SiemensJT9` de [Formato de archivo](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) clase
...
{{% blocks/products/pf/agp/code-autogen title="C# Código para USD a JT Conversión" gistPath="" %}}
```cs
