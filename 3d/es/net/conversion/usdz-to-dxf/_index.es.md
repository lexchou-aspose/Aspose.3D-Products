...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir USDZ a DXF a través de C#" h2="Exporte USDZ y otros 3D archivos usando .NET Framework, .NET Core y Mono" >}}
...
3. Pase el nombre del archivo de salida con la extensión .dxf como primer parámetro
4. Especifique el valor del campo `DXF` de [Formato de archivo](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) clase
...
{{% blocks/products/pf/agp/code-autogen title="C# Código para USDZ a DXF Conversión" gistPath="" %}}
```cs
