---
title: Convertir PDF a AMF a través de C# 
weight: 1570
url: /es/net/conversion/pdf-to-amf/ 
description: Ejemplo de código para la conversión de PDF a AMF C#. Utilice el código de ejemplo API para la conversión por lotes de archivos PDF a AMF dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PDF a AMF a través de C#" h2="Renderizar PDF como AMF sin ningún software de modelado y renderizado 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="AMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir PDF a AMF usando C#" %}}

 Para convertir PDF a AMF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir PDF a AMF a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Los programadores de .NET pueden cargar y convertir fácilmente archivos PDF a AMF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo PDF a través del constructor de la clase Escena1. Crear una instancia de AmfSaveOptions1. Establecer AMF propiedades específicas para la conversión avanzada1. Llame al método Scene.Save1. Pase la ruta de salida con la extensión de archivo AMF y el objeto de AmfSaveOptions1. Compruebe el archivo AMF resultante en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de PDF a AMF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir PDF a AMF" sectionDescription="Consulte nuestras demostraciones en vivo para [conversión de PDF a AMF](https://products.aspose.app/3d/conversion/pdf-to-amf) con los siguientes beneficios." >}}
