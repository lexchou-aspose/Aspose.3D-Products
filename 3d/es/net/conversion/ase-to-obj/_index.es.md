---
title: Convertir ASE a OBJ a través de C# 
weight: 1890
url: /es/net/conversion/ase-to-obj/ 
description: Ejemplo de código para la conversión de ASE a OBJ C#. Utilice el código de ejemplo API para la conversión por lotes de archivos ASE a OBJ dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir ASE a OBJ a través de C#" h2="Renderizar ASE como OBJ sin ningún software de modelado y renderizado 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ASE" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir ASE a OBJ usando C#" %}}

 Para convertir ASE a OBJ, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir ASE a OBJ a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Los programadores de .NET pueden cargar y convertir fácilmente archivos ASE a OBJ con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo ASE a través del constructor de la clase Escena1. Crear una instancia de ObjSaveOptions1. Establecer OBJ propiedades específicas para la conversión avanzada1. Llame al método Scene.Save1. Pase la ruta de salida con la extensión de archivo OBJ y el objeto de ObjSaveOptions1. Compruebe el archivo OBJ resultante en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de ASE a OBJ C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir ASE a OBJ" sectionDescription="Consulte nuestras demostraciones en vivo para [conversión de ASE a OBJ](https://products.aspose.app/3d/conversion/ase-to-obj) con los siguientes beneficios." >}}
