---
title: Convertir AMF a FBX a través de C# 
weight: 2770
url: /es/net/conversion/amf-to-fbx/ 
description: Ejemplo de código para la conversión de AMF a FBX C#. Utilice el código de ejemplo API para la conversión por lotes de archivos AMF a FBX dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir AMF a FBX a través de C#" h2="Renderizar AMF como FBX sin ningún software de modelado y renderizado 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir AMF a FBX usando C#" %}}

 Para convertir AMF a FBX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir AMF a FBX a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Los programadores de .NET pueden cargar y convertir fácilmente archivos AMF a FBX con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo AMF a través del constructor de la clase Escena1. Crear una instancia de FbxSaveOptions1. Establecer FBX propiedades específicas para la conversión avanzada1. Llame al método Scene.Save1. Pase la ruta de salida con la extensión de archivo FBX y el objeto de FbxSaveOptions1. Compruebe el archivo FBX resultante en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de AMF a FBX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir AMF a FBX" sectionDescription="Consulte nuestras demostraciones en vivo para [conversión de AMF a FBX](https://products.aspose.app/3d/conversion/amf-to-fbx) con los siguientes beneficios." >}}
