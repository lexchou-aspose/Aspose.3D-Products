...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir USD a DAE a través de C#" h2="Exporte USD y otros 3D archivos usando .NET Framework, .NET Core y Mono" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Código para USD a DAE Conversión" gistPath="" %}}
```cs
