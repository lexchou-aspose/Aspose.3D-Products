---
title: Cree su litofanía a partir de formatos de archivo PNG a través de .NET 
weight: 830
url: /es/net/lithophane/png/ 
description: C# código fuente para cargar, renderizar y crear su litofanía en documentos PNG en .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crea tu Lithophane a PNG a través de C#" h2="Cree sus propias aplicaciones .NET para crear su litofanía en archivos PNG mediante las API del lado del servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="PNG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo crear su archivo Lithophane a PNG usando C#" %}}

 Para crear su litofano a archivo PNG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para crear su Lithophane a PNG a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D facilita a los desarrolladores la creación de su litofanía en el archivo PNG con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

- Cree algunos parámetros nuevos y cree un objeto de malla- Realizar operaciones computacionales en objetos de malla- El archivo PNG carga la escena 3d a través de la clase Mesh- Llame al método Scene.Save con objeto
...
{{% blocks/products/pf/agp/code-block title="C# código para crear tu Lithophane a PNG" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D es un CAD y Gameware API para cargar, modificar y convertir archivos 3D. API es independiente y no requiere ningún 3D software de modelado o renderizado. Uno puede usar fácilmente API para Discreet3DS, WavefrontOBJ, STL (ASCII, binario), Universal3D, FBX (ASCII, binario), Collada, glTF, PLY, GLB, DirectX y más formatos. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para crear tu litofanía a PNG" sectionDescription="Consulte nuestras demostraciones en vivo para [Litofanía PNG](https://products.aspose.app/3d/lithophane/png) con los siguientes beneficios." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar ni configurar nada" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir o compilar código" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue el archivo PNG y presione el botón \"litofanía\"" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Descargue el archivo PNG desde el enlace, si es necesario" >}}
