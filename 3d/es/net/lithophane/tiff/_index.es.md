---
title: Cree su litofanía a partir de formatos de archivo TIFF a través de .NET 
weight: 830
url: /es/net/lithophane/tiff/ 
description: C# código fuente para cargar, renderizar y crear su litofanía en documentos TIFF en .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Cree su Lithophane a TIFF a través de C#" h2="Cree sus propias aplicaciones .NET para crear su litofano en archivos TIFF mediante las API del lado del servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="TIFF" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo crear su archivo Lithophane to TIFF usando C#" %}}

 Para crear su litofano en un archivo TIFF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para crear su litofanía a TIFF a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D facilita a los desarrolladores la creación de su litofanía en el archivo TIFF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

- Cree algunos parámetros nuevos y cree un objeto de malla- Realizar operaciones computacionales en objetos de malla- El archivo TIFF carga la escena 3d a través de la clase Mesh- Llame al método Scene.Save con objeto
...
{{% blocks/products/pf/agp/code-block title="C# código para crear su Lithophane a TIFF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D es un CAD y Gameware API para cargar, modificar y convertir archivos 3D. API es independiente y no requiere ningún 3D software de modelado o renderizado. Uno puede usar fácilmente API para Discreet3DS, WavefrontOBJ, STL (ASCII, binario), Universal3D, FBX (ASCII, binario), Collada, glTF, PLY, GLB, DirectX y más formatos. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App Gratuita para Crear tu Litofanía a TIFF" sectionDescription="Consulte nuestras demostraciones en vivo para [TIFF litófano](https://products.aspose.app/3d/lithophane/tiff) con los siguientes beneficios." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar ni configurar nada" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir o compilar código" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue el archivo TIFF y presione el botón \"litofanía\"" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Descargue el archivo TIFF desde el enlace, si es necesario" >}}
