...
{{% blocks/products/pf/agp/text %}}
 ...
 Los programadores de Java pueden convertir fácilmente el archivo DRC en FBX con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo DRC a través del constructor de la clase Escena1. Crear una instancia de FbxSaveOptions1. Establecer FBX propiedades específicas para la conversión avanzada1. Llamar al método Scene.save1. Pase la ruta de salida con la extensión de archivo FBX y el objeto de FbxSaveOptions
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de DRC a FBX Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Demostraciones en vivo de conversión de DRC a FBX" sectionDescription="[Convertir DRC a FBX](https://products.aspose.app/3d/conversion/drc-to-fbx) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo DRC, se convertirá instantáneamente a FBX." >}}
