...
description: Muestra el código de conversión Java para el formato FBX en el archivo U3D. Utilice este código de ejemplo para convertir FBX a U3D dentro de cualquier aplicación basada en Java web o de escritorio.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los programadores de Java pueden convertir fácilmente el archivo FBX en U3D con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo FBX a través del constructor de la clase Escena1. Crear una instancia de U3dSaveOptions1. Establecer U3D propiedades específicas para la conversión avanzada1. Llamar al método Scene.save1. Pase la ruta de salida con la extensión de archivo U3D y el objeto de U3dSaveOptions
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de FBX a U3D Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Demostraciones en vivo de conversión de FBX a U3D" sectionDescription="[Convertir FBX a U3D](https://products.aspose.app/3d/conversion/fbx-to-u3d) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo FBX, se convertirá instantáneamente a U3D." >}}
