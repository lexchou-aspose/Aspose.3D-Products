---
title: Convertir 3DS a DRC a través de Java 
url: /es/java/conversion/3ds-to-drc/ 
description: Muestra el código de conversión Java para el formato 3DS en el archivo DRC. Utilice este código de ejemplo para convertir 3DS a DRC dentro de cualquier aplicación basada en Java web o de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir 3DS a DRC a través de Java" h2="Conversión de 3DS a DRC utilizando la biblioteca Java sin ningún software de modelado 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir 3DS a DRC usando Java" %}}

 Para representar 3DS a DRC, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir 3DS a DRC a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los programadores de Java pueden convertir fácilmente el archivo 3DS en DRC con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo 3DS a través del constructor de la clase Escena1. Crear una instancia de DrcSaveOptions1. Establecer DRC propiedades específicas para la conversión avanzada1. Llamar al método Scene.save1. Pase la ruta de salida con la extensión de archivo DRC y el objeto de DrcSaveOptions
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de 3DS a DRC Java" offSpacer="" %}}
