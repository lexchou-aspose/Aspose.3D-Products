---
title: Wyodrębnij zasoby z OBJ formatów plików przez .NET 
weight: 830
url: /pl/net/extractor/obj/ 
description: C# kod źródłowy do ładowania, renderowania i dodawania wyodrębnianych zasobów z OBJ dokumentów w .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wyodrębnij zasoby z OBJ przez C#" h2="Twórz własne .NET aplikacje, aby wyodrębniać zasoby z OBJ plików, korzystając z interfejsów API po stronie serwera." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wyodrębnić zasoby z pliku OBJ za pomocą C#" %}}

 Aby wyodrębnić zasoby z pliku OBJ, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wyodrębnić zasoby z OBJ za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D ułatwia programistom wyodrębnianie zasobów z pliku OBJ za pomocą zaledwie kilku linijek kodu.

{{% /blocks/products/pf/agp/text %}}

- Załaduj plik OBJ za pomocą konstruktora klasy Scene- Utwórz obiekt formatu pliku zip jako format pliku wyjściowego- Utwórz klasę archiwum i obsługuj wyodrębnioną klasę aktywów- Wywołaj metodę Extract i zapisz plik
...
{{% blocks/products/pf/agp/code-block title="C# kod do wyodrębniania zasobów z OBJ" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D to CAD i Gameware API do ładowania, modyfikowania i konwertowania plików 3D. API jest samodzielny i nie wymaga żadnego 3D oprogramowania do modelowania ani renderowania. Można łatwo użyć API dla Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX i inne formaty. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezpłatna aplikacja do wyodrębniania zasobów z OBJ" sectionDescription="Sprawdź nasze prezentacje na żywo, aby [Ekstraktor OBJ](https://products.aspose.app/3d/extractor/obj) z następującymi korzyściami." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij plik OBJ i naciśnij przycisk „Wyodrębnij”" >}}
