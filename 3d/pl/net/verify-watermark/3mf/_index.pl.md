---
title: Dodaj ślepą weryfikację znaku wodnego do 3MF formatów plików za pośrednictwem .NET 
weight: 830
url: /pl/net/verify-watermark/3mf/ 
description: C# kod źródłowy do ładowania, renderowania i dodawania ślepej weryfikacji znaku wodnego do 3MF dokumentów w .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Dodaj ślepą weryfikację znaku wodnego do 3MF przez C#" h2="Twórz własne .NET aplikacje, aby dodawać ślepą weryfikację znaku wodnego do 3MF plików przy użyciu interfejsów API po stronie serwera." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3MF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3MF" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Jak weryfikować znak wodny do pliku 3MF przy użyciu C#" %}}

 W celu weryfikacji znaku wodnego 3MF plik, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, jak dodać ślepą weryfikację znaku wodnego do 3MF przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D ułatwia programistom dodawanie ślepej weryfikacji znaku wodnego do pliku 3MF za pomocą zaledwie kilku linijek kodu.

{{% /blocks/products/pf/agp/text %}}

- Załaduj plik 3MF za pomocą konstruktora klasy Scene- Pobierz klasę siatki Aspose.3D- Dodaj hasło za pomocą metody DecodeWatermark użytkownika Aspose.3D- Wywołaj metodę Scene.Save z obiektem
...
{{% blocks/products/pf/agp/code-block title="C# kod do dodania ślepej weryfikacji znaku wodnego do 3MF" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezpłatna aplikacja do dodawania ślepej weryfikacji znaku wodnego do 3MF" sectionDescription="Sprawdź nasze prezentacje na żywo, aby [Weryfikacja znaku wodnego 3MF](https://products.aspose.app/3d/verify-watermark/3mf) z następującymi korzyściami." >}}
