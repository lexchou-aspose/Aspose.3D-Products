---
title: Konwertuj ATT na PDF przez C# 
url: /pl/net/conversion/att-to-pdf/ 
description: Przykładowy kod konwersji ATT na PDF C#. Użyj API przykładowego kodu dla plików wsadowych ATT do konwersji PDF w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ATT na PDF przez C#" h2="Renderuj ATT jako PDF bez żadnego oprogramowania do modelowania i renderowania 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ATT na PDF przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki ATT na PDF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik ATT za pomocą konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Ustaw PDF określone właściwości dla zaawansowanej konwersji1. Wywołaj metodę Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku PDF i obiektem PdfSaveOptions1. Sprawdź wynikowy plik PDF w określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji ATT na PDF" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z ATT do PDF](https://products.aspose.app/3d/conversion/att-to-pdf) z następującymi korzyściami." >}}
