---
title: Konwertuj AMF na DAE przez C# 
weight: 3110
url: /pl/net/conversion/amf-to-dae/ 
description: Przykładowy kod konwersji AMF na DAE C#. Użyj API przykładowego kodu dla plików wsadowych AMF do konwersji DAE w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować AMF na DAE przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki AMF na DAE w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik AMF za pomocą konstruktora klasy Scene1. Utwórz instancję DaeSaveOptions1. Ustaw DAE określone właściwości dla zaawansowanej konwersji1. Wywołaj metodę Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku DAE i obiektem DaeSaveOptions1. Sprawdź wynikowy plik DAE w określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji AMF na DAE" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z AMF do DAE](https://products.aspose.app/3d/conversion/amf-to-dae) z następującymi korzyściami." >}}
