---
title: Konwertuj USDZ na 3MF przez C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj USDZ na 3MF przez C#" h2="Eksportuj USDZ i inne 3D pliki za pomocą .NET Framework, .NET Core i Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Eksportuj USDZ scenę jako 3MF z C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod konwersji USDZ na 3MF" gistPath="" %}}
```cs
