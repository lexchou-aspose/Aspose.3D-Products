---
title: Konwertuj USDZ na ASE przez C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj USDZ na ASE przez C#" h2="Eksportuj USDZ i inne 3D pliki za pomocą .NET Framework, .NET Core i Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Eksportuj USDZ scenę jako ASE z C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod konwersji USDZ na ASE" gistPath="" %}}
```cs
