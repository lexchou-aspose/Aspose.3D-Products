---
title: Konwertuj OBJ na GLTF przez C# 
url: /pl/net/conversion/obj-to-gltf/ 
description: Przykładowy kod konwersji OBJ na GLTF C#. Użyj API przykładowego kodu dla plików wsadowych OBJ do konwersji GLTF w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj OBJ na GLTF przez C#" h2="Renderuj OBJ jako GLTF bez żadnego oprogramowania do modelowania i renderowania 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować OBJ na GLTF przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki OBJ na GLTF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik OBJ za pomocą konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Ustaw GLTF określone właściwości dla zaawansowanej konwersji1. Wywołaj metodę Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku GLTF i obiektem GltfSaveOptions1. Sprawdź wynikowy plik GLTF w określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji OBJ na GLTF" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z OBJ do GLTF](https://products.aspose.app/3d/conversion/obj-to-gltf) z następującymi korzyściami." >}}
