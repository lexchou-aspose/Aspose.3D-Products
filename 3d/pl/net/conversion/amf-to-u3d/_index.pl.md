...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować AMF na U3D przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki AMF na U3D w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik AMF za pomocą konstruktora klasy Scene1. Utwórz instancję U3dSaveOptions1. Ustaw U3D określone właściwości dla zaawansowanej konwersji1. Wywołaj metodę Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku U3D i obiektem U3dSaveOptions1. Sprawdź wynikowy plik U3D w określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji AMF na U3D" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z AMF do U3D](https://products.aspose.app/3d/conversion/amf-to-u3d) z następującymi korzyściami." >}}
