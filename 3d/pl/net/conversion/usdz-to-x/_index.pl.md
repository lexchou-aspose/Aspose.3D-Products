...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj USDZ na X przez C#" h2="Eksportuj USDZ i inne 3D pliki za pomocą .NET Framework, .NET Core i Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Eksportuj USDZ scenę jako X z C#" %}}
...
3. Przekaż nazwę pliku wyjściowego z rozszerzeniem .x jako pierwszy parametr
4. Określ wartość pola `XBinary` z [Format pliku](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) klasa
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod konwersji USDZ na X" gistPath="" %}}
```cs
