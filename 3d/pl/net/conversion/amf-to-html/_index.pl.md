...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować AMF na HTML przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki AMF na HTML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik AMF za pomocą konstruktora klasy Scene1. Utwórz instancję HtmlSaveOptions1. Ustaw HTML określone właściwości dla zaawansowanej konwersji1. Wywołaj metodę Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku HTML i obiektem HtmlSaveOptions1. Sprawdź wynikowy plik HTML w określonej ścieżce
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od AMF do HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji AMF na HTML" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z AMF do HTML](https://products.aspose.app/3d/conversion/amf-to-html) z następującymi korzyściami." >}}
