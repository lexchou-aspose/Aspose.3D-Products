---
title: Konwertuj VRML na PLY przez Java 
weight: 1270
url: /pl/java/conversion/vrml-to-ply/ 
description: Przykładowy kod konwersji Java dla formatu VRML na plik PLY. Użyj tego przykładowego kodu, aby przekonwertować VRML na PLY w dowolnej aplikacji internetowej lub na komputerze Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VRML na PLY przez Java" h2="Konwersja z VRML do PLY przy użyciu biblioteki Java bez żadnego oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VRML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VRML na PLY za pomocą Java" %}}
 ...
 Aby wyrenderować VRML do PLY, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VRML na PLY przez Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik VRML na PLY w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VRML za pomocą konstruktora klasy Scene1. Utwórz instancję PlySaveOptions1. Ustaw PLY określone właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku PLY i obiektem PlySaveOptions
...
{{% blocks/products/pf/agp/code-block title="VRML do PLY Java Kodu źródła konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Od VRML do PLY demonstracji konwersji na żywo" sectionDescription="[Konwertuj VRML na PLY](https://products.aspose.app/3d/conversion/vrml-to-ply) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik VRML, zostanie on natychmiast przekonwertowany na PLY." >}}
