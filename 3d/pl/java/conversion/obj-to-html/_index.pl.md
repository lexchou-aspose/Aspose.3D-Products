---
title: Konwertuj OBJ na HTML przez Java 
weight: 850
url: /pl/java/conversion/obj-to-html/ 
description: Przykładowy kod konwersji Java dla formatu OBJ na plik HTML. Użyj tego przykładowego kodu, aby przekonwertować OBJ na HTML w dowolnej aplikacji internetowej lub na komputerze Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj OBJ na HTML przez Java" h2="Konwersja z OBJ do HTML przy użyciu biblioteki Java bez żadnego oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować OBJ na HTML za pomocą Java" %}}
 ...
 Aby wyrenderować OBJ do HTML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować OBJ na HTML przez Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik OBJ na HTML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik OBJ za pomocą konstruktora klasy Scene1. Utwórz instancję HtmlSaveOptions1. Ustaw HTML określone właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku HTML i obiektem HtmlSaveOptions
...
{{% blocks/products/pf/agp/code-block title="OBJ do HTML Java Kodu źródła konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Od OBJ do HTML demonstracji konwersji na żywo" sectionDescription="[Konwertuj OBJ na HTML](https://products.aspose.app/3d/conversion/obj-to-html) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik OBJ, zostanie on natychmiast przekonwertowany na HTML." >}}
