---
title: Konwertuj ASE na 3DS przez Java 
weight: 770
url: /pl/java/conversion/ase-to-3ds/ 
description: Przykładowy kod konwersji Java dla formatu ASE na plik 3DS. Użyj tego przykładowego kodu, aby przekonwertować ASE na 3DS w dowolnej aplikacji internetowej lub na komputerze Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ASE na 3DS przez Java" h2="Konwersja z ASE do 3DS przy użyciu biblioteki Java bez żadnego oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ASE" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować ASE na 3DS za pomocą Java" %}}
 ...
 Aby wyrenderować ASE do 3DS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ASE na 3DS przez Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik ASE na 3DS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik ASE za pomocą konstruktora klasy Scene1. Utwórz instancję 3dsSaveOptions1. Ustaw 3DS określone właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku 3DS i obiektem 3dsSaveOptions
...
{{% blocks/products/pf/agp/code-block title="ASE do 3DS Java Kodu źródła konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Od ASE do 3DS demonstracji konwersji na żywo" sectionDescription="[Konwertuj ASE na 3DS](https://products.aspose.app/3d/conversion/ase-to-3ds) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik ASE, zostanie on natychmiast przekonwertowany na 3DS." >}}
