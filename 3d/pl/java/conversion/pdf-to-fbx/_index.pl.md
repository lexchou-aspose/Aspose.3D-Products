...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować PDF na FBX za pomocą Java" %}}
 ...
 Aby wyrenderować PDF do FBX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować PDF na FBX przez Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik PDF na FBX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik PDF za pomocą konstruktora klasy Scene1. Utwórz instancję FbxSaveOptions1. Ustaw FBX określone właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku FBX i obiektem FbxSaveOptions
...
{{% blocks/products/pf/agp/code-block title="PDF do FBX Java Kodu źródła konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Od PDF do FBX demonstracji konwersji na żywo" sectionDescription="[Konwertuj PDF na FBX](https://products.aspose.app/3d/conversion/pdf-to-fbx) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik PDF, zostanie on natychmiast przekonwertowany na FBX." >}}
