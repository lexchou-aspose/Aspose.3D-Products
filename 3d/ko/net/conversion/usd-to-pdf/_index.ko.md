---
title: C#를 통해 USD을 PDF로 변환 
description: .NET API을(를) 사용하여 USD 및 기타 3D 파일 변환
url: /ko/net/conversion/usd-to-pdf/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C#를 통해 USD을 PDF로 변환" h2=".NET Framework, .NET Core 및 Mono를 사용하여 USD 및 기타 3D 파일 내보내기" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="C#를 사용하여 USD 장면을 PDF로 내보내기" %}}
...
3. 첫 번째 매개변수로 .pdf 확장자를 가진 출력 파일 이름을 전달합니다.
4. 다음에서 `PDF` 필드 값을 지정합니다. [파일 형식](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) 수업
...
{{% blocks/products/pf/agp/code-autogen title="USD에서 PDF로의 변환을 위한 C# 코드" gistPath="" %}}
```cs
// Scene의 객체에 USD 로드 
