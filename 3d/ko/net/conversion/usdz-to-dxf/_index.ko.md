---
title: C#를 통해 USDZ을 DXF로 변환 
description: .NET API을(를) 사용하여 USDZ 및 기타 3D 파일 변환
url: /ko/net/conversion/usdz-to-dxf/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C#를 통해 USDZ을 DXF로 변환" h2=".NET Framework, .NET Core 및 Mono를 사용하여 USDZ 및 기타 3D 파일 내보내기" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="C#를 사용하여 USDZ 장면을 DXF로 내보내기" %}}
...
3. 첫 번째 매개변수로 확장자가 .dxf인 출력 파일 이름을 전달합니다.
4. 다음에서 `DXF` 필드 값을 지정합니다. [파일 형식](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) 수업
...
{{% blocks/products/pf/agp/code-autogen title="USDZ에서 DXF로의 변환을 위한 C# 코드" gistPath="" %}}
```cs
// Scene의 객체에 USDZ 로드 
