...
{{% blocks/products/pf/agp/content h2="C#를 사용하여 DAE을 AMF로 변환하는 방법" %}}

 DAE을(를) AMF(으)로 변환하기 위해 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#를 통해 DAE을 AMF로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 프로그래머는 몇 줄의 코드로 DAE 파일을 쉽게 로드하고 AMF로 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. Scene 클래스의 생성자를 통해 DAE 파일 로드1. AmfSaveOptions의 인스턴스 생성1. 고급 변환을 위한 AMF 특정 속성 설정1. Scene.Save 메서드 호출1. AMF 파일 확장자와 AmfSaveOptions 개체를 사용하여 출력 경로를 전달합니다.1. 지정된 경로에서 결과 AMF 파일 확인
...
{{% blocks/products/pf/agp/code-block title="이 샘플 코드는 DAE에서 AMF로의 C# 전환을 보여줍니다." offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DAE을(를) AMF(으)로 변환하는 무료 앱" sectionDescription="라이브 데모를 확인하십시오. [DAE에서 AMF로의 전환](https://products.aspose.app/3d/conversion/dae-to-amf) 다음과 같은 혜택이 있습니다." >}}
