---
title: تحويل USDZ إلى AMF عبر C# 
description: تحويل USDZ وملفات 3D أخرى باستخدام .NET API
url: /ar/net/conversion/usdz-to-amf/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل USDZ إلى AMF عبر C#" h2="تصدير USDZ وملفات 3D أخرى باستخدام .NET Framework و .NET Core و Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تصدير USDZ المشهد كـ AMF بـ C#" %}}
...
3. قم بتمرير اسم ملف الإخراج بامتداد .amf كمعامل أول
4. حدد قيمة الحقل "AMF" من [تنسيق الملف](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) صف دراسي
...
{{% blocks/products/pf/agp/code-autogen title="C# رمز التحويل من USDZ إلى AMF" gistPath="" %}}
```cs
