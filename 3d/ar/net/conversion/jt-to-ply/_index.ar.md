---
title: تحويل JT إلى PLY عبر C# 
weight: 2890
url: /ar/net/conversion/jt-to-ply/ 
description: نموذج رمز للتحويل من JT إلى PLY C#. استخدم API رمز المثال لملفات الدُفعات JT PLY للتحويل داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل JT إلى PLY عبر C#" h2="تجسيد JT كـ PLY بدون أي 3D برامج تصميم وعرض." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل JT إلى PLY باستخدام C#" %}}

 لتحويل JT إلى PLY ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من JT إلى PLY عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمبرمجين .NET تحميل وتحويل ملفات JT بسهولة إلى PLY في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف JT عبر منشئ فئة المشهد1. قم بإنشاء مثيل لـ PlySaveOptions1. قم بتعيين PLY من الخصائص المحددة للتحويل المتقدم1. استدعاء طريقة Scene.Save1. قم بتمرير مسار الإخراج مع PLY امتداد الملف وكائن PlySaveOptions1. تحقق من الملف الناتج PLY في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا التحويل من JT إلى PLY C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني للتحويل من JT إلى PLY" sectionDescription="تحقق من العروض الحية لدينا ل [JT إلى PLY التحويل](https://products.aspose.app/3d/conversion/jt-to-ply) مع الفوائد التالية." >}}
