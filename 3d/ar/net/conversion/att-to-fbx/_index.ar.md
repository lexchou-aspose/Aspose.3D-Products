---
title: تحويل ATT إلى FBX عبر C# 
url: /ar/net/conversion/att-to-fbx/ 
description: نموذج رمز للتحويل من ATT إلى FBX C#. استخدم API رمز المثال لملفات الدُفعات ATT FBX للتحويل داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل ATT إلى FBX عبر C#" h2="تجسيد ATT كـ FBX بدون أي 3D برامج تصميم وعرض." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل ATT إلى FBX باستخدام C#" %}}

 لتحويل ATT إلى FBX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من ATT إلى FBX عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمبرمجين .NET تحميل وتحويل ملفات ATT بسهولة إلى FBX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف ATT عبر منشئ فئة المشهد1. قم بإنشاء مثيل AmfSaveOptions1. قم بتعيين FBX من الخصائص المحددة للتحويل المتقدم1. استدعاء طريقة Scene.Save1. قم بتمرير مسار الإخراج مع FBX امتداد الملف وكائن FbxSaveOptions1. تحقق من الملف الناتج FBX في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا التحويل من ATT إلى FBX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني للتحويل من ATT إلى FBX" sectionDescription="تحقق من العروض الحية لدينا ل [ATT إلى FBX التحويل](https://products.aspose.app/3d/conversion/att-to-fbx) مع الفوائد التالية." >}}
