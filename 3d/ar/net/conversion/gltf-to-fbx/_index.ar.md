...
{{% blocks/products/pf/agp/content h2="كيفية تحويل GLTF إلى FBX باستخدام C#" %}}

 لتحويل GLTF إلى FBX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من GLTF إلى FBX عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمبرمجين .NET تحميل وتحويل ملفات GLTF بسهولة إلى FBX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف GLTF عبر منشئ فئة المشهد1. قم بإنشاء مثيل AmfSaveOptions1. قم بتعيين FBX من الخصائص المحددة للتحويل المتقدم1. استدعاء طريقة Scene.Save1. قم بتمرير مسار الإخراج مع FBX امتداد الملف وكائن FbxSaveOptions1. تحقق من الملف الناتج FBX في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا التحويل من GLTF إلى FBX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني للتحويل من GLTF إلى FBX" sectionDescription="تحقق من العروض الحية لدينا ل [GLTF إلى FBX التحويل](https://products.aspose.app/3d/conversion/gltf-to-fbx) مع الفوائد التالية." >}}
