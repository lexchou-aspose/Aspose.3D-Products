...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من GLTF إلى AMF عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمبرمجين .NET تحميل وتحويل ملفات GLTF بسهولة إلى AMF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف GLTF عبر منشئ فئة المشهد1. قم بإنشاء مثيل AmfSaveOptions1. قم بتعيين AMF من الخصائص المحددة للتحويل المتقدم1. استدعاء طريقة Scene.Save1. قم بتمرير مسار الإخراج مع AMF امتداد الملف وكائن AmfSaveOptions1. تحقق من الملف الناتج AMF في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا التحويل من GLTF إلى AMF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني للتحويل من GLTF إلى AMF" sectionDescription="تحقق من العروض الحية لدينا ل [GLTF إلى AMF التحويل](https://products.aspose.app/3d/conversion/gltf-to-amf) مع الفوائد التالية." >}}
