...
description: نموذج رمز للتحويل من X إلى HTML C#. استخدم API مثال الكود لملفات الدُفعات X HTML للتحويل داخل VB .NET أو Asp .NET أو أي .NET تطبيق قائم.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل X إلى HTML عبر C#" h2="عرض X كـ HTML بدون أي 3D برامج تصميم وعرض." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="X" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن للمبرمجين .NET تحميل وتحويل ملفات X بسهولة إلى HTML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف X عبر مُنشئ فئة Scene1. إنشاء مثيل HtmlSaveOptions1. قم بتعيين HTML من الخصائص المحددة للتحويل المتقدم1. استدعاء طريقة Scene.Save1. قم بتمرير مسار الإخراج مع HTML امتداد الملف وكائن HtmlSaveOptions1. تحقق من الملف الناتج HTML في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا X إلى HTML C# تحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل X إلى HTML" sectionDescription="تحقق من العروض الحية لدينا ل [X لتحويل HTML](https://products.aspose.app/3d/conversion/x-to-html) مع الفوائد التالية." >}}
