...
description: نموذج رمز للتحويل من AMF إلى HTML C#. استخدم API رمز المثال لملفات الدُفعات AMF HTML للتحويل داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل AMF إلى HTML عبر C#" h2="تجسيد AMF كـ HTML بدون أي 3D برامج تصميم وعرض." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من AMF إلى HTML عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمبرمجين .NET تحميل وتحويل ملفات AMF بسهولة إلى HTML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف AMF عبر منشئ فئة المشهد1. إنشاء مثيل HtmlSaveOptions1. قم بتعيين HTML من الخصائص المحددة للتحويل المتقدم1. استدعاء طريقة Scene.Save1. قم بتمرير مسار الإخراج مع HTML امتداد الملف وكائن HtmlSaveOptions1. تحقق من الملف الناتج HTML في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا التحويل من AMF إلى HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني للتحويل من AMF إلى HTML" sectionDescription="تحقق من العروض الحية لدينا ل [AMF إلى HTML التحويل](https://products.aspose.app/3d/conversion/amf-to-html) مع الفوائد التالية." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/3d/net/conversion/amf-to-3ds/" name="AMF إلى 3DS" description="3D Studio DOS Mesh" >}}
