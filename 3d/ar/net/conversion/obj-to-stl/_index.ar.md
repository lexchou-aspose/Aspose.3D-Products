---
title: تحويل OBJ إلى STL عبر C# 
weight: 3370
url: /ar/net/conversion/obj-to-stl/ 
description: نموذج رمز للتحويل من OBJ إلى STL C#. استخدم API رمز المثال لملفات الدُفعات OBJ STL للتحويل داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل OBJ إلى STL عبر C#" h2="تجسيد OBJ كـ STL بدون أي 3D برامج تصميم وعرض." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل OBJ إلى STL باستخدام C#" %}}

 لتحويل OBJ إلى STL ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من OBJ إلى STL عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمبرمجين .NET تحميل وتحويل ملفات OBJ بسهولة إلى STL في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف OBJ عبر منشئ فئة المشهد1. قم بإنشاء مثيل لـ StlSaveOptions1. قم بتعيين STL من الخصائص المحددة للتحويل المتقدم1. استدعاء طريقة Scene.Save1. قم بتمرير مسار الإخراج مع STL امتداد الملف وكائن StlSaveOptions1. تحقق من الملف الناتج STL في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا التحويل من OBJ إلى STL C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني للتحويل من OBJ إلى STL" sectionDescription="تحقق من العروض الحية لدينا ل [OBJ إلى STL التحويل](https://products.aspose.app/3d/conversion/obj-to-stl) مع الفوائد التالية." >}}
