---
title: تحويل USDZ إلى STL عبر C# 
description: تحويل USDZ وملفات 3D أخرى باستخدام .NET API
url: /ar/net/conversion/usdz-to-stl/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل USDZ إلى STL عبر C#" h2="تصدير USDZ وملفات 3D أخرى باستخدام .NET Framework و .NET Core و Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تصدير USDZ المشهد كـ STL بـ C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# رمز التحويل من USDZ إلى STL" gistPath="" %}}
```cs
