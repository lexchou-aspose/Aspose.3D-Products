---
title: تحويل X إلى PDF عبر C# 
weight: 2300
url: /ar/net/conversion/x-to-pdf/ 
description: نموذج رمز للتحويل من X إلى PDF C#. استخدم API مثال الكود لملفات الدُفعات X PDF للتحويل داخل VB .NET أو Asp .NET أو أي .NET تطبيق قائم.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل X إلى PDF عبر C#" h2="عرض X كـ PDF بدون أي 3D برامج تصميم وعرض." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="X" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل X إلى PDF باستخدام C#" %}}

 لتحويل X إلى PDF ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل X إلى PDF عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمبرمجين .NET تحميل وتحويل ملفات X بسهولة إلى PDF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف X عبر مُنشئ فئة Scene1. قم بإنشاء مثيل لـ PdfSaveOptions1. قم بتعيين PDF من الخصائص المحددة للتحويل المتقدم1. استدعاء طريقة Scene.Save1. قم بتمرير مسار الإخراج مع PDF امتداد الملف وكائن PdfSaveOptions1. تحقق من الملف الناتج PDF في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا X إلى PDF C# تحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل X إلى PDF" sectionDescription="تحقق من العروض الحية لدينا ل [X لتحويل PDF](https://products.aspose.app/3d/conversion/x-to-pdf) مع الفوائد التالية." >}}
