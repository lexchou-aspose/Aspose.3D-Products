---
title: تحويل JT إلى OBJ عبر C# 
weight: 1610
url: /ar/net/conversion/jt-to-obj/ 
description: نموذج رمز للتحويل من JT إلى OBJ C#. استخدم API رمز المثال لملفات الدُفعات JT OBJ للتحويل داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل JT إلى OBJ عبر C#" h2="تجسيد JT كـ OBJ بدون أي 3D برامج تصميم وعرض." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JT" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل JT إلى OBJ باستخدام C#" %}}

 لتحويل JT إلى OBJ ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من JT إلى OBJ عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمبرمجين .NET تحميل وتحويل ملفات JT بسهولة إلى OBJ في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف JT عبر منشئ فئة المشهد1. قم بإنشاء مثيل لـ ObjSaveOptions1. قم بتعيين OBJ من الخصائص المحددة للتحويل المتقدم1. استدعاء طريقة Scene.Save1. قم بتمرير مسار الإخراج مع OBJ امتداد الملف وكائن ObjSaveOptions1. تحقق من الملف الناتج OBJ في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا التحويل من JT إلى OBJ C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني للتحويل من JT إلى OBJ" sectionDescription="تحقق من العروض الحية لدينا ل [JT إلى OBJ التحويل](https://products.aspose.app/3d/conversion/jt-to-obj) مع الفوائد التالية." >}}
