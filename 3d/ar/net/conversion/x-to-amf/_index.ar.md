...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن للمبرمجين .NET تحميل وتحويل ملفات X بسهولة إلى AMF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف X عبر مُنشئ فئة Scene1. قم بإنشاء مثيل AmfSaveOptions1. قم بتعيين AMF من الخصائص المحددة للتحويل المتقدم1. استدعاء طريقة Scene.Save1. قم بتمرير مسار الإخراج مع AMF امتداد الملف وكائن AmfSaveOptions1. تحقق من الملف الناتج AMF في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا X إلى AMF C# تحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل X إلى AMF" sectionDescription="تحقق من العروض الحية لدينا ل [X لتحويل AMF](https://products.aspose.app/3d/conversion/x-to-amf) مع الفوائد التالية." >}}
