---
title: قم بإنشاء Lithophane من تنسيقات ملف PNG عبر .NET 
weight: 830
url: /ar/net/lithophane/png/ 
description: C# شفرة المصدر لتحميل وعرض وإنشاء مستندات lithophane إلى PNG على .NET Framework ، .NET Core ، Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="قم بإنشاء Lithophane إلى PNG عبر C#" h2="أنشئ تطبيقاتك البالغ عددها .NET لإنشاء ملفات lithophane إلى PNG باستخدام واجهات برمجة التطبيقات من جانب الخادم." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="PNG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء ملف Lithophane إلى ملف PNG باستخدام C#" %}}

 من أجل إنشاء ملف lithophane إلى PNG ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء Lithophane إلى PNG عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يسهل Aspose.3D على المطورين إنشاء مادة الليثوفاني الخاصة بك إلى ملف PNG باستخدام بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

- قم بإنشاء بعض المعلمات الجديدة وإنشاء كائن شبكة- إجراء عمليات حسابية على كائنات الشبكة- يقوم ملف PNG بتحميل مشهد ثلاثي الأبعاد من خلال فئة الشبكة- استدعاء طريقة Scene.Save مع الكائن
...
{{% blocks/products/pf/agp/code-block title="C# لإنشاء رمز Lithophane إلى PNG" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D هو برنامج ألعاب CAD وألعاب API لتحميل وتعديل وتحويل ملفات 3D. API هو برنامج قائم بذاته ولا يتطلب أي 3D برامج عرض أو نماذج. يمكن للمرء بسهولة استخدام API لـ Discreet3DS ، WavefrontOBJ ، STL (ASCII ، ثنائي) ، Universal3D ، FBX (ASCII ، ثنائي) ، Collada ، glTF ، PLY ، GLB و DirectX والمزيد من التنسيقات. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لإنشاء Lithophane إلى PNG" sectionDescription="تحقق من العروض الحية لدينا ل [ليثوفان PNG](https://products.aspose.app/3d/lithophane/png) مع الفوائد التالية." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل أو إعداد أي شيء" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أو ترجمة التعليمات البرمجية" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" فقط قم بتحميل ملف PNG واضغط على زر \"lithophane\"" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" قم بتنزيل ملف PNG من الرابط ، إذا لزم الأمر" >}}
