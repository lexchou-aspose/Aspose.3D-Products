---
title: Προσθήκη Blind Watermark στις U3D Μορφές αρχείων μέσω .NET 
weight: 830
url: /el/net/watermark/u3d/ 
description: C# πηγαίος κώδικας για φόρτωση, απόδοση και προσθήκη τυφλού υδατογραφήματος σε έγγραφα U3D στο .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Προσθήκη τυφλού υδατογραφήματος στο U3D μέσω C#" h2="Δημιουργήστε τις δικές σας .NET εφαρμογές για να υδατογραφήσετε U3D αρχεία χρησιμοποιώντας API από την πλευρά του διακομιστή." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="U3D" >}}
...
{{% blocks/products/pf/agp/content h2="Τρόπος υδατογραφήματος σε αρχείο U3D χρησιμοποιώντας C#" %}}

 Για να υδατογραφήσουμε το αρχείο U3D, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την προσθήκη τυφλού υδατογραφήματος στο U3D μέσω του C#" %}}

{{% blocks/products/pf/agp/text %}}

 Το Aspose.3D διευκολύνει τους προγραμματιστές να προσθέσουν τυφλό υδατογράφημα στο αρχείο U3D με λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

- Φόρτωση αρχείου U3D μέσω του κατασκευαστή της κλάσης Scene- Αποκτήστε την κατηγορία πλέγματος του Aspose.3D- Προσθέστε υδατογράφημα και κωδικό πρόσβασης χρησιμοποιώντας τη μέθοδο EncodeWatermark του Aspose.3D- Καλέστε τη μέθοδο Scene.Save με αντικείμενο
...
{{% blocks/products/pf/agp/code-block title="C# κωδικός για προσθήκη τυφλού υδατογραφήματος στο U3D" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Δωρεάν εφαρμογή για προσθήκη τυφλού υδατογραφήματος στο U3D" sectionDescription="Ελέγξτε τις ζωντανές επιδείξεις μας σε [Υδατογράφημα U3D](https://products.aspose.app/3d/watermark/u3d) με τα ακόλουθα οφέλη." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Απλώς μεταφορτώστε το αρχείο U3D και πατήστε το κουμπί \"Υδατογράφημα\"." >}}
