...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή USD σε ASE μέσω C#" h2="Εξαγωγή USD και άλλων 3D αρχείων χρησιμοποιώντας .NET Framework, .NET Core και Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Εξαγωγή σκηνής USD ως ASE με C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Κωδικός για μετατροπή USD σε ASE" gistPath="" %}}
```cs
