---
title: Создайте свой Lithophane из форматов файлов PNG с помощью .NET 
weight: 830
url: /ru/net/lithophane/png/ 
description: Исходный код C# для загрузки, рендеринга и создания документов lithophane to PNG на .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Создайте свой Lithophane в PNG через C#" h2="Создавайте свои собственные приложения .NET, чтобы преобразовывать файлы lithophan в PNG с помощью серверных API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="PNG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="Как создать файл Lithophane в PNG с помощью C#" %}}

 Чтобы создать файл lithophane to PNG, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по преобразованию Lithophane в PNG с помощью C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D позволяет разработчикам легко преобразовать литофана в файл PNG, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

- Создайте несколько новых параметров и создайте объект Mesh.- Выполнение вычислительных операций над объектами Mesh- Файл PNG загружает 3D-сцену через класс Mesh- Вызов метода Scene.Save с объектом
...
{{% blocks/products/pf/agp/code-block title="C# код для преобразования Lithophane в PNG" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D – это CAD и Gameware API для загрузки, изменения и преобразования файлов 3D. API является автономным и не требует никакого 3D программного обеспечения для моделирования или визуализации. Можно легко использовать API для Discreet3DS, WavefrontOBJ, STL (ASCII, двоичный), Universal3D, FBX (ASCII, двоичный), Collada, glTF, PLY, GLB, DirectX и другие форматы. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Бесплатное приложение для создания литофана в формате PNG" sectionDescription="Проверьте наши живые демонстрации, чтобы [Литофан PNG](https://products.aspose.app/3d/lithophane/png) со следующими преимуществами." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Не нужно ничего скачивать или настраивать" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Нет необходимости писать или компилировать код" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите файл PNG и нажмите кнопку «Литофан»." >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Скачать файл PNG по ссылке, если требуется" >}}
