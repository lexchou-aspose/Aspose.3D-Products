---
title: Создайте свой Lithophane из форматов файлов TGA через .NET 
weight: 830
url: /ru/net/lithophane/tga/ 
description: Исходный код C# для загрузки, рендеринга и создания документов lithophane to TGA на .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Создайте свой Lithophane для TGA через C#" h2="Создавайте свои собственные приложения .NET, чтобы преобразовывать файлы lithophane в TGA с помощью серверных API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TGA" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="TGA" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TGA" >}}
...
{{% blocks/products/pf/agp/content h2="Как создать файл литофана в TGA с помощью C#" %}}

 Чтобы создать файл lithophane to TGA, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по созданию Lithophane для TGA через C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D позволяет разработчикам легко преобразовать литофана в файл TGA, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

- Создайте несколько новых параметров и создайте объект Mesh.- Выполнение вычислительных операций над объектами Mesh- Файл TGA загружает 3D-сцену через класс Mesh- Вызов метода Scene.Save с объектом
...
{{% blocks/products/pf/agp/code-block title="C# код для создания вашего литофана в TGA" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D – это CAD и Gameware API для загрузки, изменения и преобразования файлов 3D. API является автономным и не требует никакого 3D программного обеспечения для моделирования или визуализации. Можно легко использовать API для Discreet3DS, WavefrontOBJ, STL (ASCII, двоичный), Universal3D, FBX (ASCII, двоичный), Collada, glTF, PLY, GLB, DirectX и другие форматы. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Бесплатное приложение для создания литофана в TGA" sectionDescription="Проверьте наши живые демонстрации, чтобы [Литофан ТГА](https://products.aspose.app/3d/lithophane/tga) со следующими преимуществами." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Не нужно ничего скачивать или настраивать" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Нет необходимости писать или компилировать код" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите файл TGA и нажмите кнопку «Литофан»." >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Скачать файл TGA по ссылке, если требуется" >}}
