---
title: Преобразование PDF в PLY через Java 
url: /ru/java/conversion/pdf-to-ply/ 
description: Пример кода преобразования Java для формата PDF в файл PLY. Используйте этот пример кода для преобразования PDF в PLY в любом веб-приложении или настольном приложении Java.
---
...
{{% blocks/products/pf/agp/content h2="Как преобразовать PDF в PLY с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию PDF в PLY через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Программисты Java могут легко преобразовать файл PDF в PLY, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите файл PDF через конструктор класса Scene1. Создайте экземпляр PlySaveOptions1. Установите определенные свойства PLY для расширенного преобразования1. Вызов метода Scene.save1. Передайте выходной путь с расширением файла PLY и объектом PlySaveOptions
...
{{% blocks/products/pf/agp/code-block title="PDF в PLY Java Исходный код преобразования" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Преобразование PDF в PLY демонстрации в реальном времени" sectionDescription="[Преобразовать PDF в PLY](https://products.aspose.app/3d/conversion/pdf-to-ply) прямо сейчас, посетив наш веб-сайт Live Demos. Живая демонстрация имеет следующие преимущества" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Нет необходимости загружать Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Нет необходимости писать какой-либо код." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите файл PDF, и он будет мгновенно преобразован в PLY." >}}
