---
title: Chuyển đổi 3DS sang GLTF qua C# 
url: /vi/net/conversion/3ds-to-gltf/ 
description: Mã mẫu cho chuyển đổi 3DS thành GLTF C#. Sử dụng API mã mẫu cho hàng loạt tệp 3DS để chuyển đổi GLTF trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi 3DS sang GLTF qua C#" h2="Hiển thị 3DS dưới dạng GLTF mà không có bất kỳ 3D phần mềm kết xuất và mô hình hóa nào." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi 3DS thành GLTF bằng cách sử dụng C#" %}}

 Để chuyển đổi 3DS thành GLTF, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi 3DS thành GLTF qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET người lập trình có thể dễ dàng tải và chuyển đổi 3DS tệp thành GLTF chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp 3DS qua hàm tạo của lớp Scene1. Tạo một phiên bản của AmfSaveOptions1. Đặt GLTF thuộc tính cụ thể cho chuyển đổi nâng cao1. Gọi phương thức Scene.Save1. Chuyển đường dẫn đầu ra với GLTF phần mở rộng tệp & đối tượng của GltfSaveOptions1. Kiểm tra tệp GLTF kết quả tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi 3DS sang GLTF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ứng dụng miễn phí để chuyển đổi 3DS sang GLTF" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi cho [Chuyển đổi 3DS thành GLTF](https://products.aspose.app/3d/conversion/3ds-to-gltf) với những lợi ích sau đây." >}}
