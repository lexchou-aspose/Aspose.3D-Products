---
title: Chuyển đổi PLY sang STL qua C# 
weight: 2130
url: /vi/net/conversion/ply-to-stl/ 
description: Mã mẫu cho chuyển đổi PLY thành STL C#. Sử dụng API mã mẫu cho hàng loạt tệp PLY để chuyển đổi STL trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi PLY sang STL qua C#" h2="Hiển thị PLY dưới dạng STL mà không có bất kỳ 3D phần mềm kết xuất và mô hình hóa nào." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PLY" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi PLY thành STL bằng cách sử dụng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi PLY thành STL qua C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi PLY sang STL C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ứng dụng miễn phí để chuyển đổi PLY sang STL" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi cho [Chuyển đổi PLY thành STL](https://products.aspose.app/3d/conversion/ply-to-stl) với những lợi ích sau đây." >}}
