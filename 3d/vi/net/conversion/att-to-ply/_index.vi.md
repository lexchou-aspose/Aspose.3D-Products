---
title: Chuyển đổi ATT sang PLY qua C# 
url: /vi/net/conversion/att-to-ply/ 
description: Mã mẫu cho chuyển đổi ATT thành PLY C#. Sử dụng API mã mẫu cho hàng loạt tệp ATT để chuyển đổi PLY trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi ATT sang PLY qua C#" h2="Hiển thị ATT dưới dạng PLY mà không có bất kỳ 3D phần mềm kết xuất và mô hình hóa nào." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi ATT thành PLY bằng cách sử dụng C#" %}}

 Để chuyển đổi ATT thành PLY, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi ATT thành PLY qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET người lập trình có thể dễ dàng tải và chuyển đổi ATT tệp thành PLY chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp ATT qua hàm tạo của lớp Scene1. Tạo một phiên bản của AmfSaveOptions1. Đặt PLY thuộc tính cụ thể cho chuyển đổi nâng cao1. Gọi phương thức Scene.Save1. Chuyển đường dẫn đầu ra với PLY phần mở rộng tệp & đối tượng của PlySaveOptions1. Kiểm tra tệp PLY kết quả tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi ATT sang PLY C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ứng dụng miễn phí để chuyển đổi ATT sang PLY" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi cho [Chuyển đổi ATT thành PLY](https://products.aspose.app/3d/conversion/att-to-ply) với những lợi ích sau đây." >}}
