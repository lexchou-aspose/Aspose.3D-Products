---
title: Chuyển đổi GLTF sang U3D qua C# 
url: /vi/net/conversion/gltf-to-u3d/ 
description: Mã mẫu cho chuyển đổi GLTF thành U3D C#. Sử dụng API mã mẫu cho hàng loạt tệp GLTF để chuyển đổi U3D trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi GLTF sang U3D qua C#" h2="Hiển thị GLTF dưới dạng U3D mà không có bất kỳ 3D phần mềm kết xuất và mô hình hóa nào." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi GLTF thành U3D bằng cách sử dụng C#" %}}

 Để chuyển đổi GLTF thành U3D, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi GLTF thành U3D qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET người lập trình có thể dễ dàng tải và chuyển đổi GLTF tệp thành U3D chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp GLTF qua hàm tạo của lớp Scene1. Tạo một phiên bản của AmfSaveOptions1. Đặt U3D thuộc tính cụ thể cho chuyển đổi nâng cao1. Gọi phương thức Scene.Save1. Chuyển đường dẫn đầu ra với U3D phần mở rộng tệp & đối tượng của U3dSaveOptions1. Kiểm tra tệp U3D kết quả tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi GLTF sang U3D C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ứng dụng miễn phí để chuyển đổi GLTF sang U3D" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi cho [Chuyển đổi GLTF thành U3D](https://products.aspose.app/3d/conversion/gltf-to-u3d) với những lợi ích sau đây." >}}
