---
title: Chuyển đổi FBX sang HTML qua C# 
weight: 3150
url: /vi/net/conversion/fbx-to-html/ 
description: Mã mẫu cho chuyển đổi FBX thành HTML C#. Sử dụng API mã mẫu cho hàng loạt tệp FBX để chuyển đổi HTML trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi FBX sang HTML qua C#" h2="Hiển thị FBX dưới dạng HTML mà không có bất kỳ 3D phần mềm kết xuất và mô hình hóa nào." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FBX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi FBX thành HTML bằng cách sử dụng C#" %}}

 Để chuyển đổi FBX thành HTML, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi FBX thành HTML qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET người lập trình có thể dễ dàng tải và chuyển đổi FBX tệp thành HTML chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp FBX qua hàm tạo của lớp Scene1. Tạo một phiên bản của HtmlSaveOptions1. Đặt HTML thuộc tính cụ thể cho chuyển đổi nâng cao1. Gọi phương thức Scene.Save1. Chuyển đường dẫn đầu ra với HTML phần mở rộng tệp & đối tượng của HtmlSaveOptions1. Kiểm tra tệp HTML kết quả tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị Chuyển đổi FBX sang HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ứng dụng miễn phí để chuyển đổi FBX sang HTML" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi cho [Chuyển đổi FBX thành HTML](https://products.aspose.app/3d/conversion/fbx-to-html) với những lợi ích sau đây." >}}
