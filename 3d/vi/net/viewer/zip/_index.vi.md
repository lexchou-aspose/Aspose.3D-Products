---
title: Xem ZIP Định dạng Tệp qua .NET 
weight: 620
url: /vi/net/viewer/zip/ 
description: C# mã nguồn để tải, kết xuất và hiển thị ZIP tài liệu trên .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ZIP Trình xem Tệp for .NET" h2="Kết xuất tệp ZIP mà không cần bất kỳ 3D phần mềm kết xuất và mô hình hóa nào." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ZIP" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ZIP" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Xem ZIP Tệp bằng C#" %}}

 Để xem tệp ZIP, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Xem ZIP qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D giúp các nhà phát triển dễ dàng xem tệp ZIP chỉ với vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp ZIP qua hàm tạo của lớp Scene1. Tạo một phiên bản của Html5SaveOptions1. Đặt thuộc tính cho định dạng nâng cao1. Gọi phương thức Scene.Save với đối tượng của Html5SaveOptions1. Kiểm tra tệp HTML kết quả trong trình duyệt mặc định
...
// tải ZIP cảnh qua một phiên bản của Cảnh
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D là một CAD và Phần mềm trò chơi API để tải, sửa đổi và chuyển đổi 3D tệp. API là một phần mềm độc lập và không yêu cầu bất kỳ 3D phần mềm kết xuất hoặc mô hình hóa nào. Người ta có thể dễ dàng sử dụng API cho Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX và các định dạng khác. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ứng dụng miễn phí để xem ZIP" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi để [Xem ZIP](https://products.aspose.app/3d/viewer/zip) với những lợi ích sau đây." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải tệp ZIP lên và nhấn nút \"Xem\"" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Tải xuống tệp ZIP từ liên kết, nếu cần" >}}

        {{< blocks/products/pf/agp/i18n/about-file-text fileFormat="ZIP" readMoreLink="https://docs.fileformat.com/compression/zip/" >}}
Phần mở rộng tệp ZIP đại diện cho các tệp lưu trữ có thể chứa một hoặc nhiều tệp hoặc thư mục. Tệp lưu trữ có thể áp dụng tính năng nén cho các tệp được bao gồm để giảm kích thước tệp ZIP. Định dạng tệp ZIP đã được Phil Katz công khai trở lại vào tháng 2 năm 1989 để đạt được khả năng lưu trữ tệp và thư mục. Định dạng này là một phần của tiện ích PKZIP, do PKWARE, Inc. và nhiều người khác.
