---
title: Xem DAE Định dạng Tệp qua .NET 
weight: 1430
url: /vi/net/viewer/dae/ 
description: C# mã nguồn để tải, kết xuất và hiển thị DAE tài liệu trên .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="DAE Trình xem Tệp for .NET" h2="Kết xuất tệp DAE mà không cần bất kỳ 3D phần mềm kết xuất và mô hình hóa nào." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Xem DAE Tệp bằng C#" %}}

 Để xem tệp DAE, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Xem DAE qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D giúp các nhà phát triển dễ dàng xem tệp DAE chỉ với vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp DAE qua hàm tạo của lớp Scene1. Tạo một phiên bản của Html5SaveOptions1. Đặt thuộc tính cho định dạng nâng cao1. Gọi phương thức Scene.Save với đối tượng của Html5SaveOptions1. Kiểm tra tệp HTML kết quả trong trình duyệt mặc định
...
// tải DAE cảnh qua một phiên bản của Cảnh
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D là một CAD và Phần mềm trò chơi API để tải, sửa đổi và chuyển đổi 3D tệp. API là một phần mềm độc lập và không yêu cầu bất kỳ 3D phần mềm kết xuất hoặc mô hình hóa nào. Người ta có thể dễ dàng sử dụng API cho Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX và các định dạng khác. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ứng dụng miễn phí để xem DAE" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi để [Xem DAE](https://products.aspose.app/3d/viewer/dae) với những lợi ích sau đây." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải tệp DAE lên và nhấn nút \"Xem\"" >}}
