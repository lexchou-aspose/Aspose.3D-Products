---
title: Xem 3DS Định dạng Tệp qua .NET 
weight: 830
url: /vi/net/viewer/3ds/ 
description: C# mã nguồn để tải, kết xuất và hiển thị 3DS tài liệu trên .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="3DS Trình xem Tệp for .NET" h2="Kết xuất tệp 3DS mà không cần bất kỳ 3D phần mềm kết xuất và mô hình hóa nào." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Xem 3DS Tệp bằng C#" %}}

 Để xem tệp 3DS, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Xem 3DS qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D giúp các nhà phát triển dễ dàng xem tệp 3DS chỉ với vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp 3DS qua hàm tạo của lớp Scene1. Tạo một phiên bản của Html5SaveOptions1. Đặt thuộc tính cho định dạng nâng cao1. Gọi phương thức Scene.Save với đối tượng của Html5SaveOptions1. Kiểm tra tệp HTML kết quả trong trình duyệt mặc định
...
// tải 3DS cảnh qua một phiên bản của Cảnh
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D là một CAD và Phần mềm trò chơi API để tải, sửa đổi và chuyển đổi 3D tệp. API là một phần mềm độc lập và không yêu cầu bất kỳ 3D phần mềm kết xuất hoặc mô hình hóa nào. Người ta có thể dễ dàng sử dụng API cho Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX và các định dạng khác. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ứng dụng miễn phí để xem 3DS" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi để [Xem 3DS](https://products.aspose.app/3d/viewer/3ds) với những lợi ích sau đây." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải tệp 3DS lên và nhấn nút \"Xem\"" >}}
