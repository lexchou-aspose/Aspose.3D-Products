---
title: Tạo Lithophane của bạn từ Định dạng tệp JPEG qua .NET 
weight: 830
url: /vi/net/lithophane/jpeg/ 
description: C# mã nguồn để tải, hiển thị và tạo tài liệu lithophane sang JPEG trên .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tạo Lithophane của bạn sang JPEG qua C#" h2="Tạo ứng dụng .NET của riêng bạn để tạo tệp lithophane thành JPEG bằng cách sử dụng API phía máy chủ." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPEG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tạo tệp Lithophane sang JPEG bằng cách sử dụng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo Lithophane của bạn sang JPEG qua C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# mã để tạo Lithophane của bạn thành JPEG" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D là một CAD và Phần mềm trò chơi API để tải, sửa đổi và chuyển đổi 3D tệp. API là một phần mềm độc lập và không yêu cầu bất kỳ 3D phần mềm kết xuất hoặc mô hình hóa nào. Người ta có thể dễ dàng sử dụng API cho Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX và các định dạng khác. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ứng dụng miễn phí để tạo Lithophane của bạn sang JPEG" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi để [Lithophane JPEG](https://products.aspose.app/3d/lithophane/JPEG) với những lợi ích sau đây." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp JPEG và nhấn nút \"lithophane\"" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Tải xuống tệp JPEG từ liên kết, nếu cần" >}}
