---
title: .NET và Java 3D API | 3D Thao tác và Chuyển đổi Tệp 
weight: 10
url: /vi/family
description: Tạo chỉnh sửa và chuyển đổi 3D tài liệu trong các ứng dụng .NET và Java bằng thư viện liên quan mà không cần cài đặt bất kỳ 3D phần mềm kết xuất hình ảnh hoặc mô hình hóa nào
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="3D API thao tác tệp" h2="Các API gốc để đọc, chỉnh sửa và chuyển đổi 3D các định dạng tài liệu mà không cần bất kỳ 3D phần mềm kết xuất hoặc mô hình hóa nào." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d.svg" pfName="Aspose.3D" downloadUrl="https://releases.aspose.com/3d" tryOnlineUrl="" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Tại sao lại là Aspose.3D Dòng sản phẩm?" tabId="success-stories" >}}
