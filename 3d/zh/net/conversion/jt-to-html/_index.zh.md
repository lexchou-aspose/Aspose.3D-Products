...
{{% blocks/products/pf/agp/feature-section-col title="通过 C# 将 JT 转换为 HTML 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 程序员只需几行代码即可轻松加载 JT 文件并将其转换为 HTML。

{{% /blocks/products/pf/agp/text %}}

1. 通过 Scene 类的构造函数加载 JT 文件1. 创建 HtmlSaveOptions 的实例1. 为高级转换设置 HTML 个特定属性1. 调用 Scene.Save 方法1. 传递带有 HTML 文件扩展名和 HtmlSaveOptions 对象的输出路径1. 检查指定路径的结果 HTML 文件
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 JT 到 HTML C# 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="将 JT 转换为 HTML 的免费应用程序" sectionDescription="查看我们的现场演示 [JT 到 HTML 的转换](https://products.aspose.app/3d/conversion/jt-to-html) 具有以下好处。" >}}
