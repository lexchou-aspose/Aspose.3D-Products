...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 USDZ 转换为 3DS" h2="使用 .NET Framework、.NET Core 和 Mono 导出 USDZ 和其他 3D 文件" >}}
...
3. 将带有 .3ds 扩展名的输出文件名作为第一个参数传递
4. 指定 `Discreet3DS` 字段值 [文件格式](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) 班级
...
{{% blocks/products/pf/agp/code-autogen title="C# USDZ 到 3DS 转换的代码" gistPath="" %}}
```cs
// 在 Scene 对象中加载 USDZ 
