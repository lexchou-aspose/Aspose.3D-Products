---
title: 通过 C# 将 USD 转换为 RVM 
description: 使用 .NET API 转换 USD 和其他 3D 文件
url: /zh/net/conversion/usd-to-rvm/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 USD 转换为 RVM" h2="使用 .NET Framework、.NET Core 和 Mono 导出 USD 和其他 3D 文件" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 C# 将 USD 场景导出为 RVM" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# USD 到 RVM 转换的代码" gistPath="" %}}
```cs
// 在 Scene 对象中加载 USD 
