...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 USD 转换为 JT" h2="使用 .NET Framework、.NET Core 和 Mono 导出 USD 和其他 3D 文件" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# USD 到 JT 转换的代码" gistPath="" %}}
```cs
// 在 Scene 对象中加载 USD 
