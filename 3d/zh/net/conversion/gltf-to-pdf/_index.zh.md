...
description: GLTF 到 PDF C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 GLTF 文件批量转换为 PDF。
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET 程序员只需几行代码即可轻松加载 GLTF 文件并将其转换为 PDF。

{{% /blocks/products/pf/agp/text %}}

1. 通过 Scene 类的构造函数加载 GLTF 文件1. 创建 AmfSaveOptions 的实例1. 为高级转换设置 PDF 个特定属性1. 调用 Scene.Save 方法1. 传递带有 PDF 文件扩展名和 PdfSaveOptions 对象的输出路径1. 检查指定路径的结果 PDF 文件
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 GLTF 到 PDF C# 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="将 GLTF 转换为 PDF 的免费应用程序" sectionDescription="查看我们的现场演示 [GLTF 到 PDF 的转换](https://products.aspose.app/3d/conversion/gltf-to-pdf) 具有以下好处。" >}}
