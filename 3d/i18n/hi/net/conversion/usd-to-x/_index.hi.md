---
title: कन्वर्ट USD X के माध्यम से करने के लिए C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="कन्वर्ट USD X के माध्यम से करने के लिए C#" h2="निर्यात USD और अन्य 3D फ़ाइलों का उपयोग .NET ढांचे, .NET कोर और Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="निर्यात USD के साथ के रूप में दृश्य X C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# कोड के लिए USD X रूपांतरण करने के लिए" gistPath="" %}}
```cs
// लोड USD में एक वस्तु के दृश्य 
var scene = new Aspose.ThreeD.Scene("template.usd");
// बचाने USD के रूप में एक X 
