---
title: कन्वर्ट USD करने के लिए STL के माध्यम से C# 
description: कन्वर्ट USD और अन्य 3D फ़ाइलों का उपयोग .NET API
url: /hi/net/conversion/usd-to-stl/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="कन्वर्ट USD करने के लिए STL के माध्यम से C#" h2="निर्यात USD और अन्य 3D फ़ाइलों का उपयोग .NET ढांचे, .NET कोर और Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="निर्यात USD दृश्य के रूप में STL के साथ C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# कोड के लिए USD करने के लिए STL रूपांतरण" gistPath="" %}}
```cs
// लोड USD में एक वस्तु के दृश्य 
var scene = new Aspose.ThreeD.Scene("template.usd");
// बचाने USD के रूप में कार्यों के साथ एक STL 
