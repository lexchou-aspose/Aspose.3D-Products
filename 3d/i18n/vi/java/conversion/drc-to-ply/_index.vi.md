...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi DRC thành PLY bằng cách sử dụng Java" %}}

 Để hiển thị DRC thành PLY, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi DRC thành PLY qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java lập trình viên có thể dễ dàng chuyển đổi tệp DRC thành PLY chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp DRC qua hàm tạo của lớp Scene1. Tạo một phiên bản của PlySaveOptions1. Đặt PLY thuộc tính cụ thể cho chuyển đổi nâng cao1. Gọi phương thức Scene.save1. Chuyển đường dẫn đầu ra với PLY phần mở rộng tệp & đối tượng của PlySaveOptions
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi DRC thành PLY Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC thành PLY Bản trình diễn Trực tiếp Chuyển đổi" sectionDescription="[Chuyển đổi DRC thành PLY](https://products.aspose.app/3d/conversion/drc-to-ply) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp DRC của bạn, tệp sẽ được chuyển đổi ngay lập tức thành PLY." >}}
