---
title: Chuyển đổi USD sang DAE qua C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi USD sang DAE qua C#" h2="Xuất các tệp USD và 3D khác bằng cách sử dụng .NET Framework, .NET Core và Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Xuất USD Cảnh dưới dạng DAE với C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Mã cho Chuyển đổi USD sang DAE" gistPath="" %}}
```cs
