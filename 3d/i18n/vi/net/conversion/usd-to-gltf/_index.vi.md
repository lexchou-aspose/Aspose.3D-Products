---
title: Chuyển đổi USD để GLTF qua C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi USD để GLTF qua C#" h2="Xuất khẩu USD & khác 3D các tập tin sử dụng .NET Khuôn Khổ, .NET lõi và Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Xuất khẩu USD Cảnh như GLTF với C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# mã cho USD để GLTF Chuyển Đổi" gistPath="" %}}
```cs
// Tải các USD trong một đối tượng của Cảnh 
var scene = new Aspose.ThreeD.Scene("template.usd");
// Tiết kiệm USD như một GLTF 
