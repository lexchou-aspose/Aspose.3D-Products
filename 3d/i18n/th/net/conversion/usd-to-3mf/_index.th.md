---
title: แปลง USD เป็น 3MF ผ่าน C# 
description: แปลงไฟล์ USD และ 3D อื่นๆ โดยใช้ .NET API
url: /th/net/conversion/usd-to-3mf/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง USD เป็น 3MF ผ่าน C#" h2="ส่งออก USD และไฟล์ 3D อื่นๆ โดยใช้ .NET Framework, .NET Core และ Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="ส่งออก USD ฉากเป็น 3MF ด้วย C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# โค้ดสำหรับการแปลง USD ถึง 3MF" gistPath="" %}}
```cs
