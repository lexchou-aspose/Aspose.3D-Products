...
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง USD TO DRC Via C#" h2="Export USD & Other 3D Files using .NET Framework, .NET Core and Mono" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# รหัสสำหรับ USD ถึง DRC การแปลง" gistPath="" %}}
```cs
