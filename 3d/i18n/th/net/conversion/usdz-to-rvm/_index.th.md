...
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง USDZ TO RVM Via C#" h2="Export USDZ & Other 3D Files using .NET Framework, .NET Core and Mono" >}}
...
3.ผ่านเอาท์พุทชื่อไฟล์ด้วยส่วนขยาย rvm เป็นพารามิเตอร์แรก
4.ระบุค่าฟิลด์ 'rvmbinary' จาก [รูปแบบไฟล์](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) คลาส
...
{{% blocks/products/pf/agp/code-autogen title="C# รหัสสำหรับ USDZ ถึง RVM การแปลง" gistPath="" %}}
```cs
