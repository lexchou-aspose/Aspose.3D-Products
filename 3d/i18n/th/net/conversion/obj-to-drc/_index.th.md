...
{{% blocks/products/pf/agp/feature-section-col title="Steps TO convert OBJ TO DRC Via C# [ตัวอย่าง]" %}}

{{% blocks/products/pf/agp/text %}}

 .NET โปรแกรมเมอร์สามารถโหลดและแปลง OBJ ไฟล์ DRC ในเพียงไม่กี่บรรทัดของรหัส

{{% /blocks/products/pf/agp/text %}}

1. โหลด OBJ ไฟล์ผ่านตัวสร้างชั้นฉาก1. สร้างอินสแตนซ์ของ amfsaveoptions1. ตั้งค่า DRC คุณสมบัติเฉพาะสำหรับการแปลงขั้นสูง1. เรียกฉากบันทึกวิธี1. ผ่านเส้นทางเอาท์พุทที่มี DRC นามสกุลไฟล์และวัตถุของ drcsaveoptions1. ตรวจสอบผลลัพธ์ DRC ไฟล์ที่เส้นทางที่ระบุ
...
{{% blocks/products/pf/agp/code-block title="รหัสตัวอย่างนี้แสดง OBJ เป็น DRC C# การแปลง" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free APP TO convert OBJ TO DRC" sectionDescription="ตรวจสอบการสาธิตสดของเราสำหรับ [OBJ TO DRC Conversion](https://products.aspose.app/3d/conversion/obj-to-drc) ที่มีประโยชน์ดังต่อไปนี้" >}}
