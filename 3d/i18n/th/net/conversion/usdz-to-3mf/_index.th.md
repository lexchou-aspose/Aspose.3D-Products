...
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง USDZ TO 3MF Via C#" h2="Export USDZ & Other 3D Files using .NET Framework, .NET Core and Mono" >}}
...
3.ผ่านเอาท์พุทชื่อไฟล์ที่มีนามสกุล.3mf เป็นพารามิเตอร์แรก
4.ระบุค่าฟิลด์ 'microsoft3mf' จาก [รูปแบบไฟล์](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) คลาส
...
{{% blocks/products/pf/agp/code-autogen title="C# รหัสสำหรับ USDZ ถึง 3MF การแปลง" gistPath="" %}}
```cs
