...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter DAE para GLB via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programadores podem facilmente carregar e converter DAE arquivos para GLB em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar DAE arquivo através do construtor da classe Scene1. Chame a cena. Salve o método com o formato de GLB.1. Verifique o arquivo GLB resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra DAE a GLB C# Conversão" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para converter DAE para GLB" sectionDescription="Verifique nossas demonstrações ao vivo para [Conversão de DAE para GLB](https://products.aspose.app/3d/conversion/dae-to-glb) Com os seguintes benefícios." >}}
