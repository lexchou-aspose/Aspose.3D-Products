...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter OBJ em GLB via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programadores podem facilmente carregar e converter arquivos OBJ para GLB em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo OBJ por meio do construtor da classe Scene1. Crie uma instância de AmfSaveOptions1. Defina GLB propriedades específicas para conversão avançada1. Chame o método Scene.Save1. Passe o caminho de saída com extensão de arquivo GLB e objeto de StlSaveOptions1. Verifique o arquivo GLB resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de OBJ para GLB C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para converter OBJ em GLB" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de OBJ para GLB](https://products.aspose.app/3d/conversion/obj-to-glb) com os seguintes benefícios." >}}
