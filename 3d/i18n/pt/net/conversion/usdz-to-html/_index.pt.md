---
title: Converter USDZ para HTML via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter USDZ para HTML via C#" h2="Exportar USDZ e outros arquivos 3D usando .NET Framework, .NET Core e Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportar USDZ cena como HTML com C#" %}}
...
3. Passe o nome do arquivo de saída com. Extensão html como primeiro parâmetro
4. Especifique o valor do campo 'HTML5' de [FileFormat](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Classe
...
{{% blocks/products/pf/agp/code-autogen title="C# Código para USDZ para HTML Conversão" gistPath="" %}}
```cs
// Carregar o USDZ em um objeto de cena 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// Salvar USDZ como um HTML 
