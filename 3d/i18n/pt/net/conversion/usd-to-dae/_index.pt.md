---
title: Converter USD em DAE via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter USD em DAE via C#" h2="Exporte USD e outros 3D arquivos usando .NET Framework, .NET Core e Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportar cena USD como DAE com C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Código para conversão de USD em DAE" gistPath="" %}}
```cs
// carregue o USD em um objeto de Scene 
var scene = new Aspose.ThreeD.Scene("template.usd");
// salve USD como um DAE 
