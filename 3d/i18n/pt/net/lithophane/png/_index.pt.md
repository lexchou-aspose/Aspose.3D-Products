---
title: Crie seu litofane a partir de formatos de arquivo PNG via .NET 
weight: 830
url: /pt/net/lithophane/png/ 
description: C# código-fonte para carregar, renderizar e criar seu litofane para documentos PNG em .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crie seu litofane para PNG via C#" h2="Crie seus próprios aplicativos .NET para criar seu litofane para arquivos PNG usando APIs do lado do servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="PNG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Como criar seu litofane para arquivo PNG usando C#" %}}

 Para criar seu arquivo litofane para PNG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para criar seu litofane para PNG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D facilita para os desenvolvedores criar seu litofane para o arquivo PNG com apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

- Crie alguns novos parâmetros e crie um objeto Mesh- Execute operações computacionais em objetos Mesh- O arquivo PNG carrega a cena 3d através da classe Mesh- Chame o método Scene.Save com o objeto
...
{{% blocks/products/pf/agp/code-block title="C# código para criar seu litofane para PNG" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D é um CAD e Gameware API para carregar, modificar e converter arquivos 3D. API é independente e não requer nenhum software de modelagem ou renderização de 3D. Pode-se facilmente usar API para Discreet3DS, WavefrontOBJ, STL (ASCII, Binário), Universal3D, FBX (ASCII, Binário), Collada, glTF, PLY, GLB, DirectX e mais formatos. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para criar seu litofane para PNG" sectionDescription="Confira nossas demonstrações ao vivo para [Litofane PNG](https://products.aspose.app/3d/lithophane/png) com os seguintes benefícios." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar ou configurar nada" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever ou compilar código" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do arquivo PNG e clicar no botão \"lithophane\"" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Baixe o arquivo PNG do link, se necessário" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/3d/net/lithophane/tga/" name="TGA" description="Adaptador Raster Avançado Truevision" >}}
