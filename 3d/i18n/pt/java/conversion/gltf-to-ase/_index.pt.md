---
title: Converter GLTF para ASE via Java 
weight: 1220
url: /pt/java/conversion/gltf-to-ase/ 
description: Amostra de Java código de conversão para GLTF formato para ASE arquivo. Use este código de exemplo para converter GLTF para ASE em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter GLTF para ASE via Java" h2="Conversão de GLTF para ASE usando Java biblioteca sem qualquer software de modelagem 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="ASE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter GLTF para ASE usando Java" %}}

 Para renderizar GLTF a ASE, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter GLTF para ASE via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programadores podem facilmente converter GLTF arquivo para ASE em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar GLTF arquivo através do construtor da classe Scene1. Criar uma instância de AseSaveOptions1. Definir ASE propriedades específicas para conversão avançada1. Chame o método Scene.save1. Passe o caminho de saída com ASE extensão de arquivo e objeto de AseSaveOptions
...
{{% blocks/products/pf/agp/code-block title="GLTF a ASE Java Código-fonte de conversão" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLTF a ASE Demos ao vivo de conversão" sectionDescription="[Converter GLTF para ASE](https://products.aspose.app/3d/conversion/gltf-to-ase) Agora mesmo visitando nosso site Live Demos. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever qualquer código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo GLTF, ele será convertido instantaneamente para ASE." >}}
