---
title: Converter PDF para PLY via Java 
url: /pt/java/conversion/pdf-to-ply/ 
description: Amostra de Java código de conversão para PDF formato para PLY arquivo. Use este código de exemplo para converter PDF para PLY em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PDF para PLY via Java" h2="Conversão de PDF para PLY usando Java biblioteca sem qualquer software de modelagem 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PDF para PLY usando Java" %}}

 Para renderizar PDF a PLY, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter PDF para PLY via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programadores podem facilmente converter PDF arquivo para PLY em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar PDF arquivo através do construtor da classe Scene1. Criar uma instância de PlySaveOptions1. Definir PLY propriedades específicas para conversão avançada1. Chame o método Scene.save1. Passe o caminho de saída com PLY extensão de arquivo e objeto de PlySaveOptions
...
{{% blocks/products/pf/agp/code-block title="PDF a PLY Java Código-fonte de conversão" offSpacer="" %}}
