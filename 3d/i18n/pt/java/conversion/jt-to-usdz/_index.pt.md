---
title: Converter JT para USDZ via Java
weight: 530
url: /pt/java/conversion/jt-to-usdz/ 
description: Amostra de Java código de conversão para JT formato para USDZ arquivo. Use este código de exemplo para converter JT para USDZ em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter JT para USDZ via Java" h2="Conversão de JT para USDZ usando Java biblioteca sem qualquer software de modelagem 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="USDZ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JT" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter JT para USDZ usando Java" %}}

 Para renderizar JT a USDZ, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter JT para USDZ via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programadores podem facilmente converter JT arquivo para USDZ em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar JT arquivo através do construtor da classe Scene1. Chame o método Scene.save com o formato de USDZ.1. Verifique o arquivo USDZ resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="JT a USDZ Java Código-fonte de conversão" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="JT a USDZ Demos ao vivo de conversão" sectionDescription="[Converter JT para USDZ](https://products.aspose.app/3d/conversion/jt-to-usdz) Agora mesmo visitando nosso site Live Demos. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever qualquer código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo JT, ele será convertido instantaneamente para USDZ." >}}
