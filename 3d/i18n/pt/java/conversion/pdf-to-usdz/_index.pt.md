---
title: Converter PDF para USDZ via Java
weight: 530
url: /pt/java/conversion/pdf-to-usdz/ 
description: Amostra de Java código de conversão para PDF formato para USDZ arquivo. Use este código de exemplo para converter PDF para USDZ em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PDF para USDZ via Java" h2="Conversão de PDF para USDZ usando Java biblioteca sem qualquer software de modelagem 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="USDZ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PDF para USDZ usando Java" %}}

 Para renderizar PDF a USDZ, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter PDF para USDZ via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programadores podem facilmente converter PDF arquivo para USDZ em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar PDF arquivo através do construtor da classe Scene1. Chame o método Scene.save com o formato de USDZ.1. Verifique o arquivo USDZ resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="PDF a USDZ Java Código-fonte de conversão" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PDF a USDZ Demos ao vivo de conversão" sectionDescription="[Converter PDF para USDZ](https://products.aspose.app/3d/conversion/pdf-to-usdz) Agora mesmo visitando nosso site Live Demos. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever qualquer código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo PDF, ele será convertido instantaneamente para USDZ." >}}
