---
title: Converter GLTF para 3DS via Java 
weight: 1530
url: /pt/java/conversion/gltf-to-3ds/ 
description: Amostra de Java código de conversão para GLTF formato para 3DS arquivo. Use este código de exemplo para converter GLTF para 3DS em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter GLTF para 3DS via Java" h2="Conversão de GLTF para 3DS usando Java biblioteca sem qualquer software de modelagem 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter GLTF para 3DS usando Java" %}}

 Para renderizar GLTF a 3DS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para converter GLTF para 3DS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programadores podem facilmente converter GLTF arquivo para 3DS em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar GLTF arquivo através do construtor da classe Scene1. Criar uma instância de 3dsSaveOptions1. Definir 3DS propriedades específicas para conversão avançada1. Chame o método Scene.save1. Passe o caminho de saída com 3DS extensão de arquivo e objeto de 3dsSaveOptions
...
{{% blocks/products/pf/agp/code-block title="GLTF a 3DS Java Código-fonte de conversão" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLTF a 3DS Demos ao vivo de conversão" sectionDescription="[Converter GLTF para 3DS](https://products.aspose.app/3d/conversion/gltf-to-3ds) Agora mesmo visitando nosso site Live Demos. A demonstração ao vivo tem os seguintes benefícios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever qualquer código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer o upload do seu arquivo GLTF, ele será convertido instantaneamente para 3DS." >}}
