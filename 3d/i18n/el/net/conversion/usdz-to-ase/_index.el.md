...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή USDZ σε ASE μέσω C#" h2="Εξαγωγή USDZ & άλλων αρχείων 3D χρησιμοποιώντας .NET Πλαίσιο, .NET πυρήνα και Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Εξαγωγή USDZ σκηνής ως ASE με C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Κωδικός για USDZ σε ASE Μετατροπή" gistPath="" %}}
```cs
