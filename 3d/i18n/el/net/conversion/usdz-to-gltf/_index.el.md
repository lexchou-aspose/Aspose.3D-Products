...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή USDZ σε GLTF μέσω C#" h2="Εξαγωγή USDZ & άλλων αρχείων 3D χρησιμοποιώντας .NET Πλαίσιο, .NET πυρήνα και Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Εξαγωγή USDZ σκηνής ως GLTF με C#" %}}
...
3. Πέρασε το όνομα του αρχείου εξόδου με . Επέκταση gltf ως πρώτη παράμετρος
4. Καθορισμός τιμής πεδίου 'GLTF' [Μορφή αρχείου](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Κλάσης
...
{{% blocks/products/pf/agp/code-autogen title="C# Κωδικός για USDZ σε GLTF Μετατροπή" gistPath="" %}}
```cs
