...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή USD σε JT μέσω C#" h2="Εξαγωγή USD & άλλων αρχείων 3D χρησιμοποιώντας .NET Πλαίσιο, .NET πυρήνα και Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Εξαγωγή USD σκηνής ως JT με C#" %}}
...
3. Πέρασε το όνομα του αρχείου εξόδου με . Jt επέκταση ως πρώτη παράμετρος
4. Προσδιορίστε αξία πεδίου 'SiemensJT9' [Μορφή αρχείου](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Κλάσης
...
{{% blocks/products/pf/agp/code-autogen title="C# Κωδικός για USD σε JT Μετατροπή" gistPath="" %}}
```cs
