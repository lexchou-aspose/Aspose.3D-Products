...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή USDZ σε 3MF μέσω C#" h2="Εξαγωγή USDZ & άλλων αρχείων 3D χρησιμοποιώντας .NET Πλαίσιο, .NET πυρήνα και Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Εξαγωγή USDZ σκηνής ως 3MF με C#" %}}
...
3. Πέρασε το όνομα του αρχείου εξόδου με επέκταση .3mf ως πρώτη παράμετρος
4. Καθορίστε τιμή πεδίου 'Microsoft3MF' [Μορφή αρχείου](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Κλάσης
...
{{% blocks/products/pf/agp/code-autogen title="C# Κωδικός για USDZ σε 3MF Μετατροπή" gistPath="" %}}
```cs
