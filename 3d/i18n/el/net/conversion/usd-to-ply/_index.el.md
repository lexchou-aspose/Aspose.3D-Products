...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή USD σε PLY μέσω C#" h2="Εξαγωγή USD & άλλων αρχείων 3D χρησιμοποιώντας .NET Πλαίσιο, .NET πυρήνα και Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Εξαγωγή USD σκηνής ως PLY με C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Κωδικός για USD σε PLY Μετατροπή" gistPath="" %}}
```cs
