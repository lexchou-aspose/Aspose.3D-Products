...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή USDZ σε X μέσω C#" h2="Εξαγωγή USDZ & άλλων αρχείων 3D χρησιμοποιώντας .NET Πλαίσιο, .NET πυρήνα και Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Εξαγωγή USDZ σκηνή ως X με C#" %}}
...
3. Πέρασε το όνομα του αρχείου εξόδου με . X επέκταση ως πρώτη παράμετρος
4. Καθορίστε τιμή πεδίου 'XBinary' [Μορφή αρχείου](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Κλάσης
...
{{% blocks/products/pf/agp/code-autogen title="C# Κωδικός για USDZ σε X Μετατροπή" gistPath="" %}}
```cs
// Φόρτωση του USDZ σε ένα αντικείμενο σκηνής 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// Αποθήκευση USDZ ως X 
