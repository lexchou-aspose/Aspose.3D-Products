...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή USDZ σε AMF μέσω C#" h2="Εξαγωγή USDZ & άλλων αρχείων 3D χρησιμοποιώντας .NET Πλαίσιο, .NET πυρήνα και Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Εξαγωγή USDZ σκηνής ως AMF με C#" %}}
...
3. Πέρασε το όνομα του αρχείου εξόδου με . Amf επέκταση ως πρώτη παράμετρος
4. Καθορισμός τιμής πεδίου 'AMF' [Μορφή αρχείου](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Κλάσης
...
{{% blocks/products/pf/agp/code-autogen title="C# Κωδικός για USDZ σε AMF Μετατροπή" gistPath="" %}}
```cs
