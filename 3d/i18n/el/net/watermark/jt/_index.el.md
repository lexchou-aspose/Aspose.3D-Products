---
title: Προσθήκη υδατογράφου στα JT μορφές αρχείου μέσω .NET 
weight: 830
url: /el/net/watermark/jt/ 
description: C# πηγαίος κώδικας για φόρτωση, αποτύπωση και προσθήκη τυφλών υδατοσημείων στα JT έγγραφα σε .NET Πλαίσιο, .NET Πυρήνα, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Προσθήκη τυφλού υδατογράφου στο JT μέσω C#" h2="Δημιουργήστε τις δικές σας εφαρμογές .NET σε αρχεία υδατοσήμανσης JT χρησιμοποιώντας API από το εξυπηρετητή." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JT" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JT" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Πώς να σημειωθεί στο JT αρχείο χρήσης C#" %}}

 Προκειμένου να υδατογραφήσουμε το αρχείο JT, θα χρησιμοποιήσουμε το αρχείο.
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την προσθήκη τυφλών υδατογράφου στο JT μέσω C#" %}}

{{% blocks/products/pf/agp/text %}}

 Το Aspose.3D καθιστά εύκολο για τους προγραμματιστές να προσθέσουν τυφλό υδατογράφημα στο αρχείο JT με λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

- Φόρτωση αρχείου JT μέσω του κατασκευαστή της κλάσης σκηνής- Πάρτε την κατηγορία του Aspose.3D- Προσθήκη υδατοσημείωσης και κωδικού πρόσβασης χρησιμοποιώντας τη μέθοδο EncodeWatermark του Aspose.3D- Καλέστε τη σκηνή.Save μέθοδος με αντικείμενο
...
{{% blocks/products/pf/agp/code-block title="C# κωδικός για την προσθήκη υδατογράφου στο JT" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Το Aspose.3D είναι ένα CAD και το λογισμικό API για τη φόρτωση, την τροποποίηση και τη μετατροπή αρχείων 3D. Το API είναι αυτόνομο και δεν απαιτεί κανένα λογισμικό μοντελοποίησης ή αποτύπωσης 3D. Μπορεί κανείς να χρησιμοποιήσει το API για Discreet3DS, WavefrontOBJ, STL (ASCII, δυαδικό), Universal3D, FBX (ASCII, δυαδικό), Collada, glTF, PLY, GLB, DirectX και περισσότερες μορφές. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ελεύθερη εφαρμογή για την προσθήκη τυφλών υδατογράφου στο JT" sectionDescription="Ελέγξτε τα ζωντανά μας ντέμους [Υδατογράφημα JT](https://products.aspose.app/3d/watermark/jt) Με τα ακόλουθα οφέλη." >}}
