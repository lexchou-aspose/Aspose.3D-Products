...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε STL σε USDZ χρησιμοποιώντας Java" %}}

 Για να αναγνωρίσουμε το STL έως USDZ, θα χρησιμοποιήσουμε τα ακόλουθα:
...
{{% blocks/products/pf/agp/text %}}
 ...
 Οι προγραμματιστές Java μπορούν εύκολα να μετατρέψουν το STL αρχείο σε USDZ σε λίγες μόνο γραμμές του κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση αρχείου STL μέσω του κατασκευαστή της κλάσης σκηνής1. Καλέστε τη μέθοδο Scene.save με τη μορφή του USDZ.1. Ελέγξτε το προκύπτον αρχείο USDZ σε καθορισμένη διαδρομή
...
{{% blocks/products/pf/agp/code-block title="STL σε USDZ Java Πηγαίος κώδικας μετατροπής" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="STL σε USDZ Ζωντανή μετατροπή" sectionDescription="[Μετατροπή STL σε USDZ](https://products.aspose.app/3d/conversion/stl-to-usdz) Αυτή τη στιγμή επισκεπτώντας την ιστοσελίδα μας Live Demos.Το live demo έχει τα ακόλουθα οφέλη" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Απλά ανεβάστε το αρχείο STL σας, θα μετατραπεί άμεσα σε USDZ." >}}
