...
description: Δείγμα κώδικα μετατροπής Java για μορφή GLB σε αρχείο AMF. Χρησιμοποιήστε αυτό το παράδειγμα κώδικα για να μετατρέψετε το GLB σε AMF σε οποιαδήποτε εφαρμογή που βασίζεται στον Ιστό ή στην επιφάνεια εργασίας Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή GLB σε AMF μέσω Java" h2="Μετατροπή GLB σε AMF με χρήση βιβλιοθήκης Java χωρίς λογισμικό μοντελοποίησης 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="AMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLB" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε το GLB σε AMF χρησιμοποιώντας το Java" %}}

 Για να αποδώσουμε το GLB στο AMF, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/text %}}
 ...
 Οι προγραμματιστές Java μπορούν εύκολα να μετατρέψουν το αρχείο GLB σε AMF σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση αρχείου GLB μέσω του κατασκευαστή της κλάσης Scene1. Καλέστε τη μέθοδο Scene.save με τη μορφή του AMF.1. Ελέγξτε το προκύπτον αρχείο AMF στην καθορισμένη διαδρομή
...
{{% blocks/products/pf/agp/code-block title="Πηγαίος κώδικας μετατροπής GLB σε AMF Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ζωντανές επιδείξεις μετατροπής GLB σε AMF" sectionDescription="[Μετατροπή GLB σε AMF](https://products.aspose.app/3d/conversion/glb-to-amf) αυτή τη στιγμή, επισκεπτόμενοι τον ιστότοπο Live Demos. Η ζωντανή επίδειξη έχει τα ακόλουθα πλεονεκτήματα" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Δεν χρειάζεται να κάνετε λήψη του Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Δεν χρειάζεται να γράψετε κανέναν κώδικα." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Απλώς μεταφορτώστε το αρχείο σας GLB, θα μετατραπεί αμέσως σε AMF." >}}
