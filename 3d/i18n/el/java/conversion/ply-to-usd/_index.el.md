...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε PLY σε USD χρησιμοποιώντας Java" %}}

 Για να αναγνωρίσουμε το PLY έως USD, θα χρησιμοποιήσουμε τα ακόλουθα:
...
{{% blocks/products/pf/agp/text %}}
 ...
 Οι προγραμματιστές Java μπορούν εύκολα να μετατρέψουν το PLY αρχείο σε USD σε λίγες μόνο γραμμές του κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση αρχείου PLY μέσω του κατασκευαστή της κλάσης σκηνής1. Καλέστε τη μέθοδο Scene.save με τη μορφή του USD.1. Ελέγξτε το προκύπτον αρχείο USD σε καθορισμένη διαδρομή
...
{{% blocks/products/pf/agp/code-block title="PLY σε USD Java Πηγαίος κώδικας μετατροπής" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PLY σε USD Ζωντανή μετατροπή" sectionDescription="[Μετατροπή PLY σε USD](https://products.aspose.app/3d/conversion/ply-to-usd) Αυτή τη στιγμή επισκεπτώντας την ιστοσελίδα μας Live Demos.Το live demo έχει τα ακόλουθα οφέλη" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Απλά ανεβάστε το αρχείο PLY σας, θα μετατραπεί άμεσα σε USD." >}}
