...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε DRC σε 3DS χρησιμοποιώντας Java" %}}

 Για να αναγνωρίσουμε το DRC έως 3DS, θα χρησιμοποιήσουμε τα ακόλουθα:
...
{{% blocks/products/pf/agp/text %}}
 ...
 Οι προγραμματιστές Java μπορούν εύκολα να μετατρέψουν το DRC αρχείο σε 3DS σε λίγες μόνο γραμμές του κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση αρχείου DRC μέσω του κατασκευαστή της κλάσης σκηνής1. Δημιουργία μιας διάταξης Discreet3dsSaveOptionsName1. Ορισμός συγκεκριμένων ιδιοτήτων 3DS για προηγμένη μετατροπή1. Μέθοδος κλήσης Scene.save1. Περάστε τη διαδρομή εξόδου με επέκταση αρχείου 3DS & αντικείμενο του Discreet3dsSaveOptionsName
...
{{% blocks/products/pf/agp/code-block title="DRC σε 3DS Java Πηγαίος κώδικας μετατροπής" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC σε 3DS Ζωντανή μετατροπή" sectionDescription="[Μετατροπή DRC σε 3DS](https://products.aspose.app/3d/conversion/drc-to-3ds) Αυτή τη στιγμή επισκεπτώντας την ιστοσελίδα μας Live Demos.Το live demo έχει τα ακόλουθα οφέλη" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Απλά ανεβάστε το αρχείο DRC σας, θα μετατραπεί άμεσα σε 3DS." >}}
