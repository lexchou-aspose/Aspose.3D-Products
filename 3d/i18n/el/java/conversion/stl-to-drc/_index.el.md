...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε STL σε DRC χρησιμοποιώντας Java" %}}

 Για να αναγνωρίσουμε το STL έως DRC, θα χρησιμοποιήσουμε τα ακόλουθα:
...
{{% blocks/products/pf/agp/text %}}
 ...
 Οι προγραμματιστές Java μπορούν εύκολα να μετατρέψουν το STL αρχείο σε DRC σε λίγες μόνο γραμμές του κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση αρχείου STL μέσω του κατασκευαστή της κλάσης σκηνής1. Δημιουργία μιας ένδειξης του DrcSaveOptions1. Ορισμός συγκεκριμένων ιδιοτήτων DRC για προηγμένη μετατροπή1. Μέθοδος κλήσης Scene.save1. Πέρασε τη διαδρομή εξόδου με επέκταση αρχείου DRC & αντικείμενο του DrcSaveOptions
...
{{% blocks/products/pf/agp/code-block title="STL σε DRC Java Πηγαίος κώδικας μετατροπής" offSpacer="" %}}
