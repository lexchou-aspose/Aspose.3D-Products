---
title: Convertir GLB a GLTF a través de Java
weight: 530
url: /es/java/conversion/glb-to-gltf/ 
description: Ejemplo de Java código de conversión para GLB formato a GLTF archivo. Utilice este código de ejemplo para convertir GLB a GLTF dentro de cualquier aplicación basada en Web o Escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir GLB a GLTF a través de Java" h2="Conversión de GLB a GLTF mediante Java biblioteca sin software de modelado de 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLB" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir GLB a GLTF usando Java" %}}

 Para representar GLB a GLTF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir GLB a GLTF a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programadores pueden convertir fácilmente GLB archivo a GLTF en solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="GLB a GLTF Java Código fuente de conversión" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLB a GLTF Demos en vivo de conversión" sectionDescription="[Convertir GLB a GLTF](https://products.aspose.app/3d/conversion/glb-to-gltf) Ahora mismo visitando nuestro sitio web Live Demos. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su GLB archivo, se convertirá instantáneamente a GLTF." >}}
