...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programadores pueden cargar y convertir fácilmente OBJ archivos a 3DS en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargar OBJ archivo a través del constructor de la clase Scene1. Crear una instancia de 3dsSaveOptions1. Establecer 3DS propiedades específicas para la conversión avanzada1. Llame al método Scene.Save1. Pase la ruta de salida con 3DS extensión de archivo y objeto de 3dsSaveOptions1. Comprobar 3DS archivo resultante en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de OBJ a 3DS C#" offSpacer="" %}}
