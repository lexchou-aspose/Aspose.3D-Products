...
description: Código de muestra para la conversión de GLTF a U3D C#. Use API código de ejemplo para los archivos por lotes GLTF a la conversión de U3D dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir GLTF a U3D a través de C#" h2="Render GLTF como U3D sin ningún 3D software de modelado y renderizado." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programadores pueden cargar y convertir fácilmente GLTF archivos a U3D en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargar GLTF archivo a través del constructor de la clase Scene1. Crear una instancia de AmfSaveOptions1. Establecer U3D propiedades específicas para la conversión avanzada1. Llame al método Scene.Save1. Pase la ruta de salida con U3D extensión de archivo y objeto de U3dSaveOptions1. Comprobar U3D archivo resultante en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de GLTF a U3D C#" offSpacer="" %}}
