...
description: Código de muestra para la conversión de STL a PDF C#. Use API código de ejemplo para los archivos por lotes STL a la conversión de PDF dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir STL a PDF a través de C#" h2="Render STL como PDF sin ningún 3D software de modelado y renderizado." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programadores pueden cargar y convertir fácilmente STL archivos a PDF en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargar STL archivo a través del constructor de la clase Scene1. Crear una instancia de PdfSaveOptions1. Establecer PDF propiedades específicas para la conversión avanzada1. Llame al método Scene.Save1. Pase la ruta de salida con PDF extensión de archivo y objeto de PdfSaveOptions1. Comprobar PDF archivo resultante en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de STL a PDF C#" offSpacer="" %}}
