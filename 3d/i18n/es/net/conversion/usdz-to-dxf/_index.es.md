---
title: Convertir USDZ a DXF a través de C# 
description: Convertir USDZ y otros 3D archivos usando .NET API
url: /es/net/conversion/usdz-to-dxf/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir USDZ a DXF a través de C#" h2="Exportar USDZ y otros 3D archivos usando .NET Framework, .NET Core y Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportar USDZ escena como DXF con C#" %}}
...
3. Pase el nombre del archivo de salida con. Extensión dxf como primer parámetro
4. Especifique el valor del campo 'DXF' desde [Formato de archivo](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Clase
...
{{% blocks/products/pf/agp/code-autogen title="C# código para la conversión de USDZ a DXF" gistPath="" %}}
```cs
// Cargar el USDZ en un objeto de Escena 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// Guardar USDZ como DXF 
