...
description: Código de muestra para la conversión de ATT a STL C#. Use API código de ejemplo para los archivos por lotes ATT a la conversión de STL dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir ATT a STL a través de C#" h2="Render ATT como STL sin ningún 3D software de modelado y renderizado." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programadores pueden cargar y convertir fácilmente ATT archivos a STL en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargar ATT archivo a través del constructor de la clase Scene1. Crear una instancia de AmfSaveOptions1. Establecer STL propiedades específicas para la conversión avanzada1. Llame al método Scene.Save1. Pase la ruta de salida con STL extensión de archivo y objeto de StlSaveOptions1. Comprobar STL archivo resultante en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de ATT a STL C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir ATT a STL" sectionDescription="Consulte nuestras demostraciones en vivo para [Conversión de ATT a STL](https://products.aspose.app/3d/conversion/att-to-stl) Con los siguientes beneficios." >}}
