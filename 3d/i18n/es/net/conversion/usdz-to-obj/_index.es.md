...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir USDZ a OBJ a través de C#" h2="Exportar USDZ y otros 3D archivos usando .NET Framework, .NET Core y Mono" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# código para la conversión de USDZ a OBJ" gistPath="" %}}
```cs
