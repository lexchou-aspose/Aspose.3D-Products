...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir USD a DRC a través de C#" h2="Exportar USD y otros 3D archivos usando .NET Framework, .NET Core y Mono" >}}
...
3. Pase el nombre del archivo de salida con. Extensión drc como primer parámetro
4. Especifique el valor del campo 'Draco' desde [Formato de archivo](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Clase
...
{{% blocks/products/pf/agp/code-autogen title="C# código para la conversión de USD a DRC" gistPath="" %}}
```cs
