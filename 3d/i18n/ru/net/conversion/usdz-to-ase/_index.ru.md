---
title: Конвертировать USDZ в ASE через C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертировать USDZ в ASE через C#" h2="Экспорт USDZ и других 3D файлов с использованием .NET Framework, .NET Core и Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Экспорт USDZ сцены как ASE с C#" %}}
...
3. Pass имя выходного файла с. Расширение ase как первый параметр
4. Укажите значение поля ASE из [Файл Формат](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Класс
