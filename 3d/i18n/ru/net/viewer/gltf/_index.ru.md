...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D упрощает для разработчиков просмотр файла GLTF с несколькими строками кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузить файл GLTF через конструктор класса Scene1. Создать экземпляр Html5SaveOptions1. Установить свойства для расширенного форматирования1. Вызовите метод Scene.Save с объектом Html5SaveOptions1. Проверьте результирующий файл HTML в браузере по умолчанию
...
{{% blocks/products/pf/agp/code-block title="Код C# для просмотра GLTF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D-это CAD и Gameware API для загрузки, изменения и преобразования файлов 3D. API является автономным и не требует каких-либо программ моделирования или рендеринга 3D. Можно легко использовать API для форматов Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX и других. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Бесплатное приложение для просмотра GLTF" sectionDescription="Проверьте наши живые демонстрации, чтобы [Просмотр GLTF](https://products.aspose.app/3d/viewer/gltf) Со следующими преимуществами." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите GLTF файл и нажмите кнопку \"Просмотреть\"" >}}
