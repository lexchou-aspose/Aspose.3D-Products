...
description: Исходный код C# для загрузки, визуализации и отображения документов AMF на .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="AMF Просмотр файлов for .NET" h2="Разначение файлов AMF без программного обеспечения для моделирования и рендеринга 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="AMF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Как просмотреть файл AMF с использованием C#" %}}

 Для просмотра AMF файла мы будем использовать
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D упрощает для разработчиков просмотр файла AMF с несколькими строками кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузить файл AMF через конструктор класса Scene1. Создать экземпляр Html5SaveOptions1. Установить свойства для расширенного форматирования1. Вызовите метод Scene.Save с объектом Html5SaveOptions1. Проверьте результирующий файл HTML в браузере по умолчанию
...
{{% blocks/products/pf/agp/code-block title="Код C# для просмотра AMF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D-это CAD и Gameware API для загрузки, изменения и преобразования файлов 3D. API является автономным и не требует каких-либо программ моделирования или рендеринга 3D. Можно легко использовать API для форматов Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX и других. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Бесплатное приложение для просмотра AMF" sectionDescription="Проверьте наши живые демонстрации, чтобы [Просмотр AMF](https://products.aspose.app/3d/viewer/amf) Со следующими преимуществами." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите AMF файл и нажмите кнопку \"Просмотреть\"" >}}
