---
title: DRC Dateiformate über .NET anzeigen 
...
{{< blocks/products/pf/i18n/upper-banner h1="DRC Datei-Viewer for .NET" h2="Rendern Sie DRC Dateien ohne 3D Modellierungs-und Rendering-Software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOC" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="So sehen Sie DRC-Datei mit C#" %}}

Um die DRC-Datei anzuzeigen, verwenden wir <a href="/3d/net/">Aspose.3D for .NET</a> API, eine funktions reiche, leistungs starke und einfach zu verwendende API für C# Plattform, die mit jedem Viewer verwendet werden kann. Öffnen Sie <a href="https://www.nuget.org/packages/aspose.3d">NuGet</a> Paket manager, suche nach <b>Aspose.3D</b> Und installieren. Sie können auch den folgenden Befehl von der Package Manager-Konsole verwenden.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D macht es den Entwicklern leicht, die DRC-Datei mit nur wenigen Code zeilen anzuzeigen.
...
- Microsoft Windows oder ein kompatibles Betriebs system mit .NET Framework, .NET Core, Windows Azure, Mono oder Xamarin-Plattformen- Entwicklungs umgebung wie Microsoft Visual Studio- Aspose.3D for .NET in Ihrem Projekt referenziert
{{% /blocks/products/pf/agp/feature-section-col %}}
...
// Laden Sie DRC Szene über eine Instanz von Szene
...
Aspose.3D ist ein CAD und Gameware API zum Laden, Ändern und Konvertieren von 3D Dateien. API ist ein Standalone und erfordert keine 3D Modellierungs-oder Rendering-Software. Sie können API problemlos für Discreet3DS, WavefrontOBJ, STL (ASCII, Binär), Universal3D, FBX (ASCII, Binär), Collada, glTF, PLY, GLB, DirectX und weitere Formate verwenden.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Anzeigen von DRC" sectionDescription="Sehen Sie sich unsere Live-Demos an [DRC anzeigen](https://products.aspose.app/3d/viewer/drc) Mit folgenden Vorteilen." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach DRC-Datei hoch und klicken Sie auf die Schaltfläche \"Anzeigen\"" >}}
