---
title: Wandeln Sie USDZ über C# in X um 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Wandeln Sie USDZ über C# in X um" h2="Exportieren Sie USDZ- und andere 3D-Dateien mit .NET Framework, .NET Core und Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportiere USDZ Szene als X mit C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code für Umwandlung von USDZ in X" gistPath="" %}}
```cs
// Laden Sie die USDZ in ein Objekt der Szene 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// speichere USDZ als X 
