---
title: USDZ in OBJ konvertieren über C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USDZ in OBJ konvertieren über C#" h2="Exportieren Sie USDZ & andere 3D-Dateien mit .NET Framework, .NET Core und Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USDZ Szene als OBJ mit C# exportieren" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code für USDZ in OBJ Konvertierung" gistPath="" %}}
```cs
// Laden Sie die USDZ in einem Objekt der Szene 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// USDZ als OBJ speichern 
