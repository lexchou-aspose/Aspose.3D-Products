---
title: USD in AMF konvertieren über C# 
description: USD & andere 3D-Dateien mit .NET API konvertieren
url: /de/net/conversion/usd-to-amf/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USD in AMF konvertieren über C#" h2="Exportieren Sie USD & andere 3D-Dateien mit .NET Framework, .NET Core und Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USD Szene als AMF mit C# exportieren" %}}
...
3. Geben Sie den Namen der Ausgabe datei mit. Amf-Erweiterung als erster Parameter
4. Geben Sie den Feldwert 'AMF' aus [Format](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Klasse
...
{{% blocks/products/pf/agp/code-autogen title="C# Code für USD in AMF Konvertierung" gistPath="" %}}
```cs
// Laden Sie die USD in einem Objekt der Szene 
var scene = new Aspose.ThreeD.Scene("template.usd");
// USD als AMF speichern 
