---
title: USD in DAE konvertieren über C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USD in DAE konvertieren über C#" h2="Exportieren Sie USD & andere 3D-Dateien mit .NET Framework, .NET Core und Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USD Szene als DAE mit C# exportieren" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code für USD in DAE Konvertierung" gistPath="" %}}
```cs
// Laden Sie die USD in einem Objekt der Szene 
var scene = new Aspose.ThreeD.Scene("template.usd");
// USD als DAE speichern 
