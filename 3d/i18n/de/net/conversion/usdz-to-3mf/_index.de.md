---
title: USDZ in 3MF konvertieren über C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USDZ in 3MF konvertieren über C#" h2="Exportieren Sie USDZ & andere 3D-Dateien mit .NET Framework, .NET Core und Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USDZ Szene als 3MF mit C# exportieren" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code für USDZ in 3MF Konvertierung" gistPath="" %}}
```cs
// Laden Sie die USDZ in einem Objekt der Szene 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// USDZ als 3MF speichern 
