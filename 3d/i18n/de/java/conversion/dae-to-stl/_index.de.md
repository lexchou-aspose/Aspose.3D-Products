...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie DAE in STL mit Java" %}}

 Um DAE zu STL zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Programmierer können DAE-Datei in nur wenigen Code zeilen problemlos in STL konvertieren.
...
{{% blocks/products/pf/agp/code-block title="DAE auf STL Java Konvertierungs-Quellcode" offSpacer="" %}}
