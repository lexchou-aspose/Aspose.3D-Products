---
title: 3DS in DRC konvertieren über Java 
url: /de/java/conversion/3ds-to-drc/ 
description: Beispiel für Java Konvertierungs code für 3DS-Format in DRC-Datei. Verwenden Sie diesen Beispielcode, um 3DS in DRC innerhalb einer Web-oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="3DS in DRC konvertieren über Java" h2="3DS zu DRC Konvertierung mit Java Bibliothek ohne 3D Modellierung software." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie 3DS in DRC mit Java" %}}

 Um 3DS zu DRC zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Programmierer können 3DS-Datei in nur wenigen Code zeilen problemlos in DRC konvertieren.
...
{{% blocks/products/pf/agp/code-block title="3DS auf DRC Java Konvertierungs-Quellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="3DS auf DRC Konvertierungs-Live-Demos" sectionDescription="[3DS zu DRC konvertieren](https://products.aspose.app/3d/conversion/3ds-to-drc) Jetzt durch den Besuch unserer Live-Demos-Website. Die Live-Demo hat die folgenden Vorteile" >}}
