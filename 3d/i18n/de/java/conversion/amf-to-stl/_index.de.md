---
title: AMF in STL konvertieren über Java 
weight: 3190
url: /de/java/conversion/amf-to-stl/ 
description: Beispiel für Java Konvertierungs code für AMF-Format in STL-Datei. Verwenden Sie diesen Beispielcode, um AMF in STL innerhalb einer Web-oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="AMF in STL konvertieren über Java" h2="AMF zu STL Konvertierung mit Java Bibliothek ohne 3D Modellierung software." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie AMF in STL mit Java" %}}

 Um AMF zu STL zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von AMF in STL über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Programmierer können AMF-Datei in nur wenigen Code zeilen problemlos in STL konvertieren.
...
{{% blocks/products/pf/agp/code-block title="AMF auf STL Java Konvertierungs-Quellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="AMF auf STL Konvertierungs-Live-Demos" sectionDescription="[AMF zu STL konvertieren](https://products.aspose.app/3d/conversion/amf-to-stl) Jetzt durch den Besuch unserer Live-Demos-Website. Die Live-Demo hat die folgenden Vorteile" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre AMF-Datei hoch, sie wird sofort in STL konvertiert." >}}
