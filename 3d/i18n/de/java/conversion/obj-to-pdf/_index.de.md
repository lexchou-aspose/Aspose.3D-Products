---
title: OBJ in PDF konvertieren über Java 
url: /de/java/conversion/obj-to-pdf/ 
description: Beispiel für Java Konvertierungs code für OBJ-Format in PDF-Datei. Verwenden Sie diesen Beispielcode, um OBJ in PDF innerhalb einer Web-oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="OBJ in PDF konvertieren über Java" h2="OBJ zu PDF Konvertierung mit Java Bibliothek ohne 3D Modellierung software." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OBJ in PDF mit Java" %}}

 Um OBJ zu PDF zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von OBJ in PDF über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Programmierer können OBJ-Datei in nur wenigen Code zeilen problemlos in PDF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die OBJ-Datei über den Konstruktor der Scene-Klasse1. Erstellen Sie eine Instanz von PdfSaveOptions1. Legen Sie PDF spezifische Eigenschaften für die erweiterte Konvertierung fest1. Call Scene.save-Methode1. Übergeben Sie den Ausgabe pfad mit PDF Datei erweiterung & Objekt von PdfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="OBJ auf PDF Java Konvertierungs-Quellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="OBJ auf PDF Konvertierungs-Live-Demos" sectionDescription="[OBJ zu PDF konvertieren](https://products.aspose.app/3d/conversion/obj-to-pdf) Jetzt durch den Besuch unserer Live-Demos-Website. Die Live-Demo hat die folgenden Vorteile" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre OBJ-Datei hoch, sie wird sofort in PDF konvertiert." >}}
