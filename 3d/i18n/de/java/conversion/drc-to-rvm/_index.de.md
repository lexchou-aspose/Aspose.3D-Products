...
{{% blocks/products/pf/agp/content h2="Konvertieren von DRC in RVM mit Java" %}}

 Um DRC in RVM zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Programmierer können die DRC-Datei in nur wenigen Codezeilen einfach in RVM umwandeln.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die DRC-Datei über den Konstruktor der Scene-Klasse1. Erstellen Sie eine Instanz von RvmSaveOptions1. Legen Sie RVM spezifische Eigenschaften für die erweiterte Konvertierung fest1. Rufen Sie die Scene.save-Methode auf1. Übergeben Sie den Ausgabepfad mit der Dateierweiterung RVM und dem Objekt von RvmSaveOptions
...
{{% blocks/products/pf/agp/code-block title="DRC bis RVM Java Conversion-Quellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC bis RVM Conversion-Live-Demos" sectionDescription="[Wandeln Sie DRC in RVM um](https://products.aspose.app/3d/conversion/drc-to-rvm) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
