...
{{% blocks/products/pf/agp/content h2="Konvertieren von GLTF in AMF mit Java" %}}

 Um GLTF in AMF zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Programmierer können die GLTF-Datei in nur wenigen Codezeilen einfach in AMF umwandeln.
...
{{% blocks/products/pf/agp/code-block title="GLTF bis AMF Java Conversion-Quellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLTF bis AMF Conversion-Live-Demos" sectionDescription="[Wandeln Sie GLTF in AMF um](https://products.aspose.app/3d/conversion/gltf-to-amf) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
