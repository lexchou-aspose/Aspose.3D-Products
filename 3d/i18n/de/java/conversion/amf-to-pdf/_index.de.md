...
{{% blocks/products/pf/agp/content h2="Konvertieren von AMF in PDF mit Java" %}}

 Um AMF in PDF zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Programmierer können die AMF-Datei in nur wenigen Codezeilen einfach in PDF umwandeln.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die AMF-Datei über den Konstruktor der Scene-Klasse1. Erstellen Sie eine Instanz von PdfSaveOptions1. Legen Sie PDF spezifische Eigenschaften für die erweiterte Konvertierung fest1. Rufen Sie die Scene.save-Methode auf1. Übergeben Sie den Ausgabepfad mit der Dateierweiterung PDF und dem Objekt von PdfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="AMF bis PDF Java Conversion-Quellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="AMF bis PDF Conversion-Live-Demos" sectionDescription="[Wandeln Sie AMF in PDF um](https://products.aspose.app/3d/conversion/amf-to-pdf) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
