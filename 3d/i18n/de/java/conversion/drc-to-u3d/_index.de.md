---
title: DRC in U3D konvertieren über Java 
url: /de/java/conversion/drc-to-u3d/ 
description: Beispiel für Java Konvertierungs code für DRC-Format in U3D-Datei. Verwenden Sie diesen Beispielcode, um DRC in U3D innerhalb einer Web-oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="DRC in U3D konvertieren über Java" h2="DRC zu U3D Konvertierung mit Java Bibliothek ohne 3D Modellierung software." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie DRC in U3D mit Java" %}}

 Um DRC zu U3D zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Programmierer können DRC-Datei in nur wenigen Code zeilen problemlos in U3D konvertieren.
...
{{% blocks/products/pf/agp/code-block title="DRC auf U3D Java Konvertierungs-Quellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC auf U3D Konvertierungs-Live-Demos" sectionDescription="[DRC zu U3D konvertieren](https://products.aspose.app/3d/conversion/drc-to-u3d) Jetzt durch den Besuch unserer Live-Demos-Website. Die Live-Demo hat die folgenden Vorteile" >}}
