...
description: نموذج Java من رمز التحويل لتنسيق DRC إلى ملف DAE. استخدم رمز المثال هذا لتحويل DRC إلى DAE داخل أي تطبيق ويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل DRC إلى DAE عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java يمكن للمبرمجين تحويل DRC بسهولة إلى DAE في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل DRC الملف عبر مُنشئ فئة المشهد1. إنشاء مثيل لـ DaeSaveOptions1. تعيين DAE خصائص محددة للتحويل المتقدم1. استدعاء المشهد. طريقة حفظ1. اجتياز مسار الإخراج مع امتداد الملف DAE والكائن من DaeSaveOptions
...
{{% blocks/products/pf/agp/code-block title="DRC إلى DAE Java رمز مصدر التحويل" offSpacer="" %}}
