...
description: نموذج Java رمز التحويل لصيغة X إلى ملف DRC. استخدم رمز المثال هذا لتحويل X إلى DRC داخل أي تطبيق ويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل X إلى DRC عبر Java" h2="تحويل X إلى DRC باستخدام مكتبة Java بدون أي برنامج نمذجة 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="X" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل X إلى DRC باستخدام Java" %}}
 ...
 من أجل تقديم X إلى DRC ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java يمكن للمبرمجين تحويل ملف X بسهولة إلى DRC في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف X عبر مُنشئ فئة المشهد1. إنشاء مثيل لـ DrcSaveOptions1. تعيين DRC خصائص محددة للتحويل المتقدم1. استدعاء المشهد. طريقة حفظ1. اجتياز مسار الإخراج مع امتداد الملف DRC والكائن من DrcSaveOptions
...
{{% blocks/products/pf/agp/code-block title="X to DRC Java رمز مصدر التحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="X إلى DRC تحويل العروض التوضيحية المباشرة" sectionDescription="[تحويل X إلى DRC](https://products.aspose.app/3d/conversion/x-to-drc) الآن من خلال زيارة موقع Live Demos الإلكتروني. يحتوي العرض التوضيحي المباشر على الفوائد التالية" >}}
