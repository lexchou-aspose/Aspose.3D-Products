...
description: نموذج Java شفرة تحويل من تنسيق GLTF إلى ملف FBX. استخدم رمز المثال هذا لتحويل GLTF إلى FBX داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من GLTF إلى FBX عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمبرمجين Java بسهولة تحويل GLTF ملف إلى FBX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف GLTF عبر منشئ فئة المشهد1. إنشاء مثيل FbxSaveOptions1. قم بتعيين FBX من الخصائص المحددة للتحويل المتقدم1. استدعاء طريقة Scene.save1. قم بتمرير مسار الإخراج مع FBX امتداد الملف وكائن FbxSaveOptions
...
{{% blocks/products/pf/agp/code-block title="GLTF إلى FBX Java شفرة مصدر التحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLTF إلى FBX عروض توضيحية مباشرة للتحويلات" sectionDescription="[تحويل GLTF إلى FBX](https://products.aspose.app/3d/conversion/gltf-to-fbx) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف GLTF الخاص بك ، وسيتم تحويله على الفور إلى FBX." >}}
