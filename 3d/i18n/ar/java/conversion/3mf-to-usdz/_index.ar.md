...
description: نموذج Java شفرة تحويل من تنسيق 3MF إلى ملف USDZ. استخدم رمز المثال هذا لتحويل 3MF إلى USDZ داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من 3MF إلى USDZ عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمبرمجين Java بسهولة تحويل 3MF ملف إلى USDZ في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف 3MF عبر منشئ فئة المشهد1. قم باستدعاء طريقة Scene.save بتنسيق USDZ.1. تحقق من الملف الناتج USDZ في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="3MF إلى USDZ Java شفرة مصدر التحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="3MF إلى USDZ عروض توضيحية مباشرة للتحويلات" sectionDescription="[تحويل 3MF إلى USDZ](https://products.aspose.app/3d/conversion/3mf-to-usdz) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف 3MF الخاص بك ، وسيتم تحويله على الفور إلى USDZ." >}}
