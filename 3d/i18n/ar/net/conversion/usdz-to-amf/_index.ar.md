...
{{% blocks/products/pf/agp/feature-section-col title="تصدير USDZ مشهد باسم AMF مع C#" %}}
...
3. تمرير اسم الملف الإخراج مع. تمديد amf كمعلمة أولى
4. تحديد قيمة الحقل "AMF" من [FileFormat](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) فئة
...
{{% blocks/products/pf/agp/code-autogen title="C# كود لـ USDZ إلى AMF تحويل" gistPath="" %}}
```cs
