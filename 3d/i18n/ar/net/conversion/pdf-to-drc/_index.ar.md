...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل PDF إلى DRC عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET يمكن للمبرمجين تحميل وتحويل PDF من الملفات بسهولة إلى DRC في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل PDF الملف عبر مُنشئ فئة المشهد1. إنشاء مثيل من AmfSaveOptions1. تعيين DRC خصائص محددة للتحويل المتقدم1. استدعاء المشهد. حفظ الطريقة1. اجتياز مسار الإخراج مع امتداد الملف DRC والكائن من DrcSaveOptions1. تحقق من ملف DRC الناتج في مسار محدد
...
{{% blocks/products/pf/agp/code-block title="يوضح رمز العينة هذا PDF إلى DRC C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لتحويل PDF إلى DRC" sectionDescription="تحقق من العروض الحية لدينا ل [PDF إلى DRC تحويل](https://products.aspose.app/3d/conversion/pdf-to-drc) مع الفوائد التالية." >}}
