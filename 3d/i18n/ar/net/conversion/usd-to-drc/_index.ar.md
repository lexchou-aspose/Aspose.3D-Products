...
{{% blocks/products/pf/agp/feature-section-col title="تصدير USD مشهد باسم DRC مع C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# كود لـ USD إلى DRC تحويل" gistPath="" %}}
```cs
