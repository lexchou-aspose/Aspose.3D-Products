...
{{% blocks/products/pf/agp/feature-section-col title="تصدير USD مشهد باسم JT مع C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# كود لـ USD إلى JT تحويل" gistPath="" %}}
```cs
