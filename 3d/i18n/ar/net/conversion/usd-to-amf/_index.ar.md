...
{{% blocks/products/pf/agp/feature-section-col title="تصدير USD مشهد باسم AMF مع C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# كود لـ USD إلى AMF تحويل" gistPath="" %}}
```cs
