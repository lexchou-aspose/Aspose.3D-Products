...
{{% blocks/products/pf/agp/feature-section-col title="تصدير USD مشهد باسم 3MF مع C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# كود لـ USD إلى 3MF تحويل" gistPath="" %}}
```cs
