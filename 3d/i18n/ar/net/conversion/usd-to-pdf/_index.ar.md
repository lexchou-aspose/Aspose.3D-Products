...
{{% blocks/products/pf/agp/feature-section-col title="تصدير USD مشهد باسم PDF مع C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# كود لـ USD إلى PDF تحويل" gistPath="" %}}
```cs
