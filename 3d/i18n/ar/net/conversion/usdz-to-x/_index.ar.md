...
{{% blocks/products/pf/agp/feature-section-col title="تصدير USDZ مشهد كX مع C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# رمز لـ USDZ إلى X Conversation" gistPath="" %}}
```cs
