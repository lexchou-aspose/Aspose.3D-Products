...
{{% blocks/products/pf/agp/feature-section-col title="تصدير USD مشهد باسم RVM مع C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# كود لـ USD إلى RVM تحويل" gistPath="" %}}
```cs
