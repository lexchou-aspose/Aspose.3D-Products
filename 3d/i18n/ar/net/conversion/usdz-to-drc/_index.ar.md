---
title: تحويل USDZ إلى DRC عبر C# 
description: تحويل USDZ وملفات 3D أخرى باستخدام .NET API
url: /ar/net/conversion/usdz-to-drc/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل USDZ إلى DRC عبر C#" h2="تصدير USDZ وملفات 3D أخرى باستخدام .NET Framework و .NET Core و Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="تصدير USDZ مشهد باسم DRC مع C#" %}}
...
3. تمرير اسم الملف الإخراج مع. تمديد drc كمعلمة أولى
4. تحديد قيمة الحقل "Draco" من [FileFormat](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) فئة
...
{{% blocks/products/pf/agp/code-autogen title="C# كود لـ USDZ إلى DRC تحويل" gistPath="" %}}
```cs
