...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D يجعل من السهل على المطورين عرض ملف X بسطور قليلة فقط من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف X عبر مُنشئ فئة المشهد1. إنشاء مثيل لـ Html5SaveOptions1. تعيين خصائص التنسيق المتقدم1. استدعاء المشهد. حفظ الطريقة مع كائن Html5SaveOptions1. تحقق من ملف HTML الناتج في المتصفح الافتراضي
...
{{% blocks/products/pf/agp/code-block title="C# رمز لعرض X" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// تحميل المشهد X عبر مثيل من المشهد
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D هو CAD و Gameweware API لتحميل وتعديل وتحويل 3D من الملفات. API مستقل ولا يتطلب أي برنامج نمذجة أو عرض 3D. يمكن للمرء بسهولة استخدام API لـ Discreet3DS ، WavefrontOBJ ، STL (ASCII ، ثنائي) ، Universal3D ، FBX (ASCII ، ثنائي) ، Collada ، glTF ، PLY ، GLB ، DirectX والمزيد من التنسيقات. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لعرض X" sectionDescription="تحقق من العروض التوضيحية الحية لدينا [عرض X](https://products.aspose.app/3d/viewer/x) مع الفوائد التالية." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" مجرد تحميل ملف X واضغط على زر \"عرض\"" >}}
