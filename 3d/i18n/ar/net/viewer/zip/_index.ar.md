...
description: C# شفرة المصدر لتحميل وعرض وعرض مستندات ZIP على .NET Framework ، .NET Core ، Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ZIP عارض الملفات for .NET" h2="عرض ملفات ZIP بدون أي 3D برامج تصميم وعرض." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ZIP" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ZIP" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يسهّل Aspose.3D على المطورين عرض ملف ZIP ببضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف ZIP عبر منشئ فئة المشهد1. قم بإنشاء مثيل لـ Html5SaveOptions1. قم بتعيين خصائص التنسيق المتقدم1. قم باستدعاء الأسلوب Scene.Save مع كائن Html5SaveOptions1. تحقق من الملف الناتج HTML في المتصفح الافتراضي
...
{{% blocks/products/pf/agp/code-block title="C# رمز لعرضه ZIP" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// تحميل المشهد ZIP عبر مثيل المشهد
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D هو برنامج ألعاب CAD وألعاب API لتحميل وتعديل وتحويل ملفات 3D. API هو برنامج قائم بذاته ولا يتطلب أي 3D برامج عرض أو نماذج. يمكن للمرء بسهولة استخدام API لـ Discreet3DS ، WavefrontOBJ ، STL (ASCII ، ثنائي) ، Universal3D ، FBX (ASCII ، ثنائي) ، Collada ، glTF ، PLY ، GLB و DirectX والمزيد من التنسيقات. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لعرضه ZIP" sectionDescription="تحقق من العروض الحية لدينا ل [عرض ZIP](https://products.aspose.app/3d/viewer/zip) مع الفوائد التالية." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل أو إعداد أي شيء" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أو ترجمة التعليمات البرمجية" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف ZIP واضغط على الزر \"عرض\"" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" قم بتنزيل ملف ZIP من الرابط ، إذا لزم الأمر" >}}

        {{< blocks/products/pf/agp/i18n/about-file-text fileFormat="ZIP" readMoreLink="https://docs.fileformat.com/compression/zip/" >}}
يمثل امتداد الملف ZIP أرشيفات يمكنها الاحتفاظ بملف أو دليل واحد أو أكثر. يمكن أن يتم تطبيق ضغط الأرشيف على الملفات المضمنة لتقليل حجم الملف ZIP. تم نشر تنسيق الملف ZIP مرة أخرى في فبراير 1989 بواسطة Phil Katz لتحقيق أرشفة الملفات والمجلدات. تم جعل التنسيق جزءًا من أداة PKZIP ، التي أنشأتها شركة PKWARE، Inc. مباشرة بعد توفر المواصفات المتاحة ، جعلت العديد من الشركات ZIP تنسيق الملف جزءًا من أدوات برامجها بما في ذلك Microsoft (منذ Windows 7) و Apple (Mac OS X) وغيرها الكثير.
