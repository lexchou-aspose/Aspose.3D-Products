---
title: عرض VRML تنسيقات الملفات عبر .NET 
weight: 2540
url: /ar/net/viewer/vrml/ 
description: C# كود المصدر لتحميل وتقديم وعرض VRML من المستندات على .NET Framework ، .NET Core ، Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VRML عارض الملفات for .NET" h2="Render VRML ملفات بدون أي برنامج نمذجة وعرض 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VRML" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VRML" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="كيفية عرض VRML ملف باستخدام C#" %}}

 لعرض VRML ملف ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات لعرض VRML عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D يجعل من السهل على المطورين عرض ملف VRML مع بضعة أسطر من التعليمات البرمجية فقط.

{{% /blocks/products/pf/agp/text %}}

1. تحميل VRML الملف عبر مُنشئ فئة المشهد1. إنشاء مثيل لـ Html5SaveOptions1. تعيين خصائص التنسيق المتقدم1. استدعاء المشهد. حفظ الطريقة مع كائن Html5SaveOptions1. تحقق من ملف HTML الناتج في المتصفح الافتراضي
...
{{% blocks/products/pf/agp/code-block title="C# رمز لعرض VRML" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// تحميل VRML مشهد عبر مثيل من المشهد
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D هو CAD و Gameweware API لتحميل وتعديل وتحويل 3D من الملفات. API مستقل ولا يتطلب أي برنامج نمذجة أو عرض 3D. يمكن للمرء بسهولة استخدام API لـ Discreet3DS ، WavefrontOBJ ، STL (ASCII ، ثنائي) ، Universal3D ، FBX (ASCII ، ثنائي) ، Collada ، glTF ، PLY ، GLB ، DirectX والمزيد من التنسيقات. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="تطبيق مجاني لعرض VRML" sectionDescription="تحقق من العروض التوضيحية الحية لدينا [عرض VRML](https://products.aspose.app/3d/viewer/vrml) مع الفوائد التالية." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل VRML من الملف والضغط على زر \"عرض\"" >}}
