---
title: Konwertuj FBX na GLB przez C# 
url: /pl/net/conversion/fbx-to-glb/ 
description: Przykładowy kod konwersji FBX na GLB C#. Użyj API przykładowego kodu dla plików wsadowych FBX do konwersji GLB w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj FBX na GLB przez C#" h2="Renderuj FBX jako GLB bez żadnego oprogramowania do modelowania i renderowania 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FBX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować FBX na GLB przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki FBX na GLB w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik FBX za pomocą konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Ustaw GLB określone właściwości dla zaawansowanej konwersji1. Wywołaj metodę Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku GLB i obiektem StlSaveOptions1. Sprawdź wynikowy plik GLB w określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji FBX na GLB" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z FBX do GLB](https://products.aspose.app/3d/conversion/fbx-to-glb) z następującymi korzyściami." >}}
