---
title: Konwertuj USDZ na X przez C# 
description: Konwertuj pliki USDZ i inne 3D za pomocą .NET API
url: /pl/net/conversion/usdz-to-x/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj USDZ na X przez C#" h2="Eksportuj USDZ i inne 3D plików przy użyciu .NET Framework, .NET Core i Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Wyeksportuj USDZ sceny jako X z C#" %}}
...
3. Przekaż nazwę pliku wyjściowego za pomocą. X rozszerzenie jako pierwszy parametr
4. Określ wartość pola „ XBinary' z [Format plików](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Klasa
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod dla konwersji USDZ na X" gistPath="" %}}
```cs
