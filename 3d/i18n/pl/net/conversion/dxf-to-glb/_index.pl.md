---
title: Konwertuj DXF na GLB za pośrednictwem C# 
weight: 530
url: /pl/net/conversion/dxf-to-glb/ 
description: Przykładowy kod dla konwersji od DXF do GLB C#. Użyj kodu przykładowego API dla plików wsadowych DXF do konwersji GLB w ramach VB.NET, asp .NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj DXF na GLB za pośrednictwem C#" h2="Renderuj DXF jako GLB bez żadnego oprogramowania do modelowania i renderowania 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DXF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować DXF na GLB za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować DXF plików na GLB w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik DXF przez konstruktora klasy Scene1. Zadzwoń do sceny. Zapisz metodę w formacie GLB.1. Sprawdź wynikowy plik GLB przy określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji DXF na GLB" sectionDescription="Sprawdź nasze dema na żywo [Konwersja DXF do GLB](https://products.aspose.app/3d/conversion/dxf-to-glb) Z następującymi korzyściami." >}}
