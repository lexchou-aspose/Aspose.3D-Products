---
title: Konwertuj USD na ASE za pośrednictwem C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj USD na ASE za pośrednictwem C#" h2="Eksportuj USD i inne 3D plików przy użyciu .NET Framework, .NET Core i Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Eksportuj USD sceny jako ASE z C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod dla USD do ASE konwersji" gistPath="" %}}
```cs
