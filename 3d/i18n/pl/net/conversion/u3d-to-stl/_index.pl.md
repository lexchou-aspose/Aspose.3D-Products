---
title: Konwertuj U3D na STL za pośrednictwem C# 
weight: 2210
url: /pl/net/conversion/u3d-to-stl/ 
description: Przykładowy kod dla konwersji od U3D do STL C#. Użyj kodu przykładowego API dla plików wsadowych U3D do konwersji STL w ramach VB.NET, asp .NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj U3D na STL za pośrednictwem C#" h2="Renderuj U3D jako STL bez żadnego oprogramowania do modelowania i renderowania 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="U3D" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować U3D na STL za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować U3D plików na STL w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik U3D przez konstruktora klasy Scene1. Utwórz instancję StlSaveOptions1. Zestaw STL specyficznych właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku StlSaveOptions STL1. Sprawdź wynikowy plik STL przy określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji U3D na STL" sectionDescription="Sprawdź nasze dema na żywo [Konwersja U3D do STL](https://products.aspose.app/3d/conversion/u3d-to-stl) Z następującymi korzyściami." >}}
