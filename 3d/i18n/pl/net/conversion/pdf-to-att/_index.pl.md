---
title: Konwertuj PDF na ATT za pośrednictwem C# 
url: /pl/net/conversion/pdf-to-att/ 
description: Przykładowy kod dla konwersji od PDF do ATT C#. Użyj kodu przykładowego API dla plików wsadowych PDF do konwersji ATT w ramach VB.NET, asp .NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj PDF na ATT za pośrednictwem C#" h2="Renderuj PDF jako ATT bez żadnego oprogramowania do modelowania i renderowania 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ATT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować PDF na ATT za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować PDF plików na ATT w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik PDF przez konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Zestaw ATT specyficznych właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku ATT AttSaveOptions1. Sprawdź wynikowy plik ATT przy określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji PDF na ATT" sectionDescription="Sprawdź nasze dema na żywo [Konwersja PDF do ATT](https://products.aspose.app/3d/conversion/pdf-to-att) Z następującymi korzyściami." >}}
