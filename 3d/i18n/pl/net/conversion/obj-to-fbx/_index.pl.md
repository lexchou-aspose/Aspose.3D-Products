---
title: Konwertuj OBJ na FBX przez C# 
weight: 3600
url: /pl/net/conversion/obj-to-fbx/ 
description: Przykładowy kod konwersji OBJ na FBX C#. Użyj API przykładowego kodu dla plików wsadowych OBJ do konwersji FBX w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj OBJ na FBX przez C#" h2="Renderuj OBJ jako FBX bez żadnego oprogramowania do modelowania i renderowania 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować OBJ na FBX przez C#" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji OBJ na FBX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z OBJ do FBX](https://products.aspose.app/3d/conversion/obj-to-fbx) z następującymi korzyściami." >}}
