---
title: Konwertuj GLTF na FBX przez C# 
url: /pl/net/conversion/gltf-to-fbx/ 
description: Przykładowy kod konwersji GLTF na FBX C#. Użyj API przykładowego kodu dla plików wsadowych GLTF do konwersji FBX w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj GLTF na FBX przez C#" h2="Renderuj GLTF jako FBX bez żadnego oprogramowania do modelowania i renderowania 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować GLTF na FBX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki GLTF na FBX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik GLTF za pomocą konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Ustaw FBX określone właściwości dla zaawansowanej konwersji1. Wywołaj metodę Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku FBX i obiektem FbxSaveOptions1. Sprawdź wynikowy plik FBX w określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji GLTF na FBX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z GLTF do FBX](https://products.aspose.app/3d/conversion/gltf-to-fbx) z następującymi korzyściami." >}}
