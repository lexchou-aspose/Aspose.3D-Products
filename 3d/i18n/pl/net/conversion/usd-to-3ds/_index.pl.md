---
title: Konwertuj USD na 3DS przez C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj USD na 3DS przez C#" h2="Eksportuj USD i inne 3D pliki za pomocą .NET Framework, .NET Core i Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Eksportuj USD scenę jako 3DS z C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod konwersji USD na 3DS" gistPath="" %}}
```cs
