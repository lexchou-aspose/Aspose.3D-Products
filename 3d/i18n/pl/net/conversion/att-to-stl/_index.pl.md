...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ATT na STL za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować ATT plików na STL w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik ATT przez konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Zestaw STL specyficznych właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku StlSaveOptions STL1. Sprawdź wynikowy plik STL przy określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji ATT na STL" sectionDescription="Sprawdź nasze dema na żywo [Konwersja ATT do STL](https://products.aspose.app/3d/conversion/att-to-stl) Z następującymi korzyściami." >}}
