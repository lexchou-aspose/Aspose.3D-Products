---
title: Konwertuj GLTF na OBJ za pośrednictwem C# 
url: /pl/net/conversion/gltf-to-obj/ 
description: Przykładowy kod dla konwersji od GLTF do OBJ C#. Użyj kodu przykładowego API dla plików wsadowych GLTF do konwersji OBJ w ramach VB.NET, asp .NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj GLTF na OBJ za pośrednictwem C#" h2="Renderuj GLTF jako OBJ bez żadnego oprogramowania do modelowania i renderowania 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować GLTF na OBJ za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować GLTF plików na OBJ w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik GLTF przez konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Zestaw OBJ specyficznych właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku OBJ ObjSaveOptions1. Sprawdź wynikowy plik OBJ przy określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji GLTF na OBJ" sectionDescription="Sprawdź nasze dema na żywo [Konwersja GLTF do OBJ](https://products.aspose.app/3d/conversion/gltf-to-obj) Z następującymi korzyściami." >}}
