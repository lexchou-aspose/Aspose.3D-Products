...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować AMF na DRC przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki AMF na DRC w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik AMF za pomocą konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Ustaw DRC określone właściwości dla zaawansowanej konwersji1. Wywołaj metodę Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku DRC i obiektem DrcSaveOptions1. Sprawdź wynikowy plik DRC w określonej ścieżce
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od AMF do DRC C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji AMF na DRC" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z AMF do DRC](https://products.aspose.app/3d/conversion/amf-to-drc) z następującymi korzyściami." >}}
