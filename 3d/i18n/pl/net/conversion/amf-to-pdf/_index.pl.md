---
title: Konwertuj AMF na PDF za pośrednictwem C# 
weight: 1400
url: /pl/net/conversion/amf-to-pdf/ 
description: Przykładowy kod dla konwersji od AMF do PDF C#. Użyj kodu przykładowego API dla plików wsadowych AMF do konwersji PDF w ramach VB.NET, asp .NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj AMF na PDF za pośrednictwem C#" h2="Renderuj AMF jako PDF bez żadnego oprogramowania do modelowania i renderowania 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować AMF na PDF za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować AMF plików na PDF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik AMF przez konstruktora klasy Scene1. Utwórz instancję PdfSaveOptions1. Zestaw PDF specyficznych właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku PDF PdfSaveOptions1. Sprawdź wynikowy plik PDF przy określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji AMF na PDF" sectionDescription="Sprawdź nasze dema na żywo [Konwersja AMF do PDF](https://products.aspose.app/3d/conversion/amf-to-pdf) Z następującymi korzyściami." >}}
