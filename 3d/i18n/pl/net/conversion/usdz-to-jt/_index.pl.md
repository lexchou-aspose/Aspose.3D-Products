---
title: Konwertuj USDZ na JT przez C# 
description: Konwertuj pliki USDZ i inne 3D za pomocą .NET API
url: /pl/net/conversion/usdz-to-jt/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj USDZ na JT przez C#" h2="Eksportuj USDZ i inne 3D pliki za pomocą .NET Framework, .NET Core i Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Eksportuj USDZ scenę jako JT z C#" %}}
...
3. Przekaż nazwę pliku wyjściowego z rozszerzeniem .jt jako pierwszy parametr
4. Określ wartość pola `SiemensJT9` z [Format pliku](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) klasa
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod konwersji USDZ na JT" gistPath="" %}}
```cs
