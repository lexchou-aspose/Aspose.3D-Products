---
title: Konwertuj USDZ na JT za pośrednictwem C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj USDZ na JT za pośrednictwem C#" h2="Eksportuj USDZ i inne 3D plików przy użyciu .NET Framework, .NET Core i Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Eksportuj USDZ sceny jako JT z C#" %}}
...
3. Przekaż nazwę pliku wyjściowego za pomocą. Jt rozszerzenie jako pierwszy parametr
4. Określ wartość pola „ SiemensJT9 ”z [Format plików](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Klasa
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod dla USDZ do JT konwersji" gistPath="" %}}
```cs
