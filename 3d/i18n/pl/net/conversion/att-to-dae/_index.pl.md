---
title: Konwertuj ATT na DAE za pośrednictwem C# 
url: /pl/net/conversion/att-to-dae/ 
description: Przykładowy kod dla konwersji od ATT do DAE C#. Użyj kodu przykładowego API dla plików wsadowych ATT do konwersji DAE w ramach VB.NET, asp .NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ATT na DAE za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować ATT plików na DAE w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik ATT przez konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Zestaw DAE specyficznych właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.Save1. Podaj ścieżkę wyjściową z rozszerzeniem i obiektem pliku DAE DaeSaveOptions1. Sprawdź wynikowy plik DAE przy określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji ATT na DAE" sectionDescription="Sprawdź nasze dema na żywo [Konwersja ATT do DAE](https://products.aspose.app/3d/conversion/att-to-dae) Z następującymi korzyściami." >}}
