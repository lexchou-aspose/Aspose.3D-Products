---
title: Konwertuj AMF na U3D za pośrednictwem C# 
weight: 2830
url: /pl/net/conversion/amf-to-u3d/ 
description: Przykładowy kod dla konwersji od AMF do U3D C#. Użyj kodu przykładowego API dla plików wsadowych AMF do konwersji U3D w ramach VB.NET, asp .NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować AMF na U3D za pomocą C#" %}}

 Aby przekonwertować AMF na U3D, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować AMF na U3D za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować AMF plików na U3D w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik AMF przez konstruktora klasy Scene1. Utwórz instancję U3dSaveOptions1. Zestaw U3D specyficznych właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku U3dSaveOptions U3D1. Sprawdź wynikowy plik U3D przy określonej ścieżce
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od AMF do U3D C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji AMF na U3D" sectionDescription="Sprawdź nasze dema na żywo [Konwersja AMF do U3D](https://products.aspose.app/3d/conversion/amf-to-u3d) Z następującymi korzyściami." >}}
