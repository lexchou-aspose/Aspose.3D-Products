...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować DAE na PLY za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować DAE plików na PLY w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik DAE przez konstruktora klasy Scene1. Utwórz instancję PlySaveOptions1. Zestaw PLY specyficznych właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem PlySaveOptions PLY1. Sprawdź wynikowy plik PLY przy określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji DAE na PLY" sectionDescription="Sprawdź nasze dema na żywo [Konwersja DAE do PLY](https://products.aspose.app/3d/conversion/dae-to-ply) Z następującymi korzyściami." >}}
