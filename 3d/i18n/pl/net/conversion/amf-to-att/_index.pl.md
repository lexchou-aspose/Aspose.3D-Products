...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować AMF na ATT przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki AMF na ATT w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik AMF za pomocą konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Ustaw ATT określone właściwości dla zaawansowanej konwersji1. Wywołaj metodę Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku ATT i obiektem AttSaveOptions1. Sprawdź wynikowy plik ATT w określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji AMF na ATT" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z AMF do ATT](https://products.aspose.app/3d/conversion/amf-to-att) z następującymi korzyściami." >}}
