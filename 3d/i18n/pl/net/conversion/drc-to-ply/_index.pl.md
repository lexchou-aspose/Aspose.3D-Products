...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować DRC na PLY przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki DRC na PLY w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik DRC za pomocą konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Ustaw PLY określone właściwości dla zaawansowanej konwersji1. Wywołaj metodę Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku PLY i obiektem PlySaveOptions1. Sprawdź wynikowy plik PLY w określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji DRC na PLY" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z DRC do PLY](https://products.aspose.app/3d/conversion/drc-to-ply) z następującymi korzyściami." >}}
