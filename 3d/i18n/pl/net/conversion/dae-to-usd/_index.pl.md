---
title: Konwertuj DAE na USD za pośrednictwem C# 
weight: 530
url: /pl/net/conversion/dae-to-usd/ 
description: Przykładowy kod dla konwersji od DAE do USD C#. Użyj kodu przykładowego API dla plików wsadowych DAE do konwersji USD w ramach VB.NET, asp .NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj DAE na USD za pośrednictwem C#" h2="Renderuj DAE jako USD bez żadnego oprogramowania do modelowania i renderowania 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="USD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować DAE na USD za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować DAE plików na USD w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik DAE przez konstruktora klasy Scene1. Zadzwoń do sceny. Zapisz metodę w formacie USD.1. Sprawdź wynikowy plik USD przy określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji DAE na USD" sectionDescription="Sprawdź nasze dema na żywo [Konwersja DAE do USD](https://products.aspose.app/3d/conversion/dae-to-usd) Z następującymi korzyściami." >}}
