...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować AMF na GLTF za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować AMF plików na GLTF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik AMF przez konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Zestaw GLTF specyficznych właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem GltfSaveOptions GLTF pliku1. Sprawdź wynikowy plik GLTF przy określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji AMF na GLTF" sectionDescription="Sprawdź nasze dema na żywo [Konwersja AMF do GLTF](https://products.aspose.app/3d/conversion/amf-to-gltf) Z następującymi korzyściami." >}}
