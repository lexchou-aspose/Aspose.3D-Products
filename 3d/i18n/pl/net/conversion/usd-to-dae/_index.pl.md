---
title: Konwertuj USD na DAE za pośrednictwem C# 
description: Konwertuj pliki USD i inne 3D za pomocą .NET API
url: /pl/net/conversion/usd-to-dae/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj USD na DAE za pośrednictwem C#" h2="Eksportuj USD i inne 3D plików przy użyciu .NET Framework, .NET Core i Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Eksportuj USD sceny jako DAE z C#" %}}
...
3. Przekaż nazwę pliku wyjściowego za pomocą. Dae rozszerzenie jako pierwszy parametr
4. Określ wartość pola „ Collada ”z [Format plików](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Klasa
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod dla USD do DAE konwersji" gistPath="" %}}
```cs
