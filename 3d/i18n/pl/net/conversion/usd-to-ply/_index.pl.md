---
title: Konwertuj USD na PLY za pośrednictwem C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj USD na PLY za pośrednictwem C#" h2="Eksportuj USD i inne 3D plików przy użyciu .NET Framework, .NET Core i Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Eksportuj USD sceny jako PLY z C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod dla USD do PLY konwersji" gistPath="" %}}
```cs
