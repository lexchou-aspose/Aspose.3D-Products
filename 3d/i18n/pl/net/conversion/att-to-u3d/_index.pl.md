...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ATT na U3D za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować ATT plików na U3D w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik ATT przez konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Zestaw U3D specyficznych właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku U3dSaveOptions U3D1. Sprawdź wynikowy plik U3D przy określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji ATT na U3D" sectionDescription="Sprawdź nasze dema na żywo [Konwersja ATT do U3D](https://products.aspose.app/3d/conversion/att-to-u3d) Z następującymi korzyściami." >}}
