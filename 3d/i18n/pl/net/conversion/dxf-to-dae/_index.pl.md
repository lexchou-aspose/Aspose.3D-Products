---
title: Konwertuj DXF na DAE przez C# 
weight: 740
url: /pl/net/conversion/dxf-to-dae/ 
description: Przykładowy kod konwersji DXF na DAE C#. Użyj API przykładowego kodu dla plików wsadowych DXF do konwersji DAE w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj DXF na DAE przez C#" h2="Renderuj DXF jako DAE bez żadnego oprogramowania do modelowania i renderowania 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DXF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować DXF na DAE przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki DXF na DAE w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik DXF za pomocą konstruktora klasy Scene1. Utwórz instancję DaeSaveOptions1. Ustaw DAE określone właściwości dla zaawansowanej konwersji1. Wywołaj metodę Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku DAE i obiektem DaeSaveOptions1. Sprawdź wynikowy plik DAE w określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji DXF na DAE" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z DXF do DAE](https://products.aspose.app/3d/conversion/dxf-to-dae) z następującymi korzyściami." >}}
