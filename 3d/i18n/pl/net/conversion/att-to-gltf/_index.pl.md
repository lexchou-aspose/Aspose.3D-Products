...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ATT na GLTF przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki ATT na GLTF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik ATT za pomocą konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Ustaw GLTF określone właściwości dla zaawansowanej konwersji1. Wywołaj metodę Scene.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku GLTF i obiektem GltfSaveOptions1. Sprawdź wynikowy plik GLTF w określonej ścieżce
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Darmowa aplikacja do konwersji ATT na GLTF" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z ATT do GLTF](https://products.aspose.app/3d/conversion/att-to-gltf) z następującymi korzyściami." >}}
