---
title: Konwertuj ASE na FBX za pośrednictwem Java 
weight: 970
url: /pl/java/conversion/ase-to-fbx/ 
description: Przykładowy kod konwersji Java dla formatu ASE do pliku FBX. Użyj tego przykładowego kodu, aby przekonwertować ASE na FBX w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ASE na FBX za pośrednictwem Java" h2="Konwersja ASE do FBX przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ASE" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować ASE na FBX za pomocą Java" %}}

 Aby renderować ASE do FBX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ASE na FBX za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować ASE plik na FBX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik ASE przez konstruktora klasy Scene1. Utwórz instancję FbxSaveOptions1. Zestaw FBX specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku FBX FbxSaveOptions
...
{{% blocks/products/pf/agp/code-block title="ASE do FBX Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="ASE do FBX Konwersja na żywo Dema" sectionDescription="[Przelicz ASE na FBX](https://products.aspose.app/3d/conversion/ase-to-fbx) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik ASE, a zostanie on natychmiast przekonwertowany na FBX." >}}
