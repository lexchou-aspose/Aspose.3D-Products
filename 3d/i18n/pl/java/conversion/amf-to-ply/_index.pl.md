---
title: Konwertuj AMF na PLY za pośrednictwem Java 
weight: 430
url: /pl/java/conversion/amf-to-ply/ 
description: Przykładowy kod konwersji Java dla formatu AMF do pliku PLY. Użyj tego przykładowego kodu, aby przekonwertować AMF na PLY w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj AMF na PLY za pośrednictwem Java" h2="Konwersja AMF do PLY przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować AMF na PLY za pomocą Java" %}}
 ...
 Aby renderować AMF do PLY, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować AMF na PLY za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować AMF plik na PLY w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik AMF przez konstruktora klasy Scene1. Utwórz instancję PlySaveOptions1. Zestaw PLY specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem PlySaveOptions PLY
...
{{% blocks/products/pf/agp/code-block title="AMF do PLY Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="AMF do PLY Konwersja na żywo Dema" sectionDescription="[Przelicz AMF na PLY](https://products.aspose.app/3d/conversion/amf-to-ply) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik AMF, a zostanie on natychmiast przekonwertowany na PLY." >}}
