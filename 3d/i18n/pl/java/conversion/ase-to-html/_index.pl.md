---
title: Konwertuj ASE na HTML za pośrednictwem Java 
weight: 2920
url: /pl/java/conversion/ase-to-html/ 
description: Przykładowy kod konwersji Java dla formatu ASE do pliku HTML. Użyj tego przykładowego kodu, aby przekonwertować ASE na HTML w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj ASE na HTML za pośrednictwem Java" h2="Konwersja ASE do HTML przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ASE" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować ASE na HTML za pomocą Java" %}}

 Aby renderować ASE do HTML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować ASE na HTML za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować ASE plik na HTML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik ASE przez konstruktora klasy Scene1. Utwórz instancję HtmlSaveOptions1. Zestaw HTML specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku HTML HtmlSaveOptions
...
{{% blocks/products/pf/agp/code-block title="ASE do HTML Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="ASE do HTML Konwersja na żywo Dema" sectionDescription="[Przelicz ASE na HTML](https://products.aspose.app/3d/conversion/ase-to-html) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik ASE, a zostanie on natychmiast przekonwertowany na HTML." >}}
