---
title: Konwertuj DRC na ASE za pośrednictwem Java 
url: /pl/java/conversion/drc-to-ase/ 
description: Przykładowy kod konwersji Java dla formatu DRC do pliku ASE. Użyj tego przykładowego kodu, aby przekonwertować DRC na ASE w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj DRC na ASE za pośrednictwem Java" h2="Konwersja DRC do ASE przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="ASE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować DRC na ASE za pomocą Java" %}}
 ...
 Aby renderować DRC do ASE, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować DRC na ASE za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować DRC plik na ASE w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik DRC przez konstruktora klasy Scene1. Utwórz instancję AseSaveOptions1. Zestaw ASE specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku ASE AseSaveOptions
...
{{% blocks/products/pf/agp/code-block title="DRC do ASE Java Kod źródłowy konwersji" offSpacer="" %}}
