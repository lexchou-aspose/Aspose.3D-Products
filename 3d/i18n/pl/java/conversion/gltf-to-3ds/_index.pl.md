---
title: Konwertuj GLTF na 3DS za pośrednictwem Java 
weight: 1530
url: /pl/java/conversion/gltf-to-3ds/ 
description: Przykładowy kod konwersji Java dla formatu GLTF do pliku 3DS. Użyj tego przykładowego kodu, aby przekonwertować GLTF na 3DS w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj GLTF na 3DS za pośrednictwem Java" h2="Konwersja GLTF do 3DS przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować GLTF na 3DS za pomocą Java" %}}
 ...
 Aby renderować GLTF do 3DS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować GLTF na 3DS za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować GLTF plik na 3DS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik GLTF przez konstruktora klasy Scene1. Utwórz instancję 3dsSaveOptions1. Zestaw 3DS specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku 3DS i obiektem 3dsSaveOptions
...
{{% blocks/products/pf/agp/code-block title="GLTF do 3DS Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLTF do 3DS Konwersja na żywo Dema" sectionDescription="[Przelicz GLTF na 3DS](https://products.aspose.app/3d/conversion/gltf-to-3ds) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik GLTF, a zostanie on natychmiast przekonwertowany na 3DS." >}}
