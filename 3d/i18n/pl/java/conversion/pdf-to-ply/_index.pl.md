---
title: Konwertuj PDF na PLY za pośrednictwem Java 
url: /pl/java/conversion/pdf-to-ply/ 
description: Przykładowy kod konwersji Java dla formatu PDF do pliku PLY. Użyj tego przykładowego kodu, aby przekonwertować PDF na PLY w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj PDF na PLY za pośrednictwem Java" h2="Konwersja PDF do PLY przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować PDF na PLY za pomocą Java" %}}

 Aby renderować PDF do PLY, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować PDF na PLY za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować PDF plik na PLY w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik PDF przez konstruktora klasy Scene1. Utwórz instancję PlySaveOptions1. Zestaw PLY specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem PlySaveOptions PLY
...
{{% blocks/products/pf/agp/code-block title="PDF do PLY Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PDF do PLY Konwersja na żywo Dema" sectionDescription="[Przelicz PDF na PLY](https://products.aspose.app/3d/conversion/pdf-to-ply) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik PDF, a zostanie on natychmiast przekonwertowany na PLY." >}}
