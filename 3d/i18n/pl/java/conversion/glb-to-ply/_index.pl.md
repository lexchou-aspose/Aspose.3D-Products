---
title: Konwertuj GLB na PLY za pośrednictwem Java
weight: 530
url: /pl/java/conversion/glb-to-ply/ 
description: Przykładowy kod konwersji Java dla formatu GLB do pliku PLY. Użyj tego przykładowego kodu, aby przekonwertować GLB na PLY w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj GLB na PLY za pośrednictwem Java" h2="Konwersja GLB do PLY przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLB" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować GLB na PLY za pomocą Java" %}}

 Aby renderować GLB do PLY, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować GLB na PLY za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować GLB plik na PLY w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik GLB przez konstruktora klasy Scene1. Wywołaj metodę Scene.save z formatem PLY.1. Sprawdź wynikowy plik PLY przy określonej ścieżce
...
{{% blocks/products/pf/agp/code-block title="GLB do PLY Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLB do PLY Konwersja na żywo Dema" sectionDescription="[Przelicz GLB na PLY](https://products.aspose.app/3d/conversion/glb-to-ply) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik GLB, a zostanie on natychmiast przekonwertowany na PLY." >}}
