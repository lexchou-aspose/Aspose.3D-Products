---
title: Konwertuj 3DS na GLTF przez Java 
weight: 1830
url: /pl/java/conversion/3ds-to-gltf/ 
description: Przykładowy kod konwersji Java dla formatu 3DS na plik GLTF. Użyj tego przykładowego kodu, aby przekonwertować 3DS na GLTF w dowolnej aplikacji internetowej lub na komputerze Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj 3DS na GLTF przez Java" h2="Konwersja z 3DS do GLTF przy użyciu biblioteki Java bez żadnego oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować 3DS na GLTF przez Java" %}}
...
{{% blocks/products/pf/agp/code-block title="3DS do GLTF Java Kodu źródła konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Od 3DS do GLTF demonstracji konwersji na żywo" sectionDescription="[Konwertuj 3DS na GLTF](https://products.aspose.app/3d/conversion/3ds-to-gltf) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik 3DS, zostanie on natychmiast przekonwertowany na GLTF." >}}
