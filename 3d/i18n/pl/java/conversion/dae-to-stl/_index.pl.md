---
title: Konwertuj DAE na STL za pośrednictwem Java 
weight: 1500
url: /pl/java/conversion/dae-to-stl/ 
description: Przykładowy kod konwersji Java dla formatu DAE do pliku STL. Użyj tego przykładowego kodu, aby przekonwertować DAE na STL w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj DAE na STL za pośrednictwem Java" h2="Konwersja DAE do STL przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować DAE na STL za pomocą Java" %}}
 ...
 Aby renderować DAE do STL, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować DAE na STL za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować DAE plik na STL w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik DAE przez konstruktora klasy Scene1. Utwórz instancję StlSaveOptions1. Zestaw STL specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku StlSaveOptions STL
...
{{% blocks/products/pf/agp/code-block title="DAE do STL Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DAE do STL Konwersja na żywo Dema" sectionDescription="[Przelicz DAE na STL](https://products.aspose.app/3d/conversion/dae-to-stl) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik DAE, a zostanie on natychmiast przekonwertowany na STL." >}}
