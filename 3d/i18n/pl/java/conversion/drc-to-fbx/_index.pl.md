...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować DRC na FBX za pomocą Java" %}}
 ...
 Aby wyrenderować DRC do FBX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować DRC na FBX przez Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik DRC na FBX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik DRC za pomocą konstruktora klasy Scene1. Utwórz instancję FbxSaveOptions1. Ustaw FBX określone właściwości dla zaawansowanej konwersji1. Zadzwoń do metody Scene.save1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku FBX i obiektem FbxSaveOptions
...
{{% blocks/products/pf/agp/code-block title="DRC do FBX Java Kodu źródła konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Od DRC do FBX demonstracji konwersji na żywo" sectionDescription="[Konwertuj DRC na FBX](https://products.aspose.app/3d/conversion/drc-to-fbx) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik DRC, zostanie on natychmiast przekonwertowany na FBX." >}}
