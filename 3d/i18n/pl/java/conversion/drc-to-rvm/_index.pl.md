...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować DRC na RVM za pomocą Java" %}}
 ...
 Aby renderować DRC do RVM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować DRC na RVM za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować DRC plik na RVM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik DRC przez konstruktora klasy Scene1. Utwórz instancję RvmSaveOptions1. Zestaw RVM specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku RVM RvmSaveOptions
...
{{% blocks/products/pf/agp/code-block title="DRC do RVM Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC do RVM Konwersja na żywo Dema" sectionDescription="[Przelicz DRC na RVM](https://products.aspose.app/3d/conversion/drc-to-rvm) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik DRC, a zostanie on natychmiast przekonwertowany na RVM." >}}
