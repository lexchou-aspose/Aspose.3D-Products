---
title: Konwertuj DAE na 3DS za pośrednictwem Java 
weight: 1320
url: /pl/java/conversion/dae-to-3ds/ 
description: Przykładowy kod konwersji Java dla formatu DAE do pliku 3DS. Użyj tego przykładowego kodu, aby przekonwertować DAE na 3DS w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj DAE na 3DS za pośrednictwem Java" h2="Konwersja DAE do 3DS przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować DAE na 3DS za pomocą Java" %}}
 ...
 Aby renderować DAE do 3DS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować DAE na 3DS za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować DAE plik na 3DS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik DAE przez konstruktora klasy Scene1. Utwórz instancję 3dsSaveOptions1. Zestaw 3DS specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem pliku 3DS i obiektem 3dsSaveOptions
...
{{% blocks/products/pf/agp/code-block title="DAE do 3DS Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DAE do 3DS Konwersja na żywo Dema" sectionDescription="[Przelicz DAE na 3DS](https://products.aspose.app/3d/conversion/dae-to-3ds) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik DAE, a zostanie on natychmiast przekonwertowany na 3DS." >}}
