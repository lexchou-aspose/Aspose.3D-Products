---
title: Konwertuj STL na DRC za pośrednictwem Java 
url: /pl/java/conversion/stl-to-drc/ 
description: Przykładowy kod konwersji Java dla formatu STL do pliku DRC. Użyj tego przykładowego kodu, aby przekonwertować STL na DRC w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj STL na DRC za pośrednictwem Java" h2="Konwersja STL do DRC przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować STL na DRC za pomocą Java" %}}

 Aby renderować STL do DRC, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować STL na DRC za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować STL plik na DRC w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik STL przez konstruktora klasy Scene1. Utwórz instancję DrcSaveOptions1. Zestaw DRC specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Podaj ścieżkę wyjściową z rozszerzeniem i obiektem pliku DrcSaveOptions DRC
...
{{% blocks/products/pf/agp/code-block title="STL do DRC Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="STL do DRC Konwersja na żywo Dema" sectionDescription="[Przelicz STL na DRC](https://products.aspose.app/3d/conversion/stl-to-drc) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik STL, a zostanie on natychmiast przekonwertowany na DRC." >}}
