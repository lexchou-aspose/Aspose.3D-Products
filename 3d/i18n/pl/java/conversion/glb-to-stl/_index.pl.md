---
title: Konwertuj GLB na STL za pośrednictwem Java
weight: 530
url: /pl/java/conversion/glb-to-stl/ 
description: Przykładowy kod konwersji Java dla formatu GLB do pliku STL. Użyj tego przykładowego kodu, aby przekonwertować GLB na STL w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj GLB na STL za pośrednictwem Java" h2="Konwersja GLB do STL przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLB" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować GLB na STL za pomocą Java" %}}

 Aby renderować GLB do STL, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować GLB na STL za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować GLB plik na STL w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik GLB przez konstruktora klasy Scene1. Wywołaj metodę Scene.save z formatem STL.1. Sprawdź wynikowy plik STL przy określonej ścieżce
...
{{% blocks/products/pf/agp/code-block title="GLB do STL Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLB do STL Konwersja na żywo Dema" sectionDescription="[Przelicz GLB na STL](https://products.aspose.app/3d/conversion/glb-to-stl) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik GLB, a zostanie on natychmiast przekonwertowany na STL." >}}
