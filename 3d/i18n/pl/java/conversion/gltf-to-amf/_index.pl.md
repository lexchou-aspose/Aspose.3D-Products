---
title: Konwertuj GLTF na AMF za pośrednictwem Java 
weight: 560
url: /pl/java/conversion/gltf-to-amf/ 
description: Przykładowy kod konwersji Java dla formatu GLTF do pliku AMF. Użyj tego przykładowego kodu, aby przekonwertować GLTF na AMF w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj GLTF na AMF za pośrednictwem Java" h2="Konwersja GLTF do AMF przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="AMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować GLTF na AMF za pomocą Java" %}}
 ...
 Aby renderować GLTF do AMF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować GLTF na AMF za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować GLTF plik na AMF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik GLTF przez konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Zestaw AMF specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku AMF AmfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="GLTF do AMF Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLTF do AMF Konwersja na żywo Dema" sectionDescription="[Przelicz GLTF na AMF](https://products.aspose.app/3d/conversion/gltf-to-amf) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik GLTF, a zostanie on natychmiast przekonwertowany na AMF." >}}
