---
title: Konwertuj GLB na USD za pośrednictwem Java
weight: 530
url: /pl/java/conversion/glb-to-usd/ 
description: Przykładowy kod konwersji Java dla formatu GLB do pliku USD. Użyj tego przykładowego kodu, aby przekonwertować GLB na USD w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj GLB na USD za pośrednictwem Java" h2="Konwersja GLB do USD przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="USD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLB" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować GLB na USD za pomocą Java" %}}
 ...
 Aby renderować GLB do USD, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować GLB na USD za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować GLB plik na USD w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik GLB przez konstruktora klasy Scene1. Wywołaj metodę Scene.save z formatem USD.1. Sprawdź wynikowy plik USD przy określonej ścieżce
...
{{% blocks/products/pf/agp/code-block title="GLB do USD Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLB do USD Konwersja na żywo Dema" sectionDescription="[Przelicz GLB na USD](https://products.aspose.app/3d/conversion/glb-to-usd) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik GLB, a zostanie on natychmiast przekonwertowany na USD." >}}
