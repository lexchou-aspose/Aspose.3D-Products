---
title: Konwertuj OBJ na GLTF za pośrednictwem Java 
weight: 2450
url: /pl/java/conversion/obj-to-gltf/ 
description: Przykładowy kod konwersji Java dla formatu OBJ do pliku GLTF. Użyj tego przykładowego kodu, aby przekonwertować OBJ na GLTF w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj OBJ na GLTF za pośrednictwem Java" h2="Konwersja OBJ do GLTF przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować OBJ na GLTF za pomocą Java" %}}
 ...
 Aby renderować OBJ do GLTF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować OBJ na GLTF za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować OBJ plik na GLTF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik OBJ przez konstruktora klasy Scene1. Utwórz instancję GltfSaveOptions1. Zestaw GLTF specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem GltfSaveOptions GLTF pliku
...
{{% blocks/products/pf/agp/code-block title="OBJ do GLTF Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="OBJ do GLTF Konwersja na żywo Dema" sectionDescription="[Przelicz OBJ na GLTF](https://products.aspose.app/3d/conversion/obj-to-gltf) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik OBJ, a zostanie on natychmiast przekonwertowany na GLTF." >}}
