---
title: Konwertuj STL na PDF za pośrednictwem Java 
url: /pl/java/conversion/stl-to-pdf/ 
description: Przykładowy kod konwersji Java dla formatu STL do pliku PDF. Użyj tego przykładowego kodu, aby przekonwertować STL na PDF w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj STL na PDF za pośrednictwem Java" h2="Konwersja STL do PDF przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować STL na PDF za pomocą Java" %}}
 ...
 Aby renderować STL do PDF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować STL na PDF za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować STL plik na PDF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik STL przez konstruktora klasy Scene1. Utwórz instancję PdfSaveOptions1. Zestaw PDF specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku PDF PdfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="STL do PDF Java Kod źródłowy konwersji" offSpacer="" %}}
