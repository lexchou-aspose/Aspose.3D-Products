---
title: Konwertuj FBX na GLTF za pośrednictwem Java 
weight: 790
url: /pl/java/conversion/fbx-to-gltf/ 
description: Przykładowy kod konwersji Java dla formatu FBX do pliku GLTF. Użyj tego przykładowego kodu, aby przekonwertować FBX na GLTF w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj FBX na GLTF za pośrednictwem Java" h2="Konwersja FBX do GLTF przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FBX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować FBX na GLTF za pomocą Java" %}}
 ...
 Aby renderować FBX do GLTF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować FBX na GLTF za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować FBX plik na GLTF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik FBX przez konstruktora klasy Scene1. Utwórz instancję GltfSaveOptions1. Zestaw GLTF specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem GltfSaveOptions GLTF pliku
...
{{% blocks/products/pf/agp/code-block title="FBX do GLTF Java Kod źródłowy konwersji" offSpacer="" %}}
