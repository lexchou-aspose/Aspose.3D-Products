---
title: Konwertuj GLB na FBX za pośrednictwem Java
weight: 530
url: /pl/java/conversion/glb-to-fbx/ 
description: Przykładowy kod konwersji Java dla formatu GLB do pliku FBX. Użyj tego przykładowego kodu, aby przekonwertować GLB na FBX w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj GLB na FBX za pośrednictwem Java" h2="Konwersja GLB do FBX przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLB" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować GLB na FBX za pomocą Java" %}}

 Aby renderować GLB do FBX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować GLB na FBX za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować GLB plik na FBX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik GLB przez konstruktora klasy Scene1. Wywołaj metodę Scene.save z formatem FBX.1. Sprawdź wynikowy plik FBX przy określonej ścieżce
...
{{% blocks/products/pf/agp/code-block title="GLB do FBX Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLB do FBX Konwersja na żywo Dema" sectionDescription="[Przelicz GLB na FBX](https://products.aspose.app/3d/conversion/glb-to-fbx) Teraz odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik GLB, a zostanie on natychmiast przekonwertowany na FBX." >}}
