---
title: Konwertuj RVM na AMF za pośrednictwem Java 
weight: 3290
url: /pl/java/conversion/rvm-to-amf/ 
description: Przykładowy kod konwersji Java dla formatu RVM do pliku AMF. Użyj tego przykładowego kodu, aby przekonwertować RVM na AMF w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj RVM na AMF za pośrednictwem Java" h2="Konwersja RVM do AMF przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="AMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="RVM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować RVM na AMF za pomocą Java" %}}

 Aby renderować RVM do AMF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować RVM na AMF za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować RVM plik na AMF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik RVM przez konstruktora klasy Scene1. Utwórz instancję AmfSaveOptions1. Zestaw AMF specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Przekaż ścieżkę wyjściową z rozszerzeniem i obiektem pliku AMF AmfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="RVM do AMF Java Kod źródłowy konwersji" offSpacer="" %}}
