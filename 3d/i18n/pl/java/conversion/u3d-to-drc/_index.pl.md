---
title: Konwertuj U3D na DRC za pośrednictwem Java 
url: /pl/java/conversion/u3d-to-drc/ 
description: Przykładowy kod konwersji Java dla formatu U3D do pliku DRC. Użyj tego przykładowego kodu, aby przekonwertować U3D na DRC w dowolnej aplikacji opartej na sieci Web lub pulpicie Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj U3D na DRC za pośrednictwem Java" h2="Konwersja U3D do DRC przy użyciu biblioteki Java bez oprogramowania do modelowania 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="U3D" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować U3D na DRC za pomocą Java" %}}
 ...
 Aby renderować U3D do DRC, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować U3D na DRC za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą z łatwością przekonwertować U3D plik na DRC w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik U3D przez konstruktora klasy Scene1. Utwórz instancję DrcSaveOptions1. Zestaw DRC specyficznych właściwości dla zaawansowanej konwersji1. Scena wywołania. Metoda zapisywania1. Podaj ścieżkę wyjściową z rozszerzeniem i obiektem pliku DrcSaveOptions DRC
...
{{% blocks/products/pf/agp/code-block title="U3D do DRC Java Kod źródłowy konwersji" offSpacer="" %}}
