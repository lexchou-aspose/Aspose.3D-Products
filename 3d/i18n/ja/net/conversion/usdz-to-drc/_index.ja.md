...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# 経由で USDZ を DRC に変換" h2=".NET Framework、 .NET Core、 Mono を使用して USDZ およびその他の 3D ファイルをエクスポート" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USDZ シーンを DRC として C# でエクスポート" %}}
...
{{% blocks/products/pf/agp/code-autogen title="USDZ から DRC の変換のための C# コード" gistPath="" %}}
```cs
