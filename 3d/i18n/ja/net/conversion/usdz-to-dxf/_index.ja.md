...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C#を介してUSDZをDXFに変換します" h2=".NETフレームワーク、.NETコア、およびMonoを使用してUSDZおよびその他の3Dファイルをエクスポートします" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USDZシーンをC#付きのDXFとしてエクスポート" %}}
...
3.最初のパラメーターとして.dxf拡張子を持つ出力ファイル名を渡します
4.から`DXF`フィールド値を指定します [FileFormat](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) クラス
...
{{% blocks/products/pf/agp/code-autogen title="C#USDZからDXFへの変換のコード" gistPath="" %}}
```cs
