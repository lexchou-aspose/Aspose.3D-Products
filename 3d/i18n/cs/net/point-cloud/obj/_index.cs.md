---
title: Generovat formát souborů point cloud do OBJ prostřednictvím .NET 
weight: 830
url: /cs/net/point-cloud/obj/ 
description: C# zdrojový kód pro načtení, renderování a přidání generování bodu cloud do dokumentů OBJ na .NET framework, .NET core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Generovat point cloud na OBJ přes C#" h2="Vytvořte vlastní aplikace .NET pro generování souborů point cloud do OBJ pomocí api na straně serveru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="How to generate point cloud to OBJ file using C#" %}}
 ...
 Pro generování souboru point cloud do OBJ použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro generování point cloud na OBJ prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D umožňuje vývojářům snadno generovat point cloud do souboru OBJ s několika řadami kódu.

{{% /blocks/products/pf/agp/text %}}

- Načíst soubor OBJ prostřednictvím konstruktora třídy scény- Získat objekt pointcloud z Aspose.3D- Vytvořit objekt transformace pomocí metody evaluateglobaltransform- Generovat point cloud pomocí metody sloučení- Volejte scénu. uložit metodu s objektem
...
{{% blocks/products/pf/agp/code-block title="C# kód pro generování point cloud na OBJ" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D je CAD a gameware API pro načtení, úpravu a převod souborů 3D. API je samostatný a nevyžaduje žádný 3D modelování nebo vykreslování softwaru. Lze snadno použít API pro Discreet3DS, WavefrontOBJ, STL (ascii, binární), Universal3D, FBX (ascii, binární), Collada, glTF, PLY, GLB, directx a další formáty. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to generate point cloud to OBJ" sectionDescription="Check our live demos to [Point cloud 3DS](https://products.aspose.app/3d/point-cloud/obj) S následujícími přínosy." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát soubor OBJ a stiskněte tlačítko \"generovat\"" >}}
