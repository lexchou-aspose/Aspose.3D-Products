---
title: Generovat formát souborů point cloud do AMF prostřednictvím .NET 
weight: 830
url: /cs/net/point-cloud/amf/ 
description: C# zdrojový kód pro načtení, renderování a přidání generování bodu cloud do dokumentů AMF na .NET framework, .NET core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Generovat point cloud na AMF přes C#" h2="Vytvořte vlastní aplikace .NET pro generování souborů point cloud do AMF pomocí api na straně serveru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="AMF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/content h2="How to generate point cloud to AMF file using C#" %}}
 ...
 Pro generování souboru point cloud do AMF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro generování point cloud na AMF prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D umožňuje vývojářům snadno generovat point cloud do souboru AMF s několika řadami kódu.

{{% /blocks/products/pf/agp/text %}}

- Načíst soubor AMF prostřednictvím konstruktora třídy scény- Získat objekt pointcloud z Aspose.3D- Vytvořit objekt transformace pomocí metody evaluateglobaltransform- Generovat point cloud pomocí metody sloučení- Volejte scénu. uložit metodu s objektem
...
{{% blocks/products/pf/agp/code-block title="C# kód pro generování point cloud na AMF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to generate point cloud to AMF" sectionDescription="Check our live demos to [Point cloud 3DS](https://products.aspose.app/3d/point-cloud/amf) S následujícími přínosy." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát soubor AMF a stiskněte tlačítko \"generovat\"" >}}
