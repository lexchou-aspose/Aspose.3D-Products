...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro přidání slepého vodního označení 3MF přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D umožňuje vývojářům snadno přidat slepý vodík do souboru 3MF jen s několika řádky kódu.

{{% /blocks/products/pf/agp/text %}}

- Načíst soubor 3MF prostřednictvím konstruktora třídy scény- Získejte třídu mesh Aspose.3D- Přidat vodopis a heslo pomocí metody encodewatermark Aspose.3D- Volejte scénu. uložit metodu s objektem
...
{{% blocks/products/pf/agp/code-block title="C# code to add blind watermark to 3MF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to add blind watermark to 3MF" sectionDescription="Check our live demos to [Vodní značka 3MF](https://products.aspose.app/3d/watermark/3mf) S následujícími přínosy." >}}
