---
title: Přidat slepý vodní znak do 3DS formátů souborů přes .NET 
weight: 830
url: /cs/net/watermark/3ds/ 
description: C# zdrojový kód pro načtení, renderování a přidání slepého vodního označení k dokumentům 3DS na .NET framework, .NET core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Přidat slepou vodní značku 3DS přes C#" h2="Vytvořte si vlastní aplikace .NET do souborů s vodorovným označením 3DS pomocí api na straně serveru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="How to watermark to 3DS file using C#" %}}
 ...
 Chcete-li použít soubor 3DS vodík, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro přidání slepého vodního označení 3DS přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D umožňuje vývojářům snadno přidat slepý vodík do souboru 3DS jen s několika řádky kódu.

{{% /blocks/products/pf/agp/text %}}

- Načíst soubor 3DS prostřednictvím konstruktora třídy scény- Získejte třídu mesh Aspose.3D- Přidat vodopis a heslo pomocí metody encodewatermark Aspose.3D- Volejte scénu. uložit metodu s objektem
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D je CAD a gameware API pro načtení, úpravu a převod souborů 3D. API je samostatný a nevyžaduje žádný 3D modelování nebo vykreslování softwaru. Lze snadno použít API pro Discreet3DS, WavefrontOBJ, STL (ascii, binární), Universal3D, FBX (ascii, binární), Collada, glTF, PLY, GLB, directx a další formáty. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to add blind watermark to 3DS" sectionDescription="Check our live demos to [Vodní značka 3DS](https://products.aspose.app/3d/watermark/3ds) S následujícími přínosy." >}}
