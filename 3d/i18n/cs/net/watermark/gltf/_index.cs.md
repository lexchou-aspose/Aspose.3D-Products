...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro přidání slepého vodního označení GLTF přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D umožňuje vývojářům snadno přidat slepý vodík do souboru GLTF jen s několika řádky kódu.

{{% /blocks/products/pf/agp/text %}}

- Načíst soubor GLTF prostřednictvím konstruktora třídy scény- Získejte třídu mesh Aspose.3D- Přidat vodopis a heslo pomocí metody encodewatermark Aspose.3D- Volejte scénu. uložit metodu s objektem
...
{{% blocks/products/pf/agp/code-block title="C# code to add blind watermark to GLTF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to add blind watermark to GLTF" sectionDescription="Check our live demos to [Vodní značka GLTF](https://products.aspose.app/3d/watermark/gltf) S následujícími přínosy." >}}
