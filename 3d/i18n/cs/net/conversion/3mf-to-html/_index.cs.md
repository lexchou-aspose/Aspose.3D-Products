---
title: Convert 3MF to HTML via C# 
weight: 460
url: /cs/net/conversion/3mf-to-html/ 
description: Vzorový kód pro konverzaci 3MF na HTML C#. Použijte API příklad kódu pro dávku 3MF souborů na HTML konverzaci v rámci vb .NET, asp .NET nebo kterékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert 3MF to HTML via C#" h2="Render 3MF as HTML without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3MF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést 3MF na HTML pomocí C#" %}}
 ...
 Pro převádění 3MF na HTML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod 3MF na HTML prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programátoři mohou snadno načíst a převést 3MF soubory do HTML v několika řadách kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor 3MF prostřednictvím konstruktora třídy scény1. Vytvořit instanci htmlsaveoptions1. Nastavit specifické vlastnosti HTML pro pokročilou konverzii1. Volejte scénu. uložit metodu1. Přejít výstupní cestu s HTML rozšířením souboru a objektem htmlsaveoptions1. Zkontrolovat výsledný soubor HTML při zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento vzorový kód ukazuje konverzaci 3MF na HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert 3MF to HTML" sectionDescription="Check our live demos for [Konverzace 3MF na HTML](https://products.aspose.app/3d/conversion/3mf-to-html) S následujícími přínosy." >}}
