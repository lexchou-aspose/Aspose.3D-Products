---
title: Convert STL to DAE via C# 
weight: 2040
url: /cs/net/conversion/stl-to-dae/ 
description: Vzorový kód pro konverzaci STL na DAE C#. Použijte API příklad kódu pro dávku STL souborů na DAE konverzaci v rámci vb .NET, asp .NET nebo kterékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert STL to DAE via C#" h2="Render STL as DAE without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést STL na DAE pomocí C#" %}}
 ...
 Pro převádění STL na DAE použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod STL na DAE prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programátoři mohou snadno načíst a převést STL soubory do DAE v několika řadách kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor STL prostřednictvím konstruktora třídy scény1. Vytvořit instance of daesaveoptions1. Nastavit specifické vlastnosti DAE pro pokročilou konverzii1. Volejte scénu. uložit metodu1. Přejít výstupní cestu s DAE rozšířením souboru a objektem aplikace daesaveoptions1. Zkontrolovat výsledný soubor DAE při zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento vzorový kód ukazuje konverzaci STL na DAE C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert STL to DAE" sectionDescription="Check our live demos for [Konverzace STL na DAE](https://products.aspose.app/3d/conversion/stl-to-dae) S následujícími přínosy." >}}
