---
title: Convert STL to U3D via C# 
weight: 260
url: /cs/net/conversion/stl-to-u3d/ 
description: Vzorový kód pro konverzaci STL na U3D C#. Použijte API příklad kódu pro dávku STL souborů na U3D konverzaci v rámci vb .NET, asp .NET nebo kterékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert STL to U3D via C#" h2="Render STL as U3D without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést STL na U3D pomocí C#" %}}
 ...
 Pro převádění STL na U3D použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod STL na U3D prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programátoři mohou snadno načíst a převést STL soubory do U3D v několika řadách kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor STL prostřednictvím konstruktora třídy scény1. Vytvořit instanci u3dsaveoptions1. Nastavit specifické vlastnosti U3D pro pokročilou konverzii1. Volejte scénu. uložit metodu1. Přejít výstupní cestu s U3D rozšířením souboru a objektem u3dsaveoptions1. Zkontrolovat výsledný soubor U3D při zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento vzorový kód ukazuje konverzaci STL na U3D C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert STL to U3D" sectionDescription="Check our live demos for [Konverzace STL na U3D](https://products.aspose.app/3d/conversion/stl-to-u3d) S následujícími přínosy." >}}
