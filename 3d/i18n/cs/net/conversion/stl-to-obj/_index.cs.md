...
description: Vzorový kód pro konverzaci STL na OBJ C#. Použijte API příklad kódu pro dávku STL souborů na OBJ konverzaci v rámci vb .NET, asp .NET nebo kterékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert STL to OBJ via C#" h2="Render STL as OBJ without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést STL na OBJ pomocí C#" %}}
 ...
 Pro převádění STL na OBJ použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod STL na OBJ prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programátoři mohou snadno načíst a převést STL soubory do OBJ v několika řadách kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor STL prostřednictvím konstruktora třídy scény1. Vytvořit instance objsaveoptions1. Nastavit specifické vlastnosti OBJ pro pokročilou konverzii1. Volejte scénu. uložit metodu1. Přejít výstupní cestu s OBJ rozšířením souboru a objektem opcí objsaveoptions1. Zkontrolovat výsledný soubor OBJ při zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento vzorový kód ukazuje konverzaci STL na OBJ C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert STL to OBJ" sectionDescription="Check our live demos for [Konverzace STL na OBJ](https://products.aspose.app/3d/conversion/stl-to-obj) S následujícími přínosy." >}}
