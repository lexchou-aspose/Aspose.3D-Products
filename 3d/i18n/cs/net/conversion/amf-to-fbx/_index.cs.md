...
{{% blocks/products/pf/agp/content h2="Jak převést AMF na FBX pomocí C#" %}}
 ...
 Abychom převedli AMF na FBX, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi AMF na FBX prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři .NET mohou snadno načíst a převést soubory AMF na FBX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor AMF pomocí konstruktoru třídy Scene1. Vytvořte instanci FbxSaveOptions1. Nastavte FBX konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.Save1. Předejte výstupní cestu s příponou souboru FBX a objektem FbxSaveOptions1. Zkontrolujte výsledný soubor FBX v zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi AMF na FBX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod AMF na FBX" sectionDescription="Podívejte se na naše živé ukázky [Konverze AMF na FBX](https://products.aspose.app/3d/conversion/amf-to-fbx) s následujícími výhodami." >}}
