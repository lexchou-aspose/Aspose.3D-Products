---
title: Convert FBX to PLY via C# 
weight: 2600
url: /cs/net/conversion/fbx-to-ply/ 
description: Vzorový kód pro konverzaci FBX na PLY C#. Použijte API příklad kódu pro dávku FBX souborů na PLY konverzaci v rámci vb .NET, asp .NET nebo kterékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert FBX to PLY via C#" h2="Render FBX as PLY without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FBX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést FBX na PLY pomocí C#" %}}
 ...
 Pro převádění FBX na PLY použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod FBX na PLY prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programátoři mohou snadno načíst a převést FBX soubory do PLY v několika řadách kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor FBX prostřednictvím konstruktora třídy scény1. Vytvořit instance of plysaveoptions1. Nastavit specifické vlastnosti PLY pro pokročilou konverzii1. Volejte scénu. uložit metodu1. Přejít výstupní cestu s PLY rozšířením souboru a objektem aplikace plysaveoptions1. Zkontrolovat výsledný soubor PLY při zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento vzorový kód ukazuje konverzaci FBX na PLY C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert FBX to PLY" sectionDescription="Check our live demos for [Konverzace FBX na PLY](https://products.aspose.app/3d/conversion/fbx-to-ply) S následujícími přínosy." >}}
