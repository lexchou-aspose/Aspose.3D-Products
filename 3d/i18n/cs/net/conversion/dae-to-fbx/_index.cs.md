---
title: Convert DAE to FBX via C# 
weight: 20
url: /cs/net/conversion/dae-to-fbx/ 
description: Vzorový kód pro konverzaci DAE na FBX C#. Použijte API příklad kódu pro dávku DAE souborů na FBX konverzaci v rámci vb .NET, asp .NET nebo kterékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert DAE to FBX via C#" h2="Render DAE as FBX without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést DAE na FBX pomocí C#" %}}
 ...
 Pro převádění DAE na FBX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod DAE na FBX prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programátoři mohou snadno načíst a převést DAE soubory do FBX v několika řadách kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor DAE prostřednictvím konstruktora třídy scény1. Vytvořit instance fbxsaveoptions1. Nastavit specifické vlastnosti FBX pro pokročilou konverzii1. Volejte scénu. uložit metodu1. Přejít výstupní cestu s FBX rozšířením souboru a objektem fbxsaveopcí (% + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + +1. Zkontrolovat výsledný soubor FBX při zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento vzorový kód ukazuje konverzaci DAE na FBX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert DAE to FBX" sectionDescription="Check our live demos for [Konverzace DAE na FBX](https://products.aspose.app/3d/conversion/dae-to-fbx) S následujícími přínosy." >}}
