---
title: Převést USD na OBJ prostřednictvím C# 
description: Převeďte USD a další soubory 3D pomocí .NET API
url: /cs/net/conversion/usd-to-obj/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést USD na OBJ prostřednictvím C#" h2="Exportujte USD a další soubory 3D pomocí .NET Framework, .NET Core a Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportovat scénu USD jako OBJ pomocí C#" %}}
...
3. Jako první parametr předejte název výstupního souboru s příponou .obj
...
{{% blocks/products/pf/agp/code-autogen title="C# Kód pro konverzi USD na OBJ" gistPath="" %}}
```cs
