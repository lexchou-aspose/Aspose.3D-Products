...
description: Vzorový kód pro konverzaci ATT na PDF C#. Použijte API příklad kódu pro dávku ATT souborů na PDF konverzaci v rámci vb .NET, asp .NET nebo kterékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert ATT to PDF via C#" h2="Render ATT as PDF without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ATT na PDF pomocí C#" %}}
 ...
 Pro převádění ATT na PDF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod ATT na PDF prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programátoři mohou snadno načíst a převést ATT soubory do PDF v několika řadách kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor ATT prostřednictvím konstruktora třídy scény1. Vytvořit instance of amfsaveoptions1. Nastavit specifické vlastnosti PDF pro pokročilou konverzii1. Volejte scénu. uložit metodu1. Přejít výstupní cestu s PDF příponou souboru a objektem pdfsaveoptions1. Zkontrolovat výsledný soubor PDF při zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento vzorový kód ukazuje konverzaci ATT na PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert ATT to PDF" sectionDescription="Check our live demos for [Konverzace ATT na PDF](https://products.aspose.app/3d/conversion/att-to-pdf) S následujícími přínosy." >}}
