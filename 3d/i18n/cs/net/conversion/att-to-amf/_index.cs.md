...
description: Vzorový kód pro konverzaci ATT na AMF C#. Použijte API příklad kódu pro dávku ATT souborů na AMF konverzaci v rámci vb .NET, asp .NET nebo kterékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert ATT to AMF via C#" h2="Render ATT as AMF without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="AMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést ATT na AMF pomocí C#" %}}
 ...
 Pro převádění ATT na AMF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod ATT na AMF prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programátoři mohou snadno načíst a převést ATT soubory do AMF v několika řadách kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor ATT prostřednictvím konstruktora třídy scény1. Vytvořit instance of amfsaveoptions1. Nastavit specifické vlastnosti AMF pro pokročilou konverzii1. Volejte scénu. uložit metodu1. Přejít výstupní cestu s AMF rozšířením a objektem amfsaveoptions1. Zkontrolovat výsledný soubor AMF při zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento vzorový kód ukazuje konverzaci ATT na AMF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert ATT to AMF" sectionDescription="Check our live demos for [Konverzace ATT na AMF](https://products.aspose.app/3d/conversion/att-to-amf) S následujícími přínosy." >}}
