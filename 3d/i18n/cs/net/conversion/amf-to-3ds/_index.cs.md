...
{{% blocks/products/pf/agp/content h2="Jak převést AMF na 3DS pomocí C#" %}}
 ...
 Abychom převedli AMF na 3DS, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi AMF na 3DS prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři .NET mohou snadno načíst a převést soubory AMF na 3DS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor AMF pomocí konstruktoru třídy Scene1. Vytvořte instanci 3dsSaveOptions1. Nastavte 3DS konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.Save1. Předejte výstupní cestu s příponou souboru 3DS a objektem 3dsSaveOptions1. Zkontrolujte výsledný soubor 3DS v zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi AMF na 3DS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod AMF na 3DS" sectionDescription="Podívejte se na naše živé ukázky [Konverze AMF na 3DS](https://products.aspose.app/3d/conversion/amf-to-3ds) s následujícími výhodami." >}}
