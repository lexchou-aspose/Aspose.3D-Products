---
title: Convert PDF to DRC via C# 
url: /cs/net/conversion/pdf-to-drc/ 
description: Vzorový kód pro konverzaci PDF na DRC C#. Použijte API příklad kódu pro dávku PDF souborů na DRC konverzaci v rámci vb .NET, asp .NET nebo kterékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert PDF to DRC via C#" h2="Render PDF as DRC without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PDF na DRC pomocí C#" %}}
 ...
 Pro převádění PDF na DRC použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod PDF na DRC prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programátoři mohou snadno načíst a převést PDF soubory do DRC v několika řadách kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor PDF prostřednictvím konstruktora třídy scény1. Vytvořit instance of amfsaveoptions1. Nastavit specifické vlastnosti DRC pro pokročilou konverzii1. Volejte scénu. uložit metodu1. Přejít výstupní cestu s DRC rozšířením souboru a objektem drcsaveoptions1. Zkontrolovat výsledný soubor DRC při zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento vzorový kód ukazuje konverzaci PDF na DRC C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert PDF to DRC" sectionDescription="Check our live demos for [Konverzace PDF na DRC](https://products.aspose.app/3d/conversion/pdf-to-drc) S následujícími přínosy." >}}
