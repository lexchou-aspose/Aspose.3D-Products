---
title: Convert STL to PLY via C# 
weight: 3500
url: /cs/net/conversion/stl-to-ply/ 
description: Vzorový kód pro konverzaci STL na PLY C#. Použijte API příklad kódu pro dávku STL souborů na PLY konverzaci v rámci vb .NET, asp .NET nebo kterékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert STL to PLY via C#" h2="Render STL as PLY without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést STL na PLY pomocí C#" %}}
 ...
 Pro převádění STL na PLY použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod STL na PLY prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programátoři mohou snadno načíst a převést STL soubory do PLY v několika řadách kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor STL prostřednictvím konstruktora třídy scény1. Vytvořit instance of plysaveoptions1. Nastavit specifické vlastnosti PLY pro pokročilou konverzii1. Volejte scénu. uložit metodu1. Přejít výstupní cestu s PLY rozšířením souboru a objektem aplikace plysaveoptions1. Zkontrolovat výsledný soubor PLY při zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento vzorový kód ukazuje konverzaci STL na PLY C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert STL to PLY" sectionDescription="Check our live demos for [Konverzace STL na PLY](https://products.aspose.app/3d/conversion/stl-to-ply) S následujícími přínosy." >}}
