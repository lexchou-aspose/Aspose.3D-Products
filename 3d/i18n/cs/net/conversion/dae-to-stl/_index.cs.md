...
description: Vzorový kód pro konverzaci DAE na STL C#. Použijte API příklad kódu pro dávku DAE souborů na STL konverzaci v rámci vb .NET, asp .NET nebo kterékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert DAE to STL via C#" h2="Render DAE as STL without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést DAE na STL pomocí C#" %}}
 ...
 Pro převádění DAE na STL použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod DAE na STL prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programátoři mohou snadno načíst a převést DAE soubory do STL v několika řadách kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor DAE prostřednictvím konstruktora třídy scény1. Vytvořit instanci stlsaveoptions1. Nastavit specifické vlastnosti STL pro pokročilou konverzii1. Volejte scénu. uložit metodu1. Přejít výstupní cestu s STL příponou souboru a objektem stlsaveoptions (% % % % + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + + +1. Zkontrolovat výsledný soubor STL při zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento vzorový kód ukazuje konverzaci DAE na STL C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert DAE to STL" sectionDescription="Check our live demos for [Konverzace DAE na STL](https://products.aspose.app/3d/conversion/dae-to-stl) S následujícími přínosy." >}}
