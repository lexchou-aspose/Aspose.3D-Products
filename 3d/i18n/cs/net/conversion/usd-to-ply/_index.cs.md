---
title: Convert USD to PLY via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert USD to PLY via C#" h2="Exportovat USD a další 3D soubory pomocí .NET framework, .NET core a Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportovat scénu USD jako PLY s C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# kód pro převedení USD na PLY-= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =" gistPath="" %}}
```cs
