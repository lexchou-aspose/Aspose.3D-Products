---
title: Convert DRC to OBJ via C# 
url: /cs/net/conversion/drc-to-obj/ 
description: Vzorový kód pro konverzaci DRC na OBJ C#. Použijte API příklad kódu pro dávku DRC souborů na OBJ konverzaci v rámci vb .NET, asp .NET nebo kterékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert DRC to OBJ via C#" h2="Render DRC as OBJ without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést DRC na OBJ pomocí C#" %}}
 ...
 Pro převádění DRC na OBJ použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod DRC na OBJ prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programátoři mohou snadno načíst a převést DRC soubory do OBJ v několika řadách kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor DRC prostřednictvím konstruktora třídy scény1. Vytvořit instance of amfsaveoptions1. Nastavit specifické vlastnosti OBJ pro pokročilou konverzii1. Volejte scénu. uložit metodu1. Přejít výstupní cestu s OBJ rozšířením souboru a objektem opcí objsaveoptions1. Zkontrolovat výsledný soubor OBJ při zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento vzorový kód ukazuje konverzaci DRC na OBJ C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert DRC to OBJ" sectionDescription="Check our live demos for [Konverzace DRC na OBJ](https://products.aspose.app/3d/conversion/drc-to-obj) S následujícími přínosy." >}}
