...
url: /cs/net/conversion/gltf-to-3ds/ 
description: Vzorový kód pro konverzaci GLTF na 3DS C#. Použijte API příklad kódu pro dávku GLTF souborů na 3DS konverzaci v rámci vb .NET, asp .NET nebo kterékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert GLTF to 3DS via C#" h2="Render GLTF as 3DS without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Jak převést GLTF na 3DS pomocí C#" %}}

 Pro převádění GLTF na 3DS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod GLTF na 3DS prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programátoři mohou snadno načíst a převést GLTF soubory do 3DS v několika řadách kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor GLTF prostřednictvím konstruktora třídy scény1. Vytvořit instance of amfsaveoptions1. Nastavit specifické vlastnosti 3DS pro pokročilou konverzii1. Volejte scénu. uložit metodu1. Přejít výstupní cestu s 3DS rozšíření souboru a objekt diskrét3dssaveoptions1. Zkontrolovat výsledný soubor 3DS při zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento vzorový kód ukazuje konverzaci GLTF na 3DS C#" offSpacer="" %}}

```cs
// Načíst GLTF v objektu scény 
var document = new Aspose.ThreeD.Scene("template.gltf");
// Vytvořit instanci diskrét3dssaveoptions 
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert GLTF to 3DS" sectionDescription="Check our live demos for [Konverzace GLTF na 3DS](https://products.aspose.app/3d/conversion/gltf-to-3ds) S následujícími přínosy." >}}
