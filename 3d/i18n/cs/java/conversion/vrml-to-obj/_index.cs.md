...
{{% blocks/products/pf/agp/content h2="Jak převést VRML na OBJ pomocí Java" %}}
 ...
 K vykreslení VRML do OBJ použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VRML na OBJ prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři Java mohou snadno převést soubor VRML na OBJ pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VRML pomocí konstruktoru třídy Scene1. Vytvořte instanci ObjSaveOptions1. Nastavte OBJ konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.save1. Předejte výstupní cestu s příponou souboru OBJ a objektem ObjSaveOptions
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze VRML na OBJ Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Živá ukázka konverzí VRML na OBJ" sectionDescription="[Převést VRML na OBJ](https://products.aspose.app/3d/conversion/vrml-to-obj) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor VRML, bude okamžitě převeden na OBJ." >}}
