---
title: Convert DXF to OBJ via Java 
weight: 160
url: /cs/java/conversion/dxf-to-obj/ 
description: Vzorek Java konverzní kód pro formát DXF do souboru OBJ. Použijte tento příkladný kód k převedení DXF na OBJ v rámci kterékoli aplikace založené na webu nebo ploše Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert DXF to OBJ via Java" h2="Konverzace DXF na OBJ pomocí knihovny Java bez modelovacího softwaru 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DXF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést DXF na OBJ pomocí Java" %}}

 K vykreslování DXF do OBJ použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod DXF na OBJ prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programátoři mohou snadno převést soubor DXF na OBJ v několika řádcích kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor DXF prostřednictvím konstruktora třídy scény1. Vytvořit instance objsaveoptions1. Nastavit specifické vlastnosti OBJ pro pokročilou konverzii1. Volání scény. uložit metodu1. Přejít výstupní cestu s OBJ rozšířením souboru a objektem opcí objsaveoptions
...
{{% blocks/products/pf/agp/code-block title="DXF to OBJ Java conversion source code" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Konverzace live demonstrací DXF na OBJ" sectionDescription="[Převést DXF na OBJ](https://products.aspose.app/3d/conversion/dxf-to-obj) Právě teď navštívit naše live demos webové stránky. live demo má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your DXF file, it will be converted instantly to OBJ." >}}
