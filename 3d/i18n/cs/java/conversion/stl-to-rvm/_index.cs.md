---
title: Convert STL to RVM via Java 
weight: 330
url: /cs/java/conversion/stl-to-rvm/ 
description: Vzorek Java konverzní kód pro formát STL do souboru RVM. Použijte tento příkladný kód k převedení STL na RVM v rámci kterékoli aplikace založené na webu nebo ploše Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert STL to RVM via Java" h2="Konverzace STL na RVM pomocí knihovny Java bez modelovacího softwaru 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="RVM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést STL na RVM pomocí Java" %}}
 ...
 K vykreslování STL do RVM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod STL na RVM prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programátoři mohou snadno převést soubor STL na RVM v několika řádcích kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor STL prostřednictvím konstruktora třídy scény1. Vytvořit instance of rvmsaveoptions1. Nastavit specifické vlastnosti RVM pro pokročilou konverzii1. Volání scény. uložit metodu1. Přejít výstupní cestu s RVM rozšířením souboru a objektem aplikace rvmsaveoptions
...
{{% blocks/products/pf/agp/code-block title="STL to RVM Java conversion source code" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Konverzace live demonstrací STL na RVM" sectionDescription="[Převést STL na RVM](https://products.aspose.app/3d/conversion/stl-to-rvm) Právě teď navštívit naše live demos webové stránky. live demo má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your STL file, it will be converted instantly to RVM." >}}
