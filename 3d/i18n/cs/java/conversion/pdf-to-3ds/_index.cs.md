...
description: Vzorek Java konverzní kód pro formát PDF do souboru 3DS. Použijte tento příkladný kód k převedení PDF na 3DS v rámci kterékoli aplikace založené na webu nebo ploše Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert PDF to 3DS via Java" h2="Konverzace PDF na 3DS pomocí knihovny Java bez modelovacího softwaru 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést PDF na 3DS pomocí Java" %}}
 ...
 K vykreslování PDF do 3DS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod PDF na 3DS prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programátoři mohou snadno převést soubor PDF na 3DS v několika řádcích kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor PDF prostřednictvím konstruktora třídy scény1. Vytvořit instanci diskrét3dssaveoptions1. Nastavit specifické vlastnosti 3DS pro pokročilou konverzii1. Volání scény. uložit metodu1. Přejít výstupní cestu s 3DS rozšíření souboru a objekt diskrét3dssaveoptions
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Konverzace live demonstrací PDF na 3DS" sectionDescription="[Převést PDF na 3DS](https://products.aspose.app/3d/conversion/pdf-to-3ds) Právě teď navštívit naše live demos webové stránky. live demo má následující výhody" >}}
