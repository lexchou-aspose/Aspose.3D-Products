...
{{% blocks/products/pf/agp/content h2="Jak převést STL na GLTF pomocí Java" %}}
 ...
 K vykreslování STL do GLTF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod STL na GLTF prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programátoři mohou snadno převést soubor STL na GLTF v několika řádcích kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor STL prostřednictvím konstruktora třídy scény1. Vytvořit instanci gltfsaveoptions1. Nastavit specifické vlastnosti GLTF pro pokročilou konverzii1. Volání scény. uložit metodu1. Přejít výstupní cestu s GLTF příponou souboru a objektem gltfsaveoptions
...
{{% blocks/products/pf/agp/code-block title="STL to GLTF Java conversion source code" offSpacer="" %}}
