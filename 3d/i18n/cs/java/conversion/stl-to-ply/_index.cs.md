...
description: Vzorek Java konverzní kód pro formát STL do souboru PLY. Použijte tento příkladný kód k převedení STL na PLY v rámci kterékoli aplikace založené na webu nebo ploše Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert STL to PLY via Java" h2="Konverzace STL na PLY pomocí knihovny Java bez modelovacího softwaru 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést STL na PLY pomocí Java" %}}
 ...
 K vykreslování STL do PLY použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod STL na PLY prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programátoři mohou snadno převést soubor STL na PLY v několika řádcích kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor STL prostřednictvím konstruktora třídy scény1. Vytvořit instance of plysaveoptions1. Nastavit specifické vlastnosti PLY pro pokročilou konverzii1. Volání scény. uložit metodu1. Přejít výstupní cestu s PLY rozšířením souboru a objektem aplikace plysaveoptions
...
{{% blocks/products/pf/agp/code-block title="STL to PLY Java conversion source code" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Konverzace live demonstrací STL na PLY" sectionDescription="[Převést STL na PLY](https://products.aspose.app/3d/conversion/stl-to-ply) Právě teď navštívit naše live demos webové stránky. live demo má následující výhody" >}}
