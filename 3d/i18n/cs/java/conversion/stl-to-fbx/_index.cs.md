---
title: Převést STL na FBX prostřednictvím Java 
weight: 1450
url: /cs/java/conversion/stl-to-fbx/ 
description: Ukázkový konverzní kód Java pro formát STL na soubor FBX. Pomocí tohoto příkladu kódu převeďte STL na FBX v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést STL na FBX prostřednictvím Java" h2="Převod STL na FBX pomocí knihovny Java bez jakéhokoli modelovacího softwaru 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést STL na FBX pomocí Java" %}}

 K vykreslení STL do FBX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi STL na FBX prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři Java mohou snadno převést soubor STL na FBX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor STL pomocí konstruktoru třídy Scene1. Vytvořte instanci FbxSaveOptions1. Nastavte FBX konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.save1. Předejte výstupní cestu s příponou souboru FBX a objektem FbxSaveOptions
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze STL na FBX Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Živá ukázka konverzí STL na FBX" sectionDescription="[Převést STL na FBX](https://products.aspose.app/3d/conversion/stl-to-fbx) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor STL, bude okamžitě převeden na FBX." >}}
