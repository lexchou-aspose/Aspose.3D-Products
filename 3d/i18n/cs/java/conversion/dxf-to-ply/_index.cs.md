---
title: Convert DXF to PLY via Java 
weight: 3260
url: /cs/java/conversion/dxf-to-ply/ 
description: Vzorek Java konverzní kód pro formát DXF do souboru PLY. Použijte tento příkladný kód k převedení DXF na PLY v rámci kterékoli aplikace založené na webu nebo ploše Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convert DXF to PLY via Java" h2="Konverzace DXF na PLY pomocí knihovny Java bez modelovacího softwaru 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DXF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést DXF na PLY pomocí Java" %}}

 K vykreslování DXF do PLY použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod DXF na PLY prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programátoři mohou snadno převést soubor DXF na PLY v několika řádcích kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor DXF prostřednictvím konstruktora třídy scény1. Vytvořit instance of plysaveoptions1. Nastavit specifické vlastnosti PLY pro pokročilou konverzii1. Volání scény. uložit metodu1. Přejít výstupní cestu s PLY rozšířením souboru a objektem aplikace plysaveoptions
...
{{% blocks/products/pf/agp/code-block title="DXF to PLY Java conversion source code" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Konverzace live demonstrací DXF na PLY" sectionDescription="[Převést DXF na PLY](https://products.aspose.app/3d/conversion/dxf-to-ply) Právě teď navštívit naše live demos webové stránky. live demo má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your DXF file, it will be converted instantly to PLY." >}}
