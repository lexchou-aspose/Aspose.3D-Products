---
title: Převést DAE na ASE prostřednictvím Java 
weight: 1600
url: /cs/java/conversion/dae-to-ase/ 
description: Ukázkový konverzní kód Java pro formát DAE na soubor ASE. Pomocí tohoto příkladu kódu převeďte DAE na ASE v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést DAE na ASE prostřednictvím Java" h2="Převod DAE na ASE pomocí knihovny Java bez jakéhokoli modelovacího softwaru 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="ASE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést DAE na ASE pomocí Java" %}}
 ...
 K vykreslení DAE do ASE použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi DAE na ASE prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři Java mohou snadno převést soubor DAE na ASE pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor DAE pomocí konstruktoru třídy Scene1. Vytvořte instanci AseSaveOptions1. Nastavte ASE konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.save1. Předejte výstupní cestu s příponou souboru ASE a objektem AseSaveOptions
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze DAE na ASE Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Živá ukázka konverzí DAE na ASE" sectionDescription="[Převést DAE na ASE](https://products.aspose.app/3d/conversion/dae-to-ase) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor DAE, bude okamžitě převeden na ASE." >}}
