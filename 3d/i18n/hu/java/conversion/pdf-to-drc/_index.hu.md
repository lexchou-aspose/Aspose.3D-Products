...
{{% blocks/products/pf/agp/content h2="Hogyan lehet konvertálni PDF DRC Java használatával" %}}

 A PDF DRC rendereléséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a PDF DRC-re való konvertálásához Java-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Java a programozók a PDF fájlt egyszerűen DRC-re konvertálhatják néhány sor kóddal.

{{% /blocks/products/pf/agp/text %}}

1. A PDF fájl betöltése a jelenet-osztály konstruktőrjén keresztül1. Hívja a jelenet. mentse módszer DRC formátumban.1. Ellenőrizze a resultant DRC fájlt a megadott útvonalon
...
{{% blocks/products/pf/agp/code-block title="PDF a DRC Java konverziós forráskódhoz" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PDF a DRC konverziós élő demók" sectionDescription="[Konvertálni PDF DRC](https://products.aspose.app/3d/conversion/pdf-to-drc) Most az élő demók honlapunkon. az élő demó a következő előnyökkel jár" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltsön fel a PDF fájlt, akkor azonnal átalakítani DRC." >}}
