---
title: GLTF DRC-re konvertálni Java-en keresztül 
url: /hu/java/conversion/gltf-to-drc/ 
description: Minta Java konverziós kód GLTF formátumban DRC fájlba. Használja ezt a példakódot a GLTF DRC-re történő konvertálásához bármely webes vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="GLTF DRC-re konvertálni Java-en keresztül" h2="GLTF DRC konverzióra Java könyvtár használatával minden 3D modellezési szoftver nélkül." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet konvertálni GLTF DRC Java használatával" %}}

 A GLTF DRC rendereléséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a GLTF DRC-re való konvertálásához Java-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Java a programozók a GLTF fájlt egyszerűen DRC-re konvertálhatják néhány sor kóddal.

{{% /blocks/products/pf/agp/text %}}

1. A GLTF fájl betöltése a jelenet-osztály konstruktőrjén keresztül1. Hozzon létre egy példányt drcsaveoptions1. DRC specifikus tulajdonságok beállítása a fejlett konverzióhoz1. Hívás jelenet. mentés módszer1. Adja át a kimeneti utat DRC fájl kiterjesztés & objektum drcsaveoptions
...
{{% blocks/products/pf/agp/code-block title="GLTF a DRC Java konverziós forráskódhoz" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLTF a DRC konverziós élő demók" sectionDescription="[Konvertálni GLTF DRC](https://products.aspose.app/3d/conversion/gltf-to-drc) Most az élő demók honlapunkon. az élő demó a következő előnyökkel jár" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltsön fel a GLTF fájlt, akkor azonnal átalakítani DRC." >}}
