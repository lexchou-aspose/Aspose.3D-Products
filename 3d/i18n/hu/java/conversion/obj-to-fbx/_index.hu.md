---
title: OBJ FBX-re konvertálni Java-en keresztül 
weight: 2650
url: /hu/java/conversion/obj-to-fbx/ 
description: Minta Java konverziós kód OBJ formátumban FBX fájlba. Használja ezt a példakódot a OBJ FBX-re történő konvertálásához bármely webes vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="OBJ FBX-re konvertálni Java-en keresztül" h2="OBJ FBX konverzióra Java könyvtár használatával minden 3D modellezési szoftver nélkül." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet konvertálni OBJ FBX Java használatával" %}}

 A OBJ FBX rendereléséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a OBJ FBX-re való konvertálásához Java-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Java a programozók a OBJ fájlt egyszerűen FBX-re konvertálhatják néhány sor kóddal.

{{% /blocks/products/pf/agp/text %}}

1. A OBJ fájl betöltése a jelenet-osztály konstruktőrjén keresztül1. Hozzon létre egy példány fbxsaveoptions1. FBX specifikus tulajdonságok beállítása a fejlett konverzióhoz1. Hívás jelenet. mentés módszer1. Adja át a kimeneti utat FBX fájl kiterjesztés & objektum fbxsaveoptions
...
{{% blocks/products/pf/agp/code-block title="OBJ a FBX Java konverziós forráskódhoz" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="OBJ a FBX konverziós élő demók" sectionDescription="[Konvertálni OBJ FBX](https://products.aspose.app/3d/conversion/obj-to-fbx) Most az élő demók honlapunkon. az élő demó a következő előnyökkel jár" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltsön fel a OBJ fájlt, akkor azonnal átalakítani FBX." >}}
