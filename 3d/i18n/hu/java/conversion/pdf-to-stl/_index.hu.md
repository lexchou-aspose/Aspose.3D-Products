...
{{% blocks/products/pf/agp/content h2="PDF konvertálása STL-re a Java használatával" %}}

 A(z) PDF megjelenítéséhez a(z) STL számára a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) PDF konvertálásához STL-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java programozói könnyedén konvertálhatnak PDF fájlt STL formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. PDF fájl betöltése a Scene osztály konstruktorán keresztül1. Hozzon létre egy StlSaveOptions példányt1. Állítson be STL speciális tulajdonságot a speciális konverzióhoz1. Hívja a Scene.save metódust1. Adja meg a kimeneti útvonalat STL fájlkiterjesztéssel és az StlSaveOptions objektumával
...
{{% blocks/products/pf/agp/code-block title="PDF – STL Java Konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PDF–STL Konverziós élő bemutatók" sectionDescription="[PDF konvertálása STL-re](https://products.aspose.app/3d/conversion/pdf-to-stl) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a(z) PDF fájlt, és azonnal konvertálódik a(z) STL fájlba." >}}
