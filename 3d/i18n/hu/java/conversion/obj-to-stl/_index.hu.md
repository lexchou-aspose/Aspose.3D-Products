---
title: OBJ STL-re konvertálni Java-en keresztül 
weight: 2860
url: /hu/java/conversion/obj-to-stl/ 
description: Minta Java konverziós kód OBJ formátumban STL fájlba. Használja ezt a példakódot a OBJ STL-re történő konvertálásához bármely webes vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="OBJ STL-re konvertálni Java-en keresztül" h2="OBJ STL konverzióra Java könyvtár használatával minden 3D modellezési szoftver nélkül." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan lehet konvertálni OBJ STL Java használatával" %}}

 A OBJ STL rendereléséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a OBJ STL-re való konvertálásához Java-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Java a programozók a OBJ fájlt egyszerűen STL-re konvertálhatják néhány sor kóddal.

{{% /blocks/products/pf/agp/text %}}

1. A OBJ fájl betöltése a jelenet-osztály konstruktőrjén keresztül1. Hozzon létre egy példány stlsaveoptions1. STL specifikus tulajdonságok beállítása a fejlett konverzióhoz1. Hívás jelenet. mentés módszer1. Adja át a kimeneti utat STL fájl kiterjesztés & objektum stlsaveoptions
...
{{% blocks/products/pf/agp/code-block title="OBJ a STL Java konverziós forráskódhoz" offSpacer="" %}}
