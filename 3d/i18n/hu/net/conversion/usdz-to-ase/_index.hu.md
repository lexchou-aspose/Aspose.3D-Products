---
title: USDZ ASE-re konvertálni C#-en keresztül 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USDZ ASE-re konvertálni C#-en keresztül" h2="USDZ és egyéb 3D fájlok exportálása .NET keretrendszer, .NET core és Mono használatával" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USDZ jelenet exportálása ASE C#" %}}
...
3. adja át a kimeneti fájl nevét. Az ase kiterjesztés első paraméterként
4. adja meg a 'ASE' mezőértéket a [Fileformat](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Osztály
...
{{% blocks/products/pf/agp/code-autogen title="C# kód USDZ to ASE konverzióra" gistPath="" %}}
```cs
