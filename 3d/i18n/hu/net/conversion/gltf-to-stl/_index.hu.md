...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a GLTF STL-re való konvertálásához C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 .NET a programozók a GLTF fájlokat egyszerűen STL-re tölthetik és konvertálhatják néhány sor kóddal.

{{% /blocks/products/pf/agp/text %}}

1. A GLTF fájl betöltése a jelenet-osztály konstruktőrjén keresztül1. Hozzon létre egy példány amfsaveoptions1. STL specifikus tulajdonságok beállítása a fejlett konverzióhoz1. Hívja a jelenetet. mentse módszer1. Adja át a kimeneti utat STL fájl kiterjesztés & objektum stlsaveoptions1. Ellenőrizze a resultant STL fájlt a megadott útvonalon
...
{{% blocks/products/pf/agp/code-block title="Ez a minta kód megmutatja a GLTF to STL C# konverziót" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert GLTF to STL" sectionDescription="Ellenőrizze az élő demók [GLTF a STL konverzióra](https://products.aspose.app/3d/conversion/gltf-to-stl) A következő előnyökkel." >}}
