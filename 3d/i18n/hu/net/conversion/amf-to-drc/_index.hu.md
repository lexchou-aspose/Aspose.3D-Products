...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a AMF DRC-re való konvertálásához C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 .NET a programozók a AMF fájlokat egyszerűen DRC-re tölthetik és konvertálhatják néhány sor kóddal.

{{% /blocks/products/pf/agp/text %}}

1. A AMF fájl betöltése a jelenet-osztály konstruktőrjén keresztül1. Hozzon létre egy példány amfsaveoptions1. DRC specifikus tulajdonságok beállítása a fejlett konverzióhoz1. Hívja a jelenetet. mentse módszer1. Adja át a kimeneti utat DRC fájl kiterjesztés & objektum drcsaveoptions1. Ellenőrizze a resultant DRC fájlt a megadott útvonalon
...
{{% blocks/products/pf/agp/code-block title="Ez a minta kód megmutatja a AMF to DRC C# konverziót" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert AMF to DRC" sectionDescription="Ellenőrizze az élő demók [AMF a DRC konverzióra](https://products.aspose.app/3d/conversion/amf-to-drc) A következő előnyökkel." >}}
