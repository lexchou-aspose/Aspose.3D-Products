---
title: USDZ PDF-re konvertálni C#-en keresztül 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USDZ PDF-re konvertálni C#-en keresztül" h2="USDZ és egyéb 3D fájlok exportálása .NET keretrendszer, .NET core és Mono használatával" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USDZ jelenet exportálása PDF C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# kód USDZ to PDF konverzióra" gistPath="" %}}
```cs
