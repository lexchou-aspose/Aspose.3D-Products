...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a FBX 3DS-re való konvertálásához C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 .NET a programozók a FBX fájlokat egyszerűen 3DS-re tölthetik és konvertálhatják néhány sor kóddal.

{{% /blocks/products/pf/agp/text %}}

1. A FBX fájl betöltése a jelenet-osztály konstruktőrjén keresztül1. Hozzon létre egy példány 3dssaveoptions1. 3DS specifikus tulajdonságok beállítása a fejlett konverzióhoz1. Hívja a jelenetet. mentse módszer1. Adja át a kimeneti utat 3DS fájl kiterjesztés & objektum 3dssaveoptions1. Ellenőrizze a resultant 3DS fájlt a megadott útvonalon
...
{{% blocks/products/pf/agp/code-block title="Ez a minta kód megmutatja a FBX to 3DS C# konverziót" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert FBX to 3DS" sectionDescription="Ellenőrizze az élő demók [FBX a 3DS konverzióra](https://products.aspose.app/3d/conversion/fbx-to-3ds) A következő előnyökkel." >}}
