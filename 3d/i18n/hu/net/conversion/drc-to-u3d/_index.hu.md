...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a DRC U3D-re való konvertálásához C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 .NET a programozók a DRC fájlokat egyszerűen U3D-re tölthetik és konvertálhatják néhány sor kóddal.

{{% /blocks/products/pf/agp/text %}}

1. A DRC fájl betöltése a jelenet-osztály konstruktőrjén keresztül1. Hozzon létre egy példány amfsaveoptions1. U3D specifikus tulajdonságok beállítása a fejlett konverzióhoz1. Hívja a jelenetet. mentse módszer1. Adja át a kimeneti utat U3D fájl kiterjesztés & objektum u3dsaveoptions1. Ellenőrizze a resultant U3D fájlt a megadott útvonalon
...
{{% blocks/products/pf/agp/code-block title="Ez a minta kód megmutatja a DRC to U3D C# konverziót" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Free app to convert DRC to U3D" sectionDescription="Ellenőrizze az élő demók [DRC a U3D konverzióra](https://products.aspose.app/3d/conversion/drc-to-u3d) A következő előnyökkel." >}}
