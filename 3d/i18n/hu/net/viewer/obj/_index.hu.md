---
title: OBJ fájlformátumok megtekintése .NET-en keresztül 
weight: 1070
url: /hu/net/viewer/obj/ 
description: C# forráskód a .NET keretrendszeren, a .NET core Mono OBJ dokumentumok betöltéséhez, rendereléséhez és megjelenítéséhez.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="OBJ file viewer for .NET" h2="OBJ fájlok renderelése minden 3D modellezési és renderezési szoftver nélkül." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="A OBJ fájl C# használatával való megtekintése" %}}

 A OBJ fájl megtekintéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A OBJ C#-en keresztül történő megtekintéséhez" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D megkönnyíti a fejlesztők számára, hogy megtekinthessék a OBJ fájlt mindössze néhány sor kóddal.

{{% /blocks/products/pf/agp/text %}}

1. A OBJ fájl betöltése a jelenet-osztály konstruktőrjén keresztül1. Hozzon létre egy példány html5saveoptions1. Speciális formázás tulajdonságainak beállítása1. Hívja a jelenetet. mentse módszer objektum html5saveoptions1. Az eredő HTML fájl ellenőrzése az alapértelmezett böngészőben
...
{{% blocks/products/pf/agp/code-block title="C# kód OBJ megtekintéséhez" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// OBJ jelenet betöltése a jelenet egy példányán keresztül
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D egy CAD és a gameware API 3D fájlok betöltésére, módosítására és átalakítására. API önálló és nem igényel semmilyen 3D modellezési vagy renderezési szoftvert. API Discreet3DS, WavefrontOBJ, STL (ascii, bináris), Universal3D, FBX (ascii, bináris), Collada, glTF, PLY, GLB, directx és több formátum. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás OBJ megtekintéséhez" sectionDescription="Ellenőrizze az élő demók [Nézet OBJ](https://products.aspose.app/3d/viewer/obj) A következő előnyökkel." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nem kell letölteni vagy beállítani semmit" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nincs szükség kódot írni vagy fordítani" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak feltölteni OBJ fájlt, és nyomja meg a \"nézet\" gombot" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" OBJ fájl letöltése a linkből, ha szükséges" >}}
