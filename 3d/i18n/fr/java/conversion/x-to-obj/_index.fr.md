...
description: Exemple de code de conversion Java pour le format X en fichier OBJ. Utilisez cet exemple de code pour convertir X en OBJ dans n'importe quelle application Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir X en OBJ via Java" h2="Conversion X à OBJ à l\'aide de la bibliothèque Java sans logiciel de modélisation 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="X" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir X en OBJ en utilisant Java" %}}
 ...
 Pour rendre X à OBJ, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java les programmeurs peuvent facilement convertir le fichier X en OBJ en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier X via le constructeur de la classe Scène1. Créer une instance d'ObjSaveOptions1. Définir des propriétés spécifiques OBJ pour une conversion avancée1. Call Scene.save méthode1. Passer le chemin de sortie avec OBJ extension de fichier et objet d'ObjSaveOptions
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="X à OBJ Démos en direct de conversion" sectionDescription="[Convertir X en OBJ](https://products.aspose.app/3d/conversion/x-to-obj) En ce moment en visitant notre site Web Live Demos. La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Il suffit de télécharger votre fichier X, il sera converti instantanément en OBJ." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/3d/java/conversion/x-to-stl/" name="X À STL" description="Géométrie de surface interchangeable 3D" >}}
