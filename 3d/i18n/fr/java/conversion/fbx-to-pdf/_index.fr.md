...
description: Exemple de code de conversion Java pour le format FBX en fichier PDF. Utilisez cet exemple de code pour convertir FBX en PDF dans n'importe quelle application Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir FBX en PDF via Java" h2="FBX à PDF conversion à l\'aide de la bibliothèque Java sans logiciel de modélisation 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FBX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir FBX en PDF en utilisant Java" %}}
 ...
 Pour rendre FBX à PDF, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java les programmeurs peuvent facilement convertir FBX fichier en PDF en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier FBX via le constructeur de la classe Scène1. Créer une instance de PdfSaveOptions1. Définir des propriétés spécifiques PDF pour une conversion avancée1. Call Scene.save méthode1. Passer le chemin de sortie avec PDF extension de fichier et objet de PdfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="FBX à PDF Java Code source de conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="FBX en PDF Démos en direct de conversion" sectionDescription="[Convertir FBX en PDF](https://products.aspose.app/3d/conversion/fbx-to-pdf) En ce moment en visitant notre site Web Live Demos. La démo en direct présente les avantages suivants" >}}
