---
title: Convertir JT en 3DS via Java 
weight: 3300
url: /fr/java/conversion/jt-to-3ds/ 
description: Exemple de code de conversion Java pour le format JT en fichier 3DS. Utilisez cet exemple de code pour convertir JT en 3DS dans n'importe quelle application Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir JT en 3DS via Java" h2="JT à 3DS conversion à l\'aide de la bibliothèque Java sans logiciel de modélisation 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir JT en 3DS en utilisant Java" %}}

 Pour rendre JT à 3DS, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir JT en 3DS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java les programmeurs peuvent facilement convertir JT fichier en 3DS en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier JT via le constructeur de la classe Scène1. Créer une instance de 3dsSaveOptions1. Définir des propriétés spécifiques 3DS pour une conversion avancée1. Call Scene.save méthode1. Passez le chemin de sortie avec l'extension de fichier 3DS et l'objet de 3dsSaveOptions
...
{{% blocks/products/pf/agp/code-block title="JT à 3DS Java Code source de conversion" offSpacer="" %}}
...
// Enregistrer JT en tant que 3DS 
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="JT en 3DS Démos en direct de conversion" sectionDescription="[Convertir JT en 3DS](https://products.aspose.app/3d/conversion/jt-to-3ds) En ce moment en visitant notre site Web Live Demos. La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier JT, il sera converti instantanément en 3DS." >}}
