...
description: Exemple de code de conversion Java pour le format DRC en fichier RVM. Utilisez cet exemple de code pour convertir DRC en RVM dans n'importe quelle application Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir DRC en RVM via Java" h2="DRC à RVM conversion à l\'aide de la bibliothèque Java sans logiciel de modélisation 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="RVM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir DRC en RVM en utilisant Java" %}}
 ...
 Pour rendre DRC à RVM, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java les programmeurs peuvent facilement convertir DRC fichier en RVM en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier DRC via le constructeur de la classe Scène1. Créer une instance de RvmSaveOptions1. Définir des propriétés spécifiques RVM pour une conversion avancée1. Call Scene.save méthode1. Passez le chemin de sortie avec l'extension de fichier RVM et l'objet de RvmSaveOptions
...
{{% blocks/products/pf/agp/code-block title="DRC à RVM Java Code source de conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC en RVM Démos en direct de conversion" sectionDescription="[Convertir DRC en RVM](https://products.aspose.app/3d/conversion/drc-to-rvm) En ce moment en visitant notre site Web Live Demos. La démo en direct présente les avantages suivants" >}}
