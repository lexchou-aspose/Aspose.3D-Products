---
title: Convertir DAE en OBJ via Java 
weight: 1640
url: /fr/java/conversion/dae-to-obj/ 
description: Exemple de code de conversion Java pour le format DAE en fichier OBJ. Utilisez cet exemple de code pour convertir DAE en OBJ dans n'importe quelle application Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir DAE en OBJ via Java" h2="DAE à OBJ conversion à l\'aide de la bibliothèque Java sans logiciel de modélisation 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir DAE en OBJ en utilisant Java" %}}

 Pour rendre DAE à OBJ, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir DAE en OBJ via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java les programmeurs peuvent facilement convertir DAE fichier en OBJ en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier DAE via le constructeur de la classe Scène1. Créer une instance d'ObjSaveOptions1. Définir des propriétés spécifiques OBJ pour une conversion avancée1. Call Scene.save méthode1. Passer le chemin de sortie avec OBJ extension de fichier et objet d'ObjSaveOptions
...
{{% blocks/products/pf/agp/code-block title="DAE à OBJ Java Code source de conversion" offSpacer="" %}}
