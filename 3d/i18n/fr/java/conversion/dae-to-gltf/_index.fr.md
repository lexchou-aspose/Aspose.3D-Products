---
title: Convertir DAE en GLTF via Java 
weight: 30
url: /fr/java/conversion/dae-to-gltf/ 
description: Exemple de code de conversion Java pour le format DAE en fichier GLTF. Utilisez cet exemple de code pour convertir DAE en GLTF dans n'importe quelle application Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir DAE en GLTF via Java" h2="DAE à GLTF conversion à l\'aide de la bibliothèque Java sans logiciel de modélisation 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir DAE en GLTF en utilisant Java" %}}

 Pour rendre DAE à GLTF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir DAE en GLTF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java les programmeurs peuvent facilement convertir DAE fichier en GLTF en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier DAE via le constructeur de la classe Scène1. Créer une instance de GltfSaveOptions1. Définir des propriétés spécifiques GLTF pour une conversion avancée1. Call Scene.save méthode1. Passer le chemin de sortie avec GLTF extension de fichier et objet de GltfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="DAE à GLTF Java Code source de conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DAE en GLTF Démos en direct de conversion" sectionDescription="[Convertir DAE en GLTF](https://products.aspose.app/3d/conversion/dae-to-gltf) En ce moment en visitant notre site Web Live Demos. La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier DAE, il sera converti instantanément en GLTF." >}}
