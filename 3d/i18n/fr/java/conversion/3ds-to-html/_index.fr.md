---
title: Convertir 3DS en HTML via Java 
weight: 3020
url: /fr/java/conversion/3ds-to-html/ 
description: Exemple de code de conversion Java pour le format 3DS en fichier HTML. Utilisez cet exemple de code pour convertir 3DS en HTML dans n'importe quelle application Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir 3DS en HTML via Java" h2="3DS à HTML conversion à l\'aide de la bibliothèque Java sans logiciel de modélisation 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir 3DS en HTML en utilisant Java" %}}

 Pour rendre 3DS à HTML, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir 3DS en HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java les programmeurs peuvent facilement convertir 3DS fichier en HTML en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier 3DS via le constructeur de la classe Scène1. Créer une instance de HtmlSaveOptions1. Définir des propriétés spécifiques HTML pour une conversion avancée1. Call Scene.save méthode1. Passez le chemin de sortie avec l'extension de fichier HTML et l'objet de HtmlSaveOptions
...
{{% blocks/products/pf/agp/code-block title="3DS à HTML Java Code source de conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="3DS en HTML Démos en direct de conversion" sectionDescription="[Convertir 3DS en HTML](https://products.aspose.app/3d/conversion/3ds-to-html) En ce moment en visitant notre site Web Live Demos. La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier 3DS, il sera converti instantanément en HTML." >}}
