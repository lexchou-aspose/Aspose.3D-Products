---
title: Convertir AMF en OBJ via Java 
weight: 3580
url: /fr/java/conversion/amf-to-obj/ 
description: Exemple de code de conversion Java pour le format AMF en fichier OBJ. Utilisez cet exemple de code pour convertir AMF en OBJ dans n'importe quelle application Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir AMF en OBJ via Java" h2="AMF à OBJ conversion à l\'aide de la bibliothèque Java sans logiciel de modélisation 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir AMF en OBJ en utilisant Java" %}}

 Pour rendre AMF à OBJ, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir AMF en OBJ via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java les programmeurs peuvent facilement convertir AMF fichier en OBJ en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier AMF via le constructeur de la classe Scène1. Créer une instance d'ObjSaveOptions1. Définir des propriétés spécifiques OBJ pour une conversion avancée1. Call Scene.save méthode1. Passer le chemin de sortie avec OBJ extension de fichier et objet d'ObjSaveOptions
...
{{% blocks/products/pf/agp/code-block title="AMF à OBJ Java Code source de conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="AMF en OBJ Démos en direct de conversion" sectionDescription="[Convertir AMF en OBJ](https://products.aspose.app/3d/conversion/amf-to-obj) En ce moment en visitant notre site Web Live Demos. La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier AMF, il sera converti instantanément en OBJ." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/3d/java/conversion/amf-to-stl/" name="AMF À STL" description="Géométrie de surface interchangeable 3D" >}}
