...
description: Exemple de code de conversion Java pour le format DRC en fichier AMF. Utilisez cet exemple de code pour convertir DRC en AMF dans n'importe quelle application Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir DRC en AMF via Java" h2="DRC à AMF conversion à l\'aide de la bibliothèque Java sans logiciel de modélisation 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="AMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir DRC en AMF en utilisant Java" %}}
 ...
 Pour rendre DRC à AMF, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java les programmeurs peuvent facilement convertir DRC fichier en AMF en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier DRC via le constructeur de la classe Scène1. Créer une instance de AmfSaveOptions1. Définir des propriétés spécifiques AMF pour une conversion avancée1. Call Scene.save méthode1. Passer le chemin de sortie avec AMF extension de fichier et objet d'AmfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="DRC à AMF Java Code source de conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC en AMF Démos en direct de conversion" sectionDescription="[Convertir DRC en AMF](https://products.aspose.app/3d/conversion/drc-to-amf) En ce moment en visitant notre site Web Live Demos. La démo en direct présente les avantages suivants" >}}
