...
description: Exemple de code de conversion Java pour le format OBJ en fichier USD. Utilisez cet exemple de code pour convertir OBJ en USD dans n'importe quelle application Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir OBJ en USD via Java" h2="OBJ à USD conversion à l\'aide de la bibliothèque Java sans logiciel de modélisation 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="USD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir OBJ en USD en utilisant Java" %}}
 ...
 Pour rendre OBJ à USD, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java les programmeurs peuvent facilement convertir OBJ fichier en USD en seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="OBJ à USD Java Code source de conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="OBJ en USD Démos en direct de conversion" sectionDescription="[Convertir OBJ en USD](https://products.aspose.app/3d/conversion/obj-to-usd) En ce moment en visitant notre site Web Live Demos. La démo en direct présente les avantages suivants" >}}
