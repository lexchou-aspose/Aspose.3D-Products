---
title: Convertir 3DS en DAE via Java 
weight: 1370
url: /fr/java/conversion/3ds-to-dae/ 
description: Exemple de code de conversion Java pour le format 3DS en fichier DAE. Utilisez cet exemple de code pour convertir 3DS en DAE dans n'importe quelle application Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir 3DS en DAE via Java" h2="3DS à DAE conversion à l\'aide de la bibliothèque Java sans logiciel de modélisation 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir 3DS en DAE en utilisant Java" %}}

 Pour rendre 3DS à DAE, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir 3DS en DAE via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java les programmeurs peuvent facilement convertir 3DS fichier en DAE en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier 3DS via le constructeur de la classe Scène1. Créer une instance de DaeSaveOptions1. Définir des propriétés spécifiques DAE pour une conversion avancée1. Call Scene.save méthode1. Passer le chemin de sortie avec DAE extension de fichier et objet de DaeSaveOptions
...
{{% blocks/products/pf/agp/code-block title="3DS à DAE Java Code source de conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="3DS en DAE Démos en direct de conversion" sectionDescription="[Convertir 3DS en DAE](https://products.aspose.app/3d/conversion/3ds-to-dae) En ce moment en visitant notre site Web Live Demos. La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier 3DS, il sera converti instantanément en DAE." >}}
