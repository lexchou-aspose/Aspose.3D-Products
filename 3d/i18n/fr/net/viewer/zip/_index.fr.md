...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D permet aux développeurs de visualiser facilement le fichier ZIP avec seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier ZIP via le constructeur de la classe Scène1. Créer une instance de Html5SaveOptions1. Définir les propriétés pour le formatage avancé1. Appelez la méthode Scene.Save avec l'objet de Html5SaveOptions1. Vérifier le fichier résultant HTML dans le navigateur par défaut
...
{{% blocks/products/pf/agp/code-block title="C# code pour voir ZIP" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// Charger ZIP scène via une instance de scène
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D est un CAD et Gameware API pour charger, modifier et convertir des fichiers 3D. API est autonome et ne nécessite aucun logiciel de modélisation ou de rendu de 3D. On peut facilement utiliser API pour Discreet3DS, WavefrontOBJ, STL (ASCII, Binaire), Universal3D, FBX (ASCII, Binaire), Collada, glTF, PLY, GLB, DirectX et plusieurs formats. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour afficher ZIP" sectionDescription="Consultez nos démos en direct pour [Vue ZIP](https://products.aspose.app/3d/viewer/zip) Avec les avantages suivants." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Télécharger le fichier ZIP à partir du lien, si nécessaire" >}}

        {{< blocks/products/pf/agp/i18n/about-file-text fileFormat="ZIP" readMoreLink="https://docs.fileformat.com/compression/zip/" >}}
ZIP extension de fichier représente les archives qui peuvent contenir un ou plusieurs fichiers ou répertoires. L'archive peut avoir une compression appliquée aux fichiers inclus afin de réduire la taille du fichier ZIP. ZIP format de fichier a été rendu public en février 1989 par Phil Katz pour la réalisation de l'archivage des fichiers et des dossiers. Le format a été intégré à l'utilitaire PKZIP, créé par PKWARE, Inc. Juste après la disponibilité des spécifications disponibles, de nombreuses entreprises ont intégré le format de fichier ZIP à leurs utilitaires logiciels, notamment Microsoft (depuis Windows 7), Apple (Mac OS X) et bien d'autres.
