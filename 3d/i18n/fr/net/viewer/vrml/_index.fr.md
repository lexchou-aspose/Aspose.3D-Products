...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D permet aux développeurs de visualiser facilement le fichier VRML avec seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VRML via le constructeur de la classe Scène1. Créer une instance de Html5SaveOptions1. Définir les propriétés pour le formatage avancé1. Appelez la méthode Scene.Save avec l'objet de Html5SaveOptions1. Vérifier le fichier résultant HTML dans le navigateur par défaut
...
{{% blocks/products/pf/agp/code-block title="C# code pour voir VRML" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// Charger VRML scène via une instance de scène
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D est un CAD et Gameware API pour charger, modifier et convertir des fichiers 3D. API est autonome et ne nécessite aucun logiciel de modélisation ou de rendu de 3D. On peut facilement utiliser API pour Discreet3DS, WavefrontOBJ, STL (ASCII, Binaire), Universal3D, FBX (ASCII, Binaire), Collada, glTF, PLY, GLB, DirectX et plusieurs formats. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour afficher VRML" sectionDescription="Consultez nos démos en direct pour [Vue VRML](https://products.aspose.app/3d/viewer/vrml) Avec les avantages suivants." >}}
