...
description: Exemple de code pour la conversion de FBX à GLB C#. Utilisez l'exemple de code API pour les fichiers batch FBX vers la conversion GLB dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir FBX en GLB via C#" h2="Rendez FBX comme GLB sans aucun logiciel de modélisation et de rendu 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FBX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir FBX en GLB en utilisant C#" %}}
 ...
 Afin de convertir FBX en GLB, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les programmeurs .NET peuvent facilement charger et convertir des fichiers FBX en GLB en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier FBX via le constructeur de la classe Scene1. Créer une instance de AmfSaveOptions1. Définir GLB propriétés spécifiques pour la conversion avancée1. Appelez la méthode Scene.Save1. Passez le chemin de sortie avec l'extension de fichier GLB et l'objet de StlSaveOptions1. Vérifier le fichier GLB résultant au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion FBX à GLB C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir FBX en GLB" sectionDescription="Consultez nos démos en direct pour [Conversion FBX à GLB](https://products.aspose.app/3d/conversion/fbx-to-glb) avec les avantages suivants." >}}
