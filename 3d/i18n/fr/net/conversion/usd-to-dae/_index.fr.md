...
{{% blocks/products/pf/agp/feature-section-col title="Exportez USD scène comme DAE avec C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code pour la conversion de USD à DAE" gistPath="" %}}
```cs
