...
description: Exemple de code pour la conversion PDF en 3DS C#. Utilisez API exemple de code pour les fichiers par lots PDF en conversion de 3DS dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PDF en 3DS via C#" h2="Rendre PDF comme 3DS sans logiciel de modélisation et de rendu 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir PDF en 3DS en utilisant C#" %}}
 ...
 Pour convertir PDF en 3DS, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programmeurs peuvent facilement charger et convertir des fichiers PDF en 3DS en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier PDF via le constructeur de la classe Scène1. Créer une instance de 3dsSaveOptions1. Définir des propriétés spécifiques 3DS pour une conversion avancée1. Appelez la méthode Scene.Save1. Passez le chemin de sortie avec l'extension de fichier 3DS et l'objet de 3dsSaveOptions1. Vérifiez le fichier résultant 3DS au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre PDF à 3DS C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir PDF en 3DS" sectionDescription="Consultez nos démos en direct pour [Conversion PDF en 3DS](https://products.aspose.app/3d/conversion/pdf-to-3ds) Avec les avantages suivants." >}}
