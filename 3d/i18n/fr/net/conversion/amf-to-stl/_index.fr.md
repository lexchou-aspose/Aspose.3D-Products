...
{{% blocks/products/pf/agp/content h2="Comment convertir AMF en STL en utilisant C#" %}}
 ...
 Pour convertir AMF en STL, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programmeurs peuvent facilement charger et convertir des fichiers AMF en STL en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier AMF via le constructeur de la classe Scène1. Créer une instance de StlSaveOptions1. Définir des propriétés spécifiques STL pour une conversion avancée1. Appelez la méthode Scene.Save1. Passez le chemin de sortie avec l'extension de fichier STL et l'objet de StlSaveOptions1. Vérifiez le fichier résultant STL au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre AMF à STL C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir AMF en STL" sectionDescription="Consultez nos démos en direct pour [Conversion AMF en STL](https://products.aspose.app/3d/conversion/amf-to-stl) Avec les avantages suivants." >}}
