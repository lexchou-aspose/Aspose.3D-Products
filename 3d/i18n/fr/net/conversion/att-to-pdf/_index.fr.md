...
{{% blocks/products/pf/agp/content h2="Comment convertir ATT en PDF en utilisant C#" %}}
 ...
 Pour convertir ATT en PDF, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programmeurs peuvent facilement charger et convertir des fichiers ATT en PDF en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier ATT via le constructeur de la classe Scène1. Créer une instance de AmfSaveOptions1. Définir des propriétés spécifiques PDF pour une conversion avancée1. Appelez la méthode Scene.Save1. Passer le chemin de sortie avec PDF extension de fichier et objet de PdfSaveOptions1. Vérifiez le fichier résultant PDF au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre ATT à PDF C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir ATT en PDF" sectionDescription="Consultez nos démos en direct pour [Conversion ATT en PDF](https://products.aspose.app/3d/conversion/att-to-pdf) Avec les avantages suivants." >}}
