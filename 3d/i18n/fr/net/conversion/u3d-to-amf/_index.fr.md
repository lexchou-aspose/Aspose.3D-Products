...
description: Exemple de code pour la conversion U3D en AMF C#. Utilisez API exemple de code pour les fichiers par lots U3D en conversion de AMF dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir U3D en AMF via C#" h2="Rendre U3D comme AMF sans logiciel de modélisation et de rendu 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="AMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="U3D" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir U3D en AMF en utilisant C#" %}}
 ...
 Pour convertir U3D en AMF, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programmeurs peuvent facilement charger et convertir des fichiers U3D en AMF en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier U3D via le constructeur de la classe Scène1. Créer une instance de AmfSaveOptions1. Définir des propriétés spécifiques AMF pour une conversion avancée1. Appelez la méthode Scene.Save1. Passer le chemin de sortie avec AMF extension de fichier et objet d'AmfSaveOptions1. Vérifiez le fichier résultant AMF au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre U3D à AMF C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir U3D en AMF" sectionDescription="Consultez nos démos en direct pour [Conversion U3D en AMF](https://products.aspose.app/3d/conversion/u3d-to-amf) Avec les avantages suivants." >}}
