...
{{% blocks/products/pf/agp/feature-section-col title="Exportez USDZ scène comme X avec C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code pour USDZ à X Conversion" gistPath="" %}}
```cs
// Charger le USDZ dans un objet de la scène 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// Enregistrer USDZ en tant que X 
