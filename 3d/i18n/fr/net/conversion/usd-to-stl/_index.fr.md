...
{{% blocks/products/pf/agp/feature-section-col title="Exportez USD scène comme STL avec C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code pour la conversion de USD à STL" gistPath="" %}}
```cs
