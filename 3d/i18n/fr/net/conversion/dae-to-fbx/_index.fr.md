...
description: Exemple de code pour la conversion DAE en FBX C#. Utilisez API exemple de code pour les fichiers par lots DAE en conversion de FBX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir DAE en FBX via C#" h2="Rendre DAE comme FBX sans logiciel de modélisation et de rendu 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir DAE en FBX en utilisant C#" %}}
 ...
 Pour convertir DAE en FBX, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programmeurs peuvent facilement charger et convertir des fichiers DAE en FBX en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier DAE via le constructeur de la classe Scène1. Créer une instance de FbxSaveOptions1. Définir des propriétés spécifiques FBX pour une conversion avancée1. Appelez la méthode Scene.Save1. Passer le chemin de sortie avec FBX extension de fichier et objet de FbxSaveOptions1. Vérifiez le fichier résultant FBX au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre DAE à FBX C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir DAE en FBX" sectionDescription="Consultez nos démos en direct pour [Conversion DAE en FBX](https://products.aspose.app/3d/conversion/dae-to-fbx) Avec les avantages suivants." >}}
