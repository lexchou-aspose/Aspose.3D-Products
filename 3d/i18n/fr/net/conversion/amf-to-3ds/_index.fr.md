...
{{% blocks/products/pf/agp/content h2="Comment convertir AMF en 3DS en utilisant C#" %}}
 ...
 Pour convertir AMF en 3DS, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programmeurs peuvent facilement charger et convertir des fichiers AMF en 3DS en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier AMF via le constructeur de la classe Scène1. Créer une instance de 3dsSaveOptions1. Définir des propriétés spécifiques 3DS pour une conversion avancée1. Appelez la méthode Scene.Save1. Passez le chemin de sortie avec l'extension de fichier 3DS et l'objet de 3dsSaveOptions1. Vérifiez le fichier résultant 3DS au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre AMF à 3DS C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir AMF en 3DS" sectionDescription="Consultez nos démos en direct pour [Conversion AMF en 3DS](https://products.aspose.app/3d/conversion/amf-to-3ds) Avec les avantages suivants." >}}
