---
title: Convertir JT en ATT via C# 
url: /fr/net/conversion/jt-to-att/ 
description: Exemple de code pour la conversion JT en ATT C#. Utilisez API exemple de code pour les fichiers par lots JT en conversion de ATT dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir JT en ATT via C#" h2="Rendre JT comme ATT sans logiciel de modélisation et de rendu 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ATT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JT" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Comment convertir JT en ATT en utilisant C#" %}}

 Pour convertir JT en ATT, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir JT en ATT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmeurs peuvent facilement charger et convertir des fichiers JT en ATT en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier JT via le constructeur de la classe Scène1. Créer une instance de AmfSaveOptions1. Définir des propriétés spécifiques ATT pour une conversion avancée1. Appelez la méthode Scene.Save1. Passer le chemin de sortie avec l'extension de fichier ATT et l'objet d'AttSaveOptions1. Vérifiez le fichier résultant ATT au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre JT à ATT C# Conversion" offSpacer="" %}}
...
// Enregistrer JT en tant que ATT 
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir JT en ATT" sectionDescription="Consultez nos démos en direct pour [Conversion JT en ATT](https://products.aspose.app/3d/conversion/jt-to-att) Avec les avantages suivants." >}}
