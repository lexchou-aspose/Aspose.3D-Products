...
{{% blocks/products/pf/agp/content h2="Comment convertir ATT en DRC en utilisant C#" %}}
 ...
 Pour convertir ATT en DRC, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programmeurs peuvent facilement charger et convertir des fichiers ATT en DRC en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier ATT via le constructeur de la classe Scène1. Créer une instance de AmfSaveOptions1. Définir des propriétés spécifiques DRC pour une conversion avancée1. Appelez la méthode Scene.Save1. Passez le chemin de sortie avec l'extension de fichier DRC et l'objet de DrcSaveOptions1. Vérifiez le fichier résultant DRC au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre ATT à DRC C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir ATT en DRC" sectionDescription="Consultez nos démos en direct pour [Conversion ATT en DRC](https://products.aspose.app/3d/conversion/att-to-drc) Avec les avantages suivants." >}}
