...
{{% blocks/products/pf/agp/content h2="Comment convertir ATT en GLTF en utilisant C#" %}}
 ...
 Pour convertir ATT en GLTF, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programmeurs peuvent facilement charger et convertir des fichiers ATT en GLTF en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier ATT via le constructeur de la classe Scène1. Créer une instance de AmfSaveOptions1. Définir des propriétés spécifiques GLTF pour une conversion avancée1. Appelez la méthode Scene.Save1. Passer le chemin de sortie avec GLTF extension de fichier et objet de GltfSaveOptions1. Vérifiez le fichier résultant GLTF au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre ATT à GLTF C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir ATT en GLTF" sectionDescription="Consultez nos démos en direct pour [Conversion ATT en GLTF](https://products.aspose.app/3d/conversion/att-to-gltf) Avec les avantages suivants." >}}
