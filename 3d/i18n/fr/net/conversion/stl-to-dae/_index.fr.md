...
description: Exemple de code pour la conversion STL en DAE C#. Utilisez API exemple de code pour les fichiers par lots STL en conversion de DAE dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir STL en DAE via C#" h2="Rendre STL comme DAE sans logiciel de modélisation et de rendu 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir STL en DAE en utilisant C#" %}}
 ...
 Pour convertir STL en DAE, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programmeurs peuvent facilement charger et convertir des fichiers STL en DAE en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier STL via le constructeur de la classe Scène1. Créer une instance de DaeSaveOptions1. Définir des propriétés spécifiques DAE pour une conversion avancée1. Appelez la méthode Scene.Save1. Passer le chemin de sortie avec DAE extension de fichier et objet de DaeSaveOptions1. Vérifiez le fichier résultant DAE au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre STL à DAE C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir STL en DAE" sectionDescription="Consultez nos démos en direct pour [Conversion STL en DAE](https://products.aspose.app/3d/conversion/stl-to-dae) Avec les avantages suivants." >}}
