...
{{% blocks/products/pf/agp/content h2="Comment convertir ATT en PLY en utilisant C#" %}}
 ...
 Pour convertir ATT en PLY, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programmeurs peuvent facilement charger et convertir des fichiers ATT en PLY en seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier ATT via le constructeur de la classe Scène1. Créer une instance de AmfSaveOptions1. Définir des propriétés spécifiques PLY pour une conversion avancée1. Appelez la méthode Scene.Save1. Passer le chemin de sortie avec PLY extension de fichier et objet de PlySaveOptions1. Vérifiez le fichier résultant PLY au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre ATT à PLY C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir ATT en PLY" sectionDescription="Consultez nos démos en direct pour [Conversion ATT en PLY](https://products.aspose.app/3d/conversion/att-to-ply) Avec les avantages suivants." >}}
