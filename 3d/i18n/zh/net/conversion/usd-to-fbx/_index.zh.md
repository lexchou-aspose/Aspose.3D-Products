...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 USD 转换为 FBX" h2="使用 .NET 框架、 .NET 核心和 Mono 导出 USD 和其他 3D 文件" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# 用于 USD 到 FBX 转换的代码" gistPath="" %}}
```cs
// 加载场景对象中的 USD 
