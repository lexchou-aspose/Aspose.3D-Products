...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 USDZ 转换为 AMF" h2="使用 .NET 框架、 .NET 核心和 Mono 导出 USDZ 和其他 3D 文件" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# 用于 USDZ 到 AMF 转换的代码" gistPath="" %}}
```cs
// 加载场景对象中的 USDZ 
