...
description: GLB 到 JT C# 转换的示例代码。在VB.NET，Asp.NET 或任何基于 .NET 的应用程序中使用 API 示例代码将批处理 GLB 文件转换为 JT。
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET 程序员只需几行代码就可以轻松地将 GLB 文件加载和转换为 JT。

{{% /blocks/products/pf/agp/text %}}

1. 通过场景类的构造函数加载 GLB 文件1. 使用 JT 的格式调用Scene.Save方法。1. 检查指定路径处的结果 JT 文件
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 GLB 到 JT C# 的转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="免费应用程序将 GLB 转换为 JT" sectionDescription="查看我们的实时演示 [GLB 到 JT 转换](https://products.aspose.app/3d/conversion/glb-to-jt) 有以下好处。" >}}
