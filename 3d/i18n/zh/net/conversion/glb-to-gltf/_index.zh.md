...
description: GLB 到 GLTF C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 GLB 文件批量转换为 GLTF。
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET 程序员只需几行代码即可轻松加载 GLB 文件并将其转换为 GLTF。
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 GLB 到 GLTF C# 转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="将 GLB 转换为 GLTF 的免费应用程序" sectionDescription="查看我们的现场演示 [GLB 到 GLTF 的转换](https://products.aspose.app/3d/conversion/glb-to-gltf) 具有以下好处。" >}}
