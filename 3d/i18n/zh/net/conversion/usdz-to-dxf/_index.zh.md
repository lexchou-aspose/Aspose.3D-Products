...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 USDZ 转换为 DXF" h2="使用 .NET 框架、 .NET 核心和 Mono 导出 USDZ 和其他 3D 文件" >}}
...
3.传递输出文件名与dxf扩展作为第一个参数
4.从中指定 “DXF” 字段值 [文件格式](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) 类
...
{{% blocks/products/pf/agp/code-autogen title="C# 用于 USDZ 到 DXF 转换的代码" gistPath="" %}}
```cs
// 加载场景对象中的 USDZ 
