...
description: VRML 到 JT C# 转换的示例代码。在VB.NET，Asp.NET 或任何基于 .NET 的应用程序中使用 API 示例代码将批处理 VRML 文件转换为 JT。
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET 程序员只需几行代码就可以轻松地将 VRML 文件加载和转换为 JT。
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 VRML 到 JT C# 的转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="免费应用程序将 VRML 转换为 JT" sectionDescription="查看我们的实时演示 [VRML 到 JT 转换](https://products.aspose.app/3d/conversion/vrml-to-jt) 有以下好处。" >}}
