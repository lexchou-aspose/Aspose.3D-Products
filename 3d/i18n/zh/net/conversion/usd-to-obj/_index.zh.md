---
title: 通过 C# 将 USD 转换为 OBJ 
description: 使用 .NET API 转换 USD 和其他 3D 文件
url: /zh/net/conversion/usd-to-obj/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 USD 转换为 OBJ" h2="使用 .NET 框架、 .NET 核心和 Mono 导出 USD 和其他 3D 文件" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 C# 将 USD 场景导出为 OBJ" %}}
...
3.传递输出文件名与obj扩展作为第一个参数
4.从中指定 “WavefrontOBJ” 字段值 [文件格式](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) 类
...
{{% blocks/products/pf/agp/code-autogen title="C# 用于 USD 到 OBJ 转换的代码" gistPath="" %}}
```cs
// 加载场景对象中的 USD 
