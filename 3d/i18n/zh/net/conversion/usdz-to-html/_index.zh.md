---
title: 通过 C# 将 USDZ 转换为 HTML 
description: 使用 .NET API 转换 USDZ 和其他 3D 文件
url: /zh/net/conversion/usdz-to-html/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 USDZ 转换为 HTML" h2="使用 .NET 框架、 .NET 核心和 Mono 导出 USDZ 和其他 3D 文件" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 C# 将 USDZ 场景导出为 HTML" %}}
...
3.传递输出文件名与作为第一个参数的html扩展
4.从中指定 “HTML5” 字段值 [文件格式](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) 类
...
{{% blocks/products/pf/agp/code-autogen title="C# 用于 USDZ 到 HTML 转换的代码" gistPath="" %}}
```cs
// 加载场景对象中的 USDZ 
