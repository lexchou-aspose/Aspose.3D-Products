...
{{% blocks/products/pf/agp/text %}}
 ...
 Java 程序员只需几行代码就可以轻松地将 U3D 文件转换为 DRC。

{{% /blocks/products/pf/agp/text %}}

1. 通过场景类的构造函数加载 U3D 文件1. 创建DrcSaveOptions实例1. 为高级转换设置 DRC 特定属性1. 调用场景。保存方法1. 传递带有 DRC 文件扩展名的输出路径 & DrcSaveOptions的对象
...
{{% blocks/products/pf/agp/code-block title="U3D 到 DRC Java 的转换源代码" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="U3D 到 DRC 转换实时演示" sectionDescription="[将 U3D 转换为 DRC](https://products.aspose.app/3d/conversion/u3d-to-drc) 现在通过访问我们的现场演示网站。现场演示有以下好处" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 无需下载 Aspose API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 不需要编写任何代码。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 只需上传您的 U3D 文件，它将立即转换为 DRC。" >}}
