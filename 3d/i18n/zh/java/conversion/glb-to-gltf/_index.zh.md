---
title: 通过 Java 将 GLB 转换为 GLTF
weight: 530
url: /zh/java/conversion/glb-to-gltf/ 
description: GLB 格式到 GLTF 文件的示例 Java 转换代码。使用此示例代码在任何基于 Web 或桌面 Java 的应用程序中将 GLB 转换为 GLTF。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 将 GLB 转换为 GLTF" h2="在没有任何 3D 建模软件的情况下，使用 Java 库进行 GLB 到 GLTF 的转换。" logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLB" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 将 GLB 转换为 GLTF" %}}

 为了将 GLB 呈现为 GLTF，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 GLB 转换为 GLTF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Java 程序员只需几行代码即可轻松地将 GLB 文件转换为 GLTF。

{{% /blocks/products/pf/agp/text %}}

1. 通过 Scene 类的构造函数加载 GLB 文件1. 使用 GLTF 的格式调用 Scene.save 方法。1. 检查指定路径的结果 GLTF 文件
...
{{% blocks/products/pf/agp/code-block title="GLB 到 GLTF Java 转换源代码" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLB 到 GLTF 转换现场演示" sectionDescription="[将 GLB 转换为 GLTF](https://products.aspose.app/3d/conversion/glb-to-gltf) 立即访问我们的现场演示网站。现场演示具有以下好处" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 无需下载 Aspose API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 无需编写任何代码。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 只需上传您的 GLB 文件，它就会立即转换为 GLTF。" >}}
