...
{{% blocks/products/pf/agp/text %}}
 ...
 Java 程序员只需几行代码就可以轻松地将 USD 文件转换为 DRC。

{{% /blocks/products/pf/agp/text %}}

1. 通过场景类的构造函数加载 USD 文件1. 使用 DRC 的格式调用Scene.save方法。1. 检查指定路径处的结果 DRC 文件
...
{{% blocks/products/pf/agp/code-block title="USD 到 DRC Java 的转换源代码" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="USD 到 DRC 转换实时演示" sectionDescription="[将 USD 转换为 DRC](https://products.aspose.app/3d/conversion/usd-to-drc) 现在通过访问我们的现场演示网站。现场演示有以下好处" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 无需下载 Aspose API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 不需要编写任何代码。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 只需上传您的 USD 文件，它将立即转换为 DRC。" >}}
