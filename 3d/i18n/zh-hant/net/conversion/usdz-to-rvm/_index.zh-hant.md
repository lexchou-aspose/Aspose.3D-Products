...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 USDZ 轉換為 RVM" h2="使用 .NET 框架、 .NET 核心和 Mono 導出 USDZ 和其他 3D 文件" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# 用於 USDZ 到 RVM 轉換的代碼" gistPath="" %}}
```cs
// 加載場景對象中的 USDZ 
