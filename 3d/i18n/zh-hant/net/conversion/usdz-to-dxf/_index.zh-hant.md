---
title: 通過 C# 將 USDZ 轉換為 DXF 
description: 使用 .NET API 轉換 USDZ 和其他 3D 文件
url: /zh-hant/net/conversion/usdz-to-dxf/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 USDZ 轉換為 DXF" h2="使用 .NET Framework、.NET Core 和 Mono 導出 USDZ 和其他 3D 文件" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 C# 將 USDZ 場景導出為 DXF" %}}
...
3. 將帶有 .dxf 擴展名的輸出文件名作為第一個參數傳遞
4. 指定 `DXF` 字段值 [文件格式](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) 班級
...
{{% blocks/products/pf/agp/code-autogen title="C# USDZ 到 DXF 轉換的代碼" gistPath="" %}}
```cs
// 在 Scene 對像中加載 USDZ 
