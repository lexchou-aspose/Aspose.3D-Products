...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 USDZ 轉換為 DRC" h2="使用 .NET 框架、 .NET 核心和 Mono 導出 USDZ 和其他 3D 文件" >}}
...
3.傳遞輸出文件名與drc擴展作為第一個參數
4.從中指定 "Draco」 字段值 [文件格式](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) 類
...
{{% blocks/products/pf/agp/code-autogen title="C# 用於 USDZ 到 DRC 轉換的代碼" gistPath="" %}}
```cs
// 加載場景對象中的 USDZ 
