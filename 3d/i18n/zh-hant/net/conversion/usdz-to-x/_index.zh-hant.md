...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 USDZ 轉換為X" h2="使用 .NET 框架、 .NET 核心和 Mono 導出 USDZ 和其他 3D 文件" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="將 USDZ 場景導出為帶有 C# 的X" %}}
...
3.傳遞輸出文件名與x擴展作為第一個參數
4.從指定 'XBinary' 字段值 [文件格式](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) 類
...
{{% blocks/products/pf/agp/code-autogen title="USDZ 到X轉換的 C# 代碼" gistPath="" %}}
```cs
// 加載場景對象中的 USDZ 
