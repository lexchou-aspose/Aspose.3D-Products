...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 USD 轉換為 3MF" h2="使用 .NET 框架、 .NET 核心和 Mono 導出 USD 和其他 3D 文件" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# 用於 USD 到 3MF 轉換的代碼" gistPath="" %}}
```cs
// 加載場景對象中的 USD 
