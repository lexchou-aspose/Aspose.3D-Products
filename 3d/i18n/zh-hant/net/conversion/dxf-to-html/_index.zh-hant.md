...
description: DXF 到 HTML C# 轉換的示例代碼。 在VB.NET,asp.NET 或任何基於 .NET 的應用程序中使用 API 示例代碼將批處理 DXF 文件轉換為 HTML。
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET 程序員只需幾行代碼就可以輕鬆地將 DXF 文件加載和轉換為 HTML。

{{% /blocks/products/pf/agp/text %}}

1. 通過場景類的構造函數加載 DXF 文件1. 創建HtmlSaveOptions實例1. 為高級轉換設置 HTML 特定屬性1. 調用場景。 保存方法1. 傳遞帶有HtmlSaveOptions的 HTML 文件擴展名和對象的輸出路徑1. 檢查指定路徑處的結果 HTML 文件
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 DXF 到 HTML C# 的轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="免費應用程序將 DXF 轉換為 HTML" sectionDescription="查看我們的實時演示 [DXF 到 HTML 轉換](https://products.aspose.app/3d/conversion/dxf-to-html) 有以下好處。" >}}
