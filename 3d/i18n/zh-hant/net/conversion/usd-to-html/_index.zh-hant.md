---
title: 通過 C# 將 USD 轉換為 HTML 
description: 使用 .NET API 轉換 USD 和其他 3D 文件
url: /zh-hant/net/conversion/usd-to-html/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 USD 轉換為 HTML" h2="使用 .NET 框架、 .NET 核心和 Mono 導出 USD 和其他 3D 文件" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 C# 將 USD 場景導出為 HTML" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# 用於 USD 到 HTML 轉換的代碼" gistPath="" %}}
```cs
// 加載場景對象中的 USD 
