...
{{% blocks/products/pf/agp/feature-section-col title="通過 C# 將 DXF 轉換為 AMF 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 程序員只需幾行代碼就可以輕鬆地將 DXF 文件加載和轉換為 AMF。

{{% /blocks/products/pf/agp/text %}}

1. 通過場景類的構造函數加載 DXF 文件1. 創建AmfSaveOptions實例1. 為高級轉換設置 AMF 特定屬性1. 調用場景。 保存方法1. 傳遞帶有 AMF 文件擴展名的輸出路徑 & AmfSaveOptions的對象1. 檢查指定路徑處的結果 AMF 文件
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 DXF 到 AMF C# 的轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="免費應用程序將 DXF 轉換為 AMF" sectionDescription="查看我們的實時演示 [DXF 到 AMF 轉換](https://products.aspose.app/3d/conversion/dxf-to-amf) 有以下好處。" >}}
