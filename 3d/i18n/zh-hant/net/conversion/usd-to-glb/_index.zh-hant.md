...
description: USD 到 GLB C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 USD 文件批量轉換為 GLB。
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET 程序員只需幾行代碼即可輕鬆加載 USD 文件並將其轉換為 GLB。
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 USD 到 GLB C# 轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="將 USD 轉換為 GLB 的免費應用程序" sectionDescription="查看我們的現場演示 [USD 到 GLB 的轉換](https://products.aspose.app/3d/conversion/usd-to-glb) 具有以下好處。" >}}
