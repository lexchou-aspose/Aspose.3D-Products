...
description: GLB 到 3DS C# 轉換的示例代碼。 在VB.NET,asp.NET 或任何基於 .NET 的應用程序中使用 API 示例代碼將批處理 GLB 文件轉換為 3DS。
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET 程序員只需幾行代碼就可以輕鬆地將 GLB 文件加載和轉換為 3DS。
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 GLB 到 3DS C# 的轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="免費應用程序將 GLB 轉換為 3DS" sectionDescription="查看我們的實時演示 [GLB 到 3DS 轉換](https://products.aspose.app/3d/conversion/glb-to-3ds) 有以下好處。" >}}
