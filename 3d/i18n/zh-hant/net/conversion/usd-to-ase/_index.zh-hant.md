---
title: 通過 C# 將 USD 轉換為 ASE 
description: 使用 .NET API 轉換 USD 和其他 3D 文件
url: /zh-hant/net/conversion/usd-to-ase/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 USD 轉換為 ASE" h2="使用 .NET Framework、.NET Core 和 Mono 導出 USD 和其他 3D 文件" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="使用 C# 將 USD 場景導出為 ASE" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# USD 到 ASE 轉換的代碼" gistPath="" %}}
```cs
// 在 Scene 對像中加載 USD 
