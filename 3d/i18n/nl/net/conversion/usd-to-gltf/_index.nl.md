---
title: USD converteren naar GLTF via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USD converteren naar GLTF via C#" h2="Exporteer USD en andere 3D bestanden met .NET Framework, .NET Core en Mono" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# code voor USD tot GLTF conversie" gistPath="" %}}
```cs
// Laad de USD in een object van Scene 
var scene = new Aspose.ThreeD.Scene("template.usd");
// Bespaar USD als GLTF 
