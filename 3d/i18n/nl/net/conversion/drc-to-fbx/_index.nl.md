...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om DRC te converteren naar FBX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmeurs kunnen gemakkelijk DRC bestanden laden en converteren naar FBX in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad DRC bestand via de constructor van Scene klasse1. Maak een instantie van AmfSaveOptions1. Stel FBX specifieke eigenschappen in voor geavanceerde conversie1. Roep de Scene.Save-methode aan1. Geef het uitvoerpad door met FBX bestandsextensie & object van FbxSaveOptions1. Controleer het resulterende FBX-bestand op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont DRC naar FBX C# Conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om DRC naar FBX te converteren" sectionDescription="Check onze live demo\'s voor [DRC naar FBX conversie](https://products.aspose.app/3d/conversion/drc-to-fbx) met volgende voordelen." >}}
