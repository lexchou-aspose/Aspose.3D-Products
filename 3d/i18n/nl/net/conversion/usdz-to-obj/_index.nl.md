---
title: Converteer USDZ naar OBJ via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converteer USDZ naar OBJ via C#" h2="Exporteer USDZ en andere 3D bestanden met .NET Framework, .NET Core en Mono" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code voor USDZ naar OBJ conversie" gistPath="" %}}
```cs
