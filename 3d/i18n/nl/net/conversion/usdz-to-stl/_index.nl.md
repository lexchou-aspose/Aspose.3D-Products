---
title: USDZ converteren naar STL via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USDZ converteren naar STL via C#" h2="Exporteer USDZ en andere 3D bestanden met .NET Framework, .NET Core en Mono" >}}
...
3. Pass output bestandsnaam met. Stl extensie als eerste parameter
4. Geef de veldwaarde 'STLASCII' op vanaf [Bestandformaat](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Klasse
...
{{% blocks/products/pf/agp/code-autogen title="C# code voor USDZ tot STL conversie" gistPath="" %}}
```cs
// Laad de USDZ in een object van Scene 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// Bespaar USDZ als STL 
