---
title: USDZ converteren naar JT via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USDZ converteren naar JT via C#" h2="Exporteer USDZ en andere 3D bestanden met .NET Framework, .NET Core en Mono" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# code voor USDZ tot JT conversie" gistPath="" %}}
```cs
