...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om 3MF om te zetten naar PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmeurs kunnen 3MF bestanden gemakkelijk laden en converteren naar PDF in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad 3MF bestand via de constructor van de Scene-klasse1. Maak een instantie van PdfSaveOptions1. Stel PDF specifieke eigenschappen in voor geavanceerde conversie1. Roep de scène op. De methode opslaan1. Geef het uitvoerpad door met PDF bestandsextensie en object van PdfSaveOptions1. Controleer het resulterende PDF-bestand op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont de 3MF tot PDF C# conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om 3MF om te zetten naar PDF" sectionDescription="Bekijk onze live demo\'s voor [Conversie van 3MF naar PDF](https://products.aspose.app/3d/conversion/3mf-to-pdf) Met de volgende voordelen." >}}
