---
title: USD converteren naar DAE via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USD converteren naar DAE via C#" h2="Exporteer USD en andere 3D bestanden met .NET Framework, .NET Core en Mono" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# code voor USD tot DAE conversie" gistPath="" %}}
```cs
