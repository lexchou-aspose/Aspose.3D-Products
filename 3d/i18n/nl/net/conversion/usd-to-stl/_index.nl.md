---
title: USD converteren naar STL via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USD converteren naar STL via C#" h2="Exporteer USD en andere 3D bestanden met .NET Framework, .NET Core en Mono" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# code voor USD tot STL conversie" gistPath="" %}}
```cs
