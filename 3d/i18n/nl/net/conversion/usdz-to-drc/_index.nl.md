---
title: Converteer USDZ naar DRC via C# 
description: Converteer USDZ en andere 3D bestanden met .NET API
url: /nl/net/conversion/usdz-to-drc/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converteer USDZ naar DRC via C#" h2="Exporteer USDZ en andere 3D bestanden met .NET Framework, .NET Core en Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exporteer USDZ Scene als DRC met C#" %}}
...
3. Geef de naam van het uitvoerbestand door met de extensie .drc als eerste parameter
4. Geef veldwaarde 'Draco' op van [Bestandsformaat](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) klas
...
{{% blocks/products/pf/agp/code-autogen title="C# Code voor USDZ naar DRC conversie" gistPath="" %}}
```cs
// laad de USDZ in een object van Scene 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// sla USDZ op als een DRC 
