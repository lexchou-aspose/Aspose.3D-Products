---
title: Converteer USD naar PDF via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converteer USD naar PDF via C#" h2="Exporteer USD en andere 3D bestanden met .NET Framework, .NET Core en Mono" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code voor USD naar PDF conversie" gistPath="" %}}
```cs
// laad de USD in een object van Scene 
var scene = new Aspose.ThreeD.Scene("template.usd");
// sla USD op als een PDF 
