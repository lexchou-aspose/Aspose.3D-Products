---
title: USDZ converteren naar DXF via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USDZ converteren naar DXF via C#" h2="Exporteer USDZ en andere 3D bestanden met .NET Framework, .NET Core en Mono" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# code voor USDZ tot DXF conversie" gistPath="" %}}
```cs
// Laad de USDZ in een object van Scene 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// Bespaar USDZ als DXF 
