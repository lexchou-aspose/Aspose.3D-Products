---
title: Bekijk ASE Bestandsindelingen via .NET 
weight: 1060
url: /nl/net/viewer/ase/ 
description: C# broncode voor het laden, weergeven en weergeven van ASE documenten op .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ASE Bestandsviewer for .NET" h2="Render ASE bestanden zonder enige 3D modellerings- en renderingsoftware." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ASE" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ASE" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe ASE-bestand te bekijken met C#" %}}
 ...
 Om het ASE-bestand te bekijken, gebruiken we
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D maakt het de ontwikkelaars gemakkelijk om het ASE-bestand te bekijken met slechts enkele regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad ASE bestand via de constructor van Scene klasse1. Maak een instantie van Html5SaveOptions1. Eigenschappen instellen voor geavanceerde opmaak1. Roep de Scene.Save-methode aan met het object van Html5SaveOptions1. Controleer het resulterende HTML-bestand in de standaardbrowser
...
{{% blocks/products/pf/agp/code-block title="C# code om te bekijken ASE" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// laad ASE scene via een instantie van Scene
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D is een CAD en Gameware API om 3D-bestanden te laden, aan te passen en te converteren. API is een standalone en vereist geen 3D-modellerings- of renderingsoftware. Men kan gemakkelijk API gebruiken voor Discreet3DS, WavefrontOBJ, STL (ASCII, Binair), Universal3D, FBX (ASCII, Binair), Collada, glTF, PLY, GLB, DirectX en meer formaten. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om te bekijken ASE" sectionDescription="Bekijk onze live demo\'s om [Bekijk ASE](https://products.aspose.app/3d/viewer/ase) met volgende voordelen." >}}
