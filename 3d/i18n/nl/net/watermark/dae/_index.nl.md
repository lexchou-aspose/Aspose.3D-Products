---
title: Voeg een blind watermerk toe aan DAE bestandsindelingen via .NET 
weight: 830
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D maakt het voor de ontwikkelaars gemakkelijk om blind watermerk toe te voegen aan het DAE-bestand met slechts enkele regels code.

{{% /blocks/products/pf/agp/text %}}

- Laad DAE bestand via de constructor van de Scene-klasse- Krijg de mesh-klasse van Aspose.3D- Voeg watermerk en wachtwoord toe met de EncodeWatermark-methode van Aspose.3D- Roep de scène op. De methode opslaan met het object
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om blind watermerk toe te voegen aan DAE" sectionDescription="Bekijk onze live demo\'s naar [Watermerk DAE](https://products.aspose.app/3d/watermark/dae) Met de volgende voordelen." >}}
