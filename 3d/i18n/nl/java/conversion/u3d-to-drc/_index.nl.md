---
title: Converteer U3D naar DRC via Java 
url: /nl/java/conversion/u3d-to-drc/ 
description: Voorbeeld Java conversiecode voor U3D formaat naar DRC bestand. Gebruik deze voorbeeldcode om U3D naar DRC te converteren binnen elke web- of desktoptoepassing op Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer U3D naar DRC via Java" h2="U3D naar DRC conversie met behulp van Java bibliotheek zonder enige 3D modelleringssoftware." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="U3D" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u U3D naar DRC converteert met Java" %}}

 Om U3D weer te geven tot DRC, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om U3D te converteren naar DRC via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmeurs kunnen eenvoudig U3D bestanden converteren naar DRC in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad U3D bestand via de constructor van Scene klasse1. Maak een exemplaar van DrcSaveOptions1. Stel DRC specifieke eigenschappen in voor geavanceerde conversie1. Call Scene.save methode1. Geef het uitvoerpad door met DRC bestandsextensie & object van DrcSaveOptions
...
{{% blocks/products/pf/agp/code-block title="U3D naar DRC Java Conversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="U3D naar DRC conversie live demo\'s" sectionDescription="[Converteer U3D naar DRC](https://products.aspose.app/3d/conversion/u3d-to-drc) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw U3D-bestand, het wordt onmiddellijk geconverteerd naar DRC." >}}
