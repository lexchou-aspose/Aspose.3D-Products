---
title: Converteer STL naar GLTF via Java 
weight: 1560
url: /nl/java/conversion/stl-to-gltf/ 
description: Voorbeeld Java conversiecode voor STL formaat naar GLTF bestand. Gebruik deze voorbeeldcode om STL naar GLTF te converteren binnen elke web- of desktoptoepassing op Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer STL naar GLTF via Java" h2="STL naar GLTF conversie met behulp van Java bibliotheek zonder enige 3D modelleringssoftware." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u STL naar GLTF converteert met Java" %}}

 Om STL weer te geven tot GLTF, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om STL te converteren naar GLTF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmeurs kunnen eenvoudig STL bestanden converteren naar GLTF in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad STL bestand via de constructor van Scene klasse1. Maak een instantie van GltfSaveOptions1. Stel GLTF specifieke eigenschappen in voor geavanceerde conversie1. Call Scene.save methode1. Geef het uitvoerpad door met GLTF bestandsextensie & object van GltfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="STL naar GLTF Java Conversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="STL naar GLTF conversie live demo\'s" sectionDescription="[Converteer STL naar GLTF](https://products.aspose.app/3d/conversion/stl-to-gltf) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw STL-bestand, het wordt onmiddellijk geconverteerd naar GLTF." >}}
