---
title: GLB converteren naar GLTF via Java
weight: 530
url: /nl/java/conversion/glb-to-gltf/ 
description: Voorbeeld van Java conversiecode voor GLB formaat naar GLTF bestand. Gebruik deze voorbeeldcode om GLB naar GLTF te converteren binnen elke applicatie op het web of Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="GLB converteren naar GLTF via Java" h2="GLB tot GLTF conversie met behulp van Java bibliotheek zonder 3D modelleringssoftware." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLB" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe GLB naar GLTF te converteren met Java" %}}

 Als u GLB wilt renderen naar GLTF, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om GLB om te zetten naar GLTF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmeurs kunnen eenvoudig GLB bestand converteren naar GLTF in slechts enkele regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad GLB bestand via de constructor van de Scene-klasse1. Roep de methode Scene.save op met het formaat van GLTF.1. Controleer het resulterende GLTF-bestand op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="GLB tot GLTF Java conversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLB tot GLTF live-demo\'s voor conversie" sectionDescription="[GLB converteren naar GLTF](https://products.aspose.app/3d/conversion/glb-to-gltf) Nu door onze Live Demos-website te bezoeken. De live demo heeft de volgende voordelen" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw GLB bestand, het wordt direct geconverteerd naar GLTF." >}}
