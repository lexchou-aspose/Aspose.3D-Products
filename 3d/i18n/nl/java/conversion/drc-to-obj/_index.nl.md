---
title: DRC converteren naar OBJ via Java 
url: /nl/java/conversion/drc-to-obj/ 
description: Voorbeeld van Java conversiecode voor DRC formaat naar OBJ bestand. Gebruik deze voorbeeldcode om DRC naar OBJ te converteren binnen elke applicatie op het web of Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="DRC converteren naar OBJ via Java" h2="DRC tot OBJ conversie met behulp van Java bibliotheek zonder 3D modelleringssoftware." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe DRC naar OBJ te converteren met Java" %}}

 Als u DRC wilt renderen naar OBJ, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om DRC om te zetten naar OBJ via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmeurs kunnen eenvoudig DRC bestand converteren naar OBJ in slechts enkele regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad DRC bestand via de constructor van de Scene-klasse1. Maak een instantie van ObjSaveOptions1. Stel OBJ specifieke eigenschappen in voor geavanceerde conversie1. Call Scene. opslagmethode1. Geef het uitvoerpad door met OBJ bestandsextensie en object van ObjSaveOptions
...
{{% blocks/products/pf/agp/code-block title="DRC tot OBJ Java conversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC tot OBJ live-demo\'s voor conversie" sectionDescription="[DRC converteren naar OBJ](https://products.aspose.app/3d/conversion/drc-to-obj) Nu door onze Live Demos-website te bezoeken. De live demo heeft de volgende voordelen" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw DRC bestand, het wordt direct geconverteerd naar OBJ." >}}
