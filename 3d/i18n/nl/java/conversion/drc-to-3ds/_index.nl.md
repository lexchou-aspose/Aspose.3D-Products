---
title: Converteer DRC naar 3DS via Java 
url: /nl/java/conversion/drc-to-3ds/ 
description: Voorbeeld Java conversiecode voor DRC formaat naar 3DS bestand. Gebruik deze voorbeeldcode om DRC naar 3DS te converteren binnen elke web- of desktoptoepassing op Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer DRC naar 3DS via Java" h2="DRC naar 3DS conversie met behulp van Java bibliotheek zonder enige 3D modelleringssoftware." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u DRC naar 3DS converteert met Java" %}}

 Om DRC weer te geven tot 3DS, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om DRC te converteren naar 3DS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmeurs kunnen eenvoudig DRC bestanden converteren naar 3DS in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad DRC bestand via de constructor van Scene klasse1. Maak een instantie van Discreet3dsSaveOptions1. Stel 3DS specifieke eigenschappen in voor geavanceerde conversie1. Call Scene.save methode1. Geef het uitvoerpad door met 3DS bestandsextensie & object van Discreet3dsSaveOptions
...
{{% blocks/products/pf/agp/code-block title="DRC naar 3DS Java Conversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC naar 3DS conversie live demo\'s" sectionDescription="[Converteer DRC naar 3DS](https://products.aspose.app/3d/conversion/drc-to-3ds) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw DRC-bestand, het wordt onmiddellijk geconverteerd naar 3DS." >}}
