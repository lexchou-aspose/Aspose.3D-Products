---
title: STL converteren naar FBX via Java 
weight: 1450
url: /nl/java/conversion/stl-to-fbx/ 
description: Voorbeeld van Java conversiecode voor STL formaat naar FBX bestand. Gebruik deze voorbeeldcode om STL naar FBX te converteren binnen elke applicatie op het web of Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="STL converteren naar FBX via Java" h2="STL tot FBX conversie met behulp van Java bibliotheek zonder 3D modelleringssoftware." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe STL naar FBX te converteren met Java" %}}

 Als u STL wilt renderen naar FBX, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om STL om te zetten naar FBX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmeurs kunnen eenvoudig STL bestand converteren naar FBX in slechts enkele regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad STL bestand via de constructor van de Scene-klasse1. Maak een instantie van FbxSaveOptions1. Stel FBX specifieke eigenschappen in voor geavanceerde conversie1. Call Scene. opslagmethode1. Geef het uitvoerpad door met FBX bestandsextensie en object van FbxSaveOptions
...
{{% blocks/products/pf/agp/code-block title="STL tot FBX Java conversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="STL tot FBX live-demo\'s voor conversie" sectionDescription="[STL converteren naar FBX](https://products.aspose.app/3d/conversion/stl-to-fbx) Nu door onze Live Demos-website te bezoeken. De live demo heeft de volgende voordelen" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw STL bestand, het wordt direct geconverteerd naar FBX." >}}
