---
title: Converteer PDF naar PLY via Java 
url: /nl/java/conversion/pdf-to-ply/ 
description: Voorbeeld Java conversiecode voor PDF formaat naar PLY bestand. Gebruik deze voorbeeldcode om PDF naar PLY te converteren binnen elke web- of desktoptoepassing op Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PDF naar PLY via Java" h2="PDF naar PLY conversie met behulp van Java bibliotheek zonder enige 3D modelleringssoftware." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u PDF naar PLY converteert met Java" %}}

 Om PDF weer te geven tot PLY, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om PDF te converteren naar PLY via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmeurs kunnen eenvoudig PDF bestanden converteren naar PLY in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad PDF bestand via de constructor van Scene klasse1. Maak een instantie van PlySaveOptions1. Stel PLY specifieke eigenschappen in voor geavanceerde conversie1. Call Scene.save methode1. Geef het uitvoerpad door met PLY bestandsextensie & object van PlySaveOptions
...
{{% blocks/products/pf/agp/code-block title="PDF naar PLY Java Conversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PDF naar PLY conversie live demo\'s" sectionDescription="[Converteer PDF naar PLY](https://products.aspose.app/3d/conversion/pdf-to-ply) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw PDF-bestand, het wordt onmiddellijk geconverteerd naar PLY." >}}
