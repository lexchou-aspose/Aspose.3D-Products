---
title: Converteer PLY naar U3D via Java 
weight: 680
url: /nl/java/conversion/ply-to-u3d/ 
description: Voorbeeld Java conversiecode voor PLY formaat naar U3D bestand. Gebruik deze voorbeeldcode om PLY naar U3D te converteren binnen elke web- of desktoptoepassing op Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PLY naar U3D via Java" h2="PLY naar U3D conversie met behulp van Java bibliotheek zonder enige 3D modelleringssoftware." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PLY" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u PLY naar U3D converteert met Java" %}}

 Om PLY weer te geven tot U3D, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om PLY te converteren naar U3D via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmeurs kunnen eenvoudig PLY bestanden converteren naar U3D in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad PLY bestand via de constructor van Scene klasse1. Maak een instantie van U3dSaveOptions1. Stel U3D specifieke eigenschappen in voor geavanceerde conversie1. Call Scene.save methode1. Geef het uitvoerpad door met U3D bestandsextensie & object van U3dSaveOptions
...
{{% blocks/products/pf/agp/code-block title="PLY naar U3D Java Conversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PLY naar U3D conversie live demo\'s" sectionDescription="[Converteer PLY naar U3D](https://products.aspose.app/3d/conversion/ply-to-u3d) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw PLY-bestand, het wordt onmiddellijk geconverteerd naar U3D." >}}
