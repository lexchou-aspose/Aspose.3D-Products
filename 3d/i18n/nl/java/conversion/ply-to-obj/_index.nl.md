---
title: Converteer PLY naar OBJ via Java 
weight: 880
url: /nl/java/conversion/ply-to-obj/ 
description: Voorbeeld Java conversiecode voor PLY formaat naar OBJ bestand. Gebruik deze voorbeeldcode om PLY naar OBJ te converteren binnen elke web- of desktoptoepassing op Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PLY naar OBJ via Java" h2="PLY naar OBJ conversie met behulp van Java bibliotheek zonder enige 3D modelleringssoftware." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PLY" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u PLY naar OBJ converteert met Java" %}}

 Om PLY weer te geven tot OBJ, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om PLY te converteren naar OBJ via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmeurs kunnen eenvoudig PLY bestanden converteren naar OBJ in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad PLY bestand via de constructor van Scene klasse1. Maak een instantie van ObjSaveOptions1. Stel OBJ specifieke eigenschappen in voor geavanceerde conversie1. Call Scene.save methode1. Geef het uitvoerpad door met OBJ bestandsextensie & object van ObjSaveOptions
...
{{% blocks/products/pf/agp/code-block title="PLY naar OBJ Java Conversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PLY naar OBJ conversie live demo\'s" sectionDescription="[Converteer PLY naar OBJ](https://products.aspose.app/3d/conversion/ply-to-obj) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw PLY-bestand, het wordt onmiddellijk geconverteerd naar OBJ." >}}
