---
title: Convertire da USD a GLTF tramite C# 
description: Convertire USD e altri 3D file utilizzando .NET API
url: /it/net/conversion/usd-to-gltf/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertire da USD a GLTF tramite C#" h2="Esporta USD e altri 3D file utilizzando .NET Framework, .NET Core e Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Esporta USD scena come GLTF con C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# codice per la conversione da USD a GLTF" gistPath="" %}}
```cs
