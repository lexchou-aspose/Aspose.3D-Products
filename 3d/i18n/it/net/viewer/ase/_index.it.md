---
title: Visualizza ASE formati file tramite .NET 
weight: 1060
url: /it/net/viewer/ase/ 
description: C# codice sorgente da caricare, rendere e visualizzare ASE documenti su .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ASE Visualizzatore file for .NET" h2="Rendera ASE file senza 3D software di modellazione e rendering." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ASE" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ASE" >}}
...
{{% blocks/products/pf/agp/content h2="Come visualizzare ASE file utilizzando C#" %}}
 ...
 Per visualizzare il file ASE, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passi per visualizzare ASE tramite C#" %}}
...
1. Carica ASE file tramite il costruttore della classe Scene1. Creare un'istanza di Html5SaveOptions1. Imposta proprietà per la formattazione avanzata1. Chiama il metodo Scene.Save con l'oggetto di Html5SaveOptions1. Controlla il file HTML risultante nel browser predefinito
...
// Carica ASE scena tramite un'istanza di scena
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D è un CAD e Gameware API per caricare, modificare e convertire 3D file. API è autonomo e non richiede alcun software di modellazione o rendering da 3D. Si possono usare facilmente API per Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX e altri formati. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per visualizzare ASE" sectionDescription="Controlla le nostre demo live per [Visualizza ASE](https://products.aspose.app/3d/viewer/ase) Con i seguenti vantaggi." >}}
