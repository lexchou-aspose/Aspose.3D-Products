---
title: Visualizza formati file X tramite .NET 
weight: 2050
url: /it/net/viewer/x/ 
description: C# codice sorgente per caricare, rendere e visualizzare documenti X su .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="X Visualizzatore file for .NET" h2="Renderizzare i file X senza alcun software di modellazione e rendering 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="X" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="X" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passi per visualizzare X tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D rende facile per gli sviluppatori di visualizzare il file X con poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file X tramite il costruttore della classe Scene1. Creare un'istanza di Html5SaveOptions1. Imposta proprietà per la formattazione avanzata1. Chiama il metodo Scene.Save con l'oggetto di Html5SaveOptions1. Controlla il file HTML risultante nel browser predefinito
...
// Caricare la scena X tramite un'istanza di scena
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D è un CAD e Gameware API per caricare, modificare e convertire 3D file. API è autonomo e non richiede alcun software di modellazione o rendering da 3D. Si possono usare facilmente API per Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX e altri formati. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per visualizzare X" sectionDescription="Controlla le nostre demo live per [Visualizza X](https://products.aspose.app/3d/viewer/x) Con i seguenti vantaggi." >}}
