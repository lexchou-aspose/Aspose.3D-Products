...
{{% blocks/products/pf/agp/feature-section-col title="Passi per aggiungere la filigrana cieca a AMF tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D consente agli sviluppatori di aggiungere facilmente la filigrana cieca al file AMF con poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

- Carica AMF file tramite il costruttore della classe Scene- Ottieni la classe mesh di Aspose.3D- Aggiungi filigrana e password utilizzando il metodo EncodeWatermark di Aspose.3D- Chiama il metodo Scene.Save con l'oggetto
...
{{% blocks/products/pf/agp/code-block title="C# codice per aggiungere la filigrana cieca a AMF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per aggiungere la filigrana cieca a AMF" sectionDescription="Controlla le nostre demo live per [Filigrana AMF](https://products.aspose.app/3d/watermark/amf) Con i seguenti vantaggi." >}}
