---
title: Aggiungi filigrana cieca a DAE formati di file tramite .NET 
weight: 830
url: /it/net/watermark/dae/ 
description: C# codice sorgente per caricare, eseguire il rendering e aggiungere filigrana cieca a DAE documenti su .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Aggiungi filigrana cieca a DAE tramite C#" h2="Crea le tue .NET app per filigranare i file DAE utilizzando le API lato server." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Come filigranare su DAE file utilizzando C#" %}}

 Per filigranare il file DAE, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per aggiungere una filigrana cieca a DAE tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D consente agli sviluppatori di aggiungere facilmente una filigrana cieca al file DAE con poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

- Carica il file DAE tramite il costruttore della classe Scene- Ottieni la classe mesh di Aspose.3D- Aggiungi filigrana e password utilizzando il metodo EncodeWatermark di Aspose.3D- Chiama il metodo Scene.Save con l'oggetto
...
{{% blocks/products/pf/agp/code-block title="C# codice per aggiungere una filigrana cieca a DAE" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per aggiungere filigrana cieca a DAE" sectionDescription="Controlla le nostre demo dal vivo su [Filigrana DAE](https://products.aspose.app/3d/watermark/dae) con i seguenti vantaggi." >}}
