---
title: 3DS Dosya Formatlarını .NET aracılığıyla görüntüleyin 
weight: 830
url: /tr/net/viewer/3ds/ 
description: .NET Framework, .NET Core, 3DS 'de 3DS belgelerini yüklemek, işlemek ve görüntülemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="3DS Dosya Görüntüleyici for .NET" h2="3DS dosyalarını herhangi bir 3D modelleme ve oluşturma yazılımı olmadan oluşturma." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="3DS Kullanarak 3DS Dosya Nasıl Görüntüleme" %}}

 3DS dosyasını görüntülemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# üzerinden 3DS Görüntüleme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D, geliştiricilerin 3DS dosyasını sadece birkaç satır kodla görüntülemesini kolaylaştırır.

{{% /blocks/products/pf/agp/text %}}

1. Scene sınıfının kurucusu aracılığıyla 3DS dosyasını yükle1. Html5SaveOptions örneğini oluşturun1. Gelişmiş biçimlendirme için set özellikleri1. Sahneyi arayın. Html5SaveOptions nesnesi ile yöntemi kaydedin1. Sonuç olarak HTML dosyasını varsayılan tarayıcıda kontrol edin
...
{{% blocks/products/pf/agp/code-block title="C# görüntülemek için kod 3DS" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// Bir sahne örneği aracılığıyla 3DS sahneyi yükleyin
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D, 3D dosyalarını yüklemek, değiştirmek ve dönüştürmek için CAD ve Gameware API 'dir. API bir bağımsız ve herhangi bir 3D modelleme veya oluşturma yazılımı gerektirmez. Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX ve daha fazla format. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ücretsiz Uygulama 3DS" sectionDescription="Canlı demolarımızı kontrol edin [Görüntüle 3DS](https://products.aspose.app/3d/viewer/3ds) Aşağıdaki faydaları ile." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece 3DS dosyasını yükleyin ve \"Görüntüle\" düğmesine basın" >}}
