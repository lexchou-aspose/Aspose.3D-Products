---
title: STL 'i C# ile DAE 'ye dönüştürün 
weight: 2040
url: /tr/net/conversion/stl-to-dae/ 
description: STL ila DAE C# dönüşümü için örnek kod. .NET, Asp.NET veya herhangi bir .NET tabanlı uygulamada DAE dönüşümüne kadar toplu STL dosyaları için API örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="STL \'i C# ile DAE \'ye dönüştürün" h2="STL, herhangi bir 3D modelleme ve oluşturma yazılımı olmadan DAE olarak kullanın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="C# Kullanarak STL \'i DAE \'e Nasıl Dönüştürebilirsiniz?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# üzerinden STL ile DAE \'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programcılar, STL dosyalarını sadece birkaç satır kodla DAE 'ye kolayca yükleyebilir ve dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Scene sınıfının kurucusu aracılığıyla STL dosyasını yükle1. DaeSaveOptions örneğini oluşturun1. Gelişmiş dönüşüm için DAE özel özellikler ayarlayın1. Sahneyi arayın. Kaydet yöntemi1. DAE dosya uzantısı ve DaeSaveOptions nesnesi ile çıktı yolunu geçin1. Belirtilen yolda ortaya çıkan DAE dosyasını kontrol edin
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod STL ila DAE C# Dönüşümü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="STL \'i DAE \'e Dönüştürmek için Ücretsiz Uygulama" sectionDescription="Canlı demolarımızı kontrol edin [STL ila DAE dönüşüm](https://products.aspose.app/3d/conversion/stl-to-dae) Aşağıdaki faydaları ile." >}}
