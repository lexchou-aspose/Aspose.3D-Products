---
title: OBJ 'i C# ile PLY 'ye dönüştürün 
weight: 650
url: /tr/net/conversion/obj-to-ply/ 
description: OBJ ila PLY C# dönüşümü için örnek kod. .NET, Asp.NET veya herhangi bir .NET tabanlı uygulamada PLY dönüşümüne kadar toplu OBJ dosyaları için API örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="OBJ \'i C# ile PLY \'ye dönüştürün" h2="OBJ, herhangi bir 3D modelleme ve oluşturma yazılımı olmadan PLY olarak kullanın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="C# Kullanarak OBJ \'i PLY \'e Nasıl Dönüştürebilirsiniz?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# üzerinden OBJ ile PLY \'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programcılar, OBJ dosyalarını sadece birkaç satır kodla PLY 'ye kolayca yükleyebilir ve dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Scene sınıfının kurucusu aracılığıyla OBJ dosyasını yükle1. PlySaveOptions örneğini oluşturma1. Gelişmiş dönüşüm için PLY özel özellikler ayarlayın1. Sahneyi arayın. Kaydet yöntemi1. PLY dosya uzantısı ve PlySaveOptions nesnesi ile çıktı yolunu geçin1. Belirtilen yolda ortaya çıkan PLY dosyasını kontrol edin
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod OBJ ila PLY C# Dönüşümü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="OBJ \'i PLY \'e Dönüştürmek için Ücretsiz Uygulama" sectionDescription="Canlı demolarımızı kontrol edin [OBJ ila PLY dönüşüm](https://products.aspose.app/3d/conversion/obj-to-ply) Aşağıdaki faydaları ile." >}}
