---
title: C# aracılığıyla USDZ'i STL'ye dönüştürün 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# aracılığıyla USDZ\'i STL\'ye dönüştürün" h2=".NET Framework, .NET Core ve Mono kullanarak USDZ ve diğer 3D dosyalarını dışa aktarın" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="C# ile USDZ Sahneyi STL olarak dışa aktar" %}}
...
{{% blocks/products/pf/agp/code-autogen title="USDZ - STL Dönüşümü için C# Kodu" gistPath="" %}}
```cs
// USDZ öğesini bir Sahne nesnesine yükleyin 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// USDZ'i STL olarak kaydet 
