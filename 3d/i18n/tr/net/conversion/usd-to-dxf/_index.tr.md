---
title: USD 'i C# ile DXF 'ye dönüştürün 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USD \'i C# ile DXF \'ye dönüştürün" h2=".NET Framework, .NET Core ve Mono kullanarak USD ve diğer 3D dosyalarını dışa aktar" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USD Sahneyi DXF olarak C# olarak dışa aktar" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# USD ila DXF Dönüşüm için kod" gistPath="" %}}
```cs
// Bir sahne nesnesine USD yükleyin 
var scene = new Aspose.ThreeD.Scene("template.usd");
// USD 'i DXF olarak kaydedin 
