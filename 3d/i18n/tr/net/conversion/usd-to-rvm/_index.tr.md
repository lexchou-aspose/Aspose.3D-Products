---
title: USD 'i C# ile RVM 'ye dönüştürün 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USD \'i C# ile RVM \'ye dönüştürün" h2=".NET Framework, .NET Core ve Mono kullanarak USD ve diğer 3D dosyalarını dışa aktar" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USD Sahneyi RVM olarak C# olarak dışa aktar" %}}
...
3. Pass çıkış dosya adı ile. İlk parametre olarak rvm uzantısı
4. 'RvmBinary' alan değerini belirtin [FileFormat](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Sınıf
...
{{% blocks/products/pf/agp/code-autogen title="C# USD ila RVM Dönüşüm için kod" gistPath="" %}}
```cs
// Bir sahne nesnesine USD yükleyin 
var scene = new Aspose.ThreeD.Scene("template.usd");
// USD 'i RVM olarak kaydedin 
