---
title: USDZ 'i C# ile HTML 'ye dönüştürün 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USDZ \'i C# ile HTML \'ye dönüştürün" h2=".NET Framework, .NET Core ve Mono kullanarak USDZ ve diğer 3D dosyalarını dışa aktar" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USDZ Sahneyi HTML olarak C# olarak dışa aktar" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# USDZ ila HTML Dönüşüm için kod" gistPath="" %}}
```cs
// Bir sahne nesnesine USDZ yükleyin 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// USDZ 'i HTML olarak kaydedin 
