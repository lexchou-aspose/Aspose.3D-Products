---
title: .NET aracılığıyla GLTF Dosya Biçimlerine Kör Filigran Ekleme 
weight: 830
url: /tr/net/watermark/gltf/ 
description: .NET Framework, .NET Core, Mono üzerindeki GLTF belgelerine yüklemek, oluşturmak ve kör filigran eklemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla GLTF öğesine Kör Filigran Ekle" h2="Sunucu tarafı API\'lerini kullanarak GLTF dosyalarına filigran eklemek için kendi .NET uygulamalarınızı oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="C# Kullanarak GLTF Dosyaya Filigran Etme" %}}

 GLTF dosyasına filigran eklemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla GLTF öğesine Kör Filigran Ekleme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D, geliştiricilerin yalnızca birkaç satır kodla GLTF dosyasına kör filigran eklemesini kolaylaştırır.

{{% /blocks/products/pf/agp/text %}}

- GLTF dosyasını Scene sınıfının yapıcısı aracılığıyla yükleyin- Aspose.3D ağ sınıfını alın- Aspose.3D'in EncodeWatermark yöntemini kullanarak filigran ve şifre ekleyin- Nesne ile Scene.Save yöntemini çağırın
...
{{% blocks/products/pf/agp/code-block title="GLTF öğesine Kör Filigran Eklemek için C# kodu" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLTF Öğesine Kör Filigran Eklemek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [filigran GLTF](https://products.aspose.app/3d/watermark/gltf) aşağıdaki faydaları ile." >}}
