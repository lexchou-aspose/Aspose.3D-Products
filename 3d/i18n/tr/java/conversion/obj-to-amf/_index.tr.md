---
title: OBJ 'i Java ile AMF 'ye dönüştürün 
weight: 3450
url: /tr/java/conversion/obj-to-amf/ 
description: OBJ biçimi için AMF dosyası için Java dönüşüm kodunu örnekleyin. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada OBJ 'i AMF 'e dönüştürmek için bu örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="OBJ \'i Java ile AMF \'ye dönüştürün" h2="Herhangi bir 3D modelleme yazılımı olmadan Java kitaplığı kullanarak OBJ ila AMF dönüşüm." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="AMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak OBJ \'i AMF \'e Nasıl Dönüştürebilirsiniz?" %}}

 OBJ ile AMF arasında işlemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden OBJ ile AMF \'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java programcılar, OBJ dosyasını sadece birkaç satır kodla AMF 'ye kolayca dönüştürebilirler.

{{% /blocks/products/pf/agp/text %}}

1. Scene sınıfının kurucusu aracılığıyla OBJ dosyasını yükle1. AmfSaveOptions örneğini oluşturun1. Gelişmiş dönüşüm için AMF özel özellikler ayarlayın1. Call Scene.save yöntemi arayın1. Çıkış yolunu AMF dosya uzantısı ve AmfSaveOptions nesnesi ile geçin
...
{{% blocks/products/pf/agp/code-block title="OBJ ila AMF Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="OBJ-AMF Dönüşüm Canlı Demoları" sectionDescription="[OBJ \'i AMF \'ye dönüştürün](https://products.aspose.app/3d/conversion/obj-to-amf) Şu anda Canlı Demos web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece OBJ dosyanızı yükleyin, anında AMF \'ye dönüştürülecektir." >}}
