---
title: Java aracılığıyla DRC'i GLTF'ye dönüştürün 
url: /tr/java/conversion/drc-to-gltf/ 
description: DRC biçimi için GLTF dosyasına örnek Java dönüştürme kodu. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada DRC'ü GLTF'e dönüştürmek için bu örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla DRC\'i GLTF\'ye dönüştürün" h2="Herhangi bir 3D modelleme yazılımı olmadan Java kitaplığını kullanarak DRC - GLTF dönüştürme." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak DRC, GLTF\'ye Nasıl Dönüştürülür" %}}

 DRC'i GLTF olarak oluşturmak için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla DRC\'i GLTF\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java programcıları, yalnızca birkaç satır kodla DRC dosyasını GLTF'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. DRC dosyasını Scene sınıfının yapıcısı aracılığıyla yükleyin1. Bir GltfSaveOptions örneği oluşturun1. Gelişmiş dönüştürme için GLTF belirli özelliği ayarlayın1. Scene.save yöntemini çağırın1. Çıktı yolunu GLTF dosya uzantısı ve GltfSaveOptions nesnesi ile iletin
...
{{% blocks/products/pf/agp/code-block title="DRC - GLTF Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC - GLTF Dönüşüm Canlı Demoları" sectionDescription="[DRC\'i GLTF\'ye dönüştür](https://products.aspose.app/3d/conversion/drc-to-gltf) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece DRC dosyanızı yükleyin, anında GLTF dosyasına dönüştürülecektir." >}}
