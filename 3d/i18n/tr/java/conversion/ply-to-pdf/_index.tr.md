---
title: PLY 'i Java ile PDF 'ye dönüştürün 
url: /tr/java/conversion/ply-to-pdf/ 
description: PLY biçimi için PDF dosyası için Java dönüşüm kodunu örnekleyin. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada PLY 'i PDF 'e dönüştürmek için bu örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="PLY \'i Java ile PDF \'ye dönüştürün" h2="Herhangi bir 3D modelleme yazılımı olmadan Java kitaplığı kullanarak PLY ila PDF dönüşüm." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PLY" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PLY \'i PDF \'e Nasıl Dönüştürebilirsiniz?" %}}

 PLY ile PDF arasında işlemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden PLY ile PDF \'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java programcılar, PLY dosyasını sadece birkaç satır kodla PDF 'ye kolayca dönüştürebilirler.

{{% /blocks/products/pf/agp/text %}}

1. Scene sınıfının kurucusu aracılığıyla PLY dosyasını yükle1. PdfSaveOptions örneğini oluşturma1. Gelişmiş dönüşüm için PDF özel özellikler ayarlayın1. Call Scene.save yöntemi arayın1. Çıkış yolunu PDF dosya uzantısı ve PdfSaveOptions nesnesi ile geçin
...
{{% blocks/products/pf/agp/code-block title="PLY ila PDF Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
