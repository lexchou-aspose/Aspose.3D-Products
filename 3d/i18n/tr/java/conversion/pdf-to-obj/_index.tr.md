---
title: PDF 'i Java ile OBJ 'ye dönüştürün 
url: /tr/java/conversion/pdf-to-obj/ 
description: PDF biçimi için OBJ dosyası için Java dönüşüm kodunu örnekleyin. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada PDF 'i OBJ 'e dönüştürmek için bu örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="PDF \'i Java ile OBJ \'ye dönüştürün" h2="Herhangi bir 3D modelleme yazılımı olmadan Java kitaplığı kullanarak PDF ila OBJ dönüşüm." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PDF \'i OBJ \'e Nasıl Dönüştürebilirsiniz?" %}}

 PDF ile OBJ arasında işlemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden PDF ile OBJ \'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java programcılar, PDF dosyasını sadece birkaç satır kodla OBJ 'ye kolayca dönüştürebilirler.

{{% /blocks/products/pf/agp/text %}}

1. Scene sınıfının kurucusu aracılığıyla PDF dosyasını yükle1. ObjSaveOptions örneğini oluşturun1. Gelişmiş dönüşüm için OBJ özel özellikler ayarlayın1. Call Scene.save yöntemi arayın1. OBJ dosya uzantısı ve ObjSaveOptions nesnesi ile çıktı yolunu geçin
...
{{% blocks/products/pf/agp/code-block title="PDF ila OBJ Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PDF-OBJ Dönüşüm Canlı Demoları" sectionDescription="[PDF \'i OBJ \'ye dönüştürün](https://products.aspose.app/3d/conversion/pdf-to-obj) Şu anda Canlı Demos web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece PDF dosyanızı yükleyin, anında OBJ \'ye dönüştürülecektir." >}}
