---
title: GLTF 'i Java ile STL 'ye dönüştürün 
weight: 1740
url: /tr/java/conversion/gltf-to-stl/ 
description: GLTF biçimi için STL dosyası için Java dönüşüm kodunu örnekleyin. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada GLTF 'i STL 'e dönüştürmek için bu örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="GLTF \'i Java ile STL \'ye dönüştürün" h2="Herhangi bir 3D modelleme yazılımı olmadan Java kitaplığı kullanarak GLTF ila STL dönüşüm." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak GLTF \'i STL \'e Nasıl Dönüştürebilirsiniz?" %}}

 GLTF ile STL arasında işlemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden GLTF ile STL \'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java programcılar, GLTF dosyasını sadece birkaç satır kodla STL 'ye kolayca dönüştürebilirler.

{{% /blocks/products/pf/agp/text %}}

1. Scene sınıfının kurucusu aracılığıyla GLTF dosyasını yükle1. StlSaveOptions örneğini oluşturun1. Gelişmiş dönüşüm için STL özel özellikler ayarlayın1. Call Scene.save yöntemi arayın1. Çıktı yolunu STL dosya uzantısı ve StlSaveOptions nesnesi ile geçin
...
{{% blocks/products/pf/agp/code-block title="GLTF ila STL Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLTF-STL Dönüşüm Canlı Demoları" sectionDescription="[GLTF \'i STL \'ye dönüştürün](https://products.aspose.app/3d/conversion/gltf-to-stl) Şu anda Canlı Demos web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece GLTF dosyanızı yükleyin, anında STL \'ye dönüştürülecektir." >}}
