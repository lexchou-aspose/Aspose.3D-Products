---
title: Java aracılığıyla DAE'i DRC'ye dönüştürün 
url: /tr/java/conversion/dae-to-drc/ 
description: DAE biçimi için DRC dosyasına örnek Java dönüştürme kodu. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada DAE'ü DRC'e dönüştürmek için bu örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla DAE\'i DRC\'ye dönüştürün" h2="Herhangi bir 3D modelleme yazılımı olmadan Java kitaplığını kullanarak DAE - DRC dönüştürme." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak DAE, DRC\'ye Nasıl Dönüştürülür" %}}

 DAE'i DRC olarak oluşturmak için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla DAE\'i DRC\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java programcıları, yalnızca birkaç satır kodla DAE dosyasını DRC'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. DAE dosyasını Scene sınıfının yapıcısı aracılığıyla yükleyin1. Bir DrcSaveOptions örneği oluşturun1. Gelişmiş dönüştürme için DRC belirli özelliği ayarlayın1. Scene.save yöntemini çağırın1. DRC dosya uzantısı ve DrcSaveOptions nesnesi ile çıktı yolunu iletin
...
{{% blocks/products/pf/agp/code-block title="DAE - DRC Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DAE - DRC Dönüşüm Canlı Demoları" sectionDescription="[DAE\'i DRC\'ye dönüştür](https://products.aspose.app/3d/conversion/dae-to-drc) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece DAE dosyanızı yükleyin, anında DRC dosyasına dönüştürülecektir." >}}
