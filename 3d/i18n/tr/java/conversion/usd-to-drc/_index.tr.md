---
title: Java aracılığıyla USD'i DRC'ye dönüştürün
weight: 530
url: /tr/java/conversion/usd-to-drc/ 
description: USD biçimi için DRC dosyasına örnek Java dönüştürme kodu. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada USD'ü DRC'e dönüştürmek için bu örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java aracılığıyla USD\'i DRC\'ye dönüştürün" h2="Herhangi bir 3D modelleme yazılımı olmadan Java kitaplığını kullanarak USD - DRC dönüştürme." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="USD" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak USD, DRC\'ye Nasıl Dönüştürülür" %}}

 USD'i DRC olarak oluşturmak için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla USD\'i DRC\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java programcıları, yalnızca birkaç satır kodla USD dosyasını DRC'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. USD dosyasını Scene sınıfının yapıcısı aracılığıyla yükleyin1. DRC biçimiyle Scene.save yöntemini çağırın.1. Belirtilen yolda ortaya çıkan DRC dosyasını kontrol edin
...
{{% blocks/products/pf/agp/code-block title="USD - DRC Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="USD - DRC Dönüşüm Canlı Demoları" sectionDescription="[USD\'i DRC\'ye dönüştür](https://products.aspose.app/3d/conversion/usd-to-drc) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece USD dosyanızı yükleyin, anında DRC dosyasına dönüştürülecektir." >}}
