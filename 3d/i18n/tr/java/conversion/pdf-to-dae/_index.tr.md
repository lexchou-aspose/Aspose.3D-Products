---
title: PDF 'i Java ile DAE 'ye dönüştürün 
url: /tr/java/conversion/pdf-to-dae/ 
description: PDF biçimi için DAE dosyası için Java dönüşüm kodunu örnekleyin. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada PDF 'i DAE 'e dönüştürmek için bu örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="PDF \'i Java ile DAE \'ye dönüştürün" h2="Herhangi bir 3D modelleme yazılımı olmadan Java kitaplığı kullanarak PDF ila DAE dönüşüm." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak PDF \'i DAE \'e Nasıl Dönüştürebilirsiniz?" %}}

 PDF ile DAE arasında işlemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden PDF ile DAE \'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java programcılar, PDF dosyasını sadece birkaç satır kodla DAE 'ye kolayca dönüştürebilirler.

{{% /blocks/products/pf/agp/text %}}

1. Scene sınıfının kurucusu aracılığıyla PDF dosyasını yükle1. DaeSaveOptions örneğini oluşturun1. Gelişmiş dönüşüm için DAE özel özellikler ayarlayın1. Call Scene.save yöntemi arayın1. DAE dosya uzantısı ve DaeSaveOptions nesnesi ile çıktı yolunu geçin
...
{{% blocks/products/pf/agp/code-block title="PDF ila DAE Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
