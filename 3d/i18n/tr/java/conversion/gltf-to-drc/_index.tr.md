---
title: GLTF 'i Java ile DRC 'ye dönüştürün 
url: /tr/java/conversion/gltf-to-drc/ 
description: GLTF biçimi için DRC dosyası için Java dönüşüm kodunu örnekleyin. Herhangi bir Web veya Masaüstü Java tabanlı uygulamada GLTF 'i DRC 'e dönüştürmek için bu örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="GLTF \'i Java ile DRC \'ye dönüştürün" h2="Herhangi bir 3D modelleme yazılımı olmadan Java kitaplığı kullanarak GLTF ila DRC dönüşüm." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak GLTF \'i DRC \'e Nasıl Dönüştürebilirsiniz?" %}}

 GLTF ile DRC arasında işlemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden GLTF ile DRC \'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java programcılar, GLTF dosyasını sadece birkaç satır kodla DRC 'ye kolayca dönüştürebilirler.

{{% /blocks/products/pf/agp/text %}}

1. Scene sınıfının kurucusu aracılığıyla GLTF dosyasını yükle1. DrcSaveOptions örneğini oluşturma1. Gelişmiş dönüşüm için DRC özel özellikler ayarlayın1. Call Scene.save yöntemi arayın1. Çıkış yolunu DRC dosya uzantısı ve DrcSaveOptions nesnesi ile geçin
...
{{% blocks/products/pf/agp/code-block title="GLTF ila DRC Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
