---
title: C# 를 통해 USD 에서 3MF 로 변환 
description: .NET API 를 사용하여 USD 및 기타 3D 파일을 변환
url: /ko/net/conversion/usd-to-3mf/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# 를 통해 USD 에서 3MF 로 변환" h2=".NET 프레임 워크, .NET 코어 및 Mono 를 사용하여 USD 및 기타 3D 파일을 내보내기" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USD 장면을 3MF 로 C# 로 내보내기" %}}
...
3. 첫 번째 매개 변수로. 3mf 확장명을 가진 출력 파일 이름을 전달합니다.
4. 에서 'Microsoft3MF' 필드 값을 지정하십시오. [파일 형식](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) 클래스
...
{{% blocks/products/pf/agp/code-autogen title="USD ~ 3MF 변환에 대한 C# 코드" gistPath="" %}}
```cs
// 장면의 객체에 USD 로드 
