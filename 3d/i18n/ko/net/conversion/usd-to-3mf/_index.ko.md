...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C#를 통해 USD을 3MF로 변환" h2=".NET Framework, .NET Core 및 Mono를 사용하여 USD 및 기타 3D 파일 내보내기" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="C#를 사용하여 USD 장면을 3MF로 내보내기" %}}
...
{{% blocks/products/pf/agp/code-autogen title="USD에서 3MF로의 변환을 위한 C# 코드" gistPath="" %}}
```cs
// Scene의 객체에 USD 로드 
