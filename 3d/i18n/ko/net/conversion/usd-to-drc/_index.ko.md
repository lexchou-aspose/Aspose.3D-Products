...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# 를 통해 USD 에서 DRC 로 변환" h2=".NET 프레임 워크, .NET 코어 및 Mono 를 사용하여 USD 및 기타 3D 파일을 내보내기" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USD 장면을 DRC 로 C# 로 내보내기" %}}
...
{{% blocks/products/pf/agp/code-autogen title="USD ~ DRC 변환에 대한 C# 코드" gistPath="" %}}
```cs
// 장면의 객체에 USD 로드 
