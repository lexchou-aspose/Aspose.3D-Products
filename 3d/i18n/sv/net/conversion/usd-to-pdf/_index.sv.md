...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera USD till PDF via C#" h2="Exportera USD & andra 3D filer med .NET Ramverk, .NET kärna och Mono" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod för USD till PDF konvertering" gistPath="" %}}
```cs
