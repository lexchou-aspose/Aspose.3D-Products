---
title: Konvertera USD till X via C# 
description: Konvertera USD och andra 3D filer med .NET API
url: /sv/net/conversion/usd-to-x/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera USD till X via C#" h2="Exportera USD och andra 3D filer med .NET Framework, .NET Core och Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportera USD scen som X med C#" %}}
...
3. Skicka ut filnamnet med filtillägget .x som första parameter
4. Ange "XBinary" fältvärde från [Filformat](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) klass
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod för USD till X-konvertering" gistPath="" %}}
```cs
