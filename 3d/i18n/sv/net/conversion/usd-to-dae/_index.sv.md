---
title: Konvertera USD till DAE via C# 
description: Konvertera USD & andra 3D filer med .NET API
url: /sv/net/conversion/usd-to-dae/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera USD till DAE via C#" h2="Exportera USD & andra 3D filer med .NET Ramverk, .NET kärna och Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportera USD scen som DAE med C#" %}}
...
3. Pass output filnamn med . Utökning som första parametern
4. Ange fältvärde 'Collada' från [FilformatName](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Klass
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod för USD till DAE konvertering" gistPath="" %}}
```cs
