...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera USDZ till PDF via C#" h2="Exportera USDZ & andra 3D filer med .NET Ramverk, .NET kärna och Mono" >}}
...
3. Pass output filnamn med . Pdf- utökning som första parametern
4. Ange fältvärde 'PDF' från [FilformatName](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Klass
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod för USDZ till PDF konvertering" gistPath="" %}}
```cs
