...
description: Prov Java konverteringskod för DRC-format till DAE-fil. Använd den här exempelkoden för att konvertera DRC till DAE inom någon webb- eller skrivbordsbaserad program Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera DRC till DAE via Java" h2="DRC till DAE konvertering med Java bibliotek utan någon 3D modelleringsprogram." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar DRC till DAE använder Java" %}}

 För att visa DRC till DAE, använder vi oss av.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java programmerare kan enkelt konvertera DRC filen till DAE på bara några få kodrader.

{{% /blocks/products/pf/agp/text %}}

1. Ladda DRC- filen via konstruktören i scenens klass1. Skapa en instans av DaeSaveOptionsName1. Ange DAE specifika egenskaper för avancerad konvertering1. Ring Scene.save- metoden1. Passera utdata sökvägen med DAE filändelsen & objekt för DaeSaveOptions.
...
{{% blocks/products/pf/agp/code-block title="DRC till DAE Java Konverteringskältkod" offSpacer="" %}}
