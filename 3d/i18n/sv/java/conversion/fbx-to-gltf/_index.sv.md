---
title: Konvertera FBX till GLTF via Java 
weight: 790
url: /sv/java/conversion/fbx-to-gltf/ 
description: Prov Java konverteringskod för FBX-format till GLTF-fil. Använd den här exempelkoden för att konvertera FBX till GLTF inom någon webb- eller skrivbordsbaserad program Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera FBX till GLTF via Java" h2="FBX till GLTF konvertering med Java bibliotek utan någon 3D modelleringsprogram." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FBX" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar FBX till GLTF använder Java" %}}

 För att visa FBX till GLTF, använder vi oss av.
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera FBX till GLTF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmerare kan enkelt konvertera FBX filen till GLTF på bara några få kodrader.

{{% /blocks/products/pf/agp/text %}}

1. Ladda FBX- filen via konstruktören i scenens klass1. Skapa en instans av GltfSaveOptions1. Ange GLTF specifika egenskaper för avancerad konvertering1. Ring Scene.save- metoden1. Passera utdata sökvägen med GLTF filändelse & objekt av GltfSaveOptions.
...
{{% blocks/products/pf/agp/code-block title="FBX till GLTF Java Konverteringskältkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="FBX till GLTF Konvertering levande demos" sectionDescription="[Konvertera FBX till GLTF](https://products.aspose.app/3d/conversion/fbx-to-gltf) Just nu genom att besöka vår Live Demos hemsida.The live demo har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ner Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Bara ladda upp din FBX-fil, den kommer att konverteras omedelbart till GLTF." >}}
