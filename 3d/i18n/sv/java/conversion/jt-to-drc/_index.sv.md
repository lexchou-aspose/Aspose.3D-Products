...
{{% blocks/products/pf/agp/content h2="Hur man konverterar JT till DRC använder Java" %}}

 För att visa JT till DRC, använder vi oss av.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java programmerare kan enkelt konvertera JT filen till DRC på bara några få kodrader.

{{% /blocks/products/pf/agp/text %}}

1. Ladda JT- filen via konstruktören i scenens klass1. Skapa en instans av DrcSaveOptionsName1. Ange DRC specifika egenskaper för avancerad konvertering1. Ring Scene.save- metoden1. Passera utdata sökvägen med DRC filändelse & objekt av DrcSaveOptions.
...
{{% blocks/products/pf/agp/code-block title="JT till DRC Java Konverteringskältkod" offSpacer="" %}}
