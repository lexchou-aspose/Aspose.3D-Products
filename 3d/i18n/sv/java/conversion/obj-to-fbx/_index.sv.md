...
description: Prov Java konverteringskod för OBJ-format till FBX-fil. Använd den här exempelkoden för att konvertera OBJ till FBX inom någon webb- eller skrivbordsbaserad program Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera OBJ till FBX via Java" h2="OBJ till FBX konvertering med Java bibliotek utan någon 3D modelleringsprogram." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar OBJ till FBX använder Java" %}}

 För att visa OBJ till FBX, använder vi oss av.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java programmerare kan enkelt konvertera OBJ filen till FBX på bara några få kodrader.

{{% /blocks/products/pf/agp/text %}}

1. Ladda OBJ- filen via konstruktören i scenens klass1. Skapa en instans av FbxSaveOptions1. Ange FBX specifika egenskaper för avancerad konvertering1. Ring Scene.save- metoden1. Passera utdata sökvägen med FBX filändelse & objekt av FbxSaveOptions.
...
{{% blocks/products/pf/agp/code-block title="OBJ till FBX Java Konverteringskältkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="OBJ till FBX Konvertering levande demos" sectionDescription="[Konvertera OBJ till FBX](https://products.aspose.app/3d/conversion/obj-to-fbx) Just nu genom att besöka vår Live Demos hemsida.The live demo har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ner Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Bara ladda upp din OBJ-fil, den kommer att konverteras omedelbart till FBX." >}}
