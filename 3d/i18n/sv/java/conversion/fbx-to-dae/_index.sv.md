...
description: Exempel på Java-konverteringskod för FBX-format till DAE-fil. Använd den här exempelkoden för att konvertera FBX till DAE i valfri webb- eller datorbaserad applikation Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera FBX till DAE via Java" h2="FBX till DAE omvandling med Java-biblioteket utan någon 3D-modelleringsprogramvara." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FBX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du FBX till DAE med Java" %}}

 För att rendera FBX till DAE använder vi
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-programmerare kan enkelt konvertera FBX-filen till DAE på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda FBX-filen via konstruktorn för Scene-klassen1. Skapa en instans av DaeSaveOptions1. Ställ in DAE specifika egenskaper för avancerad konvertering1. Ring Scene.save-metoden1. Skicka utdatasökvägen med DAE filtillägg och objekt för DaeSaveOptions
...
{{% blocks/products/pf/agp/code-block title="FBX till DAE Java Omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="FBX till DAE Live Demos för konvertering" sectionDescription="[Konvertera FBX till DAE](https://products.aspose.app/3d/conversion/fbx-to-dae) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din FBX-fil, den konverteras omedelbart till DAE." >}}
