---
title: Mengkonversi USD untuk STL via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mengkonversi USD untuk STL via C#" h2="Ekspor USD & file 3D lainnya menggunakan kerangka .NET, .NET Core dan Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ekspor USD adegan sebagai STL dengan C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# kode untuk USD untuk STL Konversi" gistPath="" %}}
```cs
