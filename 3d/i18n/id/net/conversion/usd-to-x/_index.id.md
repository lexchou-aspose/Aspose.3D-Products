---
title: Mengkonversi USD ke X via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Mengkonversi USD ke X via C#" h2="Ekspor USD & file 3D lainnya menggunakan kerangka .NET, .NET Core dan Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ekspor USD adegan seperti X dengan C#" %}}
...
3. Berikan nama berkas keluaran dengan. X ekstensi sebagai parameter pertama
4. Tentukan 'xbinari' nilai bidang dari [Format file](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Kelas
...
{{% blocks/products/pf/agp/code-autogen title="C# kode untuk USD ke X konversi" gistPath="" %}}
```cs
