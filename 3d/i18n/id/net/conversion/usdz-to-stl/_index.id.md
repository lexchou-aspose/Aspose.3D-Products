---
title: Ubah USDZ menjadi STL melalui C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ubah USDZ menjadi STL melalui C#" h2="Ekspor USDZ & file 3D lainnya menggunakan .NET Framework, .NET Core, dan Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ekspor USDZ Scene sebagai STL dengan C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Kode untuk USDZ ke STL Konversi" gistPath="" %}}
```cs
