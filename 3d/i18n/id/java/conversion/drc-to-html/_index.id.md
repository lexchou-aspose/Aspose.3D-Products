---
title: Mengkonversi DRC untuk HTML via Java 
url: /id/java/conversion/drc-to-html/ 
description: Contoh Java kode konversi untuk format DRC ke file HTML. Gunakan kode contoh ini untuk mengonversi DRC ke HTML dalam aplikasi berbasis Web atau Desktop Java apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mengkonversi DRC untuk HTML via Java" h2="DRC untuk HTML Konversi menggunakan Java perpustakaan tanpa 3D pemodelan perangkat lunak." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Bagaimana mengkonversi DRC untuk HTML menggunakan Java" %}}

 Untuk merender DRC ke HTML, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk mengonversi DRC untuk HTML melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmer dapat dengan mudah mengkonversi DRC file ke HTML hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat berkas DRC melalui konstruktor kelas suasana1. Buat contoh html5saveoption1. Atur HTML properti khusus untuk konversi tingkat lanjut1. Adegan panggilan. Metode Simpan1. Lewati jalur keluaran dengan ekstensi berkas HTML & Objek opsi html5save
...
{{% blocks/products/pf/agp/code-block title="DRC untuk HTML Java kode sumber konversi" offSpacer="" %}}

```cs
// Muat DRC dalam objek adegan 
Scene document = new Scene("template.drc");
// Buat contoh html5saveoption 
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC untuk HTML konversi demo hidup" sectionDescription="[Mengkonversi DRC untuk HTML](https://products.aspose.app/3d/conversion/drc-to-html) Sekarang dengan mengunjungi situs demo langsung kami. demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apapun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file DRC Anda, maka akan dikonversi secara instan ke HTML." >}}
