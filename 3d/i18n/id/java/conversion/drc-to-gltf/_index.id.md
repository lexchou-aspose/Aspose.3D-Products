---
title: Mengkonversi DRC untuk GLTF via Java 
url: /id/java/conversion/drc-to-gltf/ 
description: Contoh Java kode konversi untuk format DRC ke file GLTF. Gunakan kode contoh ini untuk mengonversi DRC ke GLTF dalam aplikasi berbasis Web atau Desktop Java apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mengkonversi DRC untuk GLTF via Java" h2="DRC untuk GLTF Konversi menggunakan Java perpustakaan tanpa 3D pemodelan perangkat lunak." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Bagaimana mengkonversi DRC untuk GLTF menggunakan Java" %}}

 Untuk merender DRC ke GLTF, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk mengonversi DRC untuk GLTF melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmer dapat dengan mudah mengkonversi DRC file ke GLTF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat berkas DRC melalui konstruktor kelas suasana1. Membuat contoh gltfsaveoption1. Atur GLTF properti khusus untuk konversi tingkat lanjut1. Adegan panggilan. Metode Simpan1. Lewati jalur keluaran dengan ekstensi berkas GLTF & Objek opsi gltfsaveoption
...
{{% blocks/products/pf/agp/code-block title="DRC untuk GLTF Java kode sumber konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC untuk GLTF konversi demo hidup" sectionDescription="[Mengkonversi DRC untuk GLTF](https://products.aspose.app/3d/conversion/drc-to-gltf) Sekarang dengan mengunjungi situs demo langsung kami. demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apapun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file DRC Anda, maka akan dikonversi secara instan ke GLTF." >}}
