...
{{% blocks/products/pf/agp/content h2="Bagaimana mengkonversi JT untuk DRC menggunakan Java" %}}

 Untuk merender JT ke DRC, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk mengonversi JT untuk DRC melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmer dapat dengan mudah mengkonversi JT file ke DRC hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat berkas JT melalui konstruktor kelas suasana1. Membuat contoh drcsaveoption1. Atur DRC properti khusus untuk konversi tingkat lanjut1. Adegan panggilan. Metode Simpan1. Lewati jalur keluaran dengan ekstensi berkas DRC & Objek opsi drcsaveoption
...
{{% blocks/products/pf/agp/code-block title="JT untuk DRC Java kode sumber konversi" offSpacer="" %}}
