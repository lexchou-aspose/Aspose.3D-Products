---
title: Ubah AMF menjadi PLY melalui Java 
weight: 430
url: /id/java/conversion/amf-to-ply/ 
description: Contoh Java kode konversi untuk format AMF ke file PLY. Gunakan kode contoh ini untuk mengonversi AMF ke PLY dalam aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah AMF menjadi PLY melalui Java" h2="Konversi AMF ke PLY menggunakan pustaka Java tanpa perangkat lunak pemodelan 3D apa pun." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi AMF ke PLY Menggunakan Java" %}}

 Untuk merender AMF menjadi PLY, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi AMF ke PLY melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pemrogram dapat dengan mudah mengonversi berkas AMF menjadi PLY hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file AMF melalui konstruktor kelas Scene1. Buat instance PlySaveOptions1. Tetapkan PLY properti khusus untuk konversi lanjutan1. Metode panggilan Scene.save1. Lewati jalur keluaran dengan PLY ekstensi file & objek PlySaveOptions
...
{{% blocks/products/pf/agp/code-block title="AMF ke PLY Java Kode Sumber Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="AMF ke PLY Demo Konversi Langsung" sectionDescription="[Ubah AMF menjadi PLY](https://products.aspose.app/3d/conversion/amf-to-ply) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file AMF Anda, itu akan langsung dikonversi menjadi PLY." >}}
