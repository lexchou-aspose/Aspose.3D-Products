---
title: Ubah AMF menjadi GLTF melalui Java 
weight: 1300
url: /id/java/conversion/amf-to-gltf/ 
description: Contoh Java kode konversi untuk format AMF ke file GLTF. Gunakan kode contoh ini untuk mengonversi AMF ke GLTF dalam aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah AMF menjadi GLTF melalui Java" h2="Konversi AMF ke GLTF menggunakan pustaka Java tanpa perangkat lunak pemodelan 3D apa pun." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi AMF ke GLTF Menggunakan Java" %}}

 Untuk merender AMF menjadi GLTF, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi AMF ke GLTF melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pemrogram dapat dengan mudah mengonversi berkas AMF menjadi GLTF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file AMF melalui konstruktor kelas Scene1. Buat instance GltfSaveOptions1. Tetapkan GLTF properti khusus untuk konversi lanjutan1. Metode panggilan Scene.save1. Lewati jalur keluaran dengan GLTF ekstensi file & objek GltfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="AMF ke GLTF Java Kode Sumber Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="AMF ke GLTF Demo Konversi Langsung" sectionDescription="[Ubah AMF menjadi GLTF](https://products.aspose.app/3d/conversion/amf-to-gltf) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file AMF Anda, itu akan langsung dikonversi menjadi GLTF." >}}
