---
title: Ubah ASE menjadi GLTF melalui Java 
weight: 490
url: /id/java/conversion/ase-to-gltf/ 
description: Contoh Java kode konversi untuk format ASE ke file GLTF. Gunakan kode contoh ini untuk mengonversi ASE ke GLTF dalam aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah ASE menjadi GLTF melalui Java" h2="Konversi ASE ke GLTF menggunakan pustaka Java tanpa perangkat lunak pemodelan 3D apa pun." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ASE" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ASE ke GLTF Menggunakan Java" %}}

 Untuk merender ASE menjadi GLTF, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi ASE ke GLTF melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pemrogram dapat dengan mudah mengonversi berkas ASE menjadi GLTF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file ASE melalui konstruktor kelas Scene1. Buat instance GltfSaveOptions1. Tetapkan GLTF properti khusus untuk konversi lanjutan1. Metode panggilan Scene.save1. Lewati jalur keluaran dengan GLTF ekstensi file & objek GltfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="ASE ke GLTF Java Kode Sumber Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="ASE ke GLTF Demo Konversi Langsung" sectionDescription="[Ubah ASE menjadi GLTF](https://products.aspose.app/3d/conversion/ase-to-gltf) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file ASE Anda, itu akan langsung dikonversi menjadi GLTF." >}}
