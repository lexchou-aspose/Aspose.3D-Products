...
url: /net/conversion/usdz-to-3mf/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert USDZ to 3MF via C#" h2="Export USDZ & other 3D files using .NET Framework, .NET Core and Mono">}}
