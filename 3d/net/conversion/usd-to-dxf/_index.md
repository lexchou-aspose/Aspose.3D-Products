---
title: Convert USD to DXF via C# 
description: Convert USD & other 3D files using .NET API
url: /net/conversion/usd-to-dxf/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert USD to DXF via C#" h2="Export USD & other 3D files using .NET Framework, .NET Core and Mono">}}
