...
description: Sample code for JT to DAE C# conversion. Use API example code for batch JT files to DAE conversion within VB.NET, Asp.NET or any .NET based application.
---
