---
title: Convert FBX to RVM via C# 
weight: 550
url: /net/conversion/fbx-to-rvm/ 
description: Sample code for FBX to RVM C# conversion. Use API example code for batch FBX files to RVM conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows FBX to RVM C# Conversion" offSpacer="" %}}
