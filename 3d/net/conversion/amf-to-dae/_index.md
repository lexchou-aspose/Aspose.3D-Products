...
description: Sample code for AMF to DAE C# conversion. Use API example code for batch AMF files to DAE conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert AMF to DAE Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert AMF to DAE via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmers can easily load & convert AMF files to DAE in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows AMF to DAE C# Conversion" offSpacer="" %}}
