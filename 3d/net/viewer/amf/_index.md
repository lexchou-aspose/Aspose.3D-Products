---
title: View AMF File Formats via .NET 
weight: 1900
url: /net/viewer/amf/ 
...
{{% blocks/products/pf/agp/content h2="How to View AMF File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to View AMF via C#" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D is a CAD and Gameware API to load, modify and convert 3D files. API is a standalone and does not require any any 3D modeling or rendering software. One can easily use API for Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX and more formats. ‎
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Free App to View AMF" sectionDescription="Check our live demos to [View AMF](https://products.aspose.app/3d/viewer/amf) with following benefits." >}}
