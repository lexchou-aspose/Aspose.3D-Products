...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D makes it easy for the developers to view the STL file with just few lines of code.
...
{{% blocks/products/pf/agp/code-block title="View STL - C#" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// load STL scene via an instance of Scene
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Free App to View STL" sectionDescription="Check our live demos to [View STL](https://products.aspose.app/3d/viewer/stl) with following benefits." >}}
