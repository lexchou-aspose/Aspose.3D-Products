...
weight: 3090
url: /net/viewer/jt/ 
description: Try our On-Premise APIs to load, render and display JT documents on .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="How to View JT File Using C#" %}}

 In order to view JT file, we’ll use
