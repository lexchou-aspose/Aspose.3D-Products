...
{{% blocks/products/pf/agp/content h2="How to View PLY File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to View PLY via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D makes it easy for the developers to view the PLY file with just few lines of code.
...
// load PLY scene via an instance of Scene
