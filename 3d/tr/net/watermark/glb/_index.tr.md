---
title: .NET aracılığıyla GLB Dosya Biçimlerine Kör Filigran Ekleme 
weight: 830
url: /tr/net/watermark/glb/ 
description: .NET Framework, .NET Core, Mono üzerindeki GLB belgelerine yüklemek, oluşturmak ve kör filigran eklemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla GLB öğesine Kör Filigran Ekle" h2="Sunucu tarafı API\'lerini kullanarak GLB dosyalarına filigran eklemek için kendi .NET uygulamalarınızı oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLB" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLB" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak GLB Dosyaya Filigran Etme" %}}

 GLB dosyasına filigran eklemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla GLB öğesine Kör Filigran Ekleme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D, geliştiricilerin yalnızca birkaç satır kodla GLB dosyasına kör filigran eklemesini kolaylaştırır.

{{% /blocks/products/pf/agp/text %}}

- GLB dosyasını Scene sınıfının yapıcısı aracılığıyla yükleyin- Aspose.3D ağ sınıfını alın- Aspose.3D'in EncodeWatermark yöntemini kullanarak filigran ve şifre ekleyin- Nesne ile Scene.Save yöntemini çağırın
...
{{% blocks/products/pf/agp/code-block title="GLB öğesine Kör Filigran Eklemek için C# kodu" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLB Öğesine Kör Filigran Eklemek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [filigran GLB](https://products.aspose.app/3d/watermark/glb) aşağıdaki faydaları ile." >}}
