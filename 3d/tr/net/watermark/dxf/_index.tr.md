---
title: .NET aracılığıyla DXF Dosya Biçimlerine Kör Filigran Ekleme 
weight: 830
url: /tr/net/watermark/dxf/ 
description: .NET Framework, .NET Core, Mono üzerindeki DXF belgelerine yüklemek, oluşturmak ve kör filigran eklemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla DXF öğesine Kör Filigran Ekle" h2="Sunucu tarafı API\'lerini kullanarak DXF dosyalarına filigran eklemek için kendi .NET uygulamalarınızı oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DXF" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak DXF Dosyaya Filigran Etme" %}}

 DXF dosyasına filigran eklemek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla DXF öğesine Kör Filigran Ekleme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D, geliştiricilerin yalnızca birkaç satır kodla DXF dosyasına kör filigran eklemesini kolaylaştırır.

{{% /blocks/products/pf/agp/text %}}

- DXF dosyasını Scene sınıfının yapıcısı aracılığıyla yükleyin- Aspose.3D ağ sınıfını alın- Aspose.3D'in EncodeWatermark yöntemini kullanarak filigran ve şifre ekleyin- Nesne ile Scene.Save yöntemini çağırın
...
{{% blocks/products/pf/agp/code-block title="DXF öğesine Kör Filigran Eklemek için C# kodu" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DXF Öğesine Kör Filigran Eklemek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [filigran DXF](https://products.aspose.app/3d/watermark/dxf) aşağıdaki faydaları ile." >}}
