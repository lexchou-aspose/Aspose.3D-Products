---
title: Lithophane'nizi TGA Dosya Biçimlerinden .NET aracılığıyla oluşturun 
weight: 830
url: /tr/net/lithophane/tga/ 
description: Litofan'dan TGA'ya belgelerinizi .NET Framework, .NET Core, Mono üzerinde yüklemek, oluşturmak ve oluşturmak için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lithophane\'nizi C# üzerinden TGA\'ya oluşturun" h2="Sunucu tarafı API\'lerini kullanarak litofan - TGA dosyalarınızı oluşturmak için kendi .NET uygulamalarınızı oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TGA" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="TGA" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TGA" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak Litofan - TGA Dosyanızı Nasıl Oluşturursunuz" %}}

 Litofan to TGA dosyanızı oluşturmak için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="Litofanınızı C# üzerinden TGA\'ya Oluşturma Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D, geliştiricilerin yalnızca birkaç satır kodla litofanınızı TGA dosyasında oluşturmasını kolaylaştırır.

{{% /blocks/products/pf/agp/text %}}

- Bazı yeni parametreler oluşturun ve bir Mesh nesnesi oluşturun- Mesh nesneleri üzerinde hesaplama işlemleri gerçekleştirin- TGA dosyası, Mesh sınıfı aracılığıyla 3d sahneyi yükler- Nesne ile Scene.Save yöntemini çağırın
...
{{% blocks/products/pf/agp/code-block title="Litofan\'ınızı TGA\'ya oluşturmak için C# kodu" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D, 3D dosyalarını yüklemek, değiştirmek ve dönüştürmek için kullanılan bir CAD ve Oyun Yazılımıdır API. API bağımsızdır ve herhangi bir 3D modelleme veya işleme yazılımı gerektirmez. Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY için API kolayca kullanılabilir, GLB, DirectX ve diğer biçimler. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Litofhanenizi TGA\'ya Oluşturmak için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [Litofan TGA](https://products.aspose.app/3d/lithophane/tga) aşağıdaki faydaları ile." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece TGA dosyasını yükleyin ve \"litofan\" düğmesine basın" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Gerekirse bağlantıdan TGA dosyasını indirin" >}}
