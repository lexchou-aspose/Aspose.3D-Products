---
title: ZIP Dosya Biçimlerini .NET aracılığıyla görüntüleyin 
weight: 620
url: /tr/net/viewer/zip/ 
description: .NET Framework, .NET Core, Mono üzerinde ZIP belgeleri yüklemek, oluşturmak ve görüntülemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ZIP Dosya Görüntüleyici for .NET" h2="ZIP dosyalarını herhangi bir 3D modelleme ve işleme yazılımı olmadan işleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ZIP" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ZIP" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak ZIP Dosyası Nasıl Görüntülenir" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D, geliştiricilerin ZIP dosyasını yalnızca birkaç satır kodla görüntülemesini kolaylaştırır.

{{% /blocks/products/pf/agp/text %}}

1. ZIP dosyasını Scene sınıfının yapıcısı aracılığıyla yükleyin1. Html5SaveOptions örneğini oluşturun1. Gelişmiş biçimlendirme için özellikleri ayarlayın1. Html5SaveOptions nesnesiyle Scene.Save yöntemini çağırın1. Ortaya çıkan HTML dosyasını varsayılan tarayıcıda kontrol edin
...
{{% blocks/products/pf/agp/code-block title="ZIP görüntülemek için C# kodu" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// ZIP sahnesini bir Sahne örneği aracılığıyla yükle
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D, 3D dosyalarını yüklemek, değiştirmek ve dönüştürmek için kullanılan bir CAD ve Oyun Yazılımıdır API. API bağımsızdır ve herhangi bir 3D modelleme veya işleme yazılımı gerektirmez. Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY için API kolayca kullanılabilir, GLB, DirectX ve diğer biçimler. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Görüntülemek için Ücretsiz Uygulama ZIP" sectionDescription="için canlı demolarımızı kontrol edin [ZIP görüntüle](https://products.aspose.app/3d/viewer/zip) aşağıdaki faydaları ile." >}}
...
ZIP dosya uzantısı, bir veya daha fazla dosya veya dizini tutabilen arşivleri temsil eder. ZIP dosya boyutunu küçültmek için arşiv, dahil edilen dosyalara sıkıştırma uygulayabilir. ZIP dosya biçimi, dosya ve klasörlerin arşivlenmesini sağlamak için Phil Katz tarafından Şubat 1989'da herkese açık hale getirildi. Biçim, PKWARE, Inc. tarafından oluşturulan PKZIP yardımcı programının bir parçası haline getirildi. Mevcut özelliklerin kullanıma sunulmasından hemen sonra, birçok şirket, Microsoft (Windows 7'den beri), Apple (Mac OS X) dahil olmak üzere yazılım araçlarının ZIP dosya biçimini oluşturdu. Ve bircok digerleri.
