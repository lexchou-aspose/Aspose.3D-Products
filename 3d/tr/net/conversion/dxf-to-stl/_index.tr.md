---
title: C# aracılığıyla DXF'i STL'ye dönüştürün 
weight: 1470
url: /tr/net/conversion/dxf-to-stl/ 
description: DXF - STL C# dönüşümü için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu DXF dosyaları STL dönüştürme için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla DXF\'i STL\'ye dönüştürün" h2="Herhangi bir 3D modelleme ve oluşturma yazılımı olmadan DXF\'i STL olarak oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DXF" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak DXF, STL\'ye Nasıl Dönüştürülür" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla DXF\'i STL\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programcıları, yalnızca birkaç kod satırıyla DXF dosyalarını kolayca yükleyebilir ve STL'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. DXF dosyasını Scene sınıfının yapıcısı aracılığıyla yükleyin1. Bir StlSaveOptions örneği oluşturun1. Gelişmiş dönüştürme için STL belirli özelliği ayarlayın1. Scene.Save yöntemini çağırın1. STL dosya uzantısı ve StlSaveOptions nesnesi ile çıktı yolunu iletin1. Belirtilen yolda ortaya çıkan STL dosyasını kontrol edin
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, DXF - STL C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DXF\'i STL\'e Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [DXF - STL dönüşüm](https://products.aspose.app/3d/conversion/dxf-to-stl) aşağıdaki faydaları ile." >}}
