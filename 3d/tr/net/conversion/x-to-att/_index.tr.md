---
title: C# aracılığıyla X'i ATT'e dönüştürün 
url: /tr/net/conversion/x-to-att/ 
description: X'ten ATT C#'e dönüşüm için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu X dosyalarını ATT dönüştürme için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla X\'i ATT\'e dönüştürün" h2="Herhangi bir 3D modelleme ve işleme yazılımı olmadan X\'i ATT olarak işleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ATT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="X" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak X\'i ATT\'e Dönüştürme" %}}

 X'i ATT'e dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programcıları, yalnızca birkaç kod satırıyla X dosyalarını kolayca yükleyebilir ve ATT dosyasına dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Scene sınıfının yapıcısı aracılığıyla X dosyasını yükleyin1. Bir AmfSaveOptions örneği oluşturun1. Gelişmiş dönüştürme için ATT belirli özelliği ayarlayın1. Scene.Save yöntemini çağırın1. ATT dosya uzantısı ve AttSaveOptions nesnesi ile çıktı yolunu iletin1. Belirtilen yolda ortaya çıkan ATT dosyasını kontrol edin
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, X - ATT C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="X\'i ATT\'e Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [X\'ten ATT\'e dönüşüm](https://products.aspose.app/3d/conversion/x-to-att) aşağıdaki faydaları ile." >}}
