---
title: C# aracılığıyla PDF'i U3D'ye dönüştürün 
weight: 610
url: /tr/net/conversion/pdf-to-u3d/ 
description: PDF - U3D C# dönüşümü için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu PDF dosyaları U3D dönüştürme için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla PDF\'i U3D\'ye dönüştürün" h2="Herhangi bir 3D modelleme ve oluşturma yazılımı olmadan PDF\'i U3D olarak oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak PDF, U3D\'ye Nasıl Dönüştürülür" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla PDF\'i U3D\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programcıları, yalnızca birkaç kod satırıyla PDF dosyalarını kolayca yükleyebilir ve U3D'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. PDF dosyasını Scene sınıfının yapıcısı aracılığıyla yükleyin1. U3dSaveOptions örneğini oluşturun1. Gelişmiş dönüştürme için U3D belirli özelliği ayarlayın1. Scene.Save yöntemini çağırın1. Çıktı yolunu U3D dosya uzantısı ve U3dSaveOptions nesnesi ile iletin1. Belirtilen yolda ortaya çıkan U3D dosyasını kontrol edin
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, PDF - U3D C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PDF\'i U3D\'e Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [PDF - U3D dönüşüm](https://products.aspose.app/3d/conversion/pdf-to-u3d) aşağıdaki faydaları ile." >}}
