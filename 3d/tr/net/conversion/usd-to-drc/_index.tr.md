---
title: C# aracılığıyla USD'i DRC'ye dönüştürün 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# aracılığıyla USD\'i DRC\'ye dönüştürün" h2=".NET Framework, .NET Core ve Mono kullanarak USD ve diğer 3D dosyalarını dışa aktarın" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="C# ile USD Sahneyi DRC olarak dışa aktar" %}}
...
{{% blocks/products/pf/agp/code-autogen title="USD - DRC Dönüşümü için C# Kodu" gistPath="" %}}
```cs
// USD öğesini bir Sahne nesnesine yükleyin 
var scene = new Aspose.ThreeD.Scene("template.usd");
// USD'i DRC olarak kaydet 
