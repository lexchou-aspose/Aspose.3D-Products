---
title: C# aracılığıyla JT'i STL'ye dönüştürün 
weight: 1480
url: /tr/net/conversion/jt-to-stl/ 
description: JT - STL C# dönüşümü için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu JT dosyaları STL dönüştürme için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla JT\'i STL\'ye dönüştürün" h2="Herhangi bir 3D modelleme ve oluşturma yazılımı olmadan JT\'i STL olarak oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JT" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak JT, STL\'ye Nasıl Dönüştürülür" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla JT\'i STL\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programcıları, yalnızca birkaç kod satırıyla JT dosyalarını kolayca yükleyebilir ve STL'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. JT dosyasını Scene sınıfının yapıcısı aracılığıyla yükleyin1. Bir StlSaveOptions örneği oluşturun1. Gelişmiş dönüştürme için STL belirli özelliği ayarlayın1. Scene.Save yöntemini çağırın1. STL dosya uzantısı ve StlSaveOptions nesnesi ile çıktı yolunu iletin1. Belirtilen yolda ortaya çıkan STL dosyasını kontrol edin
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, JT - STL C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="JT\'i STL\'e Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [JT - STL dönüşüm](https://products.aspose.app/3d/conversion/jt-to-stl) aşağıdaki faydaları ile." >}}
