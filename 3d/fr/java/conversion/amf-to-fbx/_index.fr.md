...
description: Exemple de code de conversion Java pour le format AMF vers le fichier FBX. Utilisez cet exemple de code pour convertir AMF en FBX dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir AMF en FBX via Java" h2="Conversion AMF en FBX à l\'aide de la bibliothèque Java sans aucun logiciel de modélisation 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir AMF en FBX en utilisant Java" %}}
 ...
 Afin de rendre AMF à FBX, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les programmeurs Java peuvent facilement convertir le fichier AMF en FBX en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier AMF via le constructeur de la classe Scene1. Créer une instance de FbxSaveOptions1. Définir FBX propriétés spécifiques pour la conversion avancée1. Appelez la méthode Scene.save1. Passez le chemin de sortie avec l'extension de fichier FBX et l'objet de FbxSaveOptions
...
{{% blocks/products/pf/agp/code-block title="AMF à FBX Java code source des conversions" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="AMF à FBX démos en direct de conversion" sectionDescription="[Convertir AMF en FBX](https://products.aspose.app/3d/conversion/amf-to-fbx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
