...
{{% blocks/products/pf/agp/feature-section-col title="Exporter USD Scène en tant que 3MF avec C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code pour la conversion USD à 3MF" gistPath="" %}}
```cs
