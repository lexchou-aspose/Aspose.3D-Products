---
title: Convertir JT en U3D via C# 
weight: 1310
url: /fr/net/conversion/jt-to-u3d/ 
description: Exemple de code pour la conversion de JT à U3D C#. Utilisez l'exemple de code API pour les fichiers batch JT vers la conversion U3D dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir JT en U3D via C#" h2="Rendez JT comme U3D sans aucun logiciel de modélisation et de rendu 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir JT en U3D en utilisant C#" %}}

 Afin de convertir JT en U3D, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir JT en U3D via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les programmeurs .NET peuvent facilement charger et convertir des fichiers JT en U3D en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier JT via le constructeur de la classe Scene1. Créer une instance de U3dSaveOptions1. Définir U3D propriétés spécifiques pour la conversion avancée1. Appelez la méthode Scene.Save1. Passez le chemin de sortie avec l'extension de fichier U3D et l'objet de U3dSaveOptions1. Vérifier le fichier U3D résultant au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion JT à U3D C#" offSpacer="" %}}
...
// enregistrer JT en tant que U3D 
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir JT en U3D" sectionDescription="Consultez nos démos en direct pour [Conversion JT à U3D](https://products.aspose.app/3d/conversion/jt-to-u3d) avec les avantages suivants." >}}
