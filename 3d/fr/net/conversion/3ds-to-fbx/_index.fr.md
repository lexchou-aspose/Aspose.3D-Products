...
description: Exemple de code pour la conversion de 3DS à FBX C#. Utilisez l'exemple de code API pour les fichiers batch 3DS vers la conversion FBX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir 3DS en FBX via C#" h2="Rendez 3DS comme FBX sans aucun logiciel de modélisation et de rendu 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir 3DS en FBX en utilisant C#" %}}
 ...
 Afin de convertir 3DS en FBX, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les programmeurs .NET peuvent facilement charger et convertir des fichiers 3DS en FBX en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier 3DS via le constructeur de la classe Scene1. Créer une instance de FbxSaveOptions1. Définir FBX propriétés spécifiques pour la conversion avancée1. Appelez la méthode Scene.Save1. Passez le chemin de sortie avec l'extension de fichier FBX et l'objet de FbxSaveOptions1. Vérifier le fichier FBX résultant au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion 3DS à FBX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir 3DS en FBX" sectionDescription="Consultez nos démos en direct pour [Conversion 3DS à FBX](https://products.aspose.app/3d/conversion/3ds-to-fbx) avec les avantages suivants." >}}
