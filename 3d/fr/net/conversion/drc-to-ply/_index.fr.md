---
title: Convertir DRC en PLY via C# 
url: /fr/net/conversion/drc-to-ply/ 
description: Exemple de code pour la conversion de DRC à PLY C#. Utilisez l'exemple de code API pour les fichiers batch DRC vers la conversion PLY dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir DRC en PLY via C#" h2="Rendez DRC comme PLY sans aucun logiciel de modélisation et de rendu 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir DRC en PLY en utilisant C#" %}}

 Afin de convertir DRC en PLY, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir DRC en PLY via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les programmeurs .NET peuvent facilement charger et convertir des fichiers DRC en PLY en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier DRC via le constructeur de la classe Scene1. Créer une instance de AmfSaveOptions1. Définir PLY propriétés spécifiques pour la conversion avancée1. Appelez la méthode Scene.Save1. Passez le chemin de sortie avec l'extension de fichier PLY et l'objet de PlySaveOptions1. Vérifier le fichier PLY résultant au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion DRC à PLY C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir DRC en PLY" sectionDescription="Consultez nos démos en direct pour [Conversion DRC à PLY](https://products.aspose.app/3d/conversion/drc-to-ply) avec les avantages suivants." >}}
