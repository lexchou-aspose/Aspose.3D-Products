---
title: Convertir U3D en FBX via C# 
weight: 1980
url: /fr/net/conversion/u3d-to-fbx/ 
description: Exemple de code pour la conversion de U3D à FBX C#. Utilisez l'exemple de code API pour les fichiers batch U3D vers la conversion FBX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir U3D en FBX via C#" h2="Rendez U3D comme FBX sans aucun logiciel de modélisation et de rendu 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="U3D" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir U3D en FBX en utilisant C#" %}}

 Afin de convertir U3D en FBX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir U3D en FBX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les programmeurs .NET peuvent facilement charger et convertir des fichiers U3D en FBX en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier U3D via le constructeur de la classe Scene1. Créer une instance de FbxSaveOptions1. Définir FBX propriétés spécifiques pour la conversion avancée1. Appelez la méthode Scene.Save1. Passez le chemin de sortie avec l'extension de fichier FBX et l'objet de FbxSaveOptions1. Vérifier le fichier FBX résultant au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion U3D à FBX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir U3D en FBX" sectionDescription="Consultez nos démos en direct pour [Conversion U3D à FBX](https://products.aspose.app/3d/conversion/u3d-to-fbx) avec les avantages suivants." >}}
