...
description: Exemple de code pour la conversion de OBJ à 3DS C#. Utilisez l'exemple de code API pour les fichiers batch OBJ vers la conversion 3DS dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir OBJ en 3DS via C#" h2="Rendez OBJ comme 3DS sans aucun logiciel de modélisation et de rendu 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir OBJ en 3DS en utilisant C#" %}}
 ...
 Afin de convertir OBJ en 3DS, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les programmeurs .NET peuvent facilement charger et convertir des fichiers OBJ en 3DS en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier OBJ via le constructeur de la classe Scene1. Créer une instance de 3dsSaveOptions1. Définir 3DS propriétés spécifiques pour la conversion avancée1. Appelez la méthode Scene.Save1. Transmettez le chemin de sortie avec l'extension de fichier 3DS et l'objet de 3dsSaveOptions1. Vérifier le fichier 3DS résultant au chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion OBJ à 3DS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir OBJ en 3DS" sectionDescription="Consultez nos démos en direct pour [Conversion OBJ à 3DS](https://products.aspose.app/3d/conversion/obj-to-3ds) avec les avantages suivants." >}}
