---
title: Afficher les formats de fichier JT via .NET 
weight: 3090
url: /fr/net/viewer/jt/ 
description: C# code source pour charger, restituer et afficher JT documents sur .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JT Visionneuse de fichiers for .NET" h2="Rendez les fichiers JT sans aucun logiciel de modélisation et de rendu 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JT" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JT" >}}
...
{{% blocks/products/pf/agp/content h2="Comment afficher le fichier JT à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D permet aux développeurs d'afficher facilement le fichier JT avec seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier JT via le constructeur de la classe Scene1. Créer une instance de Html5SaveOptions1. Définir les propriétés du formatage avancé1. Appelez la méthode Scene.Save avec l'objet de Html5SaveOptions1. Vérifiez le fichier HTML résultant dans le navigateur par défaut
...
{{% blocks/products/pf/agp/code-block title="C# code pour afficher JT" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// charger JT scène via une instance de Scene
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D est un CAD et un Gameware API pour charger, modifier et convertir des fichiers 3D. API est autonome et ne nécessite aucun logiciel de modélisation ou de rendu 3D. On peut facilement utiliser API pour Discreet3DS, WavefrontOBJ, STL (ASCII, Binaire), Universal3D, FBX (ASCII, Binaire), Collada, glTF, PLY, GLB, DirectX et d'autres formats. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour afficher JT" sectionDescription="Consultez nos démos en direct pour [Afficher JT](https://products.aspose.app/3d/viewer/jt) avec les avantages suivants." >}}
