...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D permet aux développeurs d'afficher facilement le fichier ASE avec seulement quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier ASE via le constructeur de la classe Scene1. Créer une instance de Html5SaveOptions1. Définir les propriétés du formatage avancé1. Appelez la méthode Scene.Save avec l'objet de Html5SaveOptions1. Vérifiez le fichier HTML résultant dans le navigateur par défaut
...
{{% blocks/products/pf/agp/code-block title="C# code pour afficher ASE" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// charger ASE scène via une instance de Scene
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D est un CAD et un Gameware API pour charger, modifier et convertir des fichiers 3D. API est autonome et ne nécessite aucun logiciel de modélisation ou de rendu 3D. On peut facilement utiliser API pour Discreet3DS, WavefrontOBJ, STL (ASCII, Binaire), Universal3D, FBX (ASCII, Binaire), Collada, glTF, PLY, GLB, DirectX et d'autres formats. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour afficher ASE" sectionDescription="Consultez nos démos en direct pour [Afficher ASE](https://products.aspose.app/3d/viewer/ase) avec les avantages suivants." >}}
