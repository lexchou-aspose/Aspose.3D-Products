---
title: Wandeln Sie USDZ über C# in PLY um 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Wandeln Sie USDZ über C# in PLY um" h2="Exportieren Sie USDZ- und andere 3D-Dateien mit .NET Framework, .NET Core und Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportiere USDZ Szene als PLY mit C#" %}}
...
3. Übergeben Sie den Namen der Ausgabedatei mit der Erweiterung .ply als ersten Parameter
4. Geben Sie den Feldwert `PLY` von an [Datei Format](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Klasse
...
{{% blocks/products/pf/agp/code-autogen title="C# Code für Umwandlung von USDZ in PLY" gistPath="" %}}
```cs
// Laden Sie die USDZ in ein Objekt der Szene 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// speichere USDZ als PLY 
