---
title: Wandeln Sie USD über C# in RVM um 
description: Konvertieren Sie USD- und andere 3D-Dateien mit .NET API
url: /de/net/conversion/usd-to-rvm/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Wandeln Sie USD über C# in RVM um" h2="Exportieren Sie USD- und andere 3D-Dateien mit .NET Framework, .NET Core und Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportiere USD Szene als RVM mit C#" %}}
...
3. Übergeben Sie den Namen der Ausgabedatei mit der Erweiterung .rvm als ersten Parameter
4. Geben Sie den Feldwert „RvmBinary“ an [Datei Format](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Klasse
...
{{% blocks/products/pf/agp/code-autogen title="C# Code für Umwandlung von USD in RVM" gistPath="" %}}
```cs
// Laden Sie die USD in ein Objekt der Szene 
var scene = new Aspose.ThreeD.Scene("template.usd");
// speichere USD als RVM 
