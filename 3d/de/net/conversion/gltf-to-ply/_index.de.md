---
title: Wandeln Sie GLTF über C# in PLY um 
url: /de/net/conversion/gltf-to-ply/ 
description: Beispielcode für die Umwandlung von GLTF in PLY C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von GLTF Dateien in PLY innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wandeln Sie GLTF über C# in PLY um" h2="Rendern Sie GLTF als PLY ohne 3D-Modellierungs- und Rendering-Software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren von GLTF in PLY mit C#" %}}

 Um GLTF in PLY umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von GLTF in PLY über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Programmierer können mit nur wenigen Codezeilen problemlos GLTF-Dateien in PLY laden und konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die GLTF-Datei über den Konstruktor der Scene-Klasse1. Erstellen Sie eine Instanz von AmfSaveOptions1. Legen Sie PLY spezifische Eigenschaften für die erweiterte Konvertierung fest1. Rufen Sie die Scene.Save-Methode auf1. Übergeben Sie den Ausgabepfad mit der Dateierweiterung PLY und dem Objekt von PlySaveOptions1. Prüfen Sie die resultierende PLY-Datei im angegebenen Pfad
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von GLTF in PLY C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Konvertieren von GLTF in PLY" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von GLTF in PLY](https://products.aspose.app/3d/conversion/gltf-to-ply) mit folgenden Vorteilen." >}}
