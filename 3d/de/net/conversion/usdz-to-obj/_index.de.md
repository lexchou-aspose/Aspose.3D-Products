---
title: Wandeln Sie USDZ über C# in OBJ um 
description: Konvertieren Sie USDZ- und andere 3D-Dateien mit .NET API
url: /de/net/conversion/usdz-to-obj/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Wandeln Sie USDZ über C# in OBJ um" h2="Exportieren Sie USDZ- und andere 3D-Dateien mit .NET Framework, .NET Core und Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportiere USDZ Szene als OBJ mit C#" %}}
...
3. Übergeben Sie den Namen der Ausgabedatei mit der Erweiterung .obj als ersten Parameter
4. Geben Sie den Feldwert `WavefrontOBJ` von an [Datei Format](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) Klasse
...
{{% blocks/products/pf/agp/code-autogen title="C# Code für Umwandlung von USDZ in OBJ" gistPath="" %}}
```cs
