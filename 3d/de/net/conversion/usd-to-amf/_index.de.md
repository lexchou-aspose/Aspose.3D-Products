---
title: Wandeln Sie USD über C# in AMF um 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Wandeln Sie USD über C# in AMF um" h2="Exportieren Sie USD- und andere 3D-Dateien mit .NET Framework, .NET Core und Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportiere USD Szene als AMF mit C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code für Umwandlung von USD in AMF" gistPath="" %}}
```cs
// Laden Sie die USD in ein Objekt der Szene 
var scene = new Aspose.ThreeD.Scene("template.usd");
// speichere USD als AMF 
