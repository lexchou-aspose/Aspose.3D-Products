---
title: Wandeln Sie OBJ über C# in USDZ um 
url: /de/net/conversion/obj-to-usdz 
description: Beispielcode für die Umwandlung von OBJ in USDZ C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von OBJ Dateien in USDZ innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wandeln Sie OBJ über C# in USDZ um" h2="Rendern Sie OBJ als USDZ ohne 3D-Modellierungs- und Rendering-Software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="USDZ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren von OBJ in USDZ mit C#" %}}

 Um OBJ in USDZ umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Programmierer können mit nur wenigen Codezeilen problemlos OBJ-Dateien in USDZ laden und konvertieren.
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von OBJ in USDZ C#" offSpacer="" %}}

```cs
// Laden Sie die OBJ in ein Objekt der Szene 
var document = new Aspose.ThreeD.Scene("template.obj");
// speichere OBJ als USDZ 
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Konvertieren von OBJ in USDZ" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von OBJ in USDZ](https://products.aspose.app/3d/conversion/obj-to-usdz) mit folgenden Vorteilen." >}}
