---
title: Wandeln Sie AMF über C# in DRC um 
url: /de/net/conversion/amf-to-drc/ 
description: Beispielcode für die Umwandlung von AMF in DRC C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von AMF Dateien in DRC innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wandeln Sie AMF über C# in DRC um" h2="Rendern Sie AMF als DRC ohne 3D-Modellierungs- und Rendering-Software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren von AMF in DRC mit C#" %}}

 Um AMF in DRC umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Programmierer können mit nur wenigen Codezeilen problemlos AMF-Dateien in DRC laden und konvertieren.
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von AMF in DRC C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Konvertieren von AMF in DRC" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von AMF in DRC](https://products.aspose.app/3d/conversion/amf-to-drc) mit folgenden Vorteilen." >}}
