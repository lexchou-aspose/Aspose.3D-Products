---
title: Blindes Wasserzeichen zu GLTF Dateiformaten über .NET hinzufügen 
weight: 830
url: /de/net/watermark/gltf/ 
description: C# Quellcode zum Laden, Rendern und Hinzufügen von Blindwasserzeichen zu GLTF Dokumenten auf .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Blindes Wasserzeichen zu GLTF über C# hinzufügen" h2="Erstellen Sie mithilfe serverseitiger APIs Ihre eigenen .NET-Apps, um GLTF-Dateien mit Wasserzeichen zu versehen." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="So versehen Sie GLTF-Datei mit C# mit einem Wasserzeichen" %}}

 Um die Datei GLTF mit einem Wasserzeichen zu versehen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Hinzufügen eines blinden Wasserzeichens zu GLTF über C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D macht es Entwicklern leicht, der GLTF-Datei mit nur wenigen Codezeilen blinde Wasserzeichen hinzuzufügen.

{{% /blocks/products/pf/agp/text %}}

- Laden Sie die GLTF-Datei über den Konstruktor der Scene-Klasse- Holen Sie sich die Mesh-Klasse von Aspose.3D- Fügen Sie Wasserzeichen und Passwort mit der EncodeWatermark-Methode von Aspose.3D hinzu- Rufen Sie die Scene.Save-Methode mit Objekt auf
...
{{% blocks/products/pf/agp/code-block title="C#-Code zum Hinzufügen eines blinden Wasserzeichens zu GLTF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Hinzufügen eines blinden Wasserzeichens zu GLTF" sectionDescription="Sehen Sie sich unsere Live-Demos an [Wasserzeichen GLTF](https://products.aspose.app/3d/watermark/gltf) mit folgenden Vorteilen." >}}
