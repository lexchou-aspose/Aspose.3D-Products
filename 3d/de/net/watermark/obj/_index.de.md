---
title: Blindes Wasserzeichen zu OBJ Dateiformaten über .NET hinzufügen 
weight: 830
url: /de/net/watermark/obj/ 
description: C# Quellcode zum Laden, Rendern und Hinzufügen von Blindwasserzeichen zu OBJ Dokumenten auf .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Blindes Wasserzeichen zu OBJ über C# hinzufügen" h2="Erstellen Sie mithilfe serverseitiger APIs Ihre eigenen .NET-Apps, um OBJ-Dateien mit Wasserzeichen zu versehen." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="So versehen Sie OBJ-Datei mit C# mit einem Wasserzeichen" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Hinzufügen eines blinden Wasserzeichens zu OBJ über C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C#-Code zum Hinzufügen eines blinden Wasserzeichens zu OBJ" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D ist eine CAD und Gameware API zum Laden, Modifizieren und Konvertieren von 3D Dateien. API ist eigenständig und erfordert keine 3D-Modellierungs- oder Rendering-Software. Man kann API einfach für Discreet3DS, WavefrontOBJ, STL (ASCII, binär), Universal3D, FBX (ASCII, binär), Collada, glTF, PLY, GLB, DirectX und weitere Formate. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Hinzufügen eines blinden Wasserzeichens zu OBJ" sectionDescription="Sehen Sie sich unsere Live-Demos an [Wasserzeichen OBJ](https://products.aspose.app/3d/watermark/obj) mit folgenden Vorteilen." >}}
