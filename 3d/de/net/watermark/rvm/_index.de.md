---
title: Blindes Wasserzeichen zu RVM Dateiformaten über .NET hinzufügen 
weight: 830
url: /de/net/watermark/rvm/ 
description: C# Quellcode zum Laden, Rendern und Hinzufügen von Blindwasserzeichen zu RVM Dokumenten auf .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Blindes Wasserzeichen zu RVM über C# hinzufügen" h2="Erstellen Sie mithilfe serverseitiger APIs Ihre eigenen .NET-Apps, um RVM-Dateien mit Wasserzeichen zu versehen." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="RVM" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="RVM" >}}
...
{{% blocks/products/pf/agp/content h2="So versehen Sie RVM-Datei mit C# mit einem Wasserzeichen" %}}

 Um die Datei RVM mit einem Wasserzeichen zu versehen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Hinzufügen eines blinden Wasserzeichens zu RVM über C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D macht es Entwicklern leicht, der RVM-Datei mit nur wenigen Codezeilen blinde Wasserzeichen hinzuzufügen.

{{% /blocks/products/pf/agp/text %}}

- Laden Sie die RVM-Datei über den Konstruktor der Scene-Klasse- Holen Sie sich die Mesh-Klasse von Aspose.3D- Fügen Sie Wasserzeichen und Passwort mit der EncodeWatermark-Methode von Aspose.3D hinzu- Rufen Sie die Scene.Save-Methode mit Objekt auf
...
{{% blocks/products/pf/agp/code-block title="C#-Code zum Hinzufügen eines blinden Wasserzeichens zu RVM" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D ist eine CAD und Gameware API zum Laden, Modifizieren und Konvertieren von 3D Dateien. API ist eigenständig und erfordert keine 3D-Modellierungs- oder Rendering-Software. Man kann API einfach für Discreet3DS, WavefrontOBJ, STL (ASCII, binär), Universal3D, FBX (ASCII, binär), Collada, glTF, PLY, GLB, DirectX und weitere Formate. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Hinzufügen eines blinden Wasserzeichens zu RVM" sectionDescription="Sehen Sie sich unsere Live-Demos an [Wasserzeichen RVM](https://products.aspose.app/3d/watermark/rvm) mit folgenden Vorteilen." >}}
