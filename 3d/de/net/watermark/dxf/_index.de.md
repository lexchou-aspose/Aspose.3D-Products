---
title: Blindes Wasserzeichen zu DXF Dateiformaten über .NET hinzufügen 
weight: 830
url: /de/net/watermark/dxf/ 
description: C# Quellcode zum Laden, Rendern und Hinzufügen von Blindwasserzeichen zu DXF Dokumenten auf .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Blindes Wasserzeichen zu DXF über C# hinzufügen" h2="Erstellen Sie mithilfe serverseitiger APIs Ihre eigenen .NET-Apps, um DXF-Dateien mit Wasserzeichen zu versehen." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DXF" >}}
...
{{% blocks/products/pf/agp/content h2="So versehen Sie DXF-Datei mit C# mit einem Wasserzeichen" %}}

 Um die Datei DXF mit einem Wasserzeichen zu versehen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Hinzufügen eines blinden Wasserzeichens zu DXF über C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D macht es Entwicklern leicht, der DXF-Datei mit nur wenigen Codezeilen blinde Wasserzeichen hinzuzufügen.

{{% /blocks/products/pf/agp/text %}}

- Laden Sie die DXF-Datei über den Konstruktor der Scene-Klasse- Holen Sie sich die Mesh-Klasse von Aspose.3D- Fügen Sie Wasserzeichen und Passwort mit der EncodeWatermark-Methode von Aspose.3D hinzu- Rufen Sie die Scene.Save-Methode mit Objekt auf
...
{{% blocks/products/pf/agp/code-block title="C#-Code zum Hinzufügen eines blinden Wasserzeichens zu DXF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Hinzufügen eines blinden Wasserzeichens zu DXF" sectionDescription="Sehen Sie sich unsere Live-Demos an [Wasserzeichen DXF](https://products.aspose.app/3d/watermark/dxf) mit folgenden Vorteilen." >}}
