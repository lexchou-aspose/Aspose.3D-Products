---
title: Anzeigen von PLY Dateiformaten über .NET 
weight: 3140
...
{{< blocks/products/pf/i18n/upper-banner h1="PLY Dateibetrachter for .NET" h2="Rendern Sie PLY-Dateien ohne 3D Modellierungs- und Rendering-Software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PLY" >}}
...
{{% blocks/products/pf/agp/content h2="So zeigen Sie PLY-Datei mit C# an" %}}

 Um die Datei PLY anzuzeigen, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D erleichtert Entwicklern das Anzeigen der PLY-Datei mit nur wenigen Codezeilen.
...
// PLY-Szene über eine Instanz von Scene laden
 ...
 Aspose.3D ist eine CAD und Gameware API zum Laden, Modifizieren und Konvertieren von 3D Dateien. API ist eigenständig und erfordert keine 3D-Modellierungs- oder Rendering-Software. Man kann API einfach für Discreet3DS, WavefrontOBJ, STL (ASCII, binär), Universal3D, FBX (ASCII, binär), Collada, glTF, PLY, GLB, DirectX und weitere Formate. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Anzeigen von PLY" sectionDescription="Sehen Sie sich unsere Live-Demos an [PLY anzeigen](https://products.aspose.app/3d/viewer/ply) mit folgenden Vorteilen." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach die Datei PLY hoch und klicken Sie auf die Schaltfläche \"Anzeigen\"." >}}
