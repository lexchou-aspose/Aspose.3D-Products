...
{{% blocks/products/pf/agp/content h2="So zeigen Sie die X-Datei mit C# an" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.3D macht es den Entwicklern leicht, die X-Datei mit nur wenigen Codezeilen anzuzeigen.
...
// X-Szene über eine Instanz von Scene laden
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D ist eine CAD und Gameware API zum Laden, Modifizieren und Konvertieren von 3D Dateien. API ist eigenständig und erfordert keine 3D-Modellierungs- oder Rendering-Software. Man kann API einfach für Discreet3DS, WavefrontOBJ, STL (ASCII, binär), Universal3D, FBX (ASCII, binär), Collada, glTF, PLY, GLB, DirectX und weitere Formate. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Anzeigen von X" sectionDescription="Sehen Sie sich unsere Live-Demos an [X anzeigen](https://products.aspose.app/3d/viewer/x) mit folgenden Vorteilen." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach die X-Datei hoch und klicken Sie auf die Schaltfläche \"Anzeigen\"." >}}
