---
title: Punktwolke in FBX Dateiformaten über .NET generieren 
weight: 830
url: /de/net/point-cloud/fbx/ 
description: C# Quellcode zum Laden, Rendern und Hinzufügen von generierten Punktwolken zu FBX Dokumenten auf .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Punktwolke zu FBX über C# generieren" h2="Erstellen Sie Ihre eigenen .NET-Apps, um mit serverseitigen APIs Punktwolken in FBX-Dateien zu generieren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FBX" >}}
...
{{% blocks/products/pf/agp/content h2="So generieren Sie eine Punktwolke in eine FBX-Datei mit C#" %}}

 Um eine Punktwolke in der FBX-Datei zu generieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Generieren einer Punktwolke zu FBX über C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D macht es Entwicklern leicht, mit nur wenigen Codezeilen Punktwolken für die FBX-Datei zu generieren.

{{% /blocks/products/pf/agp/text %}}

- Laden Sie die FBX-Datei über den Konstruktor der Scene-Klasse- Punktwolkenobjekt von Aspose.3D abrufen- Erstellen Sie ein Transformationsobjekt mit der EvaluateGlobalTransform-Methode- Generieren Sie Punktwolken mit der Merge-Methode- Rufen Sie die Scene.Save-Methode mit Objekt auf
...
{{% blocks/products/pf/agp/code-block title="C#-Code zum Generieren einer Punktwolke für FBX" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D ist eine CAD und Gameware API zum Laden, Modifizieren und Konvertieren von 3D Dateien. API ist eigenständig und erfordert keine 3D-Modellierungs- oder Rendering-Software. Man kann API einfach für Discreet3DS, WavefrontOBJ, STL (ASCII, binär), Universal3D, FBX (ASCII, binär), Collada, glTF, PLY, GLB, DirectX und weitere Formate. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Kostenlose App zum Generieren von Punktwolken zu FBX" sectionDescription="Sehen Sie sich unsere Live-Demos an [Punktwolke 3DS](https://products.aspose.app/3d/point-cloud/fbx) mit folgenden Vorteilen." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach die Datei FBX hoch und klicken Sie auf die Schaltfläche \"Generieren\"." >}}
