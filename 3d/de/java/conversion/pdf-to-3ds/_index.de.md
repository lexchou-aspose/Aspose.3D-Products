...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Programmierer können die PDF-Datei in nur wenigen Codezeilen einfach in 3DS umwandeln.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die PDF-Datei über den Konstruktor der Scene-Klasse1. Erstellen Sie eine Instanz von Discreet3dsSaveOptions1. Legen Sie 3DS spezifische Eigenschaften für die erweiterte Konvertierung fest1. Rufen Sie die Scene.save-Methode auf1. Übergeben Sie den Ausgabepfad mit der Dateierweiterung 3DS und dem Objekt von Discreet3dsSaveOptions
...
{{% blocks/products/pf/agp/code-block title="PDF bis 3DS Java Conversion-Quellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PDF bis 3DS Conversion-Live-Demos" sectionDescription="[Wandeln Sie PDF in 3DS um](https://products.aspose.app/3d/conversion/pdf-to-3ds) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
