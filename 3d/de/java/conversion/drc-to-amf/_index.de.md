...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Programmierer können die DRC-Datei in nur wenigen Codezeilen einfach in AMF umwandeln.
...
{{% blocks/products/pf/agp/code-block title="DRC bis AMF Java Conversion-Quellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC bis AMF Conversion-Live-Demos" sectionDescription="[Wandeln Sie DRC in AMF um](https://products.aspose.app/3d/conversion/drc-to-amf) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
