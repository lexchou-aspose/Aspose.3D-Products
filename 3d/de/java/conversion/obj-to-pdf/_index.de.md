...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Programmierer können die OBJ-Datei in nur wenigen Codezeilen einfach in PDF umwandeln.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die OBJ-Datei über den Konstruktor der Scene-Klasse1. Erstellen Sie eine Instanz von PdfSaveOptions1. Legen Sie PDF spezifische Eigenschaften für die erweiterte Konvertierung fest1. Rufen Sie die Scene.save-Methode auf1. Übergeben Sie den Ausgabepfad mit der Dateierweiterung PDF und dem Objekt von PdfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="OBJ bis PDF Java Conversion-Quellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="OBJ bis PDF Conversion-Live-Demos" sectionDescription="[Wandeln Sie OBJ in PDF um](https://products.aspose.app/3d/conversion/obj-to-pdf) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
