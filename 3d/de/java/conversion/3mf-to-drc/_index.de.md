...
{{% blocks/products/pf/agp/content h2="Konvertieren von 3MF in DRC mit Java" %}}

 Um 3MF in DRC zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Programmierer können die 3MF-Datei in nur wenigen Codezeilen einfach in DRC umwandeln.
...
{{% blocks/products/pf/agp/code-block title="3MF bis DRC Java Conversion-Quellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="3MF bis DRC Conversion-Live-Demos" sectionDescription="[Wandeln Sie 3MF in DRC um](https://products.aspose.app/3d/conversion/3mf-to-drc) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
