---
title: C# के माध्यम से USD को OBJ में बदलें 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# के माध्यम से USD को OBJ में बदलें" h2=".NET फ्रेमवर्क, .NET कोर और Mono का उपयोग करके USD और अन्य 3D फ़ाइलें निर्यात करें" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="C# के साथ USD दृश्य को OBJ के रूप में निर्यात करें" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# USD से OBJ रूपांतरण के लिए कोड" gistPath="" %}}
```cs
// सीन के ऑब्जेक्ट में USD लोड करें 
var scene = new Aspose.ThreeD.Scene("template.usd");
// USD को OBJ के रूप में सहेजें 
