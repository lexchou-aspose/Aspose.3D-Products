---
title: C# के माध्यम से USD को JT में बदलें 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# के माध्यम से USD को JT में बदलें" h2=".NET फ्रेमवर्क, .NET कोर और Mono का उपयोग करके USD और अन्य 3D फ़ाइलें निर्यात करें" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="C# के साथ USD दृश्य को JT के रूप में निर्यात करें" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# USD से JT रूपांतरण के लिए कोड" gistPath="" %}}
```cs
