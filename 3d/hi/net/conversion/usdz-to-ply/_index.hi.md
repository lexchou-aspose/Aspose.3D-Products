---
title: C# के माध्यम से USDZ को PLY में बदलें 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# के माध्यम से USDZ को PLY में बदलें" h2=".NET फ्रेमवर्क, .NET कोर और Mono का उपयोग करके USDZ और अन्य 3D फ़ाइलें निर्यात करें" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="C# के साथ USDZ दृश्य को PLY के रूप में निर्यात करें" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# USDZ से PLY रूपांतरण के लिए कोड" gistPath="" %}}
```cs
// सीन के ऑब्जेक्ट में USDZ लोड करें 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// USDZ को PLY के रूप में सहेजें 
