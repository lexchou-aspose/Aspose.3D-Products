---
title: Converter U3D em STL via C# 
weight: 2210
url: /pt/net/conversion/u3d-to-stl/ 
description: Código de amostra para conversão de U3D para STL C#. Use API código de exemplo para arquivos U3D em lote para conversão STL em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter U3D em STL via C#" h2="Renderize U3D como STL sem nenhum software de modelagem e renderização de 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="U3D" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter U3D em STL usando C#" %}}

 Para converter U3D em STL, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter U3D em STL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programadores podem facilmente carregar e converter arquivos U3D para STL em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo U3D por meio do construtor da classe Scene1. Crie uma instância de StlSaveOptions1. Defina STL propriedades específicas para conversão avançada1. Chame o método Scene.Save1. Passe o caminho de saída com extensão de arquivo STL e objeto de StlSaveOptions1. Verifique o arquivo STL resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de U3D para STL C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para converter U3D em STL" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de U3D para STL](https://products.aspose.app/3d/conversion/u3d-to-stl) com os seguintes benefícios." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/3d/net/conversion/u3d-to-amf/" name="U3D PARA AMF" description="Formato de Manufatura Aditiva" >}}
