---
title: Converter USD em STL via C# 
description: Converta USD e outros 3D arquivos usando .NET API
url: /pt/net/conversion/usd-to-stl/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter USD em STL via C#" h2="Exporte USD e outros 3D arquivos usando .NET Framework, .NET Core e Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportar cena USD como STL com C#" %}}
...
3. Passe o nome do arquivo de saída com a extensão .stl como primeiro parâmetro
4. Especifique o valor do campo `STLASCII` de [Formato de arquivo](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) aula
...
{{% blocks/products/pf/agp/code-autogen title="C# Código para conversão de USD em STL" gistPath="" %}}
```cs
// carregue o USD em um objeto de Scene 
var scene = new Aspose.ThreeD.Scene("template.usd");
// salve USD como um STL 
