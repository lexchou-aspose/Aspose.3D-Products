---
title: Converter AMF em DRC via C# 
url: /pt/net/conversion/amf-to-drc/ 
description: Código de amostra para conversão de AMF para DRC C#. Use API código de exemplo para arquivos AMF em lote para conversão DRC em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter AMF em DRC via C#" h2="Renderize AMF como DRC sem nenhum software de modelagem e renderização de 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter AMF em DRC usando C#" %}}

 Para converter AMF em DRC, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter AMF em DRC via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programadores podem facilmente carregar e converter arquivos AMF para DRC em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo AMF por meio do construtor da classe Scene1. Crie uma instância de AmfSaveOptions1. Defina DRC propriedades específicas para conversão avançada1. Chame o método Scene.Save1. Passe o caminho de saída com extensão de arquivo DRC e objeto de DrcSaveOptions1. Verifique o arquivo DRC resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de AMF para DRC C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para converter AMF em DRC" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de AMF para DRC](https://products.aspose.app/3d/conversion/amf-to-drc) com os seguintes benefícios." >}}
