...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter DRC em RVM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programadores podem facilmente carregar e converter arquivos DRC para RVM em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo DRC por meio do construtor da classe Scene1. Crie uma instância de AmfSaveOptions1. Defina RVM propriedades específicas para conversão avançada1. Chame o método Scene.Save1. Passe o caminho de saída com a extensão de arquivo RVM e o objeto de RvmSaveOptions1. Verifique o arquivo RVM resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de DRC para RVM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para converter DRC em RVM" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de DRC para RVM](https://products.aspose.app/3d/conversion/drc-to-rvm) com os seguintes benefícios." >}}
