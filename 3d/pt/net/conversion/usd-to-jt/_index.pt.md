---
title: Converter USD em JT via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter USD em JT via C#" h2="Exporte USD e outros 3D arquivos usando .NET Framework, .NET Core e Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportar cena USD como JT com C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Código para conversão de USD em JT" gistPath="" %}}
```cs
// carregue o USD em um objeto de Scene 
var scene = new Aspose.ThreeD.Scene("template.usd");
// salve USD como um JT 
