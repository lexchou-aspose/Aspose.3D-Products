---
title: Converter U3D em 3DS via C# 
weight: 2100
url: /pt/net/conversion/u3d-to-3ds/ 
description: Código de amostra para conversão de U3D para 3DS C#. Use API código de exemplo para arquivos U3D em lote para conversão 3DS em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter U3D em 3DS via C#" h2="Renderize U3D como 3DS sem nenhum software de modelagem e renderização de 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="U3D" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter U3D em 3DS usando C#" %}}

 Para converter U3D em 3DS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter U3D em 3DS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programadores podem facilmente carregar e converter arquivos U3D para 3DS em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo U3D por meio do construtor da classe Scene1. Crie uma instância de 3dsSaveOptions1. Defina 3DS propriedades específicas para conversão avançada1. Chame o método Scene.Save1. Passe o caminho de saída com extensão de arquivo 3DS e objeto de 3dsSaveOptions1. Verifique o arquivo 3DS resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de U3D para 3DS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para converter U3D em 3DS" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de U3D para 3DS](https://products.aspose.app/3d/conversion/u3d-to-3ds) com os seguintes benefícios." >}}
