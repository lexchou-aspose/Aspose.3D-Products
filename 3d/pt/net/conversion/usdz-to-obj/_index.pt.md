---
title: Converter USDZ em OBJ via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter USDZ em OBJ via C#" h2="Exporte USDZ e outros 3D arquivos usando .NET Framework, .NET Core e Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportar cena USDZ como OBJ com C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Código para conversão de USDZ em OBJ" gistPath="" %}}
```cs
