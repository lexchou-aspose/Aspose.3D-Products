...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter USD para X via C#" h2="Exporte USD e outros 3D arquivos usando .NET Framework, .NET Core e Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exporte a cena USD como X com C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Código para conversão de USD para X" gistPath="" %}}
```cs
