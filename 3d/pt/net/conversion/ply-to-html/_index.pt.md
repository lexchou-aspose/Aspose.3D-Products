---
title: Converter PLY em HTML via C# 
weight: 3080
url: /pt/net/conversion/ply-to-html/ 
description: Código de amostra para conversão de PLY para HTML C#. Use API código de exemplo para arquivos PLY em lote para conversão HTML em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PLY em HTML via C#" h2="Renderize PLY como HTML sem nenhum software de modelagem e renderização de 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PLY" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PLY em HTML usando C#" %}}

 Para converter PLY em HTML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PLY em HTML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programadores podem facilmente carregar e converter arquivos PLY para HTML em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo PLY por meio do construtor da classe Scene1. Crie uma instância de HtmlSaveOptions1. Defina HTML propriedades específicas para conversão avançada1. Chame o método Scene.Save1. Passe o caminho de saída com extensão de arquivo HTML e objeto de HtmlSaveOptions1. Verifique o arquivo HTML resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de PLY para HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para converter PLY em HTML" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de PLY para HTML](https://products.aspose.app/3d/conversion/ply-to-html) com os seguintes benefícios." >}}
