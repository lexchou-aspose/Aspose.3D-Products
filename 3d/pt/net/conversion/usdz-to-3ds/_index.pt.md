---
title: Converter USDZ em 3DS via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter USDZ em 3DS via C#" h2="Exporte USDZ e outros 3D arquivos usando .NET Framework, .NET Core e Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportar cena USDZ como 3DS com C#" %}}
...
3. Passe o nome do arquivo de saída com a extensão .3ds como primeiro parâmetro
4. Especifique o valor do campo `Discreet3DS` de [Formato de arquivo](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) aula
...
{{% blocks/products/pf/agp/code-autogen title="C# Código para conversão de USDZ em 3DS" gistPath="" %}}
```cs
// carregue o USDZ em um objeto de Scene 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// salve USDZ como um 3DS 
