---
title: Converter USDZ em STL via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter USDZ em STL via C#" h2="Exporte USDZ e outros 3D arquivos usando .NET Framework, .NET Core e Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportar cena USDZ como STL com C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Código para conversão de USDZ em STL" gistPath="" %}}
```cs
// carregue o USDZ em um objeto de Scene 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// salve USDZ como um STL 
