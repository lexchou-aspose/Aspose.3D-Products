---
title: Converter PLY em FBX via C# 
weight: 1910
url: /pt/net/conversion/ply-to-fbx/ 
description: Código de amostra para conversão de PLY para FBX C#. Use API código de exemplo para arquivos PLY em lote para conversão FBX em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter PLY em FBX via C#" h2="Renderize PLY como FBX sem nenhum software de modelagem e renderização de 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PLY" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter PLY em FBX usando C#" %}}

 Para converter PLY em FBX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter PLY em FBX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programadores podem facilmente carregar e converter arquivos PLY para FBX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo PLY por meio do construtor da classe Scene1. Crie uma instância de FbxSaveOptions1. Defina FBX propriedades específicas para conversão avançada1. Chame o método Scene.Save1. Passe o caminho de saída com extensão de arquivo FBX e objeto de FbxSaveOptions1. Verifique o arquivo FBX resultante no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de PLY para FBX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicativo gratuito para converter PLY em FBX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de PLY para FBX](https://products.aspose.app/3d/conversion/ply-to-fbx) com os seguintes benefícios." >}}
