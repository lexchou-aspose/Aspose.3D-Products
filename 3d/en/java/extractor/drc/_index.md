---
title: Extract Assets from DRC File Formats via Java
weight: 810
url: /java/extractor/drc
description: Sample Java extract assets code for DRC file. Use this example code to extract assets from DRC file within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Extract Assets from DRC via Java" h2="Extract Assets from DRC using Java library  without any 3D modeling software." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="How to Extract Assets from DRC File Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Extract Assets from DRC via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmers can easily extract assets from DRC in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="JAVA code to Extract Assets from DRC" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox-app sectionTitle="Free App to Extract Assets from DRC" sectionDescription="[Extractor DRC](https://products.aspose.app/3d/extractor/drc) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
