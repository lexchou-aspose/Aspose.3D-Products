---
title: View USD File Formats via JAVA
weight: 810
url: /java/viewer/usd
description: Sample Java viewer code for USD file. Use this example code to view USD file within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="USD File Viewer for JAVA" h2="Render USD files without any 3D modeling and rendering software." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="USD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="USD" >}}
...
{{% blocks/products/pf/agp/content h2="How to View USD File Using Java" %}}

In order to view USD file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to View USD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmers can easily view USD in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="JAVA code to View USD" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox-app sectionTitle="Free App to View USD" sectionDescription="[Viewer USD](https://products.aspose.app/3d/viewer/usd) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload USD file and hit the \"View\" button" >}}
