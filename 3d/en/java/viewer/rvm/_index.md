---
title: View RVM File Formats via JAVA
weight: 810
url: /java/viewer/rvm
description: Sample Java viewer code for RVM file. Use this example code to view RVM file within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="RVM File Viewer for JAVA" h2="Render RVM files without any 3D modeling and rendering software." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="RVM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="RVM" >}}
...
{{% blocks/products/pf/agp/content h2="How to View RVM File Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to View RVM via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="JAVA code to View RVM" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox-app sectionTitle="Free App to View RVM" sectionDescription="[Viewer RVM](https://products.aspose.app/3d/viewer/rvm) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload RVM file and hit the \"View\" button" >}}
