...
{{% blocks/products/pf/agp/content h2="How to View X File Using Java" %}}

In order to view X file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to View X via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmers can easily view X in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="JAVA code to View X" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox-app sectionTitle="Free App to View X" sectionDescription="[Viewer X](https://products.aspose.app/3d/viewer/x) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
