...
{{% blocks/products/pf/agp/content h2="How to View DRC File Using Java" %}}

In order to view DRC file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to View DRC via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmers can easily view DRC in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="JAVA code to View DRC" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox-app sectionTitle="Free App to View DRC" sectionDescription="[Viewer DRC](https://products.aspose.app/3d/viewer/drc) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
