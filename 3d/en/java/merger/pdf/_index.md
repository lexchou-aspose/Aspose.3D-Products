---
title: Merge PDF File Formats via Java
weight: 810
url: /java/merger/pdf
description: Sample Java merge PDF file. Use this example code to merge PDF file within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge PDF via Java" h2="Merge PDF using Java library  without any 3D modeling software." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge PDF File Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Merge PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programmers can easily merge PDF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="JAVA code to Merge PDF" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox-app sectionTitle="Free App to Merge PDF" sectionDescription="[Merger PDF](https://products.aspose.app/3d/merger/pdf) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
