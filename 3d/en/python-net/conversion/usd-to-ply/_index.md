---
title: Convert USD to PLY via Python 
description: Convert USD & other 3D files using .NET API
url: /python-net/conversion/usd-to-ply/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert USD to PLY via Python" h2="Export USD & other 3D files using .NET Framework, .NET Core and Mono">}}
...
4. Specify `PLY` field value from [FileFormat](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) class
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for USD to PLY Conversion" gistPath="" %}}
```cs
