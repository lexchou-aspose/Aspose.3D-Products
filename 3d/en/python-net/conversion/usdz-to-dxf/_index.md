---
title: Convert USDZ to DXF via Python 
description: Convert USDZ & other 3D files using .NET API
url: /python-net/conversion/usdz-to-dxf/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert USDZ to DXF via Python" h2="Export USDZ & other 3D files using .NET Framework, .NET Core and Mono">}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for USDZ to DXF Conversion" gistPath="" %}}
```cs
