---
title: Convert USDZ to ASE via Python 
description: Convert USDZ & other 3D files using .NET API
url: /python-net/conversion/usdz-to-ase/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert USDZ to ASE via Python" h2="Export USDZ & other 3D files using .NET Framework, .NET Core and Mono">}}
...
4. Specify `ASE` field value from [FileFormat](https://apireference.aspose.com/3d/python-net/aspose.threed/fileformat/fields/index) class
