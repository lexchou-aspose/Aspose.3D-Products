---
title: Convert USDZ to JT via Python 
description: Convert USDZ & other 3D files using .NET API
url: /python-net/conversion/usdz-to-jt/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert USDZ to JT via Python" h2="Export USDZ & other 3D files using .NET Framework, .NET Core and Mono">}}
...
4. Specify `SiemensJT9` field value from [FileFormat](https://apireference.aspose.com/3d/python-net/aspose.threed/fileformat/fields/index) class
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for USDZ to JT Conversion" gistPath="" %}}
```cs
