---
title: Convert USDZ to STL via Python 
description: Convert USDZ & other 3D files using .NET API
url: /python-net/conversion/usdz-to-stl/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert USDZ to STL via Python" h2="Export USDZ & other 3D files using .NET Framework, .NET Core and Mono">}}
...
4. Specify `STLASCII` field value from [FileFormat](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) class
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for USDZ to STL Conversion" gistPath="" %}}
```cs
