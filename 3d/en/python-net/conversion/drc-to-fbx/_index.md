---
title: Convert DRC to FBX via Python 
url: /python-net/conversion/drc-to-fbx/ 
description: Sample code for DRC to FBX Python conversion. Use API example code for batch DRC files to FBX conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DRC to FBX via Python" h2="Render DRC as FBX without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert DRC to FBX Using Python" %}}

 In order to convert DRC to FBX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DRC to FBX via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programmers can easily load & convert DRC files to FBX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DRC to FBX Python Conversion" offSpacer="" %}}
