---
title: Convert X to DRC via Python 
url: /python-net/conversion/x-to-drc/ 
description: Sample code for X to DRC Python conversion. Use API example code for batch X files to DRC conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert X to DRC via Python" h2="Render X as DRC without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="X" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert X to DRC Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert X to DRC via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="This sample code shows X to DRC Python Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox-app sectionTitle="Free App to Convert X to DRC" sectionDescription="Check our live demos for [X to DRC conversion](https://products.aspose.app/3d/conversion/x-to-drc) with following benefits." >}}
