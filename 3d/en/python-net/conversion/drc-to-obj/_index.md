---
title: Convert DRC to OBJ via Python 
url: /python-net/conversion/drc-to-obj/ 
description: Sample code for DRC to OBJ Python conversion. Use API example code for batch DRC files to OBJ conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DRC to OBJ via Python" h2="Render DRC as OBJ without any 3D modeling and rendering software." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert DRC to OBJ Using Python" %}}

 In order to convert DRC to OBJ, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DRC to OBJ via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programmers can easily load & convert DRC files to OBJ in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows DRC to OBJ Python Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox-app sectionTitle="Free App to Convert DRC to OBJ" sectionDescription="Check our live demos for [DRC to OBJ conversion](https://products.aspose.app/3d/conversion/drc-to-obj) with following benefits." >}}
