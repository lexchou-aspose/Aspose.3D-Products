---
title: Convert USD to AMF via Python 
description: Convert USD & other 3D files using .NET API
url: /python-net/conversion/usd-to-amf/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert USD to AMF via Python" h2="Export USD & other 3D files using .NET Framework, .NET Core and Mono">}}
...
4. Specify `AMF` field value from [FileFormat](https://apireference.aspose.com/3d/python-net/aspose.threed/fileformat/fields/index) class
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for USD to AMF Conversion" gistPath="" %}}
```cs
