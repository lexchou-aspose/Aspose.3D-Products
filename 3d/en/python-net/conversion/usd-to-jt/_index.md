---
title: Convert USD to JT via Python 
description: Convert USD & other 3D files using .NET API
url: /python-net/conversion/usd-to-jt/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert USD to JT via Python" h2="Export USD & other 3D files using .NET Framework, .NET Core and Mono">}}
