...
description: Sample code for AMF to STL C# conversion. Use API example code for batch AMF files to STL conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert AMF to STL Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert AMF to STL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmers can easily load & convert AMF files to STL in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows AMF to STL C# Conversion" offSpacer="" %}}
