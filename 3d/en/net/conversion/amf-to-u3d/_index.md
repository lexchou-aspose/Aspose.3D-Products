...
description: Sample code for AMF to U3D C# conversion. Use API example code for batch AMF files to U3D conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert AMF to U3D Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert AMF to U3D via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmers can easily load & convert AMF files to U3D in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows AMF to U3D C# Conversion" offSpacer="" %}}
