...
description: Sample code for 3MF to RVM C# conversion. Use API example code for batch 3MF files to RVM conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programmers can easily load & convert 3MF files to RVM in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows 3MF to RVM C# Conversion" offSpacer="" %}}
