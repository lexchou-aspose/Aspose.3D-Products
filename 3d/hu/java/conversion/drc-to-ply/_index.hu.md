---
title: "DRC konvertálása PLY-re a következőn keresztül: Java "
url: /hu/java/conversion/drc-to-ply/ 
description: Minta Java konverziós kód DRC formátumhoz PLY fájlba. Ezzel a példakóddal konvertálhatja a(z) DRC kódot PLY-re bármely web- vagy asztali Java alapú alkalmazásban.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="DRC konvertálása PLY-re a következőn keresztül: Java" h2="DRC konvertálása PLY-re a Java könyvtár használatával, 3D modellező szoftver nélkül." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="DRC konvertálása PLY-re a Java használatával" %}}

 A(z) DRC megjelenítéséhez a(z) PLY számára a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) DRC konvertálásához PLY-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java programozói könnyedén konvertálhatnak DRC fájlt PLY formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. DRC fájl betöltése a Scene osztály konstruktorán keresztül1. Hozzon létre egy PlySaveOptions példányt1. Állítson be PLY speciális tulajdonságot a speciális konverzióhoz1. Hívja a Scene.save metódust1. Adja meg a kimeneti útvonalat PLY fájlkiterjesztéssel és a PlySaveOptions objektumával
...
{{% blocks/products/pf/agp/code-block title="DRC – PLY Java Konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="DRC–PLY Konverziós élő bemutatók" sectionDescription="[DRC konvertálása PLY-re](https://products.aspose.app/3d/conversion/drc-to-ply) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a(z) DRC fájlt, és azonnal konvertálódik a(z) PLY fájlba." >}}
