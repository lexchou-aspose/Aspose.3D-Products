---
title: "STL konvertálása FBX-re a következőn keresztül: Java "
weight: 1450
url: /hu/java/conversion/stl-to-fbx/ 
description: Minta Java konverziós kód STL formátumhoz FBX fájlba. Ezzel a példakóddal konvertálhatja a(z) STL kódot FBX-re bármely web- vagy asztali Java alapú alkalmazásban.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="STL konvertálása FBX-re a következőn keresztül: Java" h2="STL konvertálása FBX-re a Java könyvtár használatával, 3D modellező szoftver nélkül." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="STL konvertálása FBX-re a Java használatával" %}}

 A(z) STL megjelenítéséhez a(z) FBX számára a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) STL konvertálásához FBX-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java programozói könnyedén konvertálhatnak STL fájlt FBX formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. STL fájl betöltése a Scene osztály konstruktorán keresztül1. Hozzon létre egy FbxSaveOptions példányt1. Állítson be FBX speciális tulajdonságot a speciális konverzióhoz1. Hívja a Scene.save metódust1. Adja meg a kimeneti útvonalat FBX fájlkiterjesztéssel és az FbxSaveOptions objektumával
...
{{% blocks/products/pf/agp/code-block title="STL – FBX Java Konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="STL–FBX Konverziós élő bemutatók" sectionDescription="[STL konvertálása FBX-re](https://products.aspose.app/3d/conversion/stl-to-fbx) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a(z) STL fájlt, és azonnal konvertálódik a(z) FBX fájlba." >}}
