---
title: "STL fájlformátum megtekintése a következőn keresztül: .NET "
weight: 670
url: /hu/net/viewer/stl/ 
description: C# forráskód STL dokumentum betöltéséhez, megjelenítéséhez és megjelenítéséhez a .NET Framework, .NET Core, Mono rendszerben.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="STL Fájlnézegető for .NET" h2="Rendereljen le STL fájlt 3D modellező és renderelő szoftver nélkül." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan tekinthet meg STL fájlt a C# használatával" %}}

 A(z) STL fájl megtekintéséhez a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) STL megtekintéséhez a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A Aspose.3D segítségével a fejlesztők egyszerűen megtekinthetik a STL fájlt néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. STL fájl betöltése a Scene osztály konstruktorán keresztül1. Hozzon létre egy Html5SaveOptions példányt1. Állítsa be a speciális formázás tulajdonságait1. Hívja meg a Scene.Save metódust a Html5SaveOptions objektumával1. Ellenőrizze a kapott HTML fájlt az alapértelmezett böngészőben
...
{{% blocks/products/pf/agp/code-block title="C# kód a(z) STL megtekintéséhez" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// STL jelenet betöltése a Scene egy példányán keresztül
...
<!-- aboutfile Starts -->
 ...
 A Aspose.3D egy CAD és egy Gameware API, amely 3D fájlok betöltésére, módosítására és konvertálására szolgál. A API önálló, és nem igényel semmilyen 3D modellező vagy megjelenítő szoftvert. A API egyszerűen használható a következőhöz: Discreet3DS, WavefrontOBJ, STL (ASCII, bináris), Universal3D, FBX (ASCII, bináris), Collada, glTF, PLY, GLB, DirectX és további formátumok. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás a(z) STL megtekintéséhez" sectionDescription="Tekintse meg élő bemutatóinkat [STL megtekintése](https://products.aspose.app/3d/viewer/stl) a következő előnyökkel." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nem kell letölteni vagy beállítani semmit" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni vagy fordítani" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltsön fel STL fájlt, és nyomja meg a \"Nézet\" gombot" >}}
