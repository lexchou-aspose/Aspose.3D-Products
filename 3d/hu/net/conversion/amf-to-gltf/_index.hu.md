---
title: "AMF konvertálása GLTF-re a következőn keresztül: C# "
url: /hu/net/conversion/amf-to-gltf/ 
description: Mintakód a(z) AMF–GLTF C# konverzióhoz. Használjon API példakódot a kötegelt AMF fájlok GLTF konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="AMF konvertálása GLTF-re a következőn keresztül: C#" h2="A(z) AMF megjelenítése GLTF-ként 3D modellező és megjelenítő szoftver nélkül." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/content h2="AMF konvertálása GLTF-re a C# használatával" %}}

 A(z) AMF GLTF-re konvertálásához a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) AMF konvertálásához GLTF-re a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programozói könnyedén betölthetnek és konvertálhatnak AMF fájlt GLTF formátumba, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód AMF–GLTF C# konverziót mutat" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás a(z) AMF konvertálásához GLTF-re" sectionDescription="Tekintse meg élő bemutatóinkat [AMF–GLTF konverzió](https://products.aspose.app/3d/conversion/amf-to-gltf) a következő előnyökkel." >}}
