---
title: "DRC konvertálása PLY-re a következőn keresztül: C# "
url: /hu/net/conversion/drc-to-ply/ 
description: Mintakód a(z) DRC–PLY C# konverzióhoz. Használjon API példakódot a kötegelt DRC fájlok PLY konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="DRC konvertálása PLY-re a következőn keresztül: C#" h2="A(z) DRC megjelenítése PLY-ként 3D modellező és megjelenítő szoftver nélkül." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="DRC konvertálása PLY-re a C# használatával" %}}

 A(z) DRC PLY-re konvertálásához a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) DRC konvertálásához PLY-re a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programozói könnyedén betölthetnek és konvertálhatnak DRC fájlt PLY formátumba, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód DRC–PLY C# konverziót mutat" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás a(z) DRC konvertálásához PLY-re" sectionDescription="Tekintse meg élő bemutatóinkat [DRC–PLY konverzió](https://products.aspose.app/3d/conversion/drc-to-ply) a következő előnyökkel." >}}
