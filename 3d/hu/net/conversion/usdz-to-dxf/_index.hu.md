---
title: "USDZ konvertálása DXF-re a következőn keresztül: C# "
description: USDZ és egyéb 3D fájlok konvertálása a .NET API használatával
url: /hu/net/conversion/usdz-to-dxf/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USDZ konvertálása DXF-re a következőn keresztül: C#" h2="Exportáljon USDZ és egyéb 3D fájlokat a .NET Framework, a .NET Core és a Mono használatával" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="A(z) USDZ jelenet exportálása DXF néven a(z) C# használatával" %}}
...
3. Adja meg a kimeneti fájl nevét .dxf kiterjesztéssel első paraméterként
4. Adja meg a `DXF` mező értékét innen [Fájlformátum](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) osztály
...
{{% blocks/products/pf/agp/code-autogen title="C# Kód a(z) USDZ – DXF konverzióhoz" gistPath="" %}}
```cs
// töltse be a(z) USDZ elemet a jelenet egyik objektumába 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// USDZ mentése DXF-ként 
