---
title: "GLTF konvertálása PLY-re a következőn keresztül: C# "
url: /hu/net/conversion/gltf-to-ply/ 
description: Mintakód a(z) GLTF–PLY C# konverzióhoz. Használjon API példakódot a kötegelt GLTF fájlok PLY konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="GLTF konvertálása PLY-re a következőn keresztül: C#" h2="A(z) GLTF megjelenítése PLY-ként 3D modellező és megjelenítő szoftver nélkül." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="GLTF konvertálása PLY-re a C# használatával" %}}

 A(z) GLTF PLY-re konvertálásához a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) GLTF konvertálásához PLY-re a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programozói könnyedén betölthetnek és konvertálhatnak GLTF fájlt PLY formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. GLTF fájl betöltése a Scene osztály konstruktorán keresztül1. Hozzon létre egy AmfSaveOptions példányt1. Állítson be PLY speciális tulajdonságot a speciális konverzióhoz1. Hívja a Scene.Save metódust1. Adja meg a kimeneti útvonalat PLY fájlkiterjesztéssel és a PlySaveOptions objektumával1. Ellenőrizze a kapott PLY fájlt a megadott elérési úton
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód GLTF–PLY C# konverziót mutat" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás a(z) GLTF konvertálásához PLY-re" sectionDescription="Tekintse meg élő bemutatóinkat [GLTF–PLY konverzió](https://products.aspose.app/3d/conversion/gltf-to-ply) a következő előnyökkel." >}}
