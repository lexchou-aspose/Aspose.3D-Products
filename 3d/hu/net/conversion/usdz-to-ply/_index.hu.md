---
title: "USDZ konvertálása PLY-re a következőn keresztül: C# "
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USDZ konvertálása PLY-re a következőn keresztül: C#" h2="Exportáljon USDZ és egyéb 3D fájlokat a .NET Framework, a .NET Core és a Mono használatával" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="A(z) USDZ jelenet exportálása PLY néven a(z) C# használatával" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Kód a(z) USDZ – PLY konverzióhoz" gistPath="" %}}
```cs
// töltse be a(z) USDZ elemet a jelenet egyik objektumába 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// USDZ mentése PLY-ként 
