---
title: "STL konvertálása DRC-re a következőn keresztül: C# "
url: /hu/net/conversion/stl-to-drc/ 
description: Mintakód a(z) STL–DRC C# konverzióhoz. Használjon API példakódot a kötegelt STL fájlok DRC konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="STL konvertálása DRC-re a következőn keresztül: C#" h2="A(z) STL megjelenítése DRC-ként 3D modellező és megjelenítő szoftver nélkül." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="STL konvertálása DRC-re a C# használatával" %}}

 A(z) STL DRC-re konvertálásához a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) STL konvertálásához DRC-re a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programozói könnyedén betölthetnek és konvertálhatnak STL fájlt DRC formátumba, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód STL–DRC C# konverziót mutat" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás a(z) STL konvertálásához DRC-re" sectionDescription="Tekintse meg élő bemutatóinkat [STL–DRC konverzió](https://products.aspose.app/3d/conversion/stl-to-drc) a következő előnyökkel." >}}
