---
title: "USD konvertálása X-re a következőn keresztül: C# "
description: USD és egyéb 3D fájlok konvertálása a .NET API használatával
url: /hu/net/conversion/usd-to-x/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="USD konvertálása X-re a következőn keresztül: C#" h2="Exportáljon USD és egyéb 3D fájlokat a .NET Framework, a .NET Core és a Mono használatával" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="A(z) USD jelenet exportálása X-ként a(z) C# használatával" %}}
...
3. Adja meg a kimeneti fájl nevét .x kiterjesztéssel első paraméterként
4. Adja meg az "XBinary" mező értékét innen [Fájlformátum](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) osztály
...
{{% blocks/products/pf/agp/code-autogen title="C# Kód a USD-ból X-re való konverzióhoz" gistPath="" %}}
```cs
