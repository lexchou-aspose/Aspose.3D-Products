---
title: "ATT konvertálása DRC-re a következőn keresztül: C# "
url: /hu/net/conversion/att-to-drc/ 
description: Mintakód a(z) ATT–DRC C# konverzióhoz. Használjon API példakódot a kötegelt ATT fájlok DRC konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ATT konvertálása DRC-re a következőn keresztül: C#" h2="A(z) ATT megjelenítése DRC-ként 3D modellező és megjelenítő szoftver nélkül." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ATT" >}}
...
{{% blocks/products/pf/agp/content h2="ATT konvertálása DRC-re a C# használatával" %}}

 A(z) ATT DRC-re konvertálásához a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) ATT konvertálásához DRC-re a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programozói könnyedén betölthetnek és konvertálhatnak ATT fájlt DRC formátumba, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód ATT–DRC C# konverziót mutat" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás a(z) ATT konvertálásához DRC-re" sectionDescription="Tekintse meg élő bemutatóinkat [ATT–DRC konverzió](https://products.aspose.app/3d/conversion/att-to-drc) a következő előnyökkel." >}}
