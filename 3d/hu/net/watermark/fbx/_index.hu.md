---
title: "Adjon hozzá vak vízjelet a FBX fájlformátumokhoz a következőn keresztül: .NET "
weight: 830
url: /hu/net/watermark/fbx/ 
description: C# forráskód a .NET Framework, .NET Core, Mono FBX dokumentumok betöltéséhez, megjelenítéséhez és vak vízjel hozzáadásához.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Adjon hozzá vak vízjelet a következőhöz: FBX a következőn keresztül: C#" h2="Készítse el saját .NET alkalmazásait vízjellel FBX fájlokhoz szerveroldali API-k segítségével." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FBX" >}}
...
{{% blocks/products/pf/agp/content h2="Vízjel hozzáadása FBX fájlhoz a C# használatával" %}}

 A(z) FBX fájl vízjelezéséhez a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="A vak vízjel hozzáadásának lépései a(z) FBX számára a(z) C# segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A Aspose.3D megkönnyíti a fejlesztők számára, hogy néhány kódsorral vak vízjelet adjanak a FBX fájlhoz.

{{% /blocks/products/pf/agp/text %}}

- FBX fájl betöltése a Scene osztály konstruktorán keresztül- Szerezze meg a(z) Aspose.3D mesh osztályát- Adjon hozzá vízjelet és jelszót Aspose.3D EncodeWatermark metódusával- Hívja meg a Scene.Save metódust objektummal
...
{{% blocks/products/pf/agp/code-block title="C# kód a vak vízjel hozzáadásához a következőhöz: FBX" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás vak vízjel hozzáadásához a következőhöz: FBX" sectionDescription="Tekintse meg élő bemutatóinkat [Vízjel FBX](https://products.aspose.app/3d/watermark/fbx) a következő előnyökkel." >}}
