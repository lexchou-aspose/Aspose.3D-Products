---
title: "Pontfelhő generálása STL fájlformátumhoz a következőn keresztül: .NET "
weight: 830
url: /hu/net/point-cloud/stl/ 
description: C# forráskód a .NET Framework, .NET Core, Mono STL dokumentumok betöltéséhez, megjelenítéséhez és generálási pontfelhő hozzáadásához.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Pontfelhő generálása ide: STL a következőn keresztül: C#" h2="Készítse el saját .NET alkalmazásait, hogy pontfelhőt generáljon STL fájlhoz szerveroldali API-k segítségével." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Pontfelhő létrehozása STL fájlba a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A pontfelhő létrehozásának lépései a következőhöz: STL a következőn keresztül: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# kód a pontfelhő generálásához a következőhöz: STL" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 A Aspose.3D egy CAD és egy Gameware API, amely 3D fájlok betöltésére, módosítására és konvertálására szolgál. A API önálló, és nem igényel semmilyen 3D modellező vagy megjelenítő szoftvert. A API egyszerűen használható a következőhöz: Discreet3DS, WavefrontOBJ, STL (ASCII, bináris), Universal3D, FBX (ASCII, bináris), Collada, glTF, PLY, GLB, DirectX és további formátumok. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Ingyenes alkalmazás pontfelhő létrehozásához a következőhöz: STL" sectionDescription="Tekintse meg élő bemutatóinkat [Pontfelhő 3DS](https://products.aspose.app/3d/point-cloud/stl) a következő előnyökkel." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nem kell letölteni vagy beállítani semmit" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni vagy fordítani" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltsön fel STL fájlt, és nyomja meg a \"Létrehozás\" gombot" >}}
