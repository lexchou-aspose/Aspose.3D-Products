---
title: Maak uw Lithophane van TIFF-bestandsindelingen via .NET 
weight: 830
url: /nl/net/lithophane/tiff/ 
description: C# broncode om uw lithofaan naar TIFF-documenten te laden, weer te geven en te maken op .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Maak uw Lithophane naar TIFF via C#" h2="Bouw uw eigen .NET apps om uw lithofaan-naar-TIFF-bestanden te maken met server-side API\'s." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="TIFF" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TIFF" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u uw Lithophane-naar-TIFF-bestand maakt met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om uw lithofaan naar TIFF te maken via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# code om uw lithofaan naar TIFF te maken" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D is een CAD en Gameware API om 3D-bestanden te laden, aan te passen en te converteren. API is een standalone en vereist geen 3D-modellerings- of renderingsoftware. Men kan gemakkelijk API gebruiken voor Discreet3DS, WavefrontOBJ, STL (ASCII, Binair), Universal3D, FBX (ASCII, Binair), Collada, glTF, PLY, GLB, DirectX en meer formaten. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om uw lithofaan naar TIFF te maken" sectionDescription="Bekijk onze live demo\'s om [Lithofaan TIFF](https://products.aspose.app/3d/lithophane/tiff) met volgende voordelen." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft niets te downloaden of in te stellen" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven of te compileren" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon het TIFF-bestand en druk op de knop \"lithofaan\"" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Download indien nodig het TIFF-bestand via de link" >}}
