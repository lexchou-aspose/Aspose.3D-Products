---
title: Blind watermerk toevoegen aan X-bestandsindelingen via .NET 
weight: 830
url: /nl/net/watermark/x/ 
description: C# broncode om blind watermerk te laden, weer te geven en toe te voegen aan X-documenten op .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Blind watermerk toevoegen aan X via C#" h2="Bouw uw eigen .NET apps om X-bestanden van een watermerk te voorzien met behulp van server-side API\'s." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="X" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="X" >}}
...
{{% blocks/products/pf/agp/content h2="Watermerken naar X-bestand met C#" %}}

 Om het X-bestand van een watermerk te voorzien, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om blind watermerk toe te voegen aan X via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D maakt het de ontwikkelaars gemakkelijk om met slechts enkele regels code een blind watermerk aan het X-bestand toe te voegen.

{{% /blocks/products/pf/agp/text %}}

- Laad het X-bestand via de constructor van de Scene-klasse- Haal de mesh-klasse van Aspose.3D op- Voeg watermerk en wachtwoord toe met behulp van de EncodeWatermark-methode van Aspose.3D- Roep de Scene.Save-methode aan met object
...
{{% blocks/products/pf/agp/code-block title="C# code om blind watermerk toe te voegen aan X" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om blind watermerk toe te voegen aan X" sectionDescription="Bekijk onze live demo\'s om [Watermerk X](https://products.aspose.app/3d/watermark/x) met volgende voordelen." >}}
