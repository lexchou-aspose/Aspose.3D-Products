---
title: Converteer DAE naar GLTF via C# 
url: /nl/net/conversion/dae-to-gltf/ 
description: Voorbeeldcode voor conversie van DAE naar GLTF C#. Gebruik API voorbeeldcode voor batch DAE-bestanden naar GLTF-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer DAE naar GLTF via C#" h2="Geef DAE weer als GLTF zonder enige 3D modellerings- en weergavesoftware." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u DAE naar GLTF converteert met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om DAE te converteren naar GLTF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmeurs kunnen gemakkelijk DAE bestanden laden en converteren naar GLTF in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad DAE bestand via de constructor van Scene klasse1. Maak een instantie van AmfSaveOptions1. Stel GLTF specifieke eigenschappen in voor geavanceerde conversie1. Roep de Scene.Save-methode aan1. Geef het uitvoerpad door met GLTF bestandsextensie & object van GltfSaveOptions1. Controleer het resulterende GLTF-bestand op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont DAE naar GLTF C# Conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om DAE naar GLTF te converteren" sectionDescription="Check onze live demo\'s voor [DAE naar GLTF conversie](https://products.aspose.app/3d/conversion/dae-to-gltf) met volgende voordelen." >}}
