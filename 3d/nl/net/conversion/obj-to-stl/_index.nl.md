---
title: Converteer OBJ naar STL via C# 
weight: 3370
url: /nl/net/conversion/obj-to-stl/ 
description: Voorbeeldcode voor conversie van OBJ naar STL C#. Gebruik API voorbeeldcode voor batch OBJ-bestanden naar STL-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer OBJ naar STL via C#" h2="Geef OBJ weer als STL zonder enige 3D modellerings- en weergavesoftware." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u OBJ naar STL converteert met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om OBJ te converteren naar STL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmeurs kunnen gemakkelijk OBJ bestanden laden en converteren naar STL in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad OBJ bestand via de constructor van Scene klasse1. Maak een instantie van StlSaveOptions1. Stel STL specifieke eigenschappen in voor geavanceerde conversie1. Roep de Scene.Save-methode aan1. Geef het uitvoerpad door met STL bestandsextensie & object van StlSaveOptions1. Controleer het resulterende STL-bestand op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont OBJ naar STL C# Conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om OBJ naar STL te converteren" sectionDescription="Check onze live demo\'s voor [OBJ naar STL conversie](https://products.aspose.app/3d/conversion/obj-to-stl) met volgende voordelen." >}}
