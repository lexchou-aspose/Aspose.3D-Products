---
title: Converteer USDZ naar FBX via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converteer USDZ naar FBX via C#" h2="Exporteer USDZ en andere 3D bestanden met .NET Framework, .NET Core en Mono" >}}
...
3. Geef de naam van het uitvoerbestand door met de extensie .fbx als eerste parameter
4. Geef de veldwaarde 'FBX7700Binary' op van [Bestandsformaat](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) klas
...
{{% blocks/products/pf/agp/code-autogen title="C# Code voor USDZ naar FBX conversie" gistPath="" %}}
```cs
// laad de USDZ in een object van Scene 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// sla USDZ op als een FBX 
