---
title: Converteer USDZ naar 3DS via C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converteer USDZ naar 3DS via C#" h2="Exporteer USDZ en andere 3D bestanden met .NET Framework, .NET Core en Mono" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code voor USDZ naar 3DS conversie" gistPath="" %}}
```cs
// laad de USDZ in een object van Scene 
var scene = new Aspose.ThreeD.Scene("template.usdz");
// sla USDZ op als een 3DS 
