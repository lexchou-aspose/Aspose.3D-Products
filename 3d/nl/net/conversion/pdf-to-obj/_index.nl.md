---
title: Converteer PDF naar OBJ via C# 
weight: 270
url: /nl/net/conversion/pdf-to-obj/ 
description: Voorbeeldcode voor conversie van PDF naar OBJ C#. Gebruik API voorbeeldcode voor batch PDF-bestanden naar OBJ-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PDF naar OBJ via C#" h2="Geef PDF weer als OBJ zonder enige 3D modellerings- en weergavesoftware." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Hoe u PDF naar OBJ converteert met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om PDF te converteren naar OBJ via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmeurs kunnen gemakkelijk PDF bestanden laden en converteren naar OBJ in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad PDF bestand via de constructor van Scene klasse1. Maak een instantie van ObjSaveOptions1. Stel OBJ specifieke eigenschappen in voor geavanceerde conversie1. Roep de Scene.Save-methode aan1. Geef het uitvoerpad door met OBJ bestandsextensie & object van ObjSaveOptions1. Controleer het resulterende OBJ-bestand op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont PDF naar OBJ C# Conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om PDF naar OBJ te converteren" sectionDescription="Check onze live demo\'s voor [PDF naar OBJ conversie](https://products.aspose.app/3d/conversion/pdf-to-obj) met volgende voordelen." >}}
