---
title: Converteer AMF naar DRC via C# 
url: /nl/net/conversion/amf-to-drc/ 
description: Voorbeeldcode voor conversie van AMF naar DRC C#. Gebruik API voorbeeldcode voor batch AMF-bestanden naar DRC-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer AMF naar DRC via C#" h2="Geef AMF weer als DRC zonder enige 3D modellerings- en weergavesoftware." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u AMF naar DRC converteert met C#" %}}

 Om AMF naar DRC te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om AMF te converteren naar DRC via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmeurs kunnen gemakkelijk AMF bestanden laden en converteren naar DRC in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad AMF bestand via de constructor van Scene klasse1. Maak een instantie van AmfSaveOptions1. Stel DRC specifieke eigenschappen in voor geavanceerde conversie1. Roep de Scene.Save-methode aan1. Geef het uitvoerpad door met DRC bestandsextensie & object van DrcSaveOptions1. Controleer het resulterende DRC-bestand op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont AMF naar DRC C# Conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om AMF naar DRC te converteren" sectionDescription="Check onze live demo\'s voor [AMF naar DRC conversie](https://products.aspose.app/3d/conversion/amf-to-drc) met volgende voordelen." >}}
