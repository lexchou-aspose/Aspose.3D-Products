---
title: Bekijk ZIP Bestandsindelingen via .NET 
weight: 620
url: /nl/net/viewer/zip/ 
description: C# broncode voor het laden, weergeven en weergeven van ZIP documenten op .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ZIP Bestandsviewer for .NET" h2="Render ZIP bestanden zonder enige 3D modellerings- en renderingsoftware." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ZIP" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ZIP" >}}
...
{{% blocks/products/pf/agp/code-block title="C# code om te bekijken ZIP" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D is een CAD en Gameware API om 3D-bestanden te laden, aan te passen en te converteren. API is een standalone en vereist geen 3D-modellerings- of renderingsoftware. Men kan gemakkelijk API gebruiken voor Discreet3DS, WavefrontOBJ, STL (ASCII, Binair), Universal3D, FBX (ASCII, Binair), Collada, glTF, PLY, GLB, DirectX en meer formaten. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om te bekijken ZIP" sectionDescription="Bekijk onze live demo\'s om [Bekijk ZIP](https://products.aspose.app/3d/viewer/zip) met volgende voordelen." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Download ZIP bestand via de link, indien nodig" >}}
