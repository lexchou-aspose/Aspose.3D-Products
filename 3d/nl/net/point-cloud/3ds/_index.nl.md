---
title: Genereer Point Cloud naar 3DS bestandsindelingen via .NET 
weight: 830
url: /nl/net/point-cloud/3ds/ 
description: C# broncode om puntenwolk te laden, weer te geven en toe te voegen aan 3DS documenten op .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Genereer Point Cloud naar 3DS via C#" h2="Bouw uw eigen .NET apps om puntenwolken naar 3DS bestanden te genereren met behulp van server-side API\'s." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="Puntenwolk naar 3DS-bestand genereren met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om Point Cloud te genereren naar 3DS via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# code om Point Cloud te genereren naar 3DS" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D is een CAD en Gameware API om 3D-bestanden te laden, aan te passen en te converteren. API is een standalone en vereist geen 3D-modellerings- of renderingsoftware. Men kan gemakkelijk API gebruiken voor Discreet3DS, WavefrontOBJ, STL (ASCII, Binair), Universal3D, FBX (ASCII, Binair), Collada, glTF, PLY, GLB, DirectX en meer formaten. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app om puntenwolk te genereren naar 3DS" sectionDescription="Bekijk onze live demo\'s om [Puntenwolk 3DS](https://products.aspose.app/3d/point-cloud/3ds) met volgende voordelen." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft niets te downloaden of in te stellen" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven of te compileren" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon 3DS bestand en klik op de knop \"Genereren\"" >}}
