---
title: .NETおよびJava3DAPI | 3Dファイルの操作と変換 
weight: 10
url: /ja/family
description: 3Dモデリングまたは画像レンダリングソフトウェアをインストールせずに、関連するライブラリを使用して、.NETおよびJavaアプリケーションで3Dドキュメントの編集と変換を作成します
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="3Dファイル操作API" h2="3Dモデリングまたはレンダリングソフトウェアなしで3Dドキュメント形式を読み取り、編集、変換するためのネイティブAPI。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d.svg" pfName="Aspose.3D" downloadUrl="https://downloads.aspose.com/3d" tryOnlineUrl="" >}}
...
{{< blocks/products/pf/slr-element name="ドキュメンテーション" href="https://docs.aspose.com/3d/" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="なぜAspose.3D製品ファミリーなのか？" tabId="success-stories" >}}
