---
title: C#を介してPLYをDAEに変換します 
weight: 580
url: /ja/net/conversion/ply-to-dae/ 
description: PLYからDAEC#への変換のサンプルコード。 VB .NET、Asp .NET、または任意の.NETベースのアプリケーション内でのバッチPLYファイルからDAEへの変換にはAPIサンプルコードを使用します。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#を介してPLYをDAEに変換します" h2="3Dモデリングおよびレンダリングソフトウェアを使用せずに、PLYをDAEとしてレンダリングします。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PLY" >}}
...
{{% blocks/products/pf/agp/content h2="C#を使用してPLYをDAEに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#を介してPLYをDAEに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 .NETプログラマーは、わずか数行のコードでPLYファイルを簡単にロードしてDAEに変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Sceneクラスのコンストラクターを介してPLYファイルをロードします1. DaeSaveOptionsのインスタンスを作成します1. 高度な変換のためにDAE固有のプロパティを設定します1. Scene.Saveメソッドを呼び出します1. DaeSaveOptionsのファイル拡張子とオブジェクトがDAEの出力パスを渡します1. 指定されたパスで結果のDAEファイルを確認します
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、PLYからDAEC#への変換を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PLYをDAEに変換する無料アプリ" sectionDescription="ライブデモをチェックしてください [PLYからDAEへの変換](https://products.aspose.app/3d/conversion/ply-to-dae) 以下の利点があります。" >}}
