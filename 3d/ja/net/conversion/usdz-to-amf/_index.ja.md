...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C#を介してUSDZをAMFに変換します" h2=".NETフレームワーク、.NETコア、およびMonoを使用してUSDZおよびその他の3Dファイルをエクスポートします" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USDZシーンをC#付きのAMFとしてエクスポート" %}}
...
3.最初のパラメーターとして.amf拡張子を持つ出力ファイル名を渡します
4.から`AMF`フィールド値を指定します [FileFormat](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) クラス
...
{{% blocks/products/pf/agp/code-autogen title="C#USDZからAMFへの変換のコード" gistPath="" %}}
```cs
