...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C#を介してUSDZをSTLに変換します" h2=".NETフレームワーク、.NETコア、およびMonoを使用してUSDZおよびその他の3Dファイルをエクスポートします" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="USDZシーンをC#付きのSTLとしてエクスポート" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C#USDZからSTLへの変換のコード" gistPath="" %}}
```cs
