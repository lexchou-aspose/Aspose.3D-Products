---
title: Aggiungi filigrana cieca a USD formati di file tramite .NET 
weight: 830
url: /it/net/watermark/usd/ 
description: C# codice sorgente per caricare, eseguire il rendering e aggiungere filigrana cieca a USD documenti su .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Aggiungi filigrana cieca a USD tramite C#" h2="Crea le tue .NET app per filigranare i file USD utilizzando le API lato server." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="USD" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="USD" >}}
...
{{% blocks/products/pf/agp/content h2="Come filigranare su USD file utilizzando C#" %}}

 Per filigranare il file USD, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per aggiungere una filigrana cieca a USD tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D consente agli sviluppatori di aggiungere facilmente una filigrana cieca al file USD con poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

- Carica il file USD tramite il costruttore della classe Scene- Ottieni la classe mesh di Aspose.3D- Aggiungi filigrana e password utilizzando il metodo EncodeWatermark di Aspose.3D- Chiama il metodo Scene.Save con l'oggetto
...
{{% blocks/products/pf/agp/code-block title="C# codice per aggiungere una filigrana cieca a USD" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D è un CAD e un Gameware API per caricare, modificare e convertire 3D file. API è autonomo e non richiede alcun 3D software di modellazione o rendering. Si può facilmente usare API per Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX e altri formati. 
   ...
   {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per aggiungere filigrana cieca a USD" sectionDescription="Controlla le nostre demo dal vivo su [Filigrana USD](https://products.aspose.app/3d/watermark/usd) con i seguenti vantaggi." >}}
