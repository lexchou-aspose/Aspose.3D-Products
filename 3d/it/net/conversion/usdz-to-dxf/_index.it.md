---
title: Converti USDZ in DXF tramite C# 
description: Converti USDZ e altri 3D file utilizzando .NET API
url: /it/net/conversion/usdz-to-dxf/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti USDZ in DXF tramite C#" h2="Esporta file USDZ e altri 3D utilizzando .NET Framework, .NET Core e Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Esporta USDZ scena come DXF con C#" %}}
...
3. Passare il nome del file di output con estensione .dxf come primo parametro
4. Specificare il valore del campo `DXF` da [Formato del file](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) classe
...
{{% blocks/products/pf/agp/code-autogen title="C# Codice per la conversione da USDZ a DXF" gistPath="" %}}
```cs
