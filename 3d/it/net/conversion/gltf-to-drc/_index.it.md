---
title: Converti GLTF in DRC tramite C# 
url: /it/net/conversion/gltf-to-drc/ 
description: Codice di esempio per la conversione da GLTF a DRC C#. Utilizza API codice di esempio per la conversione batch di file GLTF in DRC all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti GLTF in DRC tramite C#" h2="Rendi GLTF come DRC senza alcun 3D software di modellazione e rendering." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire GLTF in DRC utilizzando C#" %}}

 Per convertire GLTF in DRC, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire GLTF in DRC tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET i programmatori possono caricare e convertire facilmente GLTF file in DRC in poche righe di codice.
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da GLTF a DRC C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per convertire GLTF in DRC" sectionDescription="Controlla le nostre demo dal vivo per [conversione da GLTF a DRC](https://products.aspose.app/3d/conversion/gltf-to-drc) con i seguenti vantaggi." >}}
