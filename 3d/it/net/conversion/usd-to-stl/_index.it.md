---
title: Converti USD in STL tramite C# 
description: Converti USD e altri 3D file utilizzando .NET API
url: /it/net/conversion/usd-to-stl/
family: 3d
platformtag: net
feature: conversion
informat: USD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti USD in STL tramite C#" h2="Esporta file USD e altri 3D utilizzando .NET Framework, .NET Core e Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Esporta USD scena come STL con C#" %}}
...
4. Specificare il valore del campo `STLASCII` da [Formato del file](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) classe
...
{{% blocks/products/pf/agp/code-autogen title="C# Codice per la conversione da USD a STL" gistPath="" %}}
```cs
