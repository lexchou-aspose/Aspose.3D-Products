---
title: Converti GLB in OBJ tramite C# 
weight: 530
url: /it/net/conversion/glb-to-obj/ 
description: Codice di esempio per la conversione da GLB a OBJ C#. Utilizza API codice di esempio per la conversione batch di file GLB in OBJ all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti GLB in OBJ tramite C#" h2="Rendi GLB come OBJ senza alcun 3D software di modellazione e rendering." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLB" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire GLB in OBJ utilizzando C#" %}}

 Per convertire GLB in OBJ, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire GLB in OBJ tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET i programmatori possono caricare e convertire facilmente GLB file in OBJ in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file GLB tramite il costruttore della classe Scene1. Chiama il metodo Scene.Save con il formato di OBJ.1. Controlla il file OBJ risultante nel percorso specificato
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per convertire GLB in OBJ" sectionDescription="Controlla le nostre demo dal vivo per [conversione da GLB a OBJ](https://products.aspose.app/3d/conversion/glb-to-obj) con i seguenti vantaggi." >}}
