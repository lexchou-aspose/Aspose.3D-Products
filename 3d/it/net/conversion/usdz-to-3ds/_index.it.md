---
title: Converti USDZ in 3DS tramite C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti USDZ in 3DS tramite C#" h2="Esporta file USDZ e altri 3D utilizzando .NET Framework, .NET Core e Mono" >}}
...
3. Passa il nome del file di output con estensione .3ds come primo parametro
4. Specificare il valore del campo `Discreet3DS` da [Formato del file](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) classe
