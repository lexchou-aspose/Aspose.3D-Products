---
title: Converti PLY in STL tramite C# 
weight: 2130
url: /it/net/conversion/ply-to-stl/ 
description: Codice di esempio per la conversione da PLY a STL C#. Utilizza API codice di esempio per la conversione batch di file PLY in STL all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti PLY in STL tramite C#" h2="Rendi PLY come STL senza alcun 3D software di modellazione e rendering." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PLY" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire PLY in STL utilizzando C#" %}}

 Per convertire PLY in STL, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire PLY in STL tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET i programmatori possono caricare e convertire facilmente PLY file in STL in poche righe di codice.
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita per convertire PLY in STL" sectionDescription="Controlla le nostre demo dal vivo per [conversione da PLY a STL](https://products.aspose.app/3d/conversion/ply-to-stl) con i seguenti vantaggi." >}}
