---
title: Visualizza 3DS formati di file tramite .NET 
weight: 830
url: /it/net/viewer/3ds/ 
description: C# codice sorgente per caricare, eseguire il rendering e visualizzare 3DS documenti su .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="3DS Visualizzatore di file for .NET" h2="Eseguire il rendering di 3DS file senza alcun 3D software di modellazione e rendering." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="Come visualizzare 3DS file utilizzando C#" %}}
 ...
 Per visualizzare il file 3DS, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per visualizzare 3DS tramite C#" %}}
...
1. Carica il file 3DS tramite il costruttore della classe Scene1. Crea un'istanza di Html5SaveOptions1. Imposta le proprietà per la formattazione avanzata1. Chiama il metodo Scene.Save con l'oggetto di Html5SaveOptions1. Controlla il file HTML risultante nel browser predefinito
...
// carica 3DS scena tramite un'istanza di Scene
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D è un CAD e un Gameware API per caricare, modificare e convertire 3D file. API è autonomo e non richiede alcun 3D software di modellazione o rendering. Si può facilmente usare API per Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX e altri formati. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita da visualizzare 3DS" sectionDescription="Controlla le nostre demo dal vivo su [Visualizza 3DS](https://products.aspose.app/3d/viewer/3ds) con i seguenti vantaggi." >}}
