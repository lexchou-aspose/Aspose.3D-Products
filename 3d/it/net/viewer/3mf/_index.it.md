---
title: Visualizza 3MF formati di file tramite .NET 
weight: 3640
url: /it/net/viewer/3mf/ 
description: C# codice sorgente per caricare, eseguire il rendering e visualizzare 3MF documenti su .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="3MF Visualizzatore di file for .NET" h2="Eseguire il rendering di 3MF file senza alcun 3D software di modellazione e rendering." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3MF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3MF" >}}
...
{{% blocks/products/pf/agp/content h2="Come visualizzare 3MF file utilizzando C#" %}}

 Per visualizzare il file 3MF, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per visualizzare 3MF tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D consente agli sviluppatori di visualizzare facilmente il file 3MF con poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file 3MF tramite il costruttore della classe Scene1. Crea un'istanza di Html5SaveOptions1. Imposta le proprietà per la formattazione avanzata1. Chiama il metodo Scene.Save con l'oggetto di Html5SaveOptions1. Controlla il file HTML risultante nel browser predefinito
...
{{% blocks/products/pf/agp/code-block title="C# codice per visualizzare 3MF" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// carica 3MF scena tramite un'istanza di Scene
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D è un CAD e un Gameware API per caricare, modificare e convertire 3D file. API è autonomo e non richiede alcun 3D software di modellazione o rendering. Si può facilmente usare API per Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX e altri formati. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita da visualizzare 3MF" sectionDescription="Controlla le nostre demo dal vivo su [Visualizza 3MF](https://products.aspose.app/3d/viewer/3mf) con i seguenti vantaggi." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare o configurare nulla" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere o compilare codice" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il file 3MF e premere il pulsante \"Visualizza\"." >}}
