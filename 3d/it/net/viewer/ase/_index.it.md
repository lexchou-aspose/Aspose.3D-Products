---
title: Visualizza ASE formati di file tramite .NET 
weight: 1060
url: /it/net/viewer/ase/ 
description: C# codice sorgente per caricare, eseguire il rendering e visualizzare ASE documenti su .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ASE Visualizzatore di file for .NET" h2="Eseguire il rendering di ASE file senza alcun 3D software di modellazione e rendering." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ASE" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ASE" >}}
...
{{% blocks/products/pf/agp/content h2="Come visualizzare ASE file utilizzando C#" %}}

 Per visualizzare il file ASE, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per visualizzare ASE tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D consente agli sviluppatori di visualizzare facilmente il file ASE con poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file ASE tramite il costruttore della classe Scene1. Crea un'istanza di Html5SaveOptions1. Imposta le proprietà per la formattazione avanzata1. Chiama il metodo Scene.Save con l'oggetto di Html5SaveOptions1. Controlla il file HTML risultante nel browser predefinito
...
{{% blocks/products/pf/agp/code-block title="C# codice per visualizzare ASE" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// carica ASE scena tramite un'istanza di Scene
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D è un CAD e un Gameware API per caricare, modificare e convertire 3D file. API è autonomo e non richiede alcun 3D software di modellazione o rendering. Si può facilmente usare API per Discreet3DS, WavefrontOBJ, STL (ASCII, Binary), Universal3D, FBX (ASCII, Binary), Collada, glTF, PLY, GLB, DirectX e altri formati. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="App gratuita da visualizzare ASE" sectionDescription="Controlla le nostre demo dal vivo su [Visualizza ASE](https://products.aspose.app/3d/viewer/ase) con i seguenti vantaggi." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare o configurare nulla" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere o compilare codice" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il file ASE e premere il pulsante \"Visualizza\"." >}}
