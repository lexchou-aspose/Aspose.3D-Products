---
title: Converti DRC in DAE tramite Java 
url: /it/java/conversion/drc-to-dae/ 
description: Esempio di codice di conversione Java per il formato DRC in file DAE. Utilizza questo codice di esempio per convertire DRC in DAE all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti DRC in DAE tramite Java" h2="Conversione da DRC a DAE utilizzando la libreria Java senza alcun software di modellazione 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire DRC in DAE utilizzando Java" %}}

 Per eseguire il rendering da DRC a DAE, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire DRC in DAE tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java i programmatori possono convertire facilmente il file DRC in DAE in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file DRC tramite il costruttore della classe Scene1. Crea un'istanza di DaeSaveOptions1. Imposta DAE proprietà specifiche per la conversione avanzata1. Chiama il metodo Scene.save1. Passa il percorso di output con DAE estensione file e oggetto di DaeSaveOptions
...
{{% blocks/products/pf/agp/code-block title="da DRC a DAE Java Codice sorgente di conversione" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Dimostrazioni live di conversione da DRC a DAE" sectionDescription="[Converti DRC in DAE](https://products.aspose.app/3d/conversion/drc-to-dae) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file DRC, verrà convertito immediatamente in DAE." >}}
