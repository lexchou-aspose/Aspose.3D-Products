---
title: Converti GLTF in U3D tramite Java 
weight: 1550
url: /it/java/conversion/gltf-to-u3d/ 
description: Esempio di codice di conversione Java per il formato GLTF in file U3D. Utilizza questo codice di esempio per convertire GLTF in U3D all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti GLTF in U3D tramite Java" h2="Conversione da GLTF a U3D utilizzando la libreria Java senza alcun software di modellazione 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire GLTF in U3D utilizzando Java" %}}

 Per eseguire il rendering da GLTF a U3D, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire GLTF in U3D tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java i programmatori possono convertire facilmente il file GLTF in U3D in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file GLTF tramite il costruttore della classe Scene1. Crea un'istanza di U3dSaveOptions1. Imposta U3D proprietà specifiche per la conversione avanzata1. Chiama il metodo Scene.save1. Passa il percorso di output con U3D estensione file e oggetto di U3dSaveOptions
...
{{% blocks/products/pf/agp/code-block title="da GLTF a U3D Java Codice sorgente di conversione" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Dimostrazioni live di conversione da GLTF a U3D" sectionDescription="[Converti GLTF in U3D](https://products.aspose.app/3d/conversion/gltf-to-u3d) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file GLTF, verrà convertito immediatamente in U3D." >}}
