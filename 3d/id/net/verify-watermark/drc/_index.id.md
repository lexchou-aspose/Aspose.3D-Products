---
title: Tambahkan Verifikasi Tanda Air Buta ke DRC Format Berkas melalui .NET 
weight: 830
url: /id/net/verify-watermark/drc/ 
description: C# kode sumber untuk memuat, merender, dan menambahkan Verifikasi Tanda Air buta ke DRC dokumen di .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tambahkan Verifikasi Tanda Air Buta ke DRC melalui C#" h2="Buat .NET aplikasi Anda sendiri untuk menambahkan verifikasi tanda air buta ke DRC file menggunakan API sisi server." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DRC" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Verifikasi Watermark ke DRC File Menggunakan C#" %}}

 Untuk verifikasi tanda air DRC file, kami akan menggunakan
...
- Muat file DRC melalui konstruktor kelas Scene- Dapatkan kelas mesh dari Aspose.3D- Tambahkan sandi menggunakan metode DecodeWatermark Aspose.3D- Panggil metode Scene.Save dengan objek
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplikasi Gratis untuk Menambahkan Verifikasi Tanda Air Buta ke DRC" sectionDescription="Periksa demo langsung kami untuk [Verifikasi Tanda Air DRC](https://products.aspose.app/3d/verify-watermark/drc) dengan manfaat sebagai berikut." >}}
