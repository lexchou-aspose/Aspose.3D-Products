---
title: Ubah USD menjadi GLTF melalui C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ubah USD menjadi GLTF melalui C#" h2="Ekspor USD & file 3D lainnya menggunakan .NET Framework, .NET Core, dan Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ekspor USD Scene sebagai GLTF dengan C#" %}}
...
3. Berikan nama file keluaran dengan ekstensi .gltf sebagai parameter pertama
4. Tentukan nilai bidang `GLTF` dari [Format File](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) kelas
...
{{% blocks/products/pf/agp/code-autogen title="C# Kode untuk USD ke GLTF Konversi" gistPath="" %}}
```cs
