---
title: Ubah FBX menjadi GLB melalui C# 
url: /id/net/conversion/fbx-to-glb/ 
description: Kode contoh untuk konversi FBX ke GLB C#. Gunakan API kode contoh untuk file FBX batch ke konversi GLB dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah FBX menjadi GLB melalui C#" h2="Render FBX sebagai GLB tanpa 3D perangkat lunak pemodelan dan rendering apa pun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FBX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi FBX ke GLB Menggunakan C#" %}}

 Untuk mengonversi FBX menjadi GLB, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi FBX ke GLB melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pemrogram dapat dengan mudah memuat & mengonversi file FBX menjadi GLB hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file FBX melalui konstruktor kelas Scene1. Buat contoh AmfSaveOptions1. Tetapkan GLB properti khusus untuk konversi lanjutan1. Panggil Scene.Save method1. Lewati jalur keluaran dengan GLB ekstensi file & objek StlSaveOptions1. Periksa file GLB yang dihasilkan pada jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan FBX ke GLB C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplikasi Gratis untuk Mengonversi FBX ke GLB" sectionDescription="Periksa demo langsung kami untuk [FBX menjadi GLB konversi](https://products.aspose.app/3d/conversion/fbx-to-glb) dengan manfaat sebagai berikut." >}}
 ...
 3D Pustaka Pemrosesan Berkas untuk memanipulasi 3D berkas tanpa perangkat lunak pemodelan dan perenderan apa pun. 3D API mendukung Discreet3DS, WavefrontOBJ, FBX (ASCII, Biner), GLB (ASCII, Binary), Universal3D, Collada, glTF, GLB, PLY, DirectX, Google Draco format file dan banyak lagi. Pengembang dapat membuat, membaca, mengonversi, memodifikasi, dan mengontrol substansi 3D format dokumen dengan mudah.
