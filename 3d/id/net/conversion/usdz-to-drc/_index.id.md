---
title: Ubah USDZ menjadi DRC melalui C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Ubah USDZ menjadi DRC melalui C#" h2="Ekspor USDZ & file 3D lainnya menggunakan .NET Framework, .NET Core, dan Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Ekspor USDZ Scene sebagai DRC dengan C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Kode untuk USDZ ke DRC Konversi" gistPath="" %}}
```cs
