---
title: Ubah GLTF menjadi FBX melalui C# 
url: /id/net/conversion/gltf-to-fbx/ 
description: Kode contoh untuk konversi GLTF ke FBX C#. Gunakan API kode contoh untuk file GLTF batch ke konversi FBX dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah GLTF menjadi FBX melalui C#" h2="Render GLTF sebagai FBX tanpa 3D perangkat lunak pemodelan dan rendering apa pun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi GLTF ke FBX Menggunakan C#" %}}

 Untuk mengonversi GLTF menjadi FBX, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi GLTF ke FBX melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pemrogram dapat dengan mudah memuat & mengonversi file GLTF menjadi FBX hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file GLTF melalui konstruktor kelas Scene1. Buat contoh AmfSaveOptions1. Tetapkan FBX properti khusus untuk konversi lanjutan1. Panggil Scene.Save method1. Lewati jalur keluaran dengan FBX ekstensi file & objek FbxSaveOptions1. Periksa file FBX yang dihasilkan pada jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan GLTF ke FBX C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplikasi Gratis untuk Mengonversi GLTF ke FBX" sectionDescription="Periksa demo langsung kami untuk [GLTF menjadi FBX konversi](https://products.aspose.app/3d/conversion/gltf-to-fbx) dengan manfaat sebagai berikut." >}}
