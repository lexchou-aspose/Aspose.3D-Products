---
title: Ubah GLTF menjadi OBJ melalui C# 
url: /id/net/conversion/gltf-to-obj/ 
description: Kode contoh untuk konversi GLTF ke OBJ C#. Gunakan API kode contoh untuk file GLTF batch ke konversi OBJ dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah GLTF menjadi OBJ melalui C#" h2="Render GLTF sebagai OBJ tanpa 3D perangkat lunak pemodelan dan rendering apa pun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi GLTF ke OBJ Menggunakan C#" %}}

 Untuk mengonversi GLTF menjadi OBJ, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi GLTF ke OBJ melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pemrogram dapat dengan mudah memuat & mengonversi file GLTF menjadi OBJ hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file GLTF melalui konstruktor kelas Scene1. Buat contoh AmfSaveOptions1. Tetapkan OBJ properti khusus untuk konversi lanjutan1. Panggil Scene.Save method1. Lewati jalur keluaran dengan OBJ ekstensi file & objek ObjSaveOptions1. Periksa file OBJ yang dihasilkan pada jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan GLTF ke OBJ C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplikasi Gratis untuk Mengonversi GLTF ke OBJ" sectionDescription="Periksa demo langsung kami untuk [GLTF menjadi OBJ konversi](https://products.aspose.app/3d/conversion/gltf-to-obj) dengan manfaat sebagai berikut." >}}
