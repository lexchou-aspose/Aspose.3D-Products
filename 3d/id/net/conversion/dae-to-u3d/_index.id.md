---
title: Ubah DAE menjadi U3D melalui C# 
weight: 530
url: /id/net/conversion/dae-to-u3d/ 
description: Kode contoh untuk konversi DAE ke U3D C#. Gunakan API kode contoh untuk file DAE batch ke konversi U3D dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah DAE menjadi U3D melalui C#" h2="Render DAE sebagai U3D tanpa 3D perangkat lunak pemodelan dan rendering apa pun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi DAE ke U3D Menggunakan C#" %}}

 Untuk mengonversi DAE menjadi U3D, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi DAE ke U3D melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pemrogram dapat dengan mudah memuat & mengonversi file DAE menjadi U3D hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file DAE melalui konstruktor kelas Scene1. Buat contoh U3dSaveOptions1. Tetapkan U3D properti khusus untuk konversi lanjutan1. Panggil Scene.Save method1. Lewati jalur keluaran dengan U3D ekstensi file & objek U3dSaveOptions1. Periksa file U3D yang dihasilkan pada jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan DAE ke U3D C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplikasi Gratis untuk Mengonversi DAE ke U3D" sectionDescription="Periksa demo langsung kami untuk [DAE menjadi U3D konversi](https://products.aspose.app/3d/conversion/dae-to-u3d) dengan manfaat sebagai berikut." >}}
