...
description: Exempel på Java-konverteringskod för PDF-format till DAE-fil. Använd den här exempelkoden för att konvertera PDF till DAE i valfri webb- eller datorbaserad applikation Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera PDF till DAE via Java" h2="PDF till DAE omvandling med Java-biblioteket utan någon 3D-modelleringsprogramvara." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for Java" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/java" installationsDocsLink="https://docs.aspose.com/3d/java" nugetLink="" nugetPackageName="" downloadAsLink="https://releases.aspose.com/3d/java" learnAsLink="https://docs.aspose.com/3d/java" apiReference="" mavenRepoLink="https://repository.aspose.com/3d/" >}}

{{% blocks/products/pf/agp/content h2="Så här konverterar du PDF till DAE med Java" %}}

 För att rendera PDF till DAE använder vi
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-programmerare kan enkelt konvertera PDF-filen till DAE på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda PDF-filen via konstruktorn för Scene-klassen1. Skapa en instans av DaeSaveOptions1. Ställ in DAE specifika egenskaper för avancerad konvertering1. Ring Scene.save-metoden1. Skicka utdatasökvägen med DAE filtillägg och objekt för DaeSaveOptions
...
{{% blocks/products/pf/agp/code-block title="PDF till DAE Java Omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PDF till DAE Live Demos för konvertering" sectionDescription="[Konvertera PDF till DAE](https://products.aspose.app/3d/conversion/pdf-to-dae) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din PDF-fil, den konverteras omedelbart till DAE." >}}
