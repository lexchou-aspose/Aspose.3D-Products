---
title: Konvertera GLTF till USD via Java
weight: 530
url: /sv/java/conversion/gltf-to-usd/ 
description: Exempel på Java-konverteringskod för GLTF-format till USD-fil. Använd den här exempelkoden för att konvertera GLTF till USD i valfri webb- eller datorbaserad applikation Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera GLTF till USD via Java" h2="GLTF till USD omvandling med Java-biblioteket utan någon 3D-modelleringsprogramvara." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="USD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du GLTF till USD med Java" %}}

 För att rendera GLTF till USD använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera GLTF till USD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-programmerare kan enkelt konvertera GLTF-filen till USD på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda GLTF-filen via konstruktorn för Scene-klassen1. Anropa metoden Scene.save med formatet USD.1. Kontrollera den resulterande filen USD vid angiven sökväg
...
{{% blocks/products/pf/agp/code-block title="GLTF till USD Java Omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="GLTF till USD Live Demos för konvertering" sectionDescription="[Konvertera GLTF till USD](https://products.aspose.app/3d/conversion/gltf-to-usd) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din GLTF-fil, den konverteras omedelbart till USD." >}}
