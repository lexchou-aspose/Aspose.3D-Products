...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-programmerare kan enkelt konvertera 3DS-filen till GLTF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda 3DS-filen via konstruktorn för Scene-klassen1. Skapa en instans av GltfSaveOptions1. Ställ in GLTF specifika egenskaper för avancerad konvertering1. Ring Scene.save-metoden1. Skicka utdatasökvägen med GLTF filtillägg och objekt för GltfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="3DS till GLTF Java Omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="3DS till GLTF Live Demos för konvertering" sectionDescription="[Konvertera 3DS till GLTF](https://products.aspose.app/3d/conversion/3ds-to-gltf) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din 3DS-fil, den konverteras omedelbart till GLTF." >}}
