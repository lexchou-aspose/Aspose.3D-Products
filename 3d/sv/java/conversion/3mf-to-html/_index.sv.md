...
description: Exempel på Java-konverteringskod för 3MF-format till HTML-fil. Använd den här exempelkoden för att konvertera 3MF till HTML i valfri webb- eller datorbaserad applikation Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera 3MF till HTML via Java" h2="3MF till HTML omvandling med Java-biblioteket utan någon 3D-modelleringsprogramvara." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3MF" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du 3MF till HTML med Java" %}}

 För att rendera 3MF till HTML använder vi
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-programmerare kan enkelt konvertera 3MF-filen till HTML på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda 3MF-filen via konstruktorn för Scene-klassen1. Skapa en instans av HtmlSaveOptions1. Ställ in HTML specifika egenskaper för avancerad konvertering1. Ring Scene.save-metoden1. Skicka utdatasökvägen med HTML filtillägg och objekt för HtmlSaveOptions
...
{{% blocks/products/pf/agp/code-block title="3MF till HTML Java Omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="3MF till HTML Live Demos för konvertering" sectionDescription="[Konvertera 3MF till HTML](https://products.aspose.app/3d/conversion/3mf-to-html) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din 3MF-fil, den konverteras omedelbart till HTML." >}}
