---
title: Lägg till blind vattenstämpel i GLB filformat via .NET 
weight: 830
url: /sv/net/watermark/glb/ 
description: C# källkod för att ladda, rendera och lägga till blind vattenstämpel i GLB dokument på .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lägg till blind vattenstämpel till GLB via C#" h2="Bygg dina egna .NET-appar för att vattenmärka GLB-filer med API:er på serversidan." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLB" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLB" >}}

{{< blocks/products/pf/main-container pfName="Aspose.3D " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-3d" liveDemosLink="https://products.aspose.app/3d/family" docsLink="https://docs.aspose.com/3d/net" installationsDocsLink="https://docs.aspose.com/3d/net" nugetLink="https://www.nuget.org/packages/aspose.3d" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/3d/net" learnAsLink="https://docs.aspose.com/3d/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Hur man vattenstämplar till GLB fil med C#" %}}

 För att vattenstämpla filen GLB använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att lägga till blind vattenstämpel till GLB via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D gör det enkelt för utvecklarna att lägga till blind vattenstämpel i GLB-filen med bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

- Ladda GLB-filen via konstruktorn för Scene-klassen- Få meshklassen Aspose.3D- Lägg till vattenstämpel och lösenord med Aspose.3Ds EncodeWatermark-metod- Anropa metoden Scene.Save med objekt
...
{{% blocks/products/pf/agp/code-block title="C#-kod för att lägga till blind vattenstämpel till GLB" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att lägga till blind vattenstämpel till GLB" sectionDescription="Kolla våra livedemos för att [Vattenstämpel GLB](https://products.aspose.app/3d/watermark/glb) med följande förmåner." >}}
