---
title: Lägg till blind vattenstämpel i 3MF filformat via .NET 
weight: 830
url: /sv/net/watermark/3mf/ 
description: C# källkod för att ladda, rendera och lägga till blind vattenstämpel i 3MF dokument på .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lägg till blind vattenstämpel till 3MF via C#" h2="Bygg dina egna .NET-appar för att vattenmärka 3MF-filer med API:er på serversidan." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3MF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3MF" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man vattenstämplar till 3MF fil med C#" %}}

 För att vattenstämpla filen 3MF använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att lägga till blind vattenstämpel till 3MF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D gör det enkelt för utvecklarna att lägga till blind vattenstämpel i 3MF-filen med bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

- Ladda 3MF-filen via konstruktorn för Scene-klassen- Få meshklassen Aspose.3D- Lägg till vattenstämpel och lösenord med Aspose.3Ds EncodeWatermark-metod- Anropa metoden Scene.Save med objekt
...
{{% blocks/products/pf/agp/code-block title="C#-kod för att lägga till blind vattenstämpel till 3MF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att lägga till blind vattenstämpel till 3MF" sectionDescription="Kolla våra livedemos för att [Vattenstämpel 3MF](https://products.aspose.app/3d/watermark/3mf) med följande förmåner." >}}
