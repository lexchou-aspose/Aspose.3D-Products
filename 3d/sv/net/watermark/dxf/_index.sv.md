---
title: Lägg till blind vattenstämpel i DXF filformat via .NET 
weight: 830
url: /sv/net/watermark/dxf/ 
description: C# källkod för att ladda, rendera och lägga till blind vattenstämpel i DXF dokument på .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lägg till blind vattenstämpel till DXF via C#" h2="Bygg dina egna .NET-appar för att vattenmärka DXF-filer med API:er på serversidan." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DXF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DXF" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man vattenstämplar till DXF fil med C#" %}}

 För att vattenstämpla filen DXF använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att lägga till blind vattenstämpel till DXF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D gör det enkelt för utvecklarna att lägga till blind vattenstämpel i DXF-filen med bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

- Ladda DXF-filen via konstruktorn för Scene-klassen- Få meshklassen Aspose.3D- Lägg till vattenstämpel och lösenord med Aspose.3Ds EncodeWatermark-metod- Anropa metoden Scene.Save med objekt
...
{{% blocks/products/pf/agp/code-block title="C#-kod för att lägga till blind vattenstämpel till DXF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att lägga till blind vattenstämpel till DXF" sectionDescription="Kolla våra livedemos för att [Vattenstämpel DXF](https://products.aspose.app/3d/watermark/dxf) med följande förmåner." >}}
