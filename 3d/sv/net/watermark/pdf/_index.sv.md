---
title: Lägg till blind vattenstämpel i PDF filformat via .NET 
weight: 830
url: /sv/net/watermark/pdf/ 
description: C# källkod för att ladda, rendera och lägga till blind vattenstämpel i PDF dokument på .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lägg till blind vattenstämpel till PDF via C#" h2="Bygg dina egna .NET-appar för att vattenmärka PDF-filer med API:er på serversidan." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man vattenstämplar till PDF fil med C#" %}}

 För att vattenstämpla filen PDF använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att lägga till blind vattenstämpel till PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D gör det enkelt för utvecklarna att lägga till blind vattenstämpel i PDF-filen med bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

- Ladda PDF-filen via konstruktorn för Scene-klassen- Få meshklassen Aspose.3D- Lägg till vattenstämpel och lösenord med Aspose.3Ds EncodeWatermark-metod- Anropa metoden Scene.Save med objekt
...
{{% blocks/products/pf/agp/code-block title="C#-kod för att lägga till blind vattenstämpel till PDF" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D är ett CAD och spelprogram API för att ladda, ändra och konvertera 3D filer. API är en fristående och kräver ingen 3D-modellerings- eller renderingsprogramvara. Man kan enkelt använda API för Discreet3DS, WavefrontOBJ, STL (ASCII, binär), Universal3D, FBX (ASCII, binär), Collada, glTF, PLY, GLB, DirectX och fler format. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att lägga till blind vattenstämpel till PDF" sectionDescription="Kolla våra livedemos för att [Vattenstämpel PDF](https://products.aspose.app/3d/watermark/pdf) med följande förmåner." >}}
