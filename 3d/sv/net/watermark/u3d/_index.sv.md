---
title: Lägg till blind vattenstämpel i U3D filformat via .NET 
weight: 830
url: /sv/net/watermark/u3d/ 
description: C# källkod för att ladda, rendera och lägga till blind vattenstämpel i U3D dokument på .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lägg till blind vattenstämpel till U3D via C#" h2="Bygg dina egna .NET-appar för att vattenmärka U3D-filer med API:er på serversidan." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="U3D" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="U3D" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man vattenstämplar till U3D fil med C#" %}}

 För att vattenstämpla filen U3D använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att lägga till blind vattenstämpel till U3D via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D gör det enkelt för utvecklarna att lägga till blind vattenstämpel i U3D-filen med bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

- Ladda U3D-filen via konstruktorn för Scene-klassen- Få meshklassen Aspose.3D- Lägg till vattenstämpel och lösenord med Aspose.3Ds EncodeWatermark-metod- Anropa metoden Scene.Save med objekt
...
{{% blocks/products/pf/agp/code-block title="C#-kod för att lägga till blind vattenstämpel till U3D" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att lägga till blind vattenstämpel till U3D" sectionDescription="Kolla våra livedemos för att [Vattenstämpel U3D](https://products.aspose.app/3d/watermark/u3d) med följande förmåner." >}}
