---
title: Extrahera tillgångar från PLY filformat via .NET 
weight: 830
url: /sv/net/extractor/ply/ 
description: C# källkod för att ladda, rendera och lägga till extrahera tillgångar från PLY dokument på .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrahera tillgångar från PLY via C#" h2="Bygg dina egna .NET-appar för att extrahera tillgångar från PLY-filer med hjälp av API:er på serversidan." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PLY" >}}
...
{{% blocks/products/pf/agp/content h2="Så här extraherar du tillgångar från PLY-fil med C#" %}}

 För att extrahera tillgångar från filen PLY kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att extrahera tillgångar från PLY via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D gör det enkelt för utvecklarna att extrahera tillgångar från PLY-filen med bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

- Ladda PLY-filen via konstruktorn för Scene-klassen- Skapa zip-filformatobjekt som utdatafilformat- Skapa arkivklass och hantera extrahera tillgångsklass- Anropa extrahera metoden och spara filen
...
{{% blocks/products/pf/agp/code-block title="C#-kod för att extrahera tillgångar från PLY" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D är ett CAD och spelprogram API för att ladda, ändra och konvertera 3D filer. API är en fristående och kräver ingen 3D-modellerings- eller renderingsprogramvara. Man kan enkelt använda API för Discreet3DS, WavefrontOBJ, STL (ASCII, binär), Universal3D, FBX (ASCII, binär), Collada, glTF, PLY, GLB, DirectX och fler format. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att extrahera tillgångar från PLY" sectionDescription="Kolla våra livedemos för att [Extraktor PLY](https://products.aspose.app/3d/extractor/ply) med följande förmåner." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp PLY fil och tryck på knappen \"Extrahera\"." >}}
