...
description: Exempelkod för konvertering från FBX till GLTF C#. Använd API exempelkod för batch-FBX-filer till GLTFkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera FBX till GLTF via C#" h2="Rendera FBX som GLTF utan någon 3D-modellerings- och renderingsprogramvara." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GLTF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FBX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du FBX till GLTF med C#" %}}

 För att konvertera FBX till GLTF använder vi
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programmerare kan enkelt ladda och konvertera FBX filer till GLTF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda FBX-filen via konstruktorn för Scene-klassen1. Skapa en instans av AmfSaveOptions1. Ställ in GLTF specifika egenskaper för avancerad konvertering1. Anropa metoden Scene.Save1. Skicka utdatasökvägen med GLTF filtillägg och objekt för GltfSaveOptions1. Kontrollera den resulterande filen GLTF vid angiven sökväg
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från FBX till GLTF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att konvertera FBX till GLTF" sectionDescription="Kolla in våra livedemos för [FBX till GLTF omvandling](https://products.aspose.app/3d/conversion/fbx-to-gltf) med följande förmåner." >}}
