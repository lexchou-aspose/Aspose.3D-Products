---
title: Konvertera PDF till PLY via C# 
weight: 3200
url: /sv/net/conversion/pdf-to-ply/ 
description: Exempelkod för konvertering från PDF till PLY C#. Använd API exempelkod för batch-PDF-filer till PLYkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera PDF till PLY via C#" h2="Rendera PDF som PLY utan någon 3D-modellerings- och renderingsprogramvara." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PDF" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du PDF till PLY med C#" %}}

 För att konvertera PDF till PLY använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera PDF till PLY via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmerare kan enkelt ladda och konvertera PDF filer till PLY på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda PDF-filen via konstruktorn för Scene-klassen1. Skapa en instans av PlySaveOptions1. Ställ in PLY specifika egenskaper för avancerad konvertering1. Anropa metoden Scene.Save1. Skicka utdatasökvägen med PLY filtillägg och objekt för PlySaveOptions1. Kontrollera den resulterande filen PLY vid angiven sökväg
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från PDF till PLY C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att konvertera PDF till PLY" sectionDescription="Kolla in våra livedemos för [PDF till PLY omvandling](https://products.aspose.app/3d/conversion/pdf-to-ply) med följande förmåner." >}}
