---
title: Konvertera AMF till USD via C# 
weight: 530
url: /sv/net/conversion/amf-to-usd/ 
description: Exempelkod för konvertering från AMF till USD C#. Använd API exempelkod för batch-AMF-filer till USDkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera AMF till USD via C#" h2="Rendera AMF som USD utan någon 3D-modellerings- och renderingsprogramvara." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="USD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="AMF" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du AMF till USD med C#" %}}

 För att konvertera AMF till USD använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera AMF till USD via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programmerare kan enkelt ladda och konvertera AMF filer till USD på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda AMF-filen via konstruktorn för Scene-klassen1. Anropa metoden Scene.Save med USDs format.1. Kontrollera den resulterande filen USD vid angiven sökväg
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från AMF till USD C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att konvertera AMF till USD" sectionDescription="Kolla in våra livedemos för [AMF till USD omvandling](https://products.aspose.app/3d/conversion/amf-to-usd) med följande förmåner." >}}
