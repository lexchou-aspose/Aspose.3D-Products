...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera USDZ till FBX via C#" h2="Exportera USDZ och andra 3D filer med .NET Framework, .NET Core och Mono" >}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Kod för omvandling från USDZ till FBX" gistPath="" %}}
```cs
