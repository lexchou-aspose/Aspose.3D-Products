---
title: Lägg till blind vattenstämpelverifiering till 3MF filformat via .NET 
weight: 830
url: /sv/net/verify-watermark/3mf/ 
description: C# källkod för att ladda, rendera och lägga till blind vattenstämpelsverifiering till 3MF dokument på .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lägg till verifiering av blind vattenstämpel till 3MF via C#" h2="Bygg dina egna .NET-appar för att lägga till blind vattenstämpelverifiering till 3MF-filer med hjälp av API:er på serversidan." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3MF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3MF" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man verifierar vattenstämpel till 3MF fil med C#" %}}

 För att vattenstämpla verifieringsfilen 3MF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att lägga till blind vattenstämpelverifiering till 3MF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D gör det enkelt för utvecklarna att lägga till blind vattenstämpelverifiering i 3MF-filen med bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

- Ladda 3MF-filen via konstruktorn för Scene-klassen- Få meshklassen Aspose.3D- Lägg till lösenord med Aspose.3Ds DecodeWatermark-metod- Anropa metoden Scene.Save med objekt
...
{{% blocks/products/pf/agp/code-block title="C#-kod för att lägga till verifiering av blind vattenstämpel till 3MF" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Gratis app för att lägga till verifiering av blind vattenstämpel till 3MF" sectionDescription="Kolla våra livedemos för att [Vattenstämpelverifiering 3MF](https://products.aspose.app/3d/verify-watermark/3mf) med följande förmåner." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp filen 3MF och tryck på knappen \"Vattenstämpel\"." >}}
