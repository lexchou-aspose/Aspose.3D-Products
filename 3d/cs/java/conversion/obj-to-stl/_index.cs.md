---
title: Převést OBJ na STL prostřednictvím Java 
weight: 2860
url: /cs/java/conversion/obj-to-stl/ 
description: Ukázkový konverzní kód Java pro formát OBJ na soubor STL. Pomocí tohoto příkladu kódu převeďte OBJ na STL v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést OBJ na STL prostřednictvím Java" h2="Převod OBJ na STL pomocí knihovny Java bez jakéhokoli modelovacího softwaru 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="STL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést OBJ na STL pomocí Java" %}}
 ...
 K vykreslení OBJ do STL použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi OBJ na STL prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři Java mohou snadno převést soubor OBJ na STL pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor OBJ pomocí konstruktoru třídy Scene1. Vytvořte instanci StlSaveOptions1. Nastavte STL konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.save1. Předejte výstupní cestu s příponou souboru STL a objektem StlSaveOptions
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze OBJ na STL Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Živá ukázka konverzí OBJ na STL" sectionDescription="[Převést OBJ na STL](https://products.aspose.app/3d/conversion/obj-to-stl) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor OBJ, bude okamžitě převeden na STL." >}}
