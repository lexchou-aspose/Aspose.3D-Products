---
title: Převést GLB na OBJ prostřednictvím Java
weight: 530
url: /cs/java/conversion/glb-to-obj/ 
description: Ukázkový konverzní kód Java pro formát GLB na soubor OBJ. Pomocí tohoto příkladu kódu převeďte GLB na OBJ v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést GLB na OBJ prostřednictvím Java" h2="Převod GLB na OBJ pomocí knihovny Java bez jakéhokoli modelovacího softwaru 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLB" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést GLB na OBJ pomocí Java" %}}
 ...
 K vykreslení GLB do OBJ použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi GLB na OBJ prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři Java mohou snadno převést soubor GLB na OBJ pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze GLB na OBJ Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Živá ukázka konverzí GLB na OBJ" sectionDescription="[Převést GLB na OBJ](https://products.aspose.app/3d/conversion/glb-to-obj) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor GLB, bude okamžitě převeden na OBJ." >}}
