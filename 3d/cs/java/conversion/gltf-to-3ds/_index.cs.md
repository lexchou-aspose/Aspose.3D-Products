---
title: Převést GLTF na 3DS prostřednictvím Java 
weight: 1530
url: /cs/java/conversion/gltf-to-3ds/ 
description: Ukázkový konverzní kód Java pro formát GLTF na soubor 3DS. Pomocí tohoto příkladu kódu převeďte GLTF na 3DS v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést GLTF na 3DS prostřednictvím Java" h2="Převod GLTF na 3DS pomocí knihovny Java bez jakéhokoli modelovacího softwaru 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést GLTF na 3DS pomocí Java" %}}
 ...
 K vykreslení GLTF do 3DS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi GLTF na 3DS prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři Java mohou snadno převést soubor GLTF na 3DS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor GLTF pomocí konstruktoru třídy Scene1. Vytvořte instanci 3dsSaveOptions1. Nastavte 3DS konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.save1. Předejte výstupní cestu s příponou souboru 3DS a objektem 3dsSaveOptions
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze GLTF na 3DS Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Živá ukázka konverzí GLTF na 3DS" sectionDescription="[Převést GLTF na 3DS](https://products.aspose.app/3d/conversion/gltf-to-3ds) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor GLTF, bude okamžitě převeden na 3DS." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/3d/java/conversion/gltf-to-obj/" name="GLTF DO OBJ" description="3D Formát souboru" >}}
