---
title: Převést X na PDF prostřednictvím Java 
url: /cs/java/conversion/x-to-pdf/ 
description: Ukázkový konverzní kód Java pro soubor ve formátu X na PDF. Pomocí tohoto příkladu kódu převeďte X na PDF v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést X na PDF prostřednictvím Java" h2="Převod X na PDF pomocí knihovny Java bez jakéhokoli modelovacího softwaru 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="X" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést X na PDF pomocí Java" %}}
 ...
 K vykreslení X na PDF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu X na PDF prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři Java mohou snadno převést soubor X na PDF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor X pomocí konstruktoru třídy Scene1. Vytvořte instanci PdfSaveOptions1. Nastavte PDF konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.save1. Předejte výstupní cestu s příponou souboru PDF a objektem PdfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze X na PDF Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Živá ukázka konverze X na PDF" sectionDescription="[Převést X na PDF](https://products.aspose.app/3d/conversion/x-to-pdf) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor X a bude okamžitě převeden na PDF." >}}
