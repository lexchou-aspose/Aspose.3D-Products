---
title: Převést 3MF na DAE prostřednictvím Java 
weight: 1650
url: /cs/java/conversion/3mf-to-dae/ 
description: Ukázkový konverzní kód Java pro formát 3MF na soubor DAE. Pomocí tohoto příkladu kódu převeďte 3MF na DAE v jakékoli webové nebo desktopové aplikaci založené na Java.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést 3MF na DAE pomocí Java" %}}
 ...
 K vykreslení 3MF do DAE použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi 3MF na DAE prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři Java mohou snadno převést soubor 3MF na DAE pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor 3MF pomocí konstruktoru třídy Scene1. Vytvořte instanci DaeSaveOptions1. Nastavte DAE konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.save1. Předejte výstupní cestu s příponou souboru DAE a objektem DaeSaveOptions
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze 3MF na DAE Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Živá ukázka konverzí 3MF na DAE" sectionDescription="[Převést 3MF na DAE](https://products.aspose.app/3d/conversion/3mf-to-dae) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor 3MF, bude okamžitě převeden na DAE." >}}
