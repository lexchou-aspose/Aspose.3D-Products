---
title: Převést 3MF na PLY prostřednictvím Java 
weight: 3040
url: /cs/java/conversion/3mf-to-ply/ 
description: Ukázkový konverzní kód Java pro formát 3MF na soubor PLY. Pomocí tohoto příkladu kódu převeďte 3MF na PLY v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést 3MF na PLY prostřednictvím Java" h2="Převod 3MF na PLY pomocí knihovny Java bez jakéhokoli modelovacího softwaru 3D." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/3d/272x272/aspose_3d-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3MF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést 3MF na PLY pomocí Java" %}}
 ...
 K vykreslení 3MF do PLY použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi 3MF na PLY prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři Java mohou snadno převést soubor 3MF na PLY pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor 3MF pomocí konstruktoru třídy Scene1. Vytvořte instanci PlySaveOptions1. Nastavte PLY konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.save1. Předejte výstupní cestu s příponou souboru PLY a objektem PlySaveOptions
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze 3MF na PLY Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Živá ukázka konverzí 3MF na PLY" sectionDescription="[Převést 3MF na PLY](https://products.aspose.app/3d/conversion/3mf-to-ply) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor 3MF, bude okamžitě převeden na PLY." >}}
