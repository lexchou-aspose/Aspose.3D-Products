...
{{% blocks/products/pf/agp/content h2="Jak převést OBJ na GLTF pomocí Java" %}}
 ...
 K vykreslení OBJ do GLTF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi OBJ na GLTF prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři Java mohou snadno převést soubor OBJ na GLTF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor OBJ pomocí konstruktoru třídy Scene1. Vytvořte instanci GltfSaveOptions1. Nastavte GLTF konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.save1. Předejte výstupní cestu s příponou souboru GLTF a objektem GltfSaveOptions
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze OBJ na GLTF Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Živá ukázka konverzí OBJ na GLTF" sectionDescription="[Převést OBJ na GLTF](https://products.aspose.app/3d/conversion/obj-to-gltf) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor OBJ, bude okamžitě převeden na GLTF." >}}
