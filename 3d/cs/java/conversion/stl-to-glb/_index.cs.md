...
{{% blocks/products/pf/agp/content h2="Jak převést STL na GLB pomocí Java" %}}
 ...
 K vykreslení STL do GLB použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi STL na GLB prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři Java mohou snadno převést soubor STL na GLB pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze STL na GLB Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Živá ukázka konverzí STL na GLB" sectionDescription="[Převést STL na GLB](https://products.aspose.app/3d/conversion/stl-to-glb) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor STL, bude okamžitě převeden na GLB." >}}
