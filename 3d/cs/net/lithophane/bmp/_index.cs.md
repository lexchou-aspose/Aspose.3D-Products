---
title: Vytvořte si Lithophane z formátů souborů BMP prostřednictvím .NET 
weight: 830
url: /cs/net/lithophane/bmp/ 
description: C# zdrojový kód k načtení, vykreslení a vytvoření dokumentů typu lithophane to BMP na .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vytvořte svůj Lithophane do BMP prostřednictvím C#" h2="Sestavte si své vlastní aplikace .NET a vytvořte si soubory lithophane to BMP pomocí rozhraní API na straně serveru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="BMP" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="BMP" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit soubor Lithophane do BMP pomocí C#" %}}

 K vytvoření vašeho souboru lithophane to BMP použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k vytvoření Lithophane do BMP prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D usnadňuje vývojářům vytvořit váš lithophane do souboru BMP pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

- Vytvořte nějaké nové parametry a vytvořte objekt Mesh- Provádějte výpočetní operace s objekty Mesh- Soubor BMP načte 3D scénu prostřednictvím třídy Mesh- Zavolejte metodu Scene.Save s objektem
...
{{% blocks/products/pf/agp/code-block title="C# kód k vytvoření Lithophane do BMP" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D je CAD a herní software API k načítání, úpravě a převodu souborů 3D. API je samostatný a nevyžaduje žádný 3D modelovací nebo vykreslovací software. Lze snadno použít API pro Discreet3DS, WavefrontOBJ, STL (ASCII, binární), Universal3D, FBX (ASCII, binární), Collada, glTF, PLY, GLB, DirectX a další formáty. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro vytvoření vašeho Lithophane do BMP" sectionDescription="Podívejte se na naše živé ukázky [Lithophane BMP](https://products.aspose.app/3d/lithophane/bmp) s následujícími výhodami." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát soubor BMP a stisknout tlačítko „lithophane“." >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" V případě potřeby stáhněte soubor BMP z odkazu" >}}
