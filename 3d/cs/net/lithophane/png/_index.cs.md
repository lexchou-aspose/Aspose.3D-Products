---
title: Vytvořte si Lithophane z formátů souborů PNG prostřednictvím .NET 
weight: 830
url: /cs/net/lithophane/png/ 
description: C# zdrojový kód k načtení, vykreslení a vytvoření dokumentů typu lithophane to PNG v .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vytvořte svůj Lithophane do PNG prostřednictvím C#" h2="Sestavte si své vlastní aplikace .NET a vytvořte si soubory lithophane to PNG pomocí rozhraní API na straně serveru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="PNG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit soubor Lithophane do PNG pomocí C#" %}}

 K vytvoření vašeho souboru lithophane to PNG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k vytvoření Lithophane do PNG prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D usnadňuje vývojářům vytvořit váš litophane do souboru PNG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

- Vytvořte nějaké nové parametry a vytvořte objekt Mesh- Provádějte výpočetní operace s objekty Mesh- Soubor PNG načte 3D scénu prostřednictvím třídy Mesh- Zavolejte metodu Scene.Save s objektem
...
{{% blocks/products/pf/agp/code-block title="C# kód k vytvoření Lithophane do PNG" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D je CAD a herní software API k načítání, úpravě a převodu souborů 3D. API je samostatný a nevyžaduje žádný 3D modelovací nebo vykreslovací software. Lze snadno použít API pro Discreet3DS, WavefrontOBJ, STL (ASCII, binární), Universal3D, FBX (ASCII, binární), Collada, glTF, PLY, GLB, DirectX a další formáty. 
  ...
  {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro vytvoření Lithophane do PNG" sectionDescription="Podívejte se na naše živé ukázky [Lithophane PNG](https://products.aspose.app/3d/lithophane/png) s následujícími výhodami." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát soubor PNG a stisknout tlačítko „lithophane“." >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" V případě potřeby stáhněte soubor PNG z odkazu" >}}
