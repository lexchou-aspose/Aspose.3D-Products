---
title: Převést DAE na OBJ prostřednictvím C# 
weight: 240
url: /cs/net/conversion/dae-to-obj/ 
description: Ukázkový kód pro konverzi DAE na OBJ C#. Použijte API ukázkový kód pro dávkový převod souborů DAE na OBJ v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést DAE na OBJ prostřednictvím C#" h2="Vykreslit DAE jako OBJ bez jakéhokoli 3D modelovacího a vykreslovacího softwaru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi DAE na OBJ prostřednictvím C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi DAE na OBJ C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod DAE na OBJ" sectionDescription="Podívejte se na naše živé ukázky [Konverze DAE na OBJ](https://products.aspose.app/3d/conversion/dae-to-obj) s následujícími výhodami." >}}
