...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi DAE na U3D prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři .NET mohou snadno načíst a převést soubory DAE na U3D pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor DAE pomocí konstruktoru třídy Scene1. Vytvořte instanci U3dSaveOptions1. Nastavte U3D konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.Save1. Předejte výstupní cestu s příponou souboru U3D a objektem U3dSaveOptions1. Zkontrolujte výsledný soubor U3D v zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi DAE na U3D C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod DAE na U3D" sectionDescription="Podívejte se na naše živé ukázky [Konverze DAE na U3D](https://products.aspose.app/3d/conversion/dae-to-u3d) s následujícími výhodami." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/3d/net/conversion/dae-to-stl/" name="DAE DO STL" description="Vyměnitelná 3D povrchová geometrie" >}}
