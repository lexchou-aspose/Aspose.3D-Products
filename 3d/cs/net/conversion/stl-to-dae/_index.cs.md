---
title: Převést STL na DAE prostřednictvím C# 
weight: 2040
url: /cs/net/conversion/stl-to-dae/ 
description: Ukázkový kód pro konverzi STL na DAE C#. Použijte API ukázkový kód pro dávkový převod souborů STL na DAE v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést STL na DAE prostřednictvím C#" h2="Vykreslit STL jako DAE bez jakéhokoli 3D modelovacího a vykreslovacího softwaru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DAE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="STL" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést STL na DAE pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi STL na DAE prostřednictvím C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi STL na DAE C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod STL na DAE" sectionDescription="Podívejte se na naše živé ukázky [Konverze STL na DAE](https://products.aspose.app/3d/conversion/stl-to-dae) s následujícími výhodami." >}}
