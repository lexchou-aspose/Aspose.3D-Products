---
title: Převést DAE na 3DS prostřednictvím C# 
weight: 520
url: /cs/net/conversion/dae-to-3ds/ 
description: Ukázkový kód pro konverzi DAE na 3DS C#. Použijte API ukázkový kód pro dávkový převod souborů DAE na 3DS v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést DAE na 3DS prostřednictvím C#" h2="Vykreslit DAE jako 3DS bez jakéhokoli 3D modelovacího a vykreslovacího softwaru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést DAE na 3DS pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi DAE na 3DS prostřednictvím C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi DAE na 3DS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod DAE na 3DS" sectionDescription="Podívejte se na naše živé ukázky [Konverze DAE na 3DS](https://products.aspose.app/3d/conversion/dae-to-3ds) s následujícími výhodami." >}}
