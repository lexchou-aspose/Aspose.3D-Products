---
title: Převést 3DS na HTML prostřednictvím C# 
weight: 2460
url: /cs/net/conversion/3ds-to-html/ 
description: Ukázkový kód pro konverzi 3DS na HTML C#. Použijte API ukázkový kód pro dávkový převod souborů 3DS na HTML v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést 3DS na HTML prostřednictvím C#" h2="Vykreslit 3DS jako HTML bez jakéhokoli 3D modelovacího a vykreslovacího softwaru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést 3DS na HTML pomocí C#" %}}
 ...
 Abychom převedli 3DS na HTML, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi 3DS na HTML prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři .NET mohou snadno načíst a převést soubory 3DS na HTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor 3DS pomocí konstruktoru třídy Scene1. Vytvořte instanci HtmlSaveOptions1. Nastavte HTML konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.Save1. Předejte výstupní cestu s příponou souboru HTML a objektem HtmlSaveOptions1. Zkontrolujte výsledný soubor HTML v zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi 3DS na HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod 3DS na HTML" sectionDescription="Podívejte se na naše živé ukázky [Konverze 3DS na HTML](https://products.aspose.app/3d/conversion/3ds-to-html) s následujícími výhodami." >}}
