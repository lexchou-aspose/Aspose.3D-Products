---
title: Převést DAE na FBX prostřednictvím C# 
weight: 20
url: /cs/net/conversion/dae-to-fbx/ 
description: Ukázkový kód pro konverzi DAE na FBX C#. Použijte API ukázkový kód pro dávkový převod souborů DAE na FBX v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést DAE na FBX prostřednictvím C#" h2="Vykreslit DAE jako FBX bez jakéhokoli 3D modelovacího a vykreslovacího softwaru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést DAE na FBX pomocí C#" %}}

 Abychom převedli DAE na FBX, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi DAE na FBX prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři .NET mohou snadno načíst a převést soubory DAE na FBX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor DAE pomocí konstruktoru třídy Scene1. Vytvořte instanci FbxSaveOptions1. Nastavte FBX konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.Save1. Předejte výstupní cestu s příponou souboru FBX a objektem FbxSaveOptions1. Zkontrolujte výsledný soubor FBX v zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi DAE na FBX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod DAE na FBX" sectionDescription="Podívejte se na naše živé ukázky [Konverze DAE na FBX](https://products.aspose.app/3d/conversion/dae-to-fbx) s následujícími výhodami." >}}
