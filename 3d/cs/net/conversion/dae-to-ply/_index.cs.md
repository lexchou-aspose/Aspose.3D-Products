---
title: Převést DAE na PLY prostřednictvím C# 
weight: 3320
url: /cs/net/conversion/dae-to-ply/ 
description: Ukázkový kód pro konverzi DAE na PLY C#. Použijte API ukázkový kód pro dávkový převod souborů DAE na PLY v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést DAE na PLY prostřednictvím C#" h2="Vykreslit DAE jako PLY bez jakéhokoli 3D modelovacího a vykreslovacího softwaru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DAE" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést DAE na PLY pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi DAE na PLY prostřednictvím C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi DAE na PLY C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod DAE na PLY" sectionDescription="Podívejte se na naše živé ukázky [Konverze DAE na PLY](https://products.aspose.app/3d/conversion/dae-to-ply) s následujícími výhodami." >}}
