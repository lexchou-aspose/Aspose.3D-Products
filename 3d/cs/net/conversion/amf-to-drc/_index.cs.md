...
{{% blocks/products/pf/agp/content h2="Jak převést AMF na DRC pomocí C#" %}}
 ...
 Abychom převedli AMF na DRC, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi AMF na DRC prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři .NET mohou snadno načíst a převést soubory AMF na DRC pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor AMF pomocí konstruktoru třídy Scene1. Vytvořte instanci AmfSaveOptions1. Nastavte DRC konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.Save1. Předejte výstupní cestu s příponou souboru DRC a objektem DrcSaveOptions1. Zkontrolujte výsledný soubor DRC v zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi AMF na DRC C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod AMF na DRC" sectionDescription="Podívejte se na naše živé ukázky [Konverze AMF na DRC](https://products.aspose.app/3d/conversion/amf-to-drc) s následujícími výhodami." >}}
