...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi 3MF na PLY prostřednictvím C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi 3MF na PLY C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod 3MF na PLY" sectionDescription="Podívejte se na naše živé ukázky [Konverze 3MF na PLY](https://products.aspose.app/3d/conversion/3mf-to-ply) s následujícími výhodami." >}}
