---
title: Převést USDZ na ASE prostřednictvím C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést USDZ na ASE prostřednictvím C#" h2="Exportujte USDZ a další soubory 3D pomocí .NET Framework, .NET Core a Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportovat scénu USDZ jako ASE pomocí C#" %}}
...
3. Jako první parametr předejte název výstupního souboru s příponou .ase
...
{{% blocks/products/pf/agp/code-autogen title="C# Kód pro konverzi USDZ na ASE" gistPath="" %}}
```cs
