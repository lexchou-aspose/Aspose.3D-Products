---
title: Převést OBJ na FBX prostřednictvím C# 
weight: 3600
url: /cs/net/conversion/obj-to-fbx/ 
description: Ukázkový kód pro konverzi OBJ na FBX C#. Použijte API ukázkový kód pro dávkový převod souborů OBJ na FBX v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést OBJ na FBX prostřednictvím C#" h2="Vykreslit OBJ jako FBX bez jakéhokoli 3D modelovacího a vykreslovacího softwaru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FBX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OBJ" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést OBJ na FBX pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi OBJ na FBX prostřednictvím C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi OBJ na FBX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod OBJ na FBX" sectionDescription="Podívejte se na naše živé ukázky [Konverze OBJ na FBX](https://products.aspose.app/3d/conversion/obj-to-fbx) s následujícími výhodami." >}}
