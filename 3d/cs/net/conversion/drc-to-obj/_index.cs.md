---
title: Převést DRC na OBJ prostřednictvím C# 
url: /cs/net/conversion/drc-to-obj/ 
description: Ukázkový kód pro konverzi DRC na OBJ C#. Použijte API ukázkový kód pro dávkový převod souborů DRC na OBJ v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést DRC na OBJ prostřednictvím C#" h2="Vykreslit DRC jako OBJ bez jakéhokoli 3D modelovacího a vykreslovacího softwaru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="OBJ" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DRC" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést DRC na OBJ pomocí C#" %}}

 Abychom převedli DRC na OBJ, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi DRC na OBJ prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři .NET mohou snadno načíst a převést soubory DRC na OBJ pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor DRC pomocí konstruktoru třídy Scene1. Vytvořte instanci AmfSaveOptions1. Nastavte OBJ konkrétních vlastností pro pokročilý převod1. Zavolejte metodu Scene.Save1. Předejte výstupní cestu s příponou souboru OBJ a objektem ObjSaveOptions1. Zkontrolujte výsledný soubor OBJ v zadané cestě
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi DRC na OBJ C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod DRC na OBJ" sectionDescription="Podívejte se na naše živé ukázky [Konverze DRC na OBJ](https://products.aspose.app/3d/conversion/drc-to-obj) s následujícími výhodami." >}}
