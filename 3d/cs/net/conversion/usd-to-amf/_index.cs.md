---
title: Převést USD na AMF prostřednictvím C# 
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést USD na AMF prostřednictvím C#" h2="Exportujte USD a další soubory 3D pomocí .NET Framework, .NET Core a Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportovat scénu USD jako AMF pomocí C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Kód pro konverzi USD na AMF" gistPath="" %}}
```cs
