---
title: Převést USDZ na JT prostřednictvím C# 
description: Převeďte USDZ a další soubory 3D pomocí .NET API
url: /cs/net/conversion/usdz-to-jt/
family: 3d
platformtag: net
feature: conversion
informat: USDZ
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést USDZ na JT prostřednictvím C#" h2="Exportujte USDZ a další soubory 3D pomocí .NET Framework, .NET Core a Mono" >}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Exportovat scénu USDZ jako JT pomocí C#" %}}
...
3. Jako první parametr předejte název výstupního souboru s příponou .jt
4. Zadejte hodnotu pole `SiemensJT9` od [Formát souboru](https://apireference.aspose.com/3d/net/aspose.threed/fileformat/fields/index) třída
...
{{% blocks/products/pf/agp/code-autogen title="C# Kód pro konverzi USDZ na JT" gistPath="" %}}
```cs
