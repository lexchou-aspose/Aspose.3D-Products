---
title: Převést GLTF na 3DS prostřednictvím C# 
url: /cs/net/conversion/gltf-to-3ds/ 
description: Ukázkový kód pro konverzi GLTF na 3DS C#. Použijte API ukázkový kód pro dávkový převod souborů GLTF na 3DS v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést GLTF na 3DS prostřednictvím C#" h2="Vykreslit GLTF jako 3DS bez jakéhokoli 3D modelovacího a vykreslovacího softwaru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3DS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="GLTF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést GLTF na 3DS pomocí C#" %}}
 ...
 Abychom převedli GLTF na 3DS, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi GLTF na 3DS prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programátoři .NET mohou snadno načíst a převést soubory GLTF na 3DS pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi GLTF na 3DS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro převod GLTF na 3DS" sectionDescription="Podívejte se na naše živé ukázky [Konverze GLTF na 3DS](https://products.aspose.app/3d/conversion/gltf-to-3ds) s následujícími výhodami." >}}
