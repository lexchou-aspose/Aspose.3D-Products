---
title: Zobrazit JT formátů souborů prostřednictvím .NET 
weight: 3090
url: /cs/net/viewer/jt/ 
description: C# zdrojový kód pro načtení, vykreslení a zobrazení JT dokumentů v .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JT Prohlížeč souborů for .NET" h2="Vykreslete JT souborů bez jakéhokoli 3D modelovacího a vykreslovacího softwaru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JT" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak zobrazit soubor JT pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k zobrazení JT prostřednictvím C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# kód k zobrazení JT" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D je CAD a herní software API k načítání, úpravě a převodu souborů 3D. API je samostatný a nevyžaduje žádný 3D modelovací nebo vykreslovací software. Lze snadno použít API pro Discreet3DS, WavefrontOBJ, STL (ASCII, binární), Universal3D, FBX (ASCII, binární), Collada, glTF, PLY, GLB, DirectX a další formáty. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace k zobrazení JT" sectionDescription="Podívejte se na naše živé ukázky [Zobrazit JT](https://products.aspose.app/3d/viewer/jt) s následujícími výhodami." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát soubor JT a stisknout tlačítko \"Zobrazit\"." >}}
