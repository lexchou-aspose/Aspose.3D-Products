---
title: Zobrazit 3MF formátů souborů prostřednictvím .NET 
weight: 3640
url: /cs/net/viewer/3mf/ 
description: C# zdrojový kód pro načtení, vykreslení a zobrazení 3MF dokumentů v .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="3MF Prohlížeč souborů for .NET" h2="Vykreslete 3MF souborů bez jakéhokoli 3D modelovacího a vykreslovacího softwaru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="3MF" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="3MF" >}}
...
{{% blocks/products/pf/agp/content h2="Jak zobrazit soubor 3MF pomocí C#" %}}

 K zobrazení souboru 3MF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k zobrazení 3MF prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D umožňuje vývojářům snadno zobrazit soubor 3MF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor 3MF pomocí konstruktoru třídy Scene1. Vytvořte instanci Html5SaveOptions1. Nastavte vlastnosti pro pokročilé formátování1. Zavolejte metodu Scene.Save s objektem Html5SaveOptions1. Zkontrolujte výsledný soubor HTML ve výchozím prohlížeči
...
{{% blocks/products/pf/agp/code-block title="C# kód k zobrazení 3MF" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// načíst scénu 3MF prostřednictvím instance Scene
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D je CAD a herní software API k načítání, úpravě a převodu souborů 3D. API je samostatný a nevyžaduje žádný 3D modelovací nebo vykreslovací software. Lze snadno použít API pro Discreet3DS, WavefrontOBJ, STL (ASCII, binární), Universal3D, FBX (ASCII, binární), Collada, glTF, PLY, GLB, DirectX a další formáty. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace k zobrazení 3MF" sectionDescription="Podívejte se na naše živé ukázky [Zobrazit 3MF](https://products.aspose.app/3d/viewer/3mf) s následujícími výhodami." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát soubor 3MF a stisknout tlačítko \"Zobrazit\"." >}}
