---
title: Zobrazit formáty souborů X prostřednictvím .NET 
weight: 2050
url: /cs/net/viewer/x/ 
description: Zdrojový kód C# pro načtení, vykreslení a zobrazení X dokumentů na .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Prohlížeč souborů X for .NET" h2="Vykreslujte soubory X bez jakéhokoli softwaru pro modelování a vykreslování 3D." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="X" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="X" >}}
...
{{% blocks/products/pf/agp/content h2="Jak zobrazit soubor X pomocí C#" %}}

 K zobrazení souboru X použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k zobrazení X prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D usnadňuje vývojářům zobrazení souboru X pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor X pomocí konstruktoru třídy Scene1. Vytvořte instanci Html5SaveOptions1. Nastavte vlastnosti pro pokročilé formátování1. Zavolejte metodu Scene.Save s objektem Html5SaveOptions1. Zkontrolujte výsledný soubor HTML ve výchozím prohlížeči
...
{{% blocks/products/pf/agp/code-block title="C# kód pro zobrazení X" offSpacer="" %}}

```cs

string output = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".html";

// načíst X scénu prostřednictvím instance Scene
...
<!-- aboutfile Starts -->
 ...
 Aspose.3D je CAD a herní software API k načítání, úpravě a převodu souborů 3D. API je samostatný a nevyžaduje žádný 3D modelovací nebo vykreslovací software. Lze snadno použít API pro Discreet3DS, WavefrontOBJ, STL (ASCII, binární), Universal3D, FBX (ASCII, binární), Collada, glTF, PLY, GLB, DirectX a další formáty. 
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro zobrazení X" sectionDescription="Podívejte se na naše živé ukázky [Zobrazit X](https://products.aspose.app/3d/viewer/x) s následujícími výhodami." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát soubor X a stisknout tlačítko \"Zobrazit\"." >}}
