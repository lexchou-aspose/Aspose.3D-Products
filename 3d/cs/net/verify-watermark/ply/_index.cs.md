---
title: Přidat slepé ověření vodoznaku do PLY formátů souborů prostřednictvím .NET 
weight: 830
url: /cs/net/verify-watermark/ply/ 
description: C# zdrojový kód pro načtení, vykreslení a přidání slepého ověření vodoznaku do PLY dokumentů na .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Přidat ověření slepého vodoznaku do PLY prostřednictvím C#" h2="Sestavte si své vlastní aplikace .NET a přidejte k souborům PLY ověření slepého vodoznaku pomocí rozhraní API na straně serveru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/3d/aspose_3d-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PLY" pfName="Aspose.3D" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PLY" >}}
...
{{% blocks/products/pf/agp/content h2="Jak ověřit vodoznak do souboru PLY pomocí C#" %}}

 K ověření vodoznaku použijeme soubor PLY
...
{{% blocks/products/pf/agp/feature-section-col title="Postup přidání ověření slepého vodoznaku do PLY prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.3D umožňuje vývojářům snadno přidat ověření slepého vodoznaku do souboru PLY pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

- Načtěte soubor PLY pomocí konstruktoru třídy Scene- Získejte třídu sítě Aspose.3D- Přidejte heslo pomocí metody DecodeWatermark společnosti Aspose.3D- Zavolejte metodu Scene.Save s objektem
...
{{% blocks/products/pf/agp/code-block title="C# kód pro přidání slepého ověření vodoznaku do PLY" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Bezplatná aplikace pro přidání ověření slepého vodoznaku do PLY" sectionDescription="Podívejte se na naše živé ukázky [Ověření vodoznaku PLY](https://products.aspose.app/3d/verify-watermark/ply) s následujícími výhodami." >}}
